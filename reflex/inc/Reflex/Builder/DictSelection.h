// @(#)root/reflex:$Id: DictSelection.h,v 1.5 2006/04/18 07:35:09 roiser Exp $
 ...
 * @c ROOT::Reflex::selection::C.  If you have such a class, it will be found
 * automatically.  If @c C is in a namespace, @c NS::C, then
 * the selection class should be in the same namespace: @c ROOT::Reflex::selection::NS::C.
 * Examples:
 *
 * @code
 *   namespace N {
 ...
 * generator will look for a class @c ROOT::Reflex::selection::C\<T> (with the same
 ...
 * struct foo_selection { ROOT::Reflex::selection::C<int> x; }
 @endcode
 *
 ...
 * @code
 *
 * template <class T> class ROOT::Reflex::selection::C; // forward declaration
 * 
 * template <class T>
 * class C
 * {
 *   ...
 *   typedef typename ROOT::Reflex::selection::C<T>::self DictSelection;
 * };
 *
 *   namespace ROOT {
 *     namespace Reflex {
 ...
 * @code
 *
 *   typedef ROOT::Reflex::selection::C<T> DictSelection;
 *
 @endcode
 *
 * then @c ROOT::Reflex::selection::C\<T> will not be fully instantiated.
 *
 ...
 *
 *   @code
 *   template <class T, class U> class ROOT::Reflex::selection::C; // forward declaration
 * 
...
#endif // ROOT_Reflex_DictSelection

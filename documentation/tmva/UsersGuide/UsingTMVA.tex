...
\caption[.]{\optionCaptionSize 
     ...
     mode (\ie, when the '\code{-b}' option of the CLING interpreter is invoked). 
...
TMVA provides simple GUIs (\code{TMVA::TMVAGui()},
\code{TMVA::TMVARegGui()} and \code{TMVA::TMVAMultiClassGui()}
\index{Graphical user interface (GUI)}, see
...
\caption[.]{\programCaptionSize ROOT macros for the representation of the 
         ...
         \code{TMVA.root}). They are conveniently called via the \code{TMVA::TMVAGui()} GUI
         (the first three macros are also called from the regression GUI \code{TMVA::TMVARegGui()}).      
...
\caption[.]{\programCaptionSize ROOT macros for the representation of the 
         ...
         are conveniently called from the \code{TMVA::TMVARegGui()} GUI. 
         \index{ROOT!macros}}

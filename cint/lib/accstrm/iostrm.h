 ...
 ************************************************************************
 * Description:
 *  Stub file for making iostream library for aCC.
 ************************************************************************
 * Copyright(c) 2001-2004   Masaharu Goto (MXJ02154@niftyserve.or.jp)
 *
...
private:
  basic_iostream(const basic_iostream& x);  // not implemented
  basic_iostream& operator=(const basic_iofstream& x); // not implemented
};

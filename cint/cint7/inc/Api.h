...
inline
   G__EXPORT
#endif
   G__pGenerateDictionary G__GetGenerateDictionary() { return 0; }
...
struct G__dictposition {
   ...
   Reflex::Scope var; // struct G__var_array *var;
   int ig15;
   /* struct tagnum */
   int tagnum;
   /* const string table */
   ...
   /* typedef table */
   int typenum; // CHECKME Should probably be replaced by an iterator of some sort.
   /* global function table position */
   Reflex::Scope ifunc; // G__ifunc_table *ifunc;
   int ifn;
   /* include path */

        ...
        *known3=0;
        ...
        case G__CALLCONSTRUCTOR:
          ...
          if (G__asm_noverflow || !G__no_exec_compile) {
            if (!G__const_noerror) {
              G__fprinterr(G__serr, "Error: Can't call %s::%s in current scope (1)", G__struct.name[G__get_tagnum(G__tagnum)], item);
            }
            G__genericerror(0);
          }
          store_exec_memberfunc=G__exec_memberfunc;
            ...
            *known3 = 0;
            switch (memfunc_flag) {
               ...
               case G__CALLCONSTRUCTOR:
                  ...
                  if (G__asm_noverflow || !G__no_exec_compile) {
                     if (!G__const_noerror) {
                        G__fprinterr(G__serr, "Error: Can't call %s::%s in current scope (2)", G__struct.name[G__get_tagnum(G__tagnum)], item);
                     }
                     G__genericerror(0);
                  }
                  store_exec_memberfunc = G__exec_memberfunc;
     ...
     if(G__TRYNORMAL==memfunc_flag
       ...
       while(target!=-1 && cursor==target) {
          ...
          // to remove the while loop
           ...
           if(G__asm_noverflow
              && (!G__throwingexception || 
                  (-1!=G__get_tagnum(G__value_typenum(result3).RawType()) &&
                   G__CPPLINK!=G__struct.iscpplink[G__get_tagnum(G__value_typenum(result3).RawType())]))
              ) {
             G__asm_inst[G__asm_cp]=G__POPTEMP;
...
/******************************************************************
* G__compiled_func_cxx() - C++ wrapper around G__compiled_func
******************************************************************/

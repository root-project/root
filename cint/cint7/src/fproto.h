...
struct G__funclist* G__add_templatefunc(char *funcnamein,struct G__param *libp,int hash,struct G__funclist *funclist,const ::Reflex::Scope &p_ifunc,int isrecursive);

...
class G__bc_funccall {
 public:
  ...
  G__bc_funccall(struct G__bytecodefunc* bc
                 ,char* localmem,char* struct_offset,int line_number
 ...
 private:
  ...
  char* m_localmem;                    // 0 if not in function
  char* m_struct_offset;               // 0 if static function
  int m_line_number;                  
...
class G__bc_funccallstack {
 ...
 private:
  ...
  std::deque<G__bc_funccall> m_funccallstack;
};
/////////////////////////////////////////////////////////////////////

...
const clang::Decl* G = lookup->tryGetScope("");
printf("G: 0x%lx\n", (unsigned long) G);
...
const clang::Decl* class_A = lookup->tryGetScope("A");
printf("class_A: 0x%lx\n", (unsigned long) class_A);
//CHECK: class_A: 0x{{[1-9a-f][0-9a-f]*$}}

const clang::Decl* class_B = lookup->tryGetScope("B");
...
const clang::Decl* namespace_N = lookup->tryGetScope("N");
...
const clang::FunctionDecl* G_f_args = lookup->tryGetFunctionArgs(G, "G_f", "");
const clang::FunctionDecl* G_f_proto = lookup->tryGetFunctionProto(G, "G_f", "");
...
const clang::FunctionDecl* G_a_args = lookup->tryGetFunctionArgs(G, "G_a", "0");
const clang::FunctionDecl* G_a_proto = lookup->tryGetFunctionProto(G, "G_a", "int");
...
const clang::FunctionDecl* G_b_args = lookup->tryGetFunctionArgs(G, "G_b", "0,0.0");
const clang::FunctionDecl* G_b_proto = lookup->tryGetFunctionProto(G, "G_b", "int,double");
...
const clang::FunctionDecl* G_c1_args = lookup->tryGetFunctionArgs(G, "G_c", "0,0");
const clang::FunctionDecl* G_c1_proto = lookup->tryGetFunctionProto(G, "G_c", "int,int");
...
const clang::FunctionDecl* G_c2_args = lookup->tryGetFunctionArgs(G, "G_c", "0,0.0");
const clang::FunctionDecl* G_c2_proto = lookup->tryGetFunctionProto(G, "G_c", "int,double");
...
const clang::FunctionDecl* G_d1_args = lookup->tryGetFunctionArgs(G, "G_d<int>", "0");
const clang::FunctionDecl* G_d1_proto = lookup->tryGetFunctionProto(G, "G_d<int>", "int");
...
const clang::FunctionDecl* G_d2_args = lookup->tryGetFunctionArgs(G, "G_d<double>", "0.0");
const clang::FunctionDecl* G_d2_proto = lookup->tryGetFunctionProto(G, "G_d<double>", "double");
...
const clang::FunctionDecl* H_f_args = lookup->tryGetFunctionArgs(namespace_N, "H_f", "");
const clang::FunctionDecl* H_f_proto = lookup->tryGetFunctionProto(namespace_N, "H_f", "");
...
const clang::FunctionDecl* H_a_args = lookup->tryGetFunctionArgs(namespace_N, "H_a", "0");
const clang::FunctionDecl* H_a_proto = lookup->tryGetFunctionProto(namespace_N, "H_a", "int");
...
const clang::FunctionDecl* H_b_args = lookup->tryGetFunctionArgs(namespace_N, "H_b", "0,0.0");
const clang::FunctionDecl* H_b_proto = lookup->tryGetFunctionProto(namespace_N, "H_b", "int,double");
...
const clang::FunctionDecl* H_c1_args = lookup->tryGetFunctionArgs(namespace_N, "H_c", "0,0");
const clang::FunctionDecl* H_c1_proto = lookup->tryGetFunctionProto(namespace_N, "H_c", "int,int");
...
const clang::FunctionDecl* H_c2_args = lookup->tryGetFunctionArgs(namespace_N, "H_c", "0,0.0");
const clang::FunctionDecl* H_c2_proto = lookup->tryGetFunctionProto(namespace_N, "H_c", "int,double");
...
const clang::FunctionDecl* H_d1_args = lookup->tryGetFunctionArgs(namespace_N, "H_d<int>", "0");
const clang::FunctionDecl* H_d1_proto = lookup->tryGetFunctionProto(namespace_N, "H_d<int>", "int");
...
const clang::FunctionDecl* H_d2_args = lookup->tryGetFunctionArgs(namespace_N, "H_d<double>", "0.0");
const clang::FunctionDecl* H_d2_proto = lookup->tryGetFunctionProto(namespace_N, "H_d<double>", "double");
...
const clang::FunctionDecl* func_A_f_args = lookup->tryGetFunctionArgs(class_A, "A_f", "");
const clang::FunctionDecl* func_A_f_proto = lookup->tryGetFunctionProto(class_A, "A_f", "");
...
const clang::FunctionDecl* func_A_g_args = lookup->tryGetFunctionArgs(class_A, "A_g", "0");
const clang::FunctionDecl* func_A_g_proto = lookup->tryGetFunctionProto(class_A, "A_g", "int");
...
const clang::FunctionDecl* func_A_h_args = lookup->tryGetFunctionArgs(class_A, "A_h", "0,0.0");
const clang::FunctionDecl* func_A_h_proto = lookup->tryGetFunctionProto(class_A, "A_h", "int,double");
...
const clang::FunctionDecl* func_A_j1_args = lookup->tryGetFunctionArgs(class_A, "A_j", "0,0");
const clang::FunctionDecl* func_A_j1_proto = lookup->tryGetFunctionProto(class_A, "A_j", "int,int");
...
const clang::FunctionDecl* func_A_j2_args = lookup->tryGetFunctionArgs(class_A, "A_j", "0,0.0");
const clang::FunctionDecl* func_A_j2_proto = lookup->tryGetFunctionProto(class_A, "A_j", "int,double");
...
const clang::FunctionDecl* func_A_k1_args = lookup->tryGetFunctionArgs(class_A, "A_k<int>", "0");
const clang::FunctionDecl* func_A_k1_proto = lookup->tryGetFunctionProto(class_A, "A_k<int>", "int");
...
const clang::FunctionDecl* func_A_k2_args = lookup->tryGetFunctionArgs(class_A, "A_k<double>", "0.0");
const clang::FunctionDecl* func_A_k2_proto = lookup->tryGetFunctionProto(class_A, "A_k<double>", "double");
...
const clang::FunctionDecl* func_A_m_args = lookup->tryGetFunctionArgs(class_A, "A_m", "0");
const clang::FunctionDecl* func_A_m_proto = lookup->tryGetFunctionProto(class_A, "A_m", "const int&");
...
const clang::FunctionDecl* func_B_F_args = lookup->tryGetFunctionArgs(class_A, "B_f", "");
const clang::FunctionDecl* func_B_F_proto = lookup->tryGetFunctionProto(class_A, "B_f", "");
...
const clang::FunctionDecl* func_B_G_args = lookup->tryGetFunctionArgs(class_A, "B_g", "0");
const clang::FunctionDecl* func_B_G_proto = lookup->tryGetFunctionProto(class_A, "B_g", "int");
...
const clang::FunctionDecl* func_B_h_args = lookup->tryGetFunctionArgs(class_A, "B_h", "0,0.0");
const clang::FunctionDecl* func_B_h_proto = lookup->tryGetFunctionProto(class_A, "B_h", "int,double");
...
const clang::FunctionDecl* func_B_j1_args = lookup->tryGetFunctionArgs(class_A, "B_j", "0,0");
const clang::FunctionDecl* func_B_j1_proto = lookup->tryGetFunctionProto(class_A, "B_j", "int,int");
...
const clang::FunctionDecl* func_B_j2_args = lookup->tryGetFunctionArgs(class_A, "B_j", "0,0.0");
const clang::FunctionDecl* func_B_j2_proto = lookup->tryGetFunctionProto(class_A, "B_j", "int,double");
...
const clang::FunctionDecl* func_B_k1_args = lookup->tryGetFunctionArgs(class_A, "B_k<int>", "0");
const clang::FunctionDecl* func_B_k1_proto = lookup->tryGetFunctionProto(class_A, "B_k<int>", "int");
...
const clang::FunctionDecl* func_B_k2_args = lookup->tryGetFunctionArgs(class_A, "B_k<double>", "0.0");
const clang::FunctionDecl* func_B_k2_proto = lookup->tryGetFunctionProto(class_A, "B_k<double>", "double");
...
const clang::FunctionDecl* func_B_m_args = lookup->tryGetFunctionArgs(class_A, "B_m", "0");
const clang::FunctionDecl* func_B_m_proto = lookup->tryGetFunctionProto(class_A, "B_m", "const int&");
...
//
//
const clang::FunctionDecl* func_B_ctr1_args = lookup->tryGetFunctionArgs(class_B, "B", "");
const clang::FunctionDecl* func_B_ctr1_proto = lookup->tryGetFunctionProto(class_B, "B", "");
...
const clang::FunctionDecl* func_B_ctr2_args = lookup->tryGetFunctionArgs(class_B, "B", "0,0.0");
const clang::FunctionDecl* func_B_ctr2_proto = lookup->tryGetFunctionProto(class_B, "B", "int,double");
...
const clang::FunctionDecl* func_B_ctr3_args = lookup->tryGetFunctionArgs(class_B, "B", "'a'");
const clang::FunctionDecl* func_B_ctr3_proto = lookup->tryGetFunctionProto(class_B, "B", "char");
...
const clang::FunctionDecl* func_B_ctr4_args = lookup->tryGetFunctionArgs(class_B, "B", "(char*)0");
const clang::FunctionDecl* func_B_ctr4_proto = lookup->tryGetFunctionProto(class_B, "B", "char*");
...
const clang::FunctionDecl* func_B_dtr_args = lookup->tryGetFunctionArgs(class_B, "~B", "");
const clang::FunctionDecl* func_B_dtr_proto = lookup->tryGetFunctionProto(class_B, "~B", "");
...
const clang::FunctionDecl* func_B_new_args = lookup->tryGetFunctionArgs(class_B, "operator new", "sizeof(B)");
const clang::FunctionDecl* func_B_new_proto = lookup->tryGetFunctionProto(class_B, "operator new", "std::size_t");
...
const clang::FunctionDecl* func_B_new_plcmt_args = lookup->tryGetFunctionArgs(class_B, "operator new", "sizeof(B),((B*)&b_arena[0])+2");
const clang::FunctionDecl* func_B_new_plcmt_proto = lookup->tryGetFunctionProto(class_B, "operator new", "std::size_t,void*");
...
const clang::FunctionDecl* func_B_new_ary_args = lookup->tryGetFunctionArgs(class_B, "operator new[]", "sizeof(B)*3");
const clang::FunctionDecl* func_B_new_ary_proto = lookup->tryGetFunctionProto(class_B, "operator new[]", "std::size_t");
...
const clang::FunctionDecl* func_B_new_ary_plcmt_args = lookup->tryGetFunctionArgs(class_B, "operator new[]", "sizeof(B)*3,&b_ary_arena[0]");
const clang::FunctionDecl* func_B_new_ary_plcmt_proto = lookup->tryGetFunctionProto(class_B, "operator new[]", "std::size_t,void*");
...
const clang::FunctionDecl* func_B_del_args = lookup->tryGetFunctionArgs(class_B, "operator delete", "b_ptr");
const clang::FunctionDecl* func_B_del_proto = lookup->tryGetFunctionProto(class_B, "operator delete", "void*");
...
const clang::FunctionDecl* func_B_del_plcmt_args = lookup->tryGetFunctionArgs(class_B, "operator delete", "((B*)&b_arena[0])+2,&b_arena[0]");
const clang::FunctionDecl* func_B_del_plcmt_proto = lookup->tryGetFunctionProto(class_B, "operator delete", "void*,void*");
...
const clang::FunctionDecl* func_B_del_ary_args = lookup->tryGetFunctionArgs(class_B, "operator delete[]", "b_ary");
const clang::FunctionDecl* func_B_del_ary_proto = lookup->tryGetFunctionProto(class_B, "operator delete[]", "void*");
...
const clang::FunctionDecl* func_B_del_ary_plcmt_args = lookup->tryGetFunctionArgs(class_B, "operator delete[]", "(B*)b_arena[3],&b_arena[0]");
const clang::FunctionDecl* func_B_del_ary_plcmt_proto = lookup->tryGetFunctionProto(class_B, "operator delete[]", "void*,void*");
...
const clang::FunctionDecl* func_B_star_args = lookup->tryGetFunctionArgs(class_B, "operator*", "");
const clang::FunctionDecl* func_B_star_proto = lookup->tryGetFunctionProto(class_B, "operator*", "");
...
const clang::FunctionDecl* func_B_plus_args = lookup->tryGetFunctionArgs(class_B, "operator+", "b_obj");
const clang::FunctionDecl* func_B_plus_proto = lookup->tryGetFunctionProto(class_B, "operator+", "B");

...
INCLUDEFILES += $(CINTDEP) $(CINTEXEDEP) $(CINTCONF)
...
$(CINTCONF): config/Makefile.$(ARCH)
	...
	echo '#define G__CFG_CINTSYSDIR "/home/axel/cint"' >> $@ && \
	echo '#define G__CFG_HAVE_CONFIG "1"' >> $@ && \
	echo '#define CINTSYSDIR "C:/cygwin/home/axel/cint"' >> $@ && \
	echo '#define G__CFG_MAKEIMPLIB ""' >> $@ && \
	echo '#define G__CFG_HAVE_CONFIG "1"' >> $@ \
	)
##### configcint.h - END

...
static int G__G__stream_4_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   else p=::new((G__iccstrmdOcxx_tag*)G__getgvp()) mbstate_t;
...
,(void*)NULL,0);
   G__memfunc_setup("operator>>",1000,G__G__stream__5_16,117,G__get_linked_tagnum(&G__G__streamLN_basic_istreamlEcharcOchar_traitslEchargRsPgR),-1,1,2,1,1,0,

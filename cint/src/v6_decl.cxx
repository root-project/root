...
* G__rawvarentry()
**************************************************************************/
static struct G__var_array *G__rawvarentry(char *name,int hash
                                           ,int *pig15,G__var_array *var)
{
  int ig15=0;
  while(var) {
...
*                                 ^     or     ^
******************************************************************/
void G__define_var(int tagnum,int typenum) /* overrides global variables */
{
  G__value reg;
  char var_type;
  int cin='\0';
...
* G__incmemvar()
**************************************************************************/
G__var_array* G__incmemvar( G__var_array *memvar,int *pindex
                           ,G__value *pbuf)
{

...
{
  result->ref = result->obj.i;
  result->obj.ll = (*(long long*)(result->obj.i));
...
{
  result->ref = result->obj.i;
  result->obj.ull = (*(unsigned long long*)(result->obj.i));
  result->type = tolower(result->type);
}
/******************************************************************
...
long ig15;
{
  ...
  buf->typenum = var->p_typetable[ig15];
  buf->ref = var->p[ig15]+offset;       
  buf->obj.ull = *(unsigned long long*)buf->ref;
}
/****************************************************************
* G__LD_p0_longdouble()
****************************************************************/
...
long ig15;
{
  ...
  buf->type = 'n';                                   
  buf->typenum = var->p_typetable[ig15];               
  buf->ref = var->p[ig15]+offset+buf->obj.i*sizeof(long long); 
  if(buf->obj.i-1>var->varlabel[ig15][1])              
    G__arrayindexerror(ig15,var,var->varnamebuf[ig15],buf->obj.i);  
  else                                                 
    buf->obj.ll = *(long long*)buf->ref;
...
long ig15;
{
  ...
  buf->type = 'm';                                   
  buf->typenum = var->p_typetable[ig15];               
  buf->ref = var->p[ig15]+offset+buf->obj.i*sizeof(unsigned long long); 
  if(buf->obj.i-1>var->varlabel[ig15][1])              
    G__arrayindexerror(ig15,var,var->varnamebuf[ig15],buf->obj.i);  
  else                                                 
    buf->obj.ull = *(unsigned long long*)buf->ref;
...
long ig15;
{
  ...
  buf->type = 'n';                                   
  buf->typenum = var->p_typetable[ig15];               
  buf->ref = var->p[ig15]+offset+p_inc*sizeof(long long); 
  if(p_inc-1>var->varlabel[ig15][1])                   
    G__arrayindexerror(ig15,var,var->varnamebuf[ig15],p_inc);  
  else                                                 
    buf->obj.ll = *(long long*)buf->ref;
...
long ig15;
{
  ...
  buf->type = 'm';                                   
  buf->typenum = var->p_typetable[ig15];               
  buf->ref = var->p[ig15]+offset+p_inc*sizeof(unsigned long long); 
  if(p_inc-1>var->varlabel[ig15][1])                   
    G__arrayindexerror(ig15,var,var->varnamebuf[ig15],p_inc);  
  else                                                 
    buf->obj.ull = *(unsigned long long*)buf->ref;
...
long ig15;
{
  ...
  buf->type = 'n';               
  buf->typenum = var->p_typetable[ig15];  
  buf->ref = *(long*)(var->p[ig15]+offset)+buf->obj.i*sizeof(long long); 
  buf->obj.i = *(long long*)buf->ref;
}
/****************************************************************
* G__LD_P10_ulonglong()
****************************************************************/
...
long ig15;
{
  ...
  buf->type = 'm';               
  buf->typenum = var->p_typetable[ig15];  
  buf->ref=*(long*)(var->p[ig15]+offset)+buf->obj.i*sizeof(unsigned long long);
  buf->obj.i = *(unsigned long long*)buf->ref;
}
/****************************************************************
...
long ig15;
{
  ...
  case 'd':
  case 'f':
    llval = (long long)val->obj.d;
    break;
  case 'n':
    llval = (long long)val->obj.ll;
    break;
  case 'm':
    llval = (long long)val->obj.ull;
    break;
  case 'q':
    llval = (long long)val->obj.ld;
    break;
  default:
    llval = (long long)val->obj.i;
    break;
  }  
  *(long long*)(var->p[ig15]+offset)=llval;
}
...
long ig15;
{
  ...
  case 'd':
  case 'f':
    ullval = (unsigned long long)val->obj.d;
    break;
  case 'n':
    ullval = (unsigned long long)val->obj.ll;
    break;
  case 'm':
    ullval = (unsigned long long)val->obj.ull;
    break;
  case 'q':
    ullval = (unsigned long long)val->obj.ld;
    break;
  default:
    ullval = (unsigned long long)val->obj.i;
    break;
  }  
  *(unsigned long long*)(var->p[ig15]+offset)=ullval;
}
/****************************************************************
* G__ST_p0_longdouble()
****************************************************************/
...
long ig15;
{
  ...
  if(val->obj.i>var->varlabel[ig15][1])                          
    ...
    *(long long*)(var->p[ig15]+offset+val->obj.i*sizeof(long long)) 
            = (long long)G__Longlong(pbuf[*psp-2]);                    
  --(*psp);
}
/****************************************************************
* G__ST_p1_ulonglong()
...
long ig15;
{
  ...
  if(val->obj.i>var->varlabel[ig15][1])                          
    ...
    *(unsigned long long*)(var->p[ig15]+offset+val->obj.i*sizeof(unsigned long long)) 
            = (unsigned long long)G__ULonglong(pbuf[*psp-2]); 
  --(*psp);
}
/****************************************************************
* G__ST_p1_longdouble()
...
long ig15;
{
  ...
  if(p_inc>var->varlabel[ig15][1])                               
    ...
    *(long long*)(var->p[ig15]+offset+p_inc*sizeof(long long))   
      = (long long)G__Longlong(pbuf[*psp-1]);
}
...
long ig15;
{
  ...
  if(p_inc>var->varlabel[ig15][1])                               
    ...
    *(unsigned long long*)(var->p[ig15]+offset+p_inc*sizeof(unsigned long long))   
      = (unsigned long long)G__ULonglong(pbuf[*psp-1]);
}
...
{
  G__value *val = &pbuf[*psp-1];                                          
  *(long long*)(*(long*)(var->p[ig15]+offset)+val->obj.i*sizeof(long long)) 
            = (long long)G__Longlong(pbuf[*psp-2]);
  --(*psp);
}
/****************************************************************
...
{
  G__value *val = &pbuf[*psp-1];                                          
  *(unsigned long long*)(*(long*)(var->p[ig15]+offset)+val->obj.i*sizeof(unsigned long long)) 
            = (unsigned long long)G__ULonglong(pbuf[*psp-2]);
  --(*psp);
}
/****************************************************************
...
G__value *bufm2;
{
  ...
  if('q'==bufm2->type || 'q'==bufm1->type) {
    ...
    *(long double*)bufm2->ref = bufm2->obj.ld;
    ...
    bufm2->obj.ll=G__Longlong(*bufm2)+G__Longlong(*bufm1);
    bufm2->type='n';
    *(long long*)bufm2->ref = bufm2->obj.ll;
  }
  else if('m'==bufm2->type || 'm'==bufm1->type) {
    bufm2->obj.ull=G__ULonglong(*bufm2)+G__ULonglong(*bufm1);
    bufm2->type='m';
    *(unsigned long long*)bufm2->ref = bufm2->obj.ull;
  }
  else 
#endif
  if(G__isdoubleM(bufm2)) {

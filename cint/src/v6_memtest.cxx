...
#endif
#ifndef G__FONS31
    G__fprinterr("free(0x%lx) not allocated",(long)p);
#else
    G__fprinterr("free(0x%x) not allocated",p);
#endif
...
#endif
#ifndef G__FONS31
    G__fprinterr("realloc(0x%lx,%d) not allocated",(long)p,size);
#else
    G__fprinterr("realloc(0x%x,%d) not allocated",p,size);
#endif
    G__genericerror((char*)NULL);
  }
#ifdef G__DUMPMEMHISTORY
...
#endif
#ifndef G__FONS31
      G__fprinterr("0x%lx\talive=%d\tuse=%d i=%d\tERROR %s\n"
	      ,(long)G__mem[i].p,G__mem[i].alive,G__mem[i].use,i ,G__mem[i].type);
#else
      G__fprinterr("0x%x\talive=%d\tuse=%d i=%d\tERROR %s\n"
	      ,G__mem[i].p,G__mem[i].alive,G__mem[i].use,i ,G__mem[i].type);
#endif
    }
    else {
...
#endif
#endif
    G__fprinterr("fclose(0x%lx) not opened",(long)p);
    G__genericerror((char*)NULL);
  }
#ifdef G__DUMPMEMHISTORY
  fflush(G__memhist);

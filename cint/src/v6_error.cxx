...
char *name;
{
  ...
  G__fprinterr( "Limitation: %s is not supported", name);
  G__printlinenum();
...
char *varname;
{
  G__fprinterr("Internal Error: malloc failed for %s", varname);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
...
int p_inc;
{
  ...
  G__fprinterr("Error: Array index out of range %s -> [%d] " ,item,p_inc);
  G__fprinterr(" valid upto %s",var->varnamebuf[ig15]);
  if(var->varlabel[ig15][1]!=0)
    G__fprinterr("[%d]",(var->varlabel[ig15][1]+1)/var->varlabel[ig15][0]-1);
  ig25=2;
  while(ig25<var->paran[ig15]+1) {
    G__fprinterr("[%d]",var->varlabel[ig15][ig25]-1);
    ig25++;
  }
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
...
int num;
{
  G__fprinterr("Loop Compile Internal Error: %s %d ",message,num);
...
G__value *pbuf;
{
  if(0==G__prerun) {
    if(pbuf->type) {
      G__fprinterr("Error: Incorrect assignment to %s, wrong type '%s'"
	      ,item ,G__type2string(pbuf->type ,pbuf->tagnum ,pbuf->typenum
				    ,pbuf->obj.reftype.reftype,0));
    }
    else {
      G__fprinterr("Error: Incorrect assignment to %s ",item);
    }
    G__genericerror((char*)NULL);
  }
#ifdef G__SECURITY
...
char *item;
{
  G__fprinterr("Error: Incorrect referencing of %s ",item);
  G__genericerror((char*)NULL);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
#endif
...
{
  G__eof=2;
  G__fprinterr("Error: Unexpected EOF %s",message);
...
#endif
  if(0==G__cpp) 
    G__fprinterr("Advice: You may need to use +P or -p option\n");
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
#endif
...
{
  G__fprinterr("%s: Failed to load Dynamic link library %s\n",message,shlname);
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
#endif
...
char *item;
{
  G__fprinterr("Error: G__getvariable: expression %s",item);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
...
char *new_name;
{
  G__fprinterr("Error: Can't take address for reference type %s",new_name);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
...
char *item;
{
  G__fprinterr("Limitation: Pointer to pointer %s not supported",item);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__DANGEROUS;
...
char *expr;
{
  G__fprinterr("Syntax Error: %s",expr);
  G__genericerror((char*)NULL);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
#endif
...
char *item;
{
  G__fprinterr("Error: trying to assign to %s",item);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
...
{
  G__fprinterr("Syntax error: %s: Parenthesis or quotation unmatch %s"
	  ,funcname ,expression);
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
...
int G__commenterror()
{
  G__fprinterr( "Syntax error: Unexpected '/' Comment?");
  G__printlinenum();
  G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
  G__security_error = G__RECOVERABLE;
...
char *item,*categ;
{
  G__fprinterr("Warning: Re-initialization %s %s",categ,item);
  G__printlinenum();
  if(0==G__prerun) {
    G__CHECK(G__SECURE_EXIT_AT_ERROR,1,G__return=G__RETURN_EXIT1);
#ifdef G__SECURITY
...
char *message;
{
  ...
  if(G__ASM_FUNC_NOP==G__asm_wholefunction) {
    ...
    if(0==G__const_noerror) {
#endif
      if(message) G__fprinterr("%s",message);
      G__printlinenum();
...
#endif
    G__fprinterr("Report: Unrecognized string '%s' ignored",statement);
    G__printlinenum();
  }
  return(0);
}
...
{
  if(d<low||up<d) { 
    G__fprinterr("Error: %s param[%d]=%g up:%g low:%g out of range"
	    ,funcname,p,d,up,low); 
    G__genericerror((char*)NULL); 
    *result7=G__null; 
    return(1); 
...
char *funcname;
{
  if(l<low||up<l) { 
#ifndef G__FONS31
    G__fprinterr("Error: %s param[%d]=%ld up:%ld low:%ld out of range"
	    ,funcname,p,l,up,low); 
#else
    G__fprinterr("Error: %s param[%d]=%d up:%d low:%d out of range"
	    ,funcname,p,l,up,low); 
#endif
    G__genericerror((char*)NULL); 
    *result7=G__null; 
...
char *funcname;
{
  if(para->type!=t1 && para->type!=t2) {
    G__fprinterr("Error: %s param[%d] type mismatch",funcname,p); 
    G__genericerror((char*)NULL); 
    *result7=G__null; 
    return(1);
  }
...
#endif
  if(0==l) { 
    G__fprinterr("Error: %s param[%d]=%ld must not be 0",funcname,p,l); 
    G__genericerror((char*)NULL); 
    *result7=G__null; 
    return(1); 
  } 
    ...
    if('Y'!=t){
      G__fprinterr("Error: %s parameter mismatch param[%d] %c %c"
...
int ipara,paran;
{
  G__fprinterr("Warning: %s() expects %d parameters, %d parameters given"
...
char *item;
{
  G__fprinterr("Syntax Error: %s Maybe missing ';'",item);
  G__genericerror((char*)NULL);
  return(0);
}

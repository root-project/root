...
static void G__copysourcetotmp(G__FastAllocString &prepname,G__input_file *pifile, int fentry)
{
  if(G__copyflag && 0==prepname[0]) {
    ...
    /*strncpy(prepname,"(tmpfile)",G__MAXFILENAME);*/
...
{
  strncpy(G__cintsysdir,cintsysdir,G__MAXFILENAME);
}
...
#ifdef G__ROOT
#ifdef G__VMS
/*      snprintf(G__cintsysdir,G__MAXFILENAME-1,env);
      strncpy(&G__cintsysdir[strlen(G__cintsysdir)-1],".cint]",G__MAXFILENAME);*/
      snprintf(G__cintsysdir,G__MAXFILENAME-1,"%s[cint]",env);
#else /* G__VMS */
# ifdef ROOTBUILD
      snprintf(G__cintsysdir, G__MAXFILENAME-1, "%s", env);
# else /* ROOTBUILD */
#  ifdef CINTINCDIR
      snprintf(G__cintsysdir, G__MAXFILENAME-1, "%s", CINTINCDIR);
#  else
       if(G__UseCINTSYSDIR) {
          strncpy(G__cintsysdir,env, G__MAXFILENAME-1);
       } else {
          strncpy(G__cintsysdir,env, G__MAXFILENAME-1);
          strncat(G__cintsysdir,"/cint",G__MAXFILENAME-1-strlen(G__cintsysdir));
       }
#  endif
# endif /* ROOTBUILD */
#endif /* G__VMS */
...
# ifdef G__ROOT
        ...
        if(p) *p = 0;
        strncat(G__cintsysdir,G__psep,G__MAXFILENAME-1-strlen(G__cintsysdir));
        strncat(G__cintsysdir,"cint",G__MAXFILENAME-1-strlen(G__cintsysdir));
# endif
        return(EXIT_SUCCESS);
      }
...
int G__loadfile_tmpfile(FILE *fp)
{
  ...
  **********************************************/
  ...
  fentry = G__nfile;
  /* strncpy(G__ifile.name,"(tmpfile)",G__MAXFILENAME); */
  snprintf(G__ifile.name,G__MAXFILENAME-1,"(tmp%d)",fentry);
   ...
   for(int i2=0;i2<3;i2++) {
      if(2==i2) {
         if((len>3&& (strcmp(filename+len-3,".sl")==0 ||
            ...
            strncpy(filename+len-3,G__getmakeinfo1("DLLPOST"),G__MAXFILENAME-1-(len-3));
         }
         else if((len>4&& (strcmp(filename+len-4,".dll")==0 ||
                           strcmp(filename+len-4,".DLL")==0))) {
            strncpy(filename+len-4,G__getmakeinfo1("DLLPOST"),G__MAXFILENAME-1-(len-4));
         }
         else if((len>2&& (strcmp(filename+len-2,".a")==0 ||
                           strcmp(filename+len-2,".A")==0))) {
            strncpy(filename+len-2,G__getmakeinfo1("DLLPOST"),G__MAXFILENAME-1-(len-2));
         }
#if defined(R__FBSD) || defined(R__OBSD)
         else if (len>strlen(soext) &&
                  strcmp(filename+len-strlen(soext),soext)==0) {
            strncpy(filename+len-strlen(soext),G__getmakeinfo1("DLLPOST"),G__MAXFILENAME-1-(len+strlen(soext)));
         }
#endif
      }
      ...
      if (G__USERHEADER == G__kindofheader &&
         ...
         strncpy (p, filename, G__MAXFILENAME-1);
         strncat (p, addpost[i2], G__MAXFILENAME-1-strlen(p));
...
int G__loadfile(const char *filenamein)
{
  ...
  **********************************************/
  if(prepname[0]) {
     ...
     **********************************************/
     strncpy(G__ifile.name, filename,G__MAXFILENAME-1);
    ...
    for(i2=0;i2<3;i2++) {
      ...
      if (G__USERHEADER == G__kindofheader &&
          ...
          store_file.name[0] != '\0') {
        char* p;
        strncpy(G__ifile.name, store_file.name, G__MAXFILENAME-1);
#ifdef G__WIN32
        ...
        strncpy (p, filename, G__MAXFILENAME-1-(p-G__ifile.name));
        strncat (p, addpost[i2], G__MAXFILENAME -1 - strlen(p));
#ifndef G__WIN32
      ...
      if(G__USERHEADER==G__kindofheader) {
#ifdef G__VMS
         snprintf(G__ifile.name,G__MAXFILENAME-1,"./%s",filename());
#else
         snprintf(G__ifile.name,G__MAXFILENAME-1,"./%s%s",filename(),addpost[i2]);
#endif
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      while(G__ifile.fp==NULL && ipath->pathname) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"%s%s%s%s"
                ,ipath->pathname,G__psep,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      G__getcintsysdir();
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"%s%s%s%sinclude%s%s%s",G__cintsysdir,G__psep,G__CFG_COREVERSION
                ,G__psep,G__psep,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      G__getcintsysdir();
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"%s%s%s%sstl%s%s%s",G__cintsysdir, G__psep, G__CFG_COREVERSION,
                G__psep, G__psep, filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      /* G__getcintsysdir(); */
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"%s%s%s%slib%s%s%s",G__cintsysdir, G__psep, G__CFG_COREVERSION,
                G__psep, G__psep,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      G__getcintsysdir();
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"include%s%s%s"
                ,G__psep,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
      ...
      G__getcintsysdir();
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"stl%s%s%s"
                ,G__psep,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
         snprintf(G__ifile.name,G__MAXFILENAME-1,"/msdev/include/%s%s",filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
        G__ifile.fp = fopen(G__ifile.name,"rb");
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
         snprintf(G__ifile.name,G__MAXFILENAME-1,"/sc/include/%s%s",filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
        G__ifile.fp = fopen(G__ifile.name,"rb");
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
        /*  snprintf(G__ifile.name,G__MAXFILENAME-1,getenv("ROOTSYS"));
            snprintf(&G__ifile.name[strlen(G__ifile.name)-1],...,".include]%s",filename);*/
         snprintf(G__ifile.name,G__MAXFILENAME-1,"%s[include]%s",getenv("ROOTSYS"),filename());
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
        /*   snprintf(G__ifile.name,"%s",G__cintsysdir);
             snprintf(&G__ifile.name[strlen(G__ifile.name)-1],".include]%s",filename);*/
         snprintf(G__ifile.name,G__MAXFILENAME-1,"%s[include]%s",G__cintsysdir,filename());
      ...
      snprintf(G__ifile.name,G__MAXFILENAME-1,"sys$common:decc$lib.reference.decc$rtdef]%s",filename());
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
         snprintf(G__ifile.name,G__MAXFILENAME-1,"/usr/include/%s%s",filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
        G__ifile.fp = fopen(G__ifile.name,"rb");
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
         snprintf(G__ifile.name,G__MAXFILENAME-1,"/usr/include/g++/%s%s",filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
        G__ifile.fp = fopen(G__ifile.name,"rb");
...
/* #ifdef __hpux */
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
         snprintf(G__ifile.name,G__MAXFILENAME-1,"/usr/include/CC/%s%s",filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
        G__ifile.fp = fopen(G__ifile.name,"rb");
...
/* #ifdef __hpux */
       ...
       **********************************************/
      if('\0'!=G__cintsysdir[0]) {
        snprintf(G__ifile.name,G__MAXFILENAME-1,"/usr/include/codelibs/%s%s"
                ,filename(),addpost[i2]);
#ifndef G__WIN32
        G__ifile.fp = fopen(G__ifile.name,"r");
#else
...
int  G__setfilecontext(const char* filename, G__input_file* ifile)
{
   ...
   strncpy(G__ifile.name, G__srcfile[found_entry].filename,G__MAXFILENAME-1);
                   ...
                   ,const char *includepath)
{
  ...
  if(flag==0 && post) {
    if('\0'==G__cppsrcpost[0]) {
      strncpy(G__cppsrcpost,G__getmakeinfo1("CPPSRCPOST"),G__LENPOST-1);
    }
    if('\0'==G__csrcpost[0]) {
      strncpy(G__csrcpost,G__getmakeinfo1("CSRCPOST"),G__LENPOST-1);
    }
    if('\0'==G__cpphdrpost[0]) {
      strncpy(G__cpphdrpost,G__getmakeinfo1("CPPHDRPOST"),G__LENPOST-1);
    }
    if('\0'==G__chdrpost[0]) {
      strncpy(G__chdrpost,G__getmakeinfo1("CHDRPOST"),G__LENPOST-1);
    }
  ...
  if(cppflag && flag) {
    ...
    if('\0'==G__ccom[0]) {
      ...
      case G__CPPLINK: /* C++ link */
        strncpy(G__ccom,G__getmakeinfo("CPPPREP"),G__MAXFILENAME-1);
        break;
      case G__CLINK: /* C link */
        strncpy(G__ccom,G__getmakeinfo("CPREP"),G__MAXFILENAME-1);
        break;
      default:
        if(G__iscpp) strncpy(G__ccom,G__getmakeinfo("CPPPREP"),G__MAXFILENAME-1);
        else         strncpy(G__ccom,G__getmakeinfo("CPREP"),G__MAXFILENAME-1);
        break;
      }
      if('\0'==G__ccom[0]) {
#ifdef __GNUC__
        snprintf(G__ccom,G__MAXFILENAME,"g++ -E");
#else
        snprintf(G__ccom,G__MAXFILENAME,"CC -E");
#endif
      }
    }
       ...
       )
    {
      ...
      do {
        ...
        if(G__CPPLINK==G__globalcomp || G__iscpp) {
          ...
          strncpy(tmpfile+tmplen,G__cppsrcpost,G__MAXFILENAME-1-tmplen);
        }
        else {
          if('\0'==G__csrcpost[0]) {
            strncpy(G__csrcpost,G__getmakeinfo1("CSRCPOST"),G__LENPOST-1);
          }
          strncpy(tmpfile+tmplen,G__csrcpost,G__MAXFILENAME-1-tmplen);
        }
        fp = fopen(tmpfile,"w");
     ...
     ***************************************************************/
    strncat(outname,".i",,G__MAXFILENAME-1-strlen(outname));
    if(G__cintsysdir[0]) {
...
int G__setTMPDIR(char *badname)
{
  ...
  strncpy(G__tmpdir,G__input("Input TMPDIR > "),G__MAXFILENAME-1);
...
char* G__tmpnam(char *name)
{
  ...
  char *tmp;
  if('\0'==G__tmpdir[0]) {
    if((tmp=getenv("CINTTMPDIR"))) strncpy(G__tmpdir,tmp, G__MAXFILENAME-1);
    else if((tmp=getenv("TEMP"))) strncpy(G__tmpdir,tmp, G__MAXFILENAME-1);
    else if((tmp=getenv("TMP"))) strncpy(G__tmpdir,tmp, G__MAXFILENAME-1);
    else strncpy(G__tmpdir,".",G__MAXFILENAME-1);
  }
  if(name) {
    strncpy(name,(tmp=tempnam(G__tmpdir,"")),G__MAXFILENAME-1);
    free((void*)tmp);
    if(strlen(name)<G__MAXFILENAME-10)
      snprintf(name+strlen(name),G__MAXFILENAME-1-strlen(name),"%d%d",pid%10000,now%10000);
    if(strlen(name)<G__MAXFILENAME-6) strncat(name,appendix,G__MAXFILENAME-strlen(name));
    G__tmpfiles.Add(name);
    return(name);
  }
  else {
    strncpy(tempname,(tmp=tempnam(G__tmpdir,"")), G__MAXFILENAME-1);
    free((void*)tmp);
    size_t lentemp=strlen(tempname);
    if(lentemp<G__MAXFILENAME-10)
      snprintf(tempname+lentemp,G__MAXFILENAME-1-lentemp,"%d%d",pid%10000,now%10000);
    if(strlen(tempname)<G__MAXFILENAME-strlen(appendix)-1)
      strncat(tempname,appendix,G__MAXFILENAME-1-strlen(tempname));
  ...
  tmpnam(name);
  if(strlen(name)<G__MAXFILENAME-6) strncat(name,appendix,G__MAXFILENAME-1-strlen(name));
  G__tmpfiles.Add(name);
  return(name);
  ...
  if('\0'==tmpdir[0]) {
    ...
    else strncpy(tmpdir,"/tmp",G__MAXFILENAME-1);
  }

  if (name==0) name = tempname;
  strncpy(name, tmpdir,G__MAXFILENAME-1);

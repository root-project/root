...
#execute "${CXX} ${OPT} ${CINTCXXFLAGS} -I. -Icint ${CXXOUT}${STDFUNCDIR}/G__c_stdcxxfunc.o \
...
pwd=`pwd`
cd ${POSIXDIR}
echo "Running ${CC} ${OPT} ${CXXOUT}mktypes${EXESUF} mktypes.c"
${CC} ${OPT} ${CXXOUT}mktypes${EXESUF} mktypes.c
./mktypes
rm -f mktypes
...
execute "${CC} ${OPT} ${CINTCFLAGS} -I. ${CXXOUT}${POSIXDIR}/G__c_posix.o \
...
#execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIR} ${CXXOUT}${STLDIR}/G__cpp_string.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_vector.o
         -c ${STLDIR}/G__cpp_vector.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_vector.cxx -c vector \
         ${LINKDEFDIR}/vectorLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_vector.o  \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_list.o \
         -c ${STLDIR}/G__cpp_list.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_list.cxx -c list \
         ${LINKDEFDIR}/listLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_list.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_deque.o \
         -c ${STLDIR}/G__cpp_deque.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_deque.cxx -c deque \
         ${LINKDEFDIR}/dequeLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_deque.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_map.o \
         -c ${STLDIR}/G__cpp_map.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_map.cxx -c map ${LINKDEFDIR}/mapLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_map.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_map2.o \
         -c ${STLDIR}/G__cpp_map2.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_map2.cxx -c -DG__MAP2 map \
         ${LINKDEFDIR}/mapLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_map2.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_set.o \
         -c ${STLDIR}/G__cpp_set.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_set.cxx -c set ${LINKDEFDIR}/setLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_set.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_multimap.o \
         -c ${STLDIR}/G__cpp_multimap.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_multimap.cxx -c map \
         ${LINKDEFDIR}/multimapLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_multimap.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_multimap2.o \
         -c ${STLDIR}/G__cpp_multimap2.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_multimap2.cxx -c -DG__MAP2 map \
         ${LINKDEFDIR}/multimapLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_multimap2.o \
...
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_multiset.o \
         -c ${STLDIR}/G__cpp_multiset.cxx"
execute "${ROOTCINT} -f ${STLDIR}/rootcint_multiset.cxx -c set \
         ${LINKDEFDIR}/multisetLinkdef.h"
execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/rootcint_multiset.o \
...
#execute "${CXX} ${OPT} ${CINTCXXFLAGS} ${INCDIRS} ${CXXOUT}${STLDIR}/G__cpp_valarray.o \

...
if (IS_DIRECTORY "${CPPINTEROP_INSTALL_PREFIX}/include")
  ...
  set(_include "/home/runner/work/root/root/interpreter/CppInterOp/include")
  set(_lib "/home/runner/work/root/root/build/interpreter/CppInterOp/${shared_lib_dir}/${_lib_prefix}clangCppInterOp${_lib_suffix}")
  set(_cmake "/home/runner/work/root/root/build/interpreter/CppInterOp/${shared_lib_dir}/cmake/CppInterOp")
endif()
...
set(CPPINTEROP_VERSION "1.8.0\;dev")
...
if (MSVC)
  if (IS_DIRECTORY "${CPPINTEROP_INSTALL_PREFIX}/include")
    ...
    set(_static_lib "/home/runner/work/root/root/build/interpreter/CppInterOp/lib/${_lib_prefix}clangCppInterOp.lib")
  endif()

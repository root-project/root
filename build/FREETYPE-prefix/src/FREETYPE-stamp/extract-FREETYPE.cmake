...
#
get_filename_component(filename "/home/runner/work/root/root/graf2d/freetype/src/freetype-2.12.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/root/root/build/FREETYPE-prefix/src/FREETYPE" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-FREETYPE${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-FREETYPE${i}")

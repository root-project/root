...
#ifndef ROOT_TGWin32Proxy
#define ROOT_TGWin32Proxy
...
////////////////////////////////////////////////////////////////////////////////
class TGWin32Proxy: public TVirtualX , public TGWin32ProxyBase {

public:
   TGWin32Proxy() {}
   TGWin32Proxy(const char *name, const char *title) {}
   virtual   ~TGWin32Proxy();

...
RETURN_METHOD_ARG2(Interpreter,Int_t,ProcessLine,const char*,line,TInterpreter::EErrorCode*,error)
RETURN_METHOD_ARG2(Interpreter,Int_t,ProcessLineSynch,const char*,line,TInterpreter::EErrorCode*,error)

// @(#)root/win32gdk:$Name:  $:$Id: TGWin32.cxx,v 1.37 2003/12/15 10:59:16 brun Exp $
...
void TGWin32::wglSwapLayerBuffers(Window_t wind, UInt_t mode)
{
   ...
   HDC hdc = GetWindowDC((HWND)GDK_DRAWABLE_XID((GdkWindow *)wind));
   ::wglSwapLayerBuffers(hdc, (UINT)mode);
   ::glFinish();
}
...
void TGWin32::glGetBooleanv(UInt_t mode, UChar_t *bRet)
{
   ...
   ::glGetBooleanv((GLenum)mode, (GLboolean *)bRet);
}
...
void TGWin32::glGetDoublev(UInt_t mode, Double_t *dRet)
{
   ...
   ::glGetDoublev((GLenum)mode, (GLdouble *)dRet);
}
...
void TGWin32::glGetFloatv(UInt_t mode, Float_t *fRet)
{
   ...
   ::glGetFloatv((GLenum)mode, (GLfloat *)fRet);
}
...
void TGWin32::glGetIntegerv(UInt_t mode, Int_t *iRet)
{
   ...
   ::glGetIntegerv((GLenum)mode, (GLint *)iRet);
}
...
void TGWin32::glDeleteLists(UInt_t list, Int_t sizei)
{
   ...
   ::glDeleteLists((GLuint)list,(GLsizei)sizei);
}
...
UInt_t TGWin32::glGenLists(UInt_t list)
{
   ...
   return ::glGenLists((GLsizei)list);
}
...
//______________________________________________________________________________
void TGWin32::glFrustum(Double_t left,Double_t right,Double_t bottom,
                        Double_t top,Double_t dnear,Double_t dfar)
{
   //
...
//______________________________________________________________________________
void TGWin32::glOrtho(Double_t left,Double_t right,Double_t bottom,Double_t top,

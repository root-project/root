// @(#)root/win32gdk:$Name:  $:$Id: TGWin32VirtualGLProxy.cxx,v 1.20 2006/03/09 11:18:31 brun Exp $
...
RETURN_METHOD_ARG3(GLManager, TObject *, Select, TVirtualGLPainter *, painter, Int_t, x, Int_t, y)

...
// Constructor. Alocates the array with a size given by level.
   fMaxLevel = (fLevel > 10) ? fLevel:10;
   fArray = new UShort_t[fMaxLevel];
}
...
// Copy constructor.
   if (fMaxLevel) {
      fArray = new UShort_t[fMaxLevel];
      if (fLevel) memcpy(fArray, other.fArray, fLevel*sizeof(UShort_t));
   }

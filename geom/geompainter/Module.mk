...
$(GEOMPAINTERMAP): $(GEOMPAINTERH1) $(GEOMPAINTERL) $(ROOTCINTTMPDEP) $(call pcmdep,GEOMPAINTER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(GEOMPAINTERDS) $(call dictModule,GEOMPAINTER) -c $(GEOMPAINTERH1) $(GEOMPAINTERL)

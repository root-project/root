...
TGeoMediumEditor::~TGeoMediumEditor()
{
   ...
   while ((el = (TGFrameElement *)next())) {
      if (el->fFrame->IsA() == TGCompositeFrame::Class() || el->fFrame->IsA() == TGHorizontalFrame::Class() ||
...
void TGeoMediumEditor::SetModel(TObject *obj)
{
   ...
   if (!strcmp(sname, fMedium->ClassName()))
      fMedName->SetText("");
   else
      fMedName->SetText(sname);
   ...
   switch (ifld) {
   case 0: fMagfldOption->Select(0); break;
   case -1: fMagfldOption->Select(1); break;
   case 1: fMagfldOption->Select(2); break;
   case 2: fMagfldOption->Select(3); break;
   case 3: fMagfldOption->Select(4); break;
   default: fMagfldOption->Select(5); break;
   }
...
void TGeoMediumEditor::DoMedName()
{
   ...
   if (!name[0] || !strcmp(name, fMedium->GetName()))
      return;
...
void TGeoMediumEditor::DoApply()
{
   ...
   if (strcmp(fMedium->GetName(), fMedName->GetText()))
      fMedium->SetName(fMedName->GetText());
   if (fMedium->GetId() != fMedId->GetIntNumber())

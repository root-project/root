...
def download_llvm_binary():
    ...
    if tar_required:
        ...
        if DIST == "Ubuntu" and REV == '20.04' and is_os_64bit():
            ...
            download_link = 'https://github.com/llvm/llvm-project/releases/download/llvmorg-13.0.1/clang+llvm-13.0.1-x86_64-linux-gnu-ubuntu-18.04.tar.xz'
            wget(url=download_link, out_dir=workdir)
            extract_tar(srcdir, 'clang+llvm-13.0.1-x86_64-linux-gnu-ubuntu-18.04.tar.xz')
        elif DIST == "Ubuntu" and REV == '16.04' and is_os_64bit():
            download_link = 'https://github.com/llvm/llvm-project/releases/download/llvmorg-13.0.0/clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz'
            wget(url=download_link, out_dir=workdir)
            extract_tar(srcdir, 'clang+llvm-13.0.0-x86_64-linux-gnu-ubuntu-16.04.tar.xz')

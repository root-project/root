...
set(LLVM_LCCRT_LIB "-llccrt")
if(LLVM_WITH_LCCRT)
  add_definitions(-DLLVM_WITH_LCCRT)
  set(LLVM_LCCRT_IDIR ${LLVM_WITH_LCCRT}/include)
  set(LLVM_LCCRT_LDIR ${LLVM_WITH_LCCRT}/lib)
endif()

if(LLVM_LCCRT_RELEASE)
  add_definitions(-DLLVM_LCCRT_RELEASE)
endif()

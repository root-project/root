...
#ifndef LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYSCANNER_H
#define LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYSCANNER_H
...
#endif // LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYSCANNER_H

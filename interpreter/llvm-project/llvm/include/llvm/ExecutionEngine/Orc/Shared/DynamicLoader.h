...
#ifndef LLVM_EXECUTIONENGINE_ORC_SHARED_DYNAMICLOADER_H
#define LLVM_EXECUTIONENGINE_ORC_SHARED_DYNAMICLOADER_H
...
#endif // LLVM_EXECUTIONENGINE_ORC_SHARED_DYNAMICLOADER_H

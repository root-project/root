...
#ifndef LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYRESOLVER_H
#define LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYRESOLVER_H
...
#endif // LLVM_EXECUTIONENGINE_ORC_SHARED_LIBRARYRESOLVER_H

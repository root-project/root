// @(#)root/html:$Name:  $:$Id: THtml.cxx,v 1.130 2007/02/13 20:22:06 axel Exp $
...
<ol style="list-style-type: upper-roman;">
  ...
  <li><a href="#index">Product and module index</a>
  ...
  <li><a href="#how">Behind the scenes</a>
</ol>
...
You can ask THtml to center the resulting image by passing the
parameter "Begin_macro(center)...". Of course you can combine any of them,
e.g. as "Begin_macro(source,center)...". 
THtml uses a 
...
This is an example output with arguments <tt>separator='=', align='rl'</tt>:
   ...
   for (Int_t i = 0; i < totalNumberOfClasses; i++) {
      ...
      if (!module) {
         ...
         if (modulename == "MATHCORE")
            ...
            module->SetSourceDir("smatrix/src");

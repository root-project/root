...
float *TCL::traat(float *a, float *s, int m, int n)
{
//
...
//____________________________________________________________
double *TCL::traat(double *a, double *s, int m, int n)
{
//  Symmetric Multiplication of Rectangular Matrices
// CERN PROGLIB# F112    TRAAT           .VERSION KERNFOR  4.15  861204
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
float *TCL::tral(float *a, float *u, float *b, int m, int n)
{
...
//____________________________________________________________
double *TCL::tral(double *a, double *u, double *b, int m, int n)
{
  // Triangular - Rectangular Multiplication
  // tral.F -- translated by f2c (version 19970219).
  // CERN PROGLIB# F112    TRAL            .VERSION KERNFOR  4.15  861204 */
...
//____________________________________________________________
float *TCL::tralt(float *a, float *u, float *b, int m, int n)
{
// Triangular - Rectangular Multiplication
...
//____________________________________________________________
double *TCL::tralt(double *a, double *u, double *b, int m, int n)
{
// Triangular - Rectangular Multiplication
// CERN PROGLIB# F112    TRALT           .VERSION KERNFOR  4.15  861204
// ORIG. 18/12/74 WH
...
//____________________________________________________________
float *TCL::tras(float *a, float *s, float *b, int m, int n)
{
...
//____________________________________________________________
double *TCL::tras(double *a, double *s, double *b, int m, int n)
{
// Symmetric - Rectangular Multiplication
// CERN PROGLIB# F112    TRAS            .VERSION KERNFOR  4.15  861204 */
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
float *TCL::trasat(float *a, float *s, float *r__, int m, int n)
{
...
//____________________________________________________________
double *TCL::trasat(double *a, double *s, double *r__, int m, int n)
{
// Transformation of Symmetric Matrix
// CERN PROGLIB# F112    TRASAT          .VERSION KERNFOR  4.15  861204 */
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
float *TCL::trasat(double *a, float *s, float *r__, int m, int n)
{
// Transformation of Symmetric Matrix
// CERN PROGLIB# F112    TRASAT          .VERSION KERNFOR  4.15  861204 */
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
float *TCL::trata(float *a, float *r__, int m, int n)
{
...
float *TCL::trats(float *a, float *s, float *b, int m, int n)
{
    /* Local variables */
     int inds, i__, j, k, ia, ib, is;
     double sum;
...
/* Subroutine */float *TCL::tratsa(float *a, float *s, float *r__, int m, int n)
{
...
float *TCL::trchlu(float *a, float *b, int n)
{
    /* Local variables */
     int ipiv, kpiv, i__, j;
     double r__, dc;
...
/* Subroutine */float *TCL::trchul(float *a, float *b, int n)
{
    /* Local variables */
     int ipiv, kpiv, i__;
     double r__;
...
//____________________________________________________________
/* Subroutine */float *TCL::trinv(float *t, float *s, int n)
{
...
/* Subroutine */float *TCL::trla(float *u, float *a, float *b, int m, int n)
{
     int ipiv, ia, ib, iu;
     double sum;
...
// Subroutine */float *TCL::trlta(float *u, float *a, float *b, int m, int n)
{
...
//____________________________________________________________
float *TCL::trqsq(float *q, float *s, float *r__, int m)
{
...
//____________________________________________________________
float *TCL::trsa(float *s, float *a, float *b, int m, int n)
{
...
//____________________________________________________________
/* Subroutine */float *TCL::trsinv(float *g, float *gi, int n)
{
...
//____________________________________________________________
/* Subroutine */float *TCL::trsmlu(float *u, float *s, int n)
{
...
//____________________________________________________________
/* Subroutine */float *TCL::trsmul(float *g, float *gi, int n)
{
...
//____________________________________________________________
float *TCL::trupck(float *u, float *s, int m)
{
...
// Subroutine */ float *TCL::trsat(float *s, float *a, float *b, int m, int n)
{
...
//____________________________________________________________
// trata.F -- translated by f2c (version 19970219).
double *TCL::trata(double *a, double *r__, int m, int n)
{
...
//____________________________________________________________
// trats.F -- translated by f2c (version 19970219).
double *TCL::trats(double *a, double *s, double *b, int m, int n)
{
    /* Local variables */
     int inds, i__, j, k, ia, ib, is;
     double sum;
...
//____________________________________________________________
// tratsa.F -- translated by f2c (version 19970219).
/* Subroutine */double *TCL::tratsa(double *a, double *s, double *r__, int m, int n)
{
    /* Local variables */
     int imax, i__, j, k;
     int ia, mn, ir, is, iaa, ind;
...
//____________________________________________________________
/* Subroutine */double *TCL::trla(double *u, double *a, double *b, int m, int n)
{
//
// trla.F -- translated by f2c (version 19970219).
// CERN PROGLIB# F112    TRLA            .VERSION KERNFOR  4.15  861204 */
...
//____________________________________________________________
double *TCL::trlta(double *u, double *a, double *b, int m, int n)
{
// trlta.F -- translated by f2c (version 19970219).
// CERN PROGLIB# F112    TRLTA           .VERSION KERNFOR  4.15  861204
// ORIG. 18/12/74 WH
...
//____________________________________________________________
/* Subroutine */double *TCL::trpck(double *s, double *u, int n)
{
 // trpck.F -- translated by f2c (version 19970219).
 // CERN PROGLIB# F112    TRPCK           .VERSION KERNFOR  2.08  741218 */
 // ORIG. 18/12/74 WH */
...
//____________________________________________________________
double *TCL::trqsq(double *q, double *s, double *r__, int m)
{
// trqsq.F -- translated by f2c (version 19970219).
// CERN PROGLIB# F112    TRQSQ           .VERSION KERNFOR  4.15  861204 */
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
double *TCL::trsa(double *s, double *a, double *b, int m, int n)
{
// trsa.F -- translated by f2c (version 19970219).
// CERN PROGLIB# F112    TRSA            .VERSION KERNFOR  4.15  861204 */
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
/* Subroutine */double *TCL::trsinv(double *g, double *gi, int n)
{
// trsinv.F -- translated by f2c (version 19970219).
// CERN PROGLIB# F112    TRSINV          .VERSION KERNFOR  2.08  741218
// ORIG. 18/12/74 WH */
...
//____________________________________________________________
double *TCL::trsat(double *s, double *a, double *b, int m, int n)
{
// trsat.F -- translated by f2c (version 19970219)
// CERN PROGLIB# F112    TRSAT           .VERSION KERNFOR  4.15  861204
// ORIG. 18/12/74 WH

   ...
   */
   ...
   public:
      ...
      */
      ...
      GSLIntegrator(Integration::Type type, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);
      ...
      GSLIntegrator(Integration::Type type, Integration::GKRule rule, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);

// @(#)root/mathmore:$Name:  $:$Id: Integrator.hv 1.0 2005/06/23 12:00:00 moneta Exp $
 ...
 */
  ...
  public: 
    ...
    */
    ...
    Integrator(const IGenFunction &f, const Integration::Type type, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);    

    Integrator(GSLFuncPointer f, const Integration::Type type, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);    
    ...
    */
    ...
    Integrator(const IGenFunction &f, const Integration::Type type, const Integration::GKRule rule, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);    

    Integrator(GSLFuncPointer f, const Integration::Type type, const Integration::GKRule rule, double absTol = 1.E-9, double relTol = 1E-6, size_t size = 1000);    

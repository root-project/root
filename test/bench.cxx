...
int main(int argc, char **argv)
{
  ...
  printf("* map<int,THit>                 %6.2f        0.68     %5.2f        5.26     *\n",cp1MAP,cx3MAP);
  printf("* multimap<int,THit>            %6.2f        0.46     %5.2f        5.26     *\n",cp1MMAP,cx3MMAP);
  ...
  printf("* multiset<THit*>               %6.2f        0.35     %5.2f        5.92     *\n",cp1MS,cx3MS);
  printf("* map<int,THit*>                %6.2f        0.35     %5.2f        3.71     *\n",cp1MAPS,cx3MAPS);
  printf("* multimap<int,THit*>           %6.2f        0.35     %5.2f        3.71     *\n",cp1MMAPS,cx3MMAPS);
  printf("* vector<THit*>NS               %6.2f        0.27     %5.2f        3.72     *\n",cp4NS,cx6NS);
  printf("* list<THit*>NS                 %6.2f        0.31     %5.2f        3.72     *\n",cp1LSNS,cx3LSNS);
  printf("* deque<THit*>NS                %6.2f        0.33     %5.2f        3.72     *\n",cp1DSNS,cx3DSNS);
  printf("* set<THit*>NS                  %6.2f        0.37     %5.2f        4.29     *\n",cp1SSNS,cx3SSNS);
  printf("* multiset<THit*>NS             %6.2f        0.36     %5.2f        4.29     *\n",cp1MSNS,cx3MSNS);
  printf("* TClonesArray(TObjHit)         %6.2f        0.25     %5.2f        5.37     *\n",cp7,cx9);
  printf("* TClonesArray(TObjHit) split   %6.2f        0.25     %5.2f        5.37     *\n",cp7,cx11);
  printf("******************************************************************************\n");
  ...
  printf("******************************************************************************\n");
  printf("* vector<THit>                  %6.2f        0.54    %6.2f        1.67     *\n",cp2w-cp1, cp3w-cp1);
  printf("* list<THit>                    %6.2f        0.36    %6.2f        1.30     *\n",cp2wL-cp1L,cp3wL-cp1L);
  printf("* deque<THit>                   %6.2f        0.35    %6.2f        1.69     *\n",cp2wD-cp1D,cp3wD-cp1D);
  printf("* set<THit>                     %6.2f        0.69    %6.2f        1.90     *\n",cp2wS-cp1S,cp3wS-cp1S);
  printf("* multiset<THit>                %6.2f        0.40    %6.2f        1.42     *\n",cp2wM-cp1M,cp3wM-cp1M);
  printf("* map<int,THit>                 %6.2f        0.57    %6.2f        1.54     *\n",cp2wMAP-cp1MAP,cp3wMAP-cp1MAP);
  printf("* multimap<int,THit>            %6.2f        0.43    %6.2f        1.80     *\n",cp2wMMAP-cp1MMAP,cp3wMMAP-cp1MMAP);
  printf("* vector<THit*>                 %6.2f        0.19    %6.2f        1.66     *\n",cp5w-cp1, cp6w-cp1);
  printf("* list<THit*>                   %6.2f        0.35    %6.2f        1.99     *\n",cp2wLS-cp1LS,cp3wLS-cp1LS);
  printf("* deque<THit*>                  %6.2f        0.34    %6.2f        1.73     *\n",cp2wDS-cp1DS,cp3wDS-cp1DS);
  printf("* set<THit*>                    %6.2f        0.35    %6.2f        1.42     *\n",cp2wSS-cp1SS,cp3wSS-cp1SS);
  printf("* multiset<THit*>               %6.2f        0.36    %6.2f        1.66     *\n",cp2wMS-cp1MS,cp3wMS-cp1MS);
  printf("* map<int,THit*>                %6.2f        0.76    %6.2f        2.80     *\n",cp2wMAPS-cp1MAPS,cp3wMAPS-cp1MAPS);
  printf("* multimap<int,THit*>           %6.2f        0.75    %6.2f        2.80     *\n",cp2wMMAPS-cp1MMAPS,cp3wMMAPS-cp1MMAPS);
  printf("* vector<THit*>NS               %6.2f        0.54    %6.2f        2.51     *\n",cp5wNS-cp1, cp6wNS-cp1);
  printf("* list<THit*>NS                 %6.2f        0.70    %6.2f        2.44     *\n",cp2wLSNS-cp1LSNS,cp3wLSNS-cp1LSNS);
  printf("* deque<THit*>NS                %6.2f        0.69    %6.2f        2.66     *\n",cp2wDSNS-cp1DSNS,cp3wDSNS-cp1DSNS);
  printf("* set<THit*>NS                  %6.2f        0.71    %6.2f        1.86     *\n",cp2wSSNS-cp1SSNS,cp3wSSNS-cp1SSNS);
  printf("* multiset<THit*>NS             %6.2f        0.72    %6.2f        2.50     *\n",cp2wMSNS-cp1MSNS,cp3wMSNS-cp1MSNS);
  printf("* TClonesArray(TObjHit)         %6.2f        0.10    %6.2f        1.40     *\n",cp8w-cp1, cp9w-cp1);
  printf("* TClonesArray(TObjHit) split   %6.2f        0.10    %6.2f        1.35     *\n",cp10w-cp1,cp11w-cp1);
  printf("******************************************************************************\n");
  printf("* Time to read in seconds       comp 0    Reference    comp 1    Reference   *\n");
  printf("******************************************************************************\n");
  printf("* vector<THit>                  %6.2f        0.32    %6.2f        0.52     *\n",cp2r,cp3r);
  printf("* list<THit>                    %6.2f        0.36    %6.2f        0.64     *\n",cp2rL,cp3rL);
  printf("* deque<THit>                   %6.2f        0.29    %6.2f        0.71     *\n",cp2rD,cp3rD);
  printf("* set<THit>                     %6.2f        0.64    %6.2f        0.70     *\n",cp2rS,cp3rS);
  printf("* multiset<THit>                %6.2f        0.65    %6.2f        0.97     *\n",cp2rM,cp3rM);
  printf("* map<int,THit>                 %6.2f        0.65    %6.2f        0.77     *\n",cp2rMAP,cp3rMAP);
  printf("* multimap<int,THit>            %6.2f        0.33    %6.2f        0.76     *\n",cp2rMMAP,cp3rMMAP);
  printf("* vector<THit*>                 %6.2f        0.54    %6.2f        0.62     *\n",cp5r,cp6r);
  printf("* list<THit*>                   %6.2f        0.47    %6.2f        0.76     *\n",cp2rLS,cp3rLS);
  printf("* deque<THit*>                  %6.2f        0.30    %6.2f        0.62     *\n",cp2rDS,cp3rDS);
  printf("* set<THit*>                    %6.2f        0.30    %6.2f        0.77     *\n",cp2rSS,cp3rSS);
  printf("* multiset<THit*>               %6.2f        0.31    %6.2f        0.55     *\n",cp2rMS,cp3rMS);
  printf("* map<int,THit*>                %6.2f        0.83    %6.2f        1.27     *\n",cp2rMAPS,cp3rMAPS);
  printf("* multimap<int,THit*>           %6.2f        0.84    %6.2f        1.29     *\n",cp2rMMAPS,cp3rMMAPS);
  printf("* vector<THit*>NS               %6.2f        0.73    %6.2f        1.12     *\n",cp5rNS,cp6rNS);
  printf("* list<THit*>NS                 %6.2f        0.98    %6.2f        1.20     *\n",cp2rLSNS,cp3rLSNS);
  printf("* deque<THit*>NS                %6.2f        0.74    %6.2f        1.16     *\n",cp2rDSNS,cp3rDSNS);
  printf("* set<THit*>NS                  %6.2f        0.85    %6.2f        1.20     *\n",cp2rSSNS,cp3rSSNS);
  printf("* multiset<THit*> NS            %6.2f        0.83    %6.2f        1.19     *\n",cp2rMSNS,cp3rMSNS);
  printf("* TClonesArray(TObjHit)         %6.2f        0.16    %6.2f        0.56     *\n",cp8r,cp9r);
  printf("* TClonesArray(TObjHit) split   %6.2f        0.17    %6.2f        0.61     *\n",cp10r,cp11r);
  printf("******************************************************************************\n");

...
//   readonly reads the remote files via various data
...
//
// *  Starting  R O O T - readonly test for protocol xroot
...
void readonly();
void readonly(const char *protoName);
...
void readonly(const char *protoName)
{
   ...
   printf("**********************************************************************\n");
   printf("*  Starting  R O O T - readonly test for protocol %s\n", protoName);
   printf("**********************************************************************\n");
...
void stressReadOnly1()
{
   ...
   if (!f) {
     printf("FAILED\n");
     printf("Could not open test file for stressReadOnly1\n");
     return;
   }
...
//  Count number of bytes read
   ...
   if (!hfile) {
      printf("Could not open event file during stressReadOnly3\n");
      return 0;
   }

...
#ifndef EventTree_NoProc_h
#define EventTree_NoProc_h
...
class EventTree_NoProc : public TSelector {
public :
   ...
   EventTree_NoProc(TTree *) { }
   EventTree_NoProc() { }
   virtual ~EventTree_NoProc() { }
...
#ifdef EventTree_NoProc_cxx
void EventTree_NoProc::Init(TTree *tree)
{
...
Bool_t EventTree_NoProc::Notify()
{
...
#endif // #ifdef EventTree_NoProc_cxx

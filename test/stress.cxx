// @(#)root/test:$Name:  $:$Id: stress.cxx,v 1.59 2005/02/09 16:59:10 brun Exp $
...
void stress2()
{
   ...
   Bool_t OK = kTRUE;
   Long64_t lastgood = 9509;
   if (last <lastgood-200 || last > lastgood+200 || comp <2.3 || comp > 2.7) OK = kFALSE;
   if (OK) printf("OK\n");
   else    {
      printf("failed\n");

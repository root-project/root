...
void guitest_playback()
{
   ...
   TStopwatch sw;
   ret = r.Replay("http://root-test.web.cern.ch/files/guitest_playback.root");
...
void graph_edit_playback()
{
   ...
   TStopwatch sw;
   ret = r.Replay("http://root-test.web.cern.ch/files/graphedit_playback.root");
...
void fitpanel_playback()
{
   ...
   TStopwatch sw;
   ret = r.Replay("http://root-test.web.cern.ch/files/fitpanel_playback.root");

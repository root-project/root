...
protected:
   ...
   void          PaintBorderPS(Double_t xl, Double_t yl, Double_t xt, Double_t yt, Int_t bmode, Int_t bsize, Int_t dark,
...
public:
   ...
   TLegend *         BuildLegend(Double_t x1 = 0.3, Double_t y1 = 0.21, Double_t x2 = 0.3, Double_t y2 = 0.21,
                                 const char *title = "", Option_t *option = "") override; // *MENU*
   ...
   void              Divide(Int_t nx = 1, Int_t ny = 1, Float_t xmargin = 0.01, Float_t ymargin = 0.01,
                            Int_t color = 0) override; // *MENU*
   ...
   void
   Range(Double_t x1, Double_t y1, Double_t x2, Double_t y2) override; // *MENU* *ARGS={x1=>fX1,y1=>fY1,x2=>fX2,y2=>fY2}
   ...
   void              ResetView3D(TObject *view = 0) override { fPadView3D = view; }
   ...
   void SetPad(const char *name, const char *title, Double_t xlow, Double_t ylow, Double_t xup, Double_t yup,
               Color_t color = 35, Short_t bordersize = 5, Short_t bordermode = -1) override;
   ...
   void SetView(TView *view = 0) override;
   ...
   Bool_t            HasViewer3D() const override { return (fViewer3D); }

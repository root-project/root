...
public:
   enum EStyle {
      kNone=0, kDot=1, kPlus, kStar, kCircle=4, kMultiply=5,
...
private:
   ...
   RAttrEnum<EStyle>    fStyle{this, "style", kDot, kFourSquaresPlus}; ///<! marker style
   ...
   RAttrMarker &SetStyle(EStyle style) { fStyle = style; return *this; }

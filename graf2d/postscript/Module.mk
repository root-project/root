...
$(POSTSCRIPTMAP): $(POSTSCRIPTH) $(POSTSCRIPTL) $(ROOTCINTTMPDEP) $(call pcmdep,POSTSCRIPT)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(POSTSCRIPTDS) $(call dictModule,POSTSCRIPT) -c $(POSTSCRIPTH) $(POSTSCRIPTL)

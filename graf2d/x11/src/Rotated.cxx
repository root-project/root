...
static char *my_strtok(char *str1, char *str2)
{
   ...
   if(str2==nullptr) return nullptr;
...
{
   if(str!=nullptr) strncpy(str, XV_COPYRIGHT, n);
   return XV_VERSION;
}
                                  ...
                                  int align, int bg)
{
   ...
   my_gc=XCreateGC(dpy, drawable, 0, nullptr);

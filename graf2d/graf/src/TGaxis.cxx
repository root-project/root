...
- Directly on the histogram. The following will set the number of division
  to 510 on the X axis of <hh>h`. To avoid optimization the number of divisions
...
/// \param[in] binLow,binHigh   New WMIN,WMAX
/// \param[in] nold             Old NDIV (primary divisions)
/// \param[in] nbins            New NDIV

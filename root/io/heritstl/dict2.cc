//
// File generated by rootcint at Fri Aug  2 17:11:36 2002.
...
extern "C" void G__cpp_reset_tagtabledict2();

extern "C" void G__set_cpp_environmentdict2() {
  G__add_compiledheader("TROOT.h");
  G__add_compiledheader("TMemberInspector.h");
  G__add_compiledheader("classes.C");
  G__cpp_reset_tagtabledict2();
}
class G__dict2dOcc_tag {};

void* operator new(size_t size,G__dict2dOcc_tag* p) {
...
void operator delete(void *p,G__dict2dOcc_tag* x) {
...
void G__DELDMY_dict2dOcc() { G__operator_delete(0); }

extern "C" int G__cpp_dllrevdict2() { return(30051515); }
...
static int G__PlexItem_PlexItem_0_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   else p=::new((G__dict2dOcc_tag*)G__getgvp()) PlexItem;
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__dict2LN_PlexItem);
...
static int G__PlexSTL_PlexSTL_0_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   else p=::new((G__dict2dOcc_tag*)G__getgvp()) PlexSTL;
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__dict2LN_PlexSTL);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_9_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   else p=::new((G__dict2dOcc_tag*)G__getgvp()) vector<PlexItem,allocator<PlexItem> >;
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR);
   return(1 || funcname || hash || result7 || libp) ;
}
...
static int G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_0_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   switch(libp->paran) {
   case 2:
      p = ::new((G__dict2dOcc_tag*)G__getgvp()) vector<PlexItem,allocator<PlexItem> >((vector<PlexItem,allocator<PlexItem> >::size_type)G__int(libp->para[0]),*(PlexItem*)libp->para[1].ref);
      break;
   case 1:
      p = ::new((G__dict2dOcc_tag*)G__getgvp()) vector<PlexItem,allocator<PlexItem> >((vector<PlexItem,allocator<PlexItem> >::size_type)G__int(libp->para[0]));
      break;
   }
      result7->obj.i = (long)p;
      result7->ref = (long)p;
...
static int G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_1_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   vector<PlexItem,allocator<PlexItem> > *p=NULL;
      p=::new((G__dict2dOcc_tag*)G__getgvp()) vector<PlexItem,allocator<PlexItem> >(*(vector<PlexItem,allocator<PlexItem> >*)libp->para[0].ref);
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR);
...
static int G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   vector<PlexItem,allocator<PlexItem> > *p=NULL;
      p=::new((G__dict2dOcc_tag*)G__getgvp()) vector<PlexItem,allocator<PlexItem> >(*((vector<PlexItem,allocator<PlexItem> >::const_iterator*)G__int(libp->para[0])),*((vector<PlexItem,allocator<PlexItem> >::const_iterator*)G__int(libp->para[1])));
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR);
...
static int G__Object_Object_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   ...
   result7->ref = (long)p;
   result7->type = 'u';
   result7->tagnum = G__get_linked_tagnum(&G__dict2LN_Object);
   return(1 || funcname || hash || result7 || libp) ;
}
...
*********************************************************/
class G__Sizep2memfuncdict2 {
 public:
  G__Sizep2memfuncdict2() {p=&G__Sizep2memfuncdict2::sizep2memfunc;}
    size_t sizep2memfunc() { return(sizeof(p)); }
  private:
    size_t (G__Sizep2memfuncdict2::*p)();
};

size_t G__get_sizep2memfuncdict2()
{
  G__Sizep2memfuncdict2 a;
...
*********************************************************/
extern "C" void G__cpp_setup_inheritancedict2() {

   /* Setting up class inheritance */
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__dict2LN_PlexSTL))) {
     PlexSTL *G__Lderived;
     G__Lderived=(PlexSTL*)0x1000;
     {
       vector<PlexItem,allocator<PlexItem> > *G__Lpbase=(vector<PlexItem,allocator<PlexItem> >*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dict2LN_PlexSTL),G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
   }
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__dict2LN_Object))) {
     Object *G__Lderived;
     G__Lderived=(Object*)0x1000;
     {
       TNamed *G__Lpbase=(TNamed*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dict2LN_Object),G__get_linked_tagnum(&G__dict2LN_TNamed),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       TObject *G__Lpbase=(TObject*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__dict2LN_Object),G__get_linked_tagnum(&G__dict2LN_TObject),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
}
...
*********************************************************/
extern "C" void G__cpp_setup_typetabledict2() {
...
-1);
   ...
   G__search_typename2("vector<PlexItem>",117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),0,-1);
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.29 2002/07/27 13:41:13 rdm Exp $",0);
   G__search_typename2("value_type",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector_type",117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("__normal_iterator<PlexItem*,vector_type>",117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),0,-1);
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.29 2002/07/27 13:41:13 rdm Exp $",0);
   G__search_typename2("iterator<std::iterator_traits<PlexItem*>::iterator_category,std::iterator_traits<PlexItem*>::value_type,std::iterator_traits<PlexItem*>::difference_type,std::iterator_traits<PlexItem*>::pointer,std::iterator_traits<PlexItem*>::reference>",117,G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR),0,-1);
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.29 2002/07/27 13:41:13 rdm Exp $",0);
   G__search_typename2("value_type",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("difference_type",108,-1,0,
G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("pointer",85,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reference",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator_category",117,G__get_linked_tagnum(&G__dict2LN_random_access_iterator_tag),0,G__get_linked_tagnum(&G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("normal_iterator_type",117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("__traits_type",117,G__get_linked_tagnum(&G__dict2LN_iterator_traitslEPlexItemmUgR),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator_category",117,G__get_linked_tagnum(&G__dict2LN_random_access_iterator_tag),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("value_type",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("difference_type",108,-1,0,
G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("pointer",85,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reference",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator",117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_iterator",117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("pointer",85,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_pointer",85,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reference",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("const_reference",117,G__get_linked_tagnum(&G__dict2LN_PlexItem),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("size_type",104,-1,0,
G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("difference_type",108,-1,0,
G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<PlexItem,difference_type>",117,G__get_linked_tagnum(&G__dict2LN_random_access_iteratorlEPlexItemcOlonggR),0,-1);
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.29 2002/07/27 13:41:13 rdm Exp $",0);
   G__search_typename2("const_reverse_iterator",117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgRcLcLreverse_iterator),0,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memvarPlexItem(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dict2LN_PlexItem));
   { PlexItem *p; p=(PlexItem*)0x1000; if (p) { }
   G__memvar_setup((void*)NULL,108,0,0,-1,-1,-1,4,"G__virtualinfo=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__dict2LN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memvarPlexSTL(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dict2LN_PlexSTL));
...
static void G__setup_memvarvectorlEPlexItemcOallocatorlEPlexItemgRsPgR(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
...
static void G__setup_memvarObject(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__dict2LN_Object));
   { Object *p; p=(Object*)0x1000; if (p) { }
   G__memvar_setup((void*)((long)(&p->vect)-(long)(p)),117,0,0,G__get_linked_tagnum(&G__dict2LN_PlexSTL),-1,-1,1,"vect=",0,(char*)NULL);
   G__memvar_setup((void*)NULL,85,0,0,G__get_linked_tagnum(&G__dict2LN_TClass),-1,-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}

extern "C" void G__cpp_setup_memvardict2() {
}
/***********************************************************
************************************************************
************************************************************
...
static void G__setup_memfuncPlexItem(void) {
   /* PlexItem */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dict2LN_PlexItem));
   G__memfunc_setup("PlexItem",808,G__PlexItem_PlexItem_0_0,105,G__get_linked_tagnum(&G__dict2LN_PlexItem),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__PlexItem_Class_2_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("IsA",253,G__PlexItem_IsA_6_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   // automatic copy constructor
   G__memfunc_setup("PlexItem",808,G__PlexItem_PlexItem_4_1,(int)('i'),G__get_linked_tagnum(&G__dict2LN_PlexItem),-1,0,1,1,1,0,"u 'PlexItem' - 11 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
static void G__setup_memfuncPlexSTL(void) {
   /* PlexSTL */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dict2LN_PlexSTL));
   G__memfunc_setup("PlexSTL",652,G__PlexSTL_PlexSTL_0_0,105,G__get_linked_tagnum(&G__dict2LN_PlexSTL),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Class",502,G__PlexSTL_Class_2_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("IsA",253,G__PlexSTL_IsA_6_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   // automatic copy constructor
   G__memfunc_setup("PlexSTL",652,G__PlexSTL_PlexSTL_4_1,(int)('i'),G__get_linked_tagnum(&G__dict2LN_PlexSTL),-1,0,1,1,1,0,"u 'PlexSTL' - 11 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
static void G__setup_memfuncvectorlEPlexItemcOallocatorlEPlexItemgRsPgR(void) {
   /* vector<PlexItem,allocator<PlexItem> > */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR));
   G__memfunc_setup("begin",517,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_begin_0_0,117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),G__defined_typename("vector<PlexItem,allocator<PlexItem> >::iterator"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("end",311,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_end_1_0,117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),G__defined_typename("vector<PlexItem,allocator<PlexItem> >::iterator"),0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("rbegin",631,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_rbegin_2_0,117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgRcLcLreverse_iterator),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("rend",425,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_rend_3_0,117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgRcLcLreverse_iterator),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("operator[]",1060,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_operatoroBcB_8_0,117,G__get_linked_tagnum(&G__dict2LN_PlexItem),-1,1,1,1,1,0,"h - 'vector<PlexItem,allocator<PlexItem> >::size_type' 0 - n",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("vector<PlexItem,allocator<PlexItem> >",3556,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_9_0,105,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("vector<PlexItem,allocator<PlexItem> >",3556,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_0_1,105,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),-1,0,2,1,1,0,
"h - 'vector<PlexItem,allocator<PlexItem> >::size_type' 0 - n u 'PlexItem' - 11 PlexItem() value",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("vector<PlexItem,allocator<PlexItem> >",3556,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_1_1,105,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),-1,0,1,1,1,0,"u 'vector<PlexItem,allocator<PlexItem> >' - 11 - x",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("vector<PlexItem,allocator<PlexItem> >",3556,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_2_1,105,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),-1,0,2,1,1,0,
"u '__normal_iterator<PlexItem*,vector<PlexItem,allocator<PlexItem> > >' 'vector<PlexItem,allocator<PlexItem> >::const_iterator' 0 - first u '__normal_iterator<PlexItem*,vector<PlexItem,allocator<PlexItem> > >' 'vector<PlexItem,allocator<PlexItem> >::const_iterator' 0 - last",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("operator=",937,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_operatoreQ_4_1,117,G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),-1,1,1,1,1,0,"u 'vector<PlexItem,allocator<PlexItem> >' - 11 - x",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("front",553,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_front_6_1,117,G__get_linked_tagnum(&G__dict2LN_PlexItem),-1,1,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("back",401,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_back_7_1,117,G__get_linked_tagnum(&G__dict2LN_PlexItem),-1,1,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("insert",661,G__vectorlEPlexItemcOallocatorlEPlexItemgRsPgR_insert_0_2,117,G__get_linked_tagnum(&G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR),G__defined_typename("vector<PlexItem,allocator<PlexItem> >::iterator"),0,2,1,1,0,
...
static void G__setup_memfuncObject(void) {
   /* Object */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__dict2LN_Object));
   G__memfunc_setup("Class",502,G__Object_Class_0_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("IsA",253,G__Object_IsA_4_0,85,G__get_linked_tagnum(&G__dict2LN_TClass),-1,0,0,1,1,8,"",(char*)NULL,(void*)NULL,1);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   // automatic default constructor
   G__memfunc_setup("Object",599,G__Object_Object_2_1,(int)('i'),G__get_linked_tagnum(&G__dict2LN_Object),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("Object",599,G__Object_Object_3_1,(int)('i'),G__get_linked_tagnum(&G__dict2LN_Object),-1,0,1,1,1,0,"u 'Object' - 11 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
*********************************************************/
extern "C" void G__cpp_setup_memfuncdict2() {
}
...
extern "C" void G__cpp_setup_globaldict2() {
...
extern "C" void G__cpp_setup_funcdict2() {
  G__cpp_setup_func0();
  G__cpp_setup_func1();
  G__cpp_setup_func2();
}
...
G__linked_taginfo G__dict2LN_TClass = { "TClass" , 99 , -1 };
G__linked_taginfo G__dict2LN_TObject = { "TObject" , 99 , -1 };
G__linked_taginfo G__dict2LN_TNamed = { "TNamed" , 99 , -1 };
G__linked_taginfo G__dict2LN_random_access_iterator_tag = { "random_access_iterator_tag" , 115 , -1 };
G__linked_taginfo G__dict2LN_PlexItem = { "PlexItem" , 99 , -1 };
G__linked_taginfo G__dict2LN_PlexSTL = { "PlexSTL" , 99 , -1 };
G__linked_taginfo G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR = { "vector<PlexItem,allocator<PlexItem> >" , 99 , -1 };
G__linked_taginfo G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR = { "__normal_iterator<PlexItem*,vector<PlexItem,allocator<PlexItem> > >" , 99 , -1 };
G__linked_taginfo G__dict2LN_iterator_traitslEPlexItemmUgR = { "iterator_traits<PlexItem*>" , 115 , -1 };
G__linked_taginfo G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR = { "iterator<random_access_iterator_tag,PlexItem,long,PlexItem*,PlexItem&>" , 115 , -1 };
G__linked_taginfo G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgRcLcLreverse_iterator = { "vector<PlexItem,allocator<PlexItem> >::reverse_iterator" , 99 , -1 };
G__linked_taginfo G__dict2LN_random_access_iteratorlEPlexItemcOlonggR = { "random_access_iterator<PlexItem,long>" , 115 , -1 };
G__linked_taginfo G__dict2LN_Object = { "Object" , 99 , -1 };

/* Reset class/struct taginfo */
extern "C" void G__cpp_reset_tagtabledict2() {
  G__dict2LN_TClass.tagnum = -1 ;
  G__dict2LN_TObject.tagnum = -1 ;
  G__dict2LN_TNamed.tagnum = -1 ;
  G__dict2LN_random_access_iterator_tag.tagnum = -1 ;
  G__dict2LN_PlexItem.tagnum = -1 ;
  G__dict2LN_PlexSTL.tagnum = -1 ;
  G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR.tagnum = -1 ;
  G__dict2LN___normal_iteratorlEPlexItemmUcOvectorlEPlexItemcOallocatorlEPlexItemgRsPgRsPgR.tagnum = -1 ;
  G__dict2LN_iterator_traitslEPlexItemmUgR.tagnum = -1 ;
  G__dict2LN_iteratorlErandom_access_iterator_tagcOPlexItemcOlongcOPlexItemmUcOPlexItemaNgR.tagnum = -1 ;
  G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgRcLcLreverse_iterator.tagnum = -1 ;
  G__dict2LN_random_access_iteratorlEPlexItemcOlonggR.tagnum = -1 ;
  G__dict2LN_Object.tagnum = -1 ;
}


extern "C" void G__cpp_setup_tagtabledict2() {

   /* Setting up class,struct,union tag entry */
   G__tagtable_setup(G__get_linked_tagnum(&G__dict2LN_PlexItem),sizeof(PlexItem),-1,263424,(char*)NULL,G__setup_memvarPlexItem,G__setup_memfuncPlexItem);
   G__tagtable_setup(G__get_linked_tagnum(&G__dict2LN_PlexSTL),sizeof(PlexSTL),-1,263424,(char*)NULL,G__setup_memvarPlexSTL,G__setup_memfuncPlexSTL);
   G__tagtable_setup(G__get_linked_tagnum(&G__dict2LN_vectorlEPlexItemcOallocatorlEPlexItemgRsPgR),sizeof(vector<PlexItem,allocator<PlexItem> >),-1,265984,(char*)NULL,G__setup_memvarvectorlEPlexItemcOallocatorlEPlexItemgRsPgR,G__setup_memfuncvectorlEPlexItemcOallocatorlEPlexItemgRsPgR);
   G__tagtable_setup(G__get_linked_tagnum(&G__dict2LN_Object),sizeof(Object),-1,290816,(char*)NULL,G__setup_memvarObject,G__setup_memfuncObject);
}
extern "C" void G__cpp_setupdict2(void) {
  G__check_setup_version(30051515,"G__cpp_setupdict2()");
  G__set_cpp_environmentdict2();
  G__cpp_setup_tagtabledict2();

  G__cpp_setup_inheritancedict2();

  G__cpp_setup_typetabledict2();

  G__cpp_setup_memvardict2();

  G__cpp_setup_memfuncdict2();
  G__cpp_setup_globaldict2();
  G__cpp_setup_funcdict2();

   if(0==G__getsizep2memfunc()) G__get_sizep2memfuncdict2();
  return;
}
class G__cpp_setup_initdict2 {
  public:
    G__cpp_setup_initdict2() { G__add_setup_func("dict2",(G__incsetup)(&G__cpp_setupdict2)); G__call_setup_funcs(); }
   ~G__cpp_setup_initdict2() { G__remove_setup_func("dict2"); }
};
G__cpp_setup_initdict2 G__cpp_setup_initializerdict2;

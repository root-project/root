...
#define SECOND_RUN
   ...
   cout << "ex4.fStr3 = " << TBufferJSON::ConvertToJSON(ex4, gROOT->GetClass("TJsonEx4"), 0, "fStr3") << endl;
   cout << "ex4.fStr4 = " << TBufferJSON::ConvertToJSON(ex4, gROOT->GetClass("TJsonEx4"), 0, "fStr4") << endl;

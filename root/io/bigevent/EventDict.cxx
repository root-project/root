//
// File generated by rootcint at Tue Oct 15 09:21:28 2002.
...
namespace ROOT {
   ...
   TGenericClassInfo *GenerateInitInstance(const Track*)
   {
      Track *ptr = 0;
      static ROOT::TGenericClassInfo 
         instance("Track", Track::Class_Version(), "Event.h", 179,
...
namespace ROOT {
   ...
   TGenericClassInfo *GenerateInitInstance(const BigTrack*)
   {
      BigTrack *ptr = 0;
      static ROOT::TGenericClassInfo 
         instance("BigTrack", BigTrack::Class_Version(), "Event.h", 237,
...
namespace ROOT {
   ...
   TGenericClassInfo *GenerateInitInstance(const HistogramManager*)
   {
      ...
      static ROOT::TGenericClassInfo 
         instance("HistogramManager", HistogramManager::Class_Version(), "Event.h", 252,
...
void Event::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
      ...
      ROOT::GenericShowMembers("vector<int>", &fVectorint, R__insp, strcat(R__parent,"fVectorint."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fVectorint",R__Event_fVectorint);
      R__insp.Inspect(R__cl, R__parent, "fVectorshort", (void*)&fVectorshort);
      ROOT::GenericShowMembers("vector<short>", &fVectorshort, R__insp, strcat(R__parent,"fVectorshort."),false);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("vector<TLine>", &fVectorTLine, R__insp, strcat(R__parent,"fVectorTLine."),false);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("vector<string>", &fLachaud, R__insp, strcat(R__parent,"fLachaud."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fLachaud",R__Event_fLachaud);
      R__insp.Inspect(R__cl, R__parent, "fDeque", (void*)&fDeque);
      ROOT::GenericShowMembers("deque<TAttLine>", &fDeque, R__insp, strcat(R__parent,"fDeque."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fDeque",R__Event_fDeque);
      R__insp.Inspect(R__cl, R__parent, "fVectorTobjectp", (void*)&fVectorTobjectp);
      ROOT::GenericShowMembers("list<const TObject*>", &fVectorTobjectp, R__insp, strcat(R__parent,"fVectorTobjectp."),false);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("list<string*>", &fListStringp, R__insp, strcat(R__parent,"fListStringp."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fListStringp",R__Event_fListStringp);
      R__insp.Inspect(R__cl, R__parent, "fMapTNamedp", (void*)&fMapTNamedp);
      ROOT::GenericShowMembers("map<TNamed*,int>", &fMapTNamedp, R__insp, strcat(R__parent,"fMapTNamedp."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fMapTNamedp",R__Event_fMapTNamedp);
      R__insp.Inspect(R__cl, R__parent, "fMapList", (void*)&fMapList);
      ROOT::GenericShowMembers("map<TString,TList*>", &fMapList, R__insp, strcat(R__parent,"fMapList."),false);
      R__parent[R__ncp] = 0;
      R__cl->SetStreamer("fMapList",R__Event_fMapList);
      R__insp.Inspect(R__cl, R__parent, "fMapTString", (void*)&fMapTString);
      ROOT::GenericShowMembers("map<TString,TString*>", &fMapTString, R__insp, strcat(R__parent,"fMapTString."),true);
      R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "fMapHeaderP", (void*)&fMapHeaderP);
      ROOT::GenericShowMembers("map<EventHeader,TString*>", &fMapHeaderP, R__insp, strcat(R__parent,"fMapHeaderP."),true);
      R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "fMapHeader", (void*)&fMapHeader);
      ROOT::GenericShowMembers("map<EventHeader,TString>", &fMapHeader, R__insp, strcat(R__parent,"fMapHeader."),true);
      R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "fMapHeaderst", (void*)&fMapHeaderst);
      ROOT::GenericShowMembers("map<EventHeader,string>", &fMapHeaderst, R__insp, strcat(R__parent,"fMapHeaderst."),true);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("set<TAxis*>", &fSetTAxis, R__insp, strcat(R__parent,"fSetTAxis."),false);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("multimap<TNamed*,int>", &fMultiMapTNamedp, R__insp, strcat(R__parent,"fMultiMapTNamedp."),false);
      R__parent[R__ncp] = 0;
      ...
      ROOT::GenericShowMembers("vector<vector<TAxis*> >", &fVectAxis, R__insp, strcat(R__parent,"fVectAxis."),true);
      R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "fMapString", (void*)&fMapString);
      ROOT::GenericShowMembers("map<string,vector<int> >", &fMapString, R__insp, strcat(R__parent,"fMapString."),true);
      R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "fDequePair", (void*)&fDequePair);
      ROOT::GenericShowMembers("deque<pair<float,float> >", &fDequePair, R__insp, strcat(R__parent,"fDequePair."),true);
      R__parent[R__ncp] = 0;
...
void Track::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
      ...
      ROOT::GenericShowMembers("vector<int>", &fHits, R__insp, strcat(R__parent,"fHits."),false);
      R__parent[R__ncp] = 0;
...
void UShortVector::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
      ...
      ROOT::GenericShowMembers("vector<unsigned short,allocator<unsigned short> >", dynamic_cast< ::vector<unsigned short,allocator<unsigned short> > *>(this ), R__insp, R__parent, false);
}
...
static int G__UShortVector_ImplFileLine_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__UShortVector_DeclFileLine_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__EventHeader_ImplFileLine_5_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__EventHeader_DeclFileLine_7_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__Event_ImplFileLine_0_4(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__Event_DeclFileLine_2_4(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__Track_DeclFileLine_6_3(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__BigTrack_ImplFileLine_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__BigTrack_DeclFileLine_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__HistogramManager_ImplFileLine_2_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
static int G__HistogramManager_DeclFileLine_4_1(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
-1);
   ...
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEunsignedsPshortcOallocatorlEunsignedsPshortgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<unsigned short,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEunsignedsPshortcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEunsignedsPshortcOallocatorlEunsignedsPshortgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEintcOallocatorlEintgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<int,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEintcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEintcOallocatorlEintgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEshortcOallocatorlEshortgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<short,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEshortcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEshortcOallocatorlEshortgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<double,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEdoublecOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEdoublecOallocatorlEdoublegRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlETLinecOallocatorlETLinegRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<TLine,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlETLinecOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlETLinecOallocatorlETLinegRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlETObjectcOallocatorlETObjectgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<TObject,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlETObjectcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlETObjectcOallocatorlETObjectgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlETNamedcOallocatorlETNamedgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<TNamed,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlETNamedcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlETNamedcOallocatorlETNamedgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEstringcOallocatorlEstringgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<string,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEstringcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEstringcOallocatorlEstringgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_dequelETAttLinecOallocatorlETAttLinegRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<TAttLine,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlETAttLinecOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_dequelETAttLinecOallocatorlETAttLinegRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_listlEconstsPTObjectmUcOallocatorlEconstsPTObjectmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<const TObject*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEconstsPTObjectmUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_listlEconstsPTObjectmUcOallocatorlEconstsPTObjectmUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_listlEstringcOallocatorlEstringgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<string,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEstringcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_listlEstringcOallocatorlEstringgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_listlEstringmUcOallocatorlEstringmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<string*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEstringmUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_listlEstringmUcOallocatorlEstringmUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplETNamedmUcOintcOlesslETNamedmUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<int,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEintcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplETNamedmUcOintcOlesslETNamedmUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplETStringcOTListmUcOlesslETStringgRcOallocatorlETListmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TList*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETListmUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplETStringcOTListmUcOlesslETStringgRcOallocatorlETListmUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplETStringcOTStringmUcOlesslETStringgRcOallocatorlETStringmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TString*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETStringmUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplETStringcOTStringmUcOlesslETStringgRcOallocatorlETStringmUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOTStringmUcOlesslEEventHeadergRcOallocatorlETStringmUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TString*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETStringmUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOTStringmUcOlesslEEventHeadergRcOallocatorlETStringmUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOTStringcOlesslEEventHeadergRcOallocatorlETStringgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TString,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETStringcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOTStringcOlesslEEventHeadergRcOallocatorlETStringgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOstringcOlesslEEventHeadergRcOallocatorlEstringgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<string,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEstringcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplEEventHeadercOstringcOlesslEEventHeadergRcOallocatorlEstringgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplETAxismUcOintcOlesslETAxismUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<int,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEintcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplETAxismUcOintcOlesslETAxismUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_setlETAxismUcOlesslETAxismUgRcOallocatorlETAxismUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TAxis*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETAxismUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_setlETAxismUcOlesslETAxismUgRcOallocatorlETAxismUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_multimaplETNamedmUcOintcOlesslETNamedmUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<int,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEintcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_multimaplETNamedmUcOintcOlesslETNamedmUgRcOallocatorlEintgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_multisetlETAxismUcOlesslETAxismUgRcOallocatorlETAxismUgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<TAxis*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlETAxismUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_multisetlETAxismUcOlesslETAxismUgRcOallocatorlETAxismUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlETAxismUcOallocatorlETAxismUgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<TAxis*,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlETAxismUcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlETAxismUcOallocatorlETAxismUgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_vectorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRcOallocatorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRsPgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<vector<TAxis*,allocator<TAxis*> >,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_vectorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRcOallocatorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRsPgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_maplEstringcOvectorlEintcOallocatorlEintgRsPgRcOlesslEstringgRcOallocatorlEvectorlEintcOallocatorlEintgRsPgRsPgRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("bidirectional_iterator<vector<int,allocator<int> >,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_bidirectional_iteratorlEvectorlEintcOallocatorlEintgRsPgRcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_maplEstringcOvectorlEintcOallocatorlEintgRsPgRcOlesslEstringgRcOallocatorlEvectorlEintcOallocatorlEintgRsPgRsPgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
G__get_linked_tagnum(&G__EventDictLN_dequelEpairlEfloatcOfloatgRcOallocatorlEpairlEfloatcOfloatgRsPgRsPgR));
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("random_access_iterator<pair<float,float>,difference_type>",117,G__get_linked_tagnum(&G__EventDictLN_random_access_iteratorlEpairlEfloatcOfloatgRcOlonggR),0,G__get_linked_tagnum(&G__EventDictLN_dequelEpairlEfloatcOfloatgRcOallocatorlEpairlEfloatcOfloatgRsPgRsPgR));
   G__setnewtype(-1,"// @(#)root/base:$Name:  $:$Id: TROOT.h,v 1.30 2002/09/16 00:01:57 rdm Exp $",0);
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("ImplFileLine",1178,G__UShortVector_ImplFileLine_2_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__UShortVector_ImplFileName_3_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__UShortVector_DeclFileLine_4_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("ImplFileLine",1178,G__EventHeader_ImplFileLine_5_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__EventHeader_ImplFileName_6_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__EventHeader_DeclFileLine_7_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("ImplFileLine",1178,G__Event_ImplFileLine_0_4,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__Event_ImplFileName_1_4,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__Event_DeclFileLine_2_4,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("DeclFileLine",1152,G__Track_DeclFileLine_6_3,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("Track",501,G__Track_Track_7_3,(int)('i'),G__get_linked_tagnum(&G__EventDictLN_Track),-1,0,1,1,1,0,"u 'Track' - 11 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("ImplFileLine",1178,G__BigTrack_ImplFileLine_2_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__BigTrack_ImplFileName_3_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__BigTrack_DeclFileLine_4_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
   G__memfunc_setup("BigTrack",775,G__BigTrack_BigTrack_5_1,(int)('i'),G__get_linked_tagnum(&G__EventDictLN_BigTrack),-1,0,1,1,1,0,"u 'BigTrack' - 11 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
...
"u 'TMemberInspector' - 1 - insp C - - 0 - parent",(char*)NULL,(void*)NULL,1);
   ...
   G__memfunc_setup("ImplFileLine",1178,G__HistogramManager_ImplFileLine_2_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("ImplFileName",1171,G__HistogramManager_ImplFileName_3_1,67,-1,-1,0,0,3,1,1,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("DeclFileLine",1152,G__HistogramManager_DeclFileLine_4_1,105,-1,-1,0,0,3,1,0,"",(char*)NULL,(void*)NULL,0);
   // automatic copy constructor
...
G__linked_taginfo G__EventDictLN_random_access_iteratorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRcOlonggR = { "random_access_iterator<vector<TAxis*,allocator<TAxis*> >,long>" , 115 , -1 };
...
G__linked_taginfo G__EventDictLN_bidirectional_iteratorlEvectorlEintcOallocatorlEintgRsPgRcOlonggR = { "bidirectional_iterator<vector<int,allocator<int> >,long>" , 115 , -1 };
...
extern "C" void G__cpp_reset_tagtableEventDict() {
  ...
  G__EventDictLN_random_access_iteratorlEvectorlETAxismUcOallocatorlETAxismUgRsPgRcOlonggR.tagnum = -1 ;
  ...
  G__EventDictLN_bidirectional_iteratorlEvectorlEintcOallocatorlEintgRsPgRcOlonggR.tagnum = -1 ;

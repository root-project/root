...
$(HISTPAINTERDS): $(HISTPAINTERH1) $(HISTPAINTERL) $(ROOTCINTTMPDEP) $(call pcmdep,HISTPAINTER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,HISTPAINTER) -c $(HISTPAINTERH1) $(HISTPAINTERL)

$(HISTPAINTERMAP): $(HISTPAINTERH1) $(HISTPAINTERL) $(ROOTCINTTMPDEP) $(call pcmdep,HISTPAINTER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(HISTPAINTERDS) $(call dictModule,HISTPAINTER) -c $(HISTPAINTERH1) $(HISTPAINTERL)

...
public:
   void Paint(TDrawable &hist, THistDrawingOpts<1> /*opts*/, TVirtualCanvasPainter & /*canv*/) final
   {
      // TODO: paint!
...
public:
   void Paint(TDrawable &drw, THistDrawingOpts<2> /*opts*/, TVirtualCanvasPainter &canv) final
   {
...
public:
   void Paint(TDrawable &hist, THistDrawingOpts<3> /*opts*/, TVirtualCanvasPainter & /*canv*/) final
   {
      // TODO: paint!
      std::cout << "Painting histogram @" << &hist << '\n';
   }

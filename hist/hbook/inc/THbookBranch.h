...
public:
   THbookBranch() {}
   THbookBranch(TTree *tree, const char *name, void *address, const char *leaflist, Int_t basketsize=32000, Int_t compress = (Int_t)ROOT::RCompressionSetting::EAlgorithm::kInherit);
   THbookBranch(TBranch *branch, const char *name, void *address, const char *leaflist, Int_t basketsize=32000, Int_t compress = (Int_t)ROOT::RCompressionSetting::EAlgorithm::kInherit);

...
TEST(HistFillTest, FillCoordContent) {
  ...
  hist.Fill({0.1111});
  EXPECT_FLOAT_EQ(1.0f+1.0f, hist.GetBinContent({0.1111}));
}
...
TEST(HistFillTest, Fill2DCoordContent) {
  ...
  hist.Fill({0.1111,4.22});
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.1111,4.22}));
  hist.Fill({0.1111,4.22});
  EXPECT_FLOAT_EQ(1.0f+1.0f, hist.GetBinContent({0.1111,4.22}));
}
...
TEST(HistFillTest, FillN2DCoordsContent) {
  ...
  hist.FillN({{0.1111,4.22},{0.2222,4.33},{0.3333,4.11}});
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.1111,4.22}));
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.2222,4.33}));
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.3333,4.11}));
  hist.FillN({{0.1111,4.22},{0.3333,4.11}});
  EXPECT_FLOAT_EQ(2.0f, hist.GetBinContent({0.1111,4.22}));
  EXPECT_FLOAT_EQ(2.0f, hist.GetBinContent({0.3333,4.11}));
}
...
TEST(HistFillTest, FillN2DCoordsUncertainty) {
  ROOT::Experimental::RH2F hist({100,0.,1},{10,3.,5.});
  float weight = .0f;
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.1111,4.22}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.2222,4.33}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.3333,4.11}));
  weight = 1.0f;
  hist.FillN({{0.1111,4.22},{0.2222,4.33},{0.3333,4.11}});
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.1111,4.22}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.2222,4.33}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.3333,4.11}));
  hist.FillN({{0.1111,4.22},{0.3333,4.11}});
  EXPECT_FLOAT_EQ(std::sqrt((weight*weight)+(weight*weight)), hist.GetBinUncertainty({0.1111,4.22}));
  EXPECT_FLOAT_EQ(std::sqrt((weight*weight)+(weight*weight)), hist.GetBinUncertainty({0.3333,4.11}));
}
...
TEST(HistFillTest, Fill3DCoordContent) {
  ...
  hist.Fill({0.1111,4.22,7.33});
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.1111,4.22,7.33}));
  hist.Fill({0.1111,4.22,7.33});
  EXPECT_FLOAT_EQ(1.0f+1.0f, hist.GetBinContent({0.1111,4.22,7.33}));
}
...
TEST(HistFillTest, FillN3DCoordsContent) {
  ...
  hist.FillN({{0.1111,4.22,7.33},{0.2222,4.33,7.11},{0.3333,4.11,7.22}});
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.1111,4.22,7.33}));
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.2222,4.33,7.11}));
  EXPECT_FLOAT_EQ(1.0f, hist.GetBinContent({0.3333,4.11,7.22}));
  hist.FillN({{0.1111,4.22,7.33},{0.3333,4.11,7.22}});
  EXPECT_FLOAT_EQ(2.0f, hist.GetBinContent({0.1111,4.22,7.33}));
  EXPECT_FLOAT_EQ(2.0f, hist.GetBinContent({0.3333,4.11,7.22}));
}
...
TEST(HistFillTest, FillN3DCoordsUncertainty) {
  ROOT::Experimental::RH3F hist({100,0.,1},{10,3.,5.},{5,7.,9.});
  float weight = .0f;
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.1111,4.22,7.33}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.2222,4.33,7.11}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.3333,4.11,7.22}));
  weight = 1.0f;
  hist.FillN({{0.1111,4.22,7.33},{0.2222,4.33,7.11},{0.3333,4.11,7.22}});
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.1111,4.22,7.33}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.2222,4.33,7.11}));
  EXPECT_FLOAT_EQ(std::sqrt(weight*weight), hist.GetBinUncertainty({0.3333,4.11,7.22}));
  hist.FillN({{0.1111,4.22,7.33},{0.3333,4.11,7.22}});
  EXPECT_FLOAT_EQ(std::sqrt((weight*weight)+(weight*weight)), hist.GetBinUncertainty({0.1111,4.22,7.33}));
  EXPECT_FLOAT_EQ(std::sqrt((weight*weight)+(weight*weight)), hist.GetBinUncertainty({0.3333,4.11,7.22}));
}

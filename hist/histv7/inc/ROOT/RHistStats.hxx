...
public:
   ...
   struct DimensionStats final {
      ...
      void Add(const DimensionStats &other)
      {
         fSumWX += other.fSumWX;
...
private:
   ...
   std::vector<DimensionStats> fDimensionStats;
...
public:
   ...
   const DimensionStats &GetDimensionStats(std::size_t dim = 0) const { return fDimensionStats.at(dim); }

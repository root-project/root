...
TMatrixDSparse *TUnfoldSys::GetSummedErrorMatrixYY(void)
{
   ...
   if(fDeltaSysTau) {
      ...
      TMatrixDSparse *emat_tau = MultiplyMSparseMSparseTranspVector(Adx_tau, Adx_tau, nullptr);
...
TMatrixDSparse *TUnfoldSys::GetSummedErrorMatrixXX(void)
{
   ...
   // error on tau
   if(fDeltaSysTau) {
      TMatrixDSparse *emat_tau = MultiplyMSparseMSparseTranspVector(fDeltaSysTau, fDeltaSysTau, nullptr);
      AddMSparse(emat_sum,1.0,emat_tau);
      DeleteMatrix(&emat_tau);
   }
   return emat_sum;

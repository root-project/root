...
protected:
   ...
   Int_t fSumErrorsMode; // How y errors are summed: kOnlyFirst = Only Fist; kSquareSum = Squared Sum; kSum = Absolute
                         // Addition
...
public:
   ...
   TGraphMultiErrors(Int_t n, const Float_t *x, const Float_t *y, const Float_t *exL = NULL, const Float_t *exH = NULL,
                     const Float_t *eyL = NULL, const Float_t *eyH = NULL, Int_t m = kOnlyFirst);
   TGraphMultiErrors(Int_t n, const Double_t *x, const Double_t *y, const Double_t *exL = NULL,
                     const Double_t *exH = NULL, const Double_t *eyL = NULL, const Double_t *eyH = NULL,
                     Int_t m = kOnlyFirst);
   TGraphMultiErrors(Int_t n, Int_t dim, const Float_t *x, const Float_t *y, const Float_t *exL = NULL,
                     const Float_t *exH = NULL, Float_t **eyL = NULL, Float_t **eyH = NULL, Int_t m = kOnlyFirst);
   TGraphMultiErrors(Int_t n, Int_t dim, const Double_t *x, const Double_t *y, const Double_t *exL = NULL,
                     const Double_t *exH = NULL, Double_t **eyL = NULL, Double_t **eyH = NULL, Int_t m = kOnlyFirst);
   ...
   TGraphMultiErrors(Int_t dim, const TVectorF &tvX, const TVectorF &tvY, const TVectorF &tvExL, const TVectorF &tvExH,
                     const TVectorF *tvEyL, const TVectorF *tvEyH, Int_t m = kOnlyFirst);
   TGraphMultiErrors(Int_t dim, const TVectorD &tvX, const TVectorD &tvY, const TVectorD &tvExL, const TVectorD &tvExH,
                     const TVectorD *tvEyL, const TVectorD *tvEyH, Int_t m = kOnlyFirst);

...
public:
   ...
   {
      return TH1::GetBinContent(GetBin(binx, biny));
   }
   ...
   TH2 *            Rebin(Int_t ngroup = 2, const char *newname = "",
                          const Double_t *xbins = 0) override; // re-implementation of the TH1 function using RebinX

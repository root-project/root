...
private:
   ...
   void      SetBins(Int_t, Double_t, Double_t) override { MayNotUse("SetBins(Int_t, Double_t, Double_t"); }
   void      SetBins(Int_t, const Double_t *) override { MayNotUse("SetBins(Int_t, const Double_t*"); }
...
public:
   ...
   {
      MayNotUse("GetBinContent(Int_t, Int_t");
      return -1; }
   ...
   {
      MayNotUse("GetBinError(Int_t, Int_t");
      return -1; }
   ...
   void SetBins(Int_t nbinsx, Double_t xmin, Double_t xmax, Int_t nbinsy, Double_t ymin, Double_t ymax, Int_t nbinsz,
                Double_t zmin, Double_t zmax) override;
   void
   SetBins(Int_t nx, const Double_t *xBins, Int_t ny, const Double_t *yBins, Int_t nz, const Double_t *zBins) override;

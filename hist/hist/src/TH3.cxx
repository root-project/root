...
Int_t TH3::FindFirstBinAbove(Double_t threshold, Int_t axis, Int_t firstBin, Int_t lastBin) const
{
   if (axis < 1 || axis > 3) {
...
Int_t TH3::FindLastBinAbove(Double_t threshold, Int_t axis, Int_t firstBin, Int_t lastBin) const
{
   if (axis < 1 || axis > 3) {

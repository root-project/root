...
//______________________________________________________________________________
   ...
   public:
      ...
      virtual Long64_t Next(Int_t *coord = nullptr);
...
THnSparseCompactBinCoord::THnSparseCompactBinCoord(Int_t dim, const Int_t *nbins)
   : THnSparseCoordCompression(dim, nbins), fHash(0), fCoordBuffer(nullptr), fCurrentBin(nullptr)
{
...
THnSparseArrayChunk::THnSparseArrayChunk(Int_t coordsize, bool errors, TArray *cont)
   : fCoordinateAllocationSize(-1), fSingleCoordinateSize(coordsize), fCoordinatesSize(0), fCoordinates(nullptr),
     fContent(cont), fSumw2(nullptr)
{
...
THnSparse::THnSparse() : fChunkSize(1024), fFilledBins(0), fCompactCoord(nullptr)
{
...
THnSparse::THnSparse(const char *name, const char *title, Int_t dim, const Int_t *nbins, const Double_t *xmin,
                     const Double_t *xmax, Int_t chunksize)
   : THnBase(name, title, dim, nbins, xmin, xmax), fChunkSize(chunksize), fFilledBins(0), fCompactCoord(nullptr)
{

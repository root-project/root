...
TEST_P(MergeTest, TestMerge3DDiff)
{
   ...
   TH3D *h1 = new TH3D("merge3DDiff-h1", "h1-Title", 11, -110, 0, 11, -110, 0, 11, -110, 0);
   TH3D *h2 = new TH3D("merge3DDiff-h2", "h2-Title", 22, 0, 110, 22, 0, 110, 22, 0, 110);
   TH3D *h3 = new TH3D("merge3DDiff-h3", "h3-Title", 44, -55, 55, 44, -55, 55, 44, -55, 55);
   TH3D *h4 = new TH3D("merge3DDiff-h4", "h4-Title", 22, -110, 110, 22, -110, 110, 22, -110, 110);
...
TEST_P(MergeTest, TestMerge2D_Diff)
{
   ...
   TH2D *h1 = new TH2D("merge2DDiff-h1", "h1-Title", 11, -110, 0, 11, -110, 0);
   TH2D *h2 = new TH2D("merge2DDiff-h2", "h2-Title", 22, 0, 110, 22, 0, 110);
   TH2D *h3 = new TH2D("merge2DDiff-h3", "h3-Title", 44, -55, 55, 44, -55, 55);
   TH2D *h4 = new TH2D("merge2DDiff-h4", "h4-Title", 22, -110, 110, 22, -110, 110);

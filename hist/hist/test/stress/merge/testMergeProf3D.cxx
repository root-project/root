...
TEST(StressHistorgram, TestMergeProf3D)
{
   ...
   TProfile3D *p1 = new TProfile3D("merge3D-p1", "p1-Title", numberOfBins, minRange, maxRange, numberOfBins + 1,
                                   minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TProfile3D *p2 = new TProfile3D("merge3D-p2", "p2-Title", numberOfBins, minRange, maxRange, numberOfBins + 1,
                                   minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TProfile3D *p3 = new TProfile3D("merge3D-p3", "p3-Title", numberOfBins, minRange, maxRange, numberOfBins + 1,
                                   minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TProfile3D *p4 = new TProfile3D("merge3D-p4", "p4-Title", numberOfBins, minRange, maxRange, numberOfBins + 1,
                                   minRange, maxRange, numberOfBins + 2, minRange, maxRange);
...
TEST(StressHistorgram, TestMergeProf3DDiff)
{
   ...
   TProfile3D *p1 = new TProfile3D("merge3DDiff-p1", "p1-Title", 11, -110, 0, 11, -110, 0, 11, -110, 0);
   TProfile3D *p2 = new TProfile3D("merge3DDiff-p2", "p2-Title", 22, 0, 110, 22, 0, 110, 22, 0, 110);
   TProfile3D *p3 = new TProfile3D("merge3DDiff-p3", "p3-Title", 44, -55, 55, 44, -55, 55, 44, -55, 55);
   TProfile3D *p4 = new TProfile3D("merge3DDiff-p4", "p4-Title", 22, -110, 110, 22, -110, 110, 22, -110, 110);

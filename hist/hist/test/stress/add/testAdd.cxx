...
TEST(StressHistogram, TestAdd1)
{
   ...
   TH1D h1("t1D1-h1", "h1-Title", numberOfBins, minRange, maxRange);
   TH1D h2("t1D1-h2", "h2-Title", numberOfBins, minRange, maxRange);
   TH1D h3("t1D1-h3", "h3=c1*h1+c2*h2", numberOfBins, minRange, maxRange);
   ...
   TH1D h4("t1D1-h4", "h4=c1*h1+h2*c2", numberOfBins, minRange, maxRange);
   h4.Add(&h1, &h2, c1, c2);
...
TEST(StressHistogram, TestAdd2)
{
   ...
   TH1D h5("t1D2-h5", "h5=   h6+c2*h7", numberOfBins, minRange, maxRange);
   TH1D h6("t1D2-h6", "h6-Title", numberOfBins, minRange, maxRange);
   TH1D h7("t1D2-h7", "h7-Title", numberOfBins, minRange, maxRange);
...
TEST(StressHistogram, TestAdd3)
{
   ...
   TH1D h1("t1D1-h1", "h1-Title", numberOfBins, minRange, maxRange);
   TH1D h2("t1D1-h2", "h2=c1*h1+c2*h2", numberOfBins, minRange, maxRange);
   ...
   TH1D h3("t1D1-h3", "h3=c1*h1", numberOfBins, minRange, maxRange);
   h3.Add(&h1, &h1, c1, -1);

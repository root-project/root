...
TEST(StressHistorgram, TestBinDataData2D)
{
   ...
   TH2D *h2 = new TH2D("fbd2D", "h2-title", numberOfBins, minRange, maxRange, numberOfBins, minRange, maxRange);
...
TEST(StressHistorgram, TestBinDataData2DInt)
{
   ...
   TH2D *h2 = new TH2D("fbdi2D", "h2-title", numberOfBins, minRange, maxRange, numberOfBins, minRange, maxRange);
   for (Int_t e = 0; e < nEvents * nEvents; ++e) {
      Double_t x = r.Uniform(0.9 * minRange, 1.1 * maxRange);
      Double_t y = r.Uniform(0.9 * minRange, 1.1 * maxRange);
      h2->Fill(x, y, 1.0);
...
TEST(StressHistorgram, TestBinDataData3D)
{
   ...
   TH3D *h3 = new TH3D("fbd3D", "h3-title", numberOfBins, minRange, maxRange, numberOfBins, minRange, maxRange,
...
TEST(StressHistorgram, TestBinDataData3DInt)
{
   ...
   TH3D *h3 = new TH3D("fbdi3D", "h3-title", numberOfBins, minRange, maxRange, numberOfBins, minRange, maxRange,
                       numberOfBins, minRange, maxRange);
   for (Int_t e = 0; e < nEvents * nEvents; ++e) {
      Double_t x = r.Uniform(0.9 * minRange, 1.1 * maxRange);
      Double_t y = r.Uniform(0.9 * minRange, 1.1 * maxRange);

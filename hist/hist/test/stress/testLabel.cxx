...
TEST(StressHistorgram, TestLabel)
{
   ...
   int extraBins = 20;
   TH1D *h2 = new TH1D("lD1-h2", "h2-Title", 2 * numberOfBins + 20, minRange,
...
TEST(StressHistorgram, TestLabel2DX)
{
   ...
   // build histo with extra  labels to tets the deflate option
   TH2D *h2 = new TH2D("lD2-h2", "h2-Title", 2 * numberOfBins + 20, minRange,
...
TEST(StressHistorgram, TestLabel2DY)
{
   ...
   // build histo with extra  labels to tets the deflate option
   TH2D *h2 = new TH2D("lD2-h2", "h2-Title", numberOfBins, minRange, maxRange, 2 * numberOfBins + 20, minRange,

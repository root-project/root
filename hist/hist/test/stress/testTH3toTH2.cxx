...
TEST(StressHistorgram, TestTH3toTH2)
{
   ...
   projected = (TH2D *)h3->Project3D("yx");
   EXPECT_EQ(0, Equals("TH3 -> XY", h2XY, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("zx");
   EXPECT_EQ(0, Equals("TH3 -> XZ", h2XZ, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("XY");
   EXPECT_EQ(0, Equals("TH3 -> YX", h2YX, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("ZY");
   EXPECT_EQ(0, Equals("TH3 -> YZ", h2YZ, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("XZ");
   EXPECT_EQ(0, Equals("TH3 -> ZX", h2ZX, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("YZ");
   EXPECT_EQ(0, Equals("TH3 -> ZY", h2ZY, projected, options));
   delete projected;
   options = 0;

   options = cmpOptStats;
   projected = (TH2D *)h3->Project3D("oyx");
   EXPECT_EQ(0, Equals("TH3O -> XY", h2XY, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("ozx");
   EXPECT_EQ(0, Equals("TH3O -> XZ", h2XZ, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oXY");
   EXPECT_EQ(0, Equals("TH3O -> YX", h2YX, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oZY");
   EXPECT_EQ(0, Equals("TH3O -> YZ", h2YZ, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oXZ");
   EXPECT_EQ(0, Equals("TH3O -> ZX", h2ZX, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oYZ");
   EXPECT_EQ(0, Equals("TH3O -> ZY", h2ZY, projected, options));
   delete projected;
   options = 0;

   options = cmpOptStats;
   TH2D *projectedProfile = (TH2D *)h3->Project3DProfile("yx  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PXY", (TH2D *)pe2XY, projectedProfile, options));
   delete projectedProfile;

   projectedProfile = (TH2D *)h3->Project3DProfile("zx  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PXZ", (TH2D *)pe2XZ, projectedProfile, options));
   delete projectedProfile;

   projectedProfile = (TH2D *)h3->Project3DProfile("xy  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PYX", (TH2D *)pe2YX, projectedProfile, options));
   delete projectedProfile;

   projectedProfile = (TH2D *)h3->Project3DProfile("zy  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PYZ", (TH2D *)pe2YZ, projectedProfile, options));
   delete projectedProfile;

   projectedProfile = (TH2D *)h3->Project3DProfile("xz  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PZX", (TH2D *)pe2ZX, projectedProfile, options));
   delete projectedProfile;

   projectedProfile = (TH2D *)h3->Project3DProfile("yz  UF OF");
   EXPECT_EQ(0, Equals("TH3 -> PZY", (TH2D *)pe2ZY, projectedProfile, options));
   delete projectedProfile;
   options = 0;

   options = cmpOptStats;
   projectedProfile = (TH2D *)h3->Project3DProfile("oyx  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PXY", (TH2D *)pe2XY, projectedProfile, options));
   delete projected;
   projectedProfile = (TH2D *)h3->Project3DProfile("ozx  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PXZ", (TH2D *)pe2XZ, projectedProfile, options));
   delete projected;
   projectedProfile = (TH2D *)h3->Project3DProfile("oxy  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PYX", (TH2D *)pe2YX, projectedProfile, options));
   delete projected;
   projectedProfile = (TH2D *)h3->Project3DProfile("ozy  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PYZ", (TH2D *)pe2YZ, projectedProfile, options));
   delete projected;
   projectedProfile = (TH2D *)h3->Project3DProfile("oxz  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PZX", (TH2D *)pe2ZX, projectedProfile, options));
   delete projected;
   projectedProfile = (TH2D *)h3->Project3DProfile("oyz  UF OF");
   EXPECT_EQ(0, Equals("TH3O -> PZY", (TH2D *)pe2ZY, projectedProfile, options));
   delete projected;
   options = 0;
   ...
   options = 0;
   projected = (TH2D *)h3->Project3D("yx");
   EXPECT_EQ(0, Equals("TH3R -> XY", h2XYR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("zx");
   EXPECT_EQ(0, Equals("TH3R -> XZ", h2XZR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("XY");
   EXPECT_EQ(0, Equals("TH3R -> YX", h2YXR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("ZY");
   EXPECT_EQ(0, Equals("TH3R -> YZ", h2YZR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("XZ");
   EXPECT_EQ(0, Equals("TH3R -> ZX", h2ZXR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("YZ");
   EXPECT_EQ(0, Equals("TH3R -> ZY", h2ZYR, projected, options));
   delete projected;
   options = 0;
   ...
   options = 0;
   projected = (TH2D *)h3->Project3D("oyx");
   EXPECT_EQ(0, Equals("TH3OR -> XY", h2XYOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("ozx");
   EXPECT_EQ(0, Equals("TH3OR -> XZ", h2XZOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oXY");
   EXPECT_EQ(0, Equals("TH3OR -> YX", h2YXOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oZY");
   EXPECT_EQ(0, Equals("TH3OR -> YZ", h2YZOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oXZ");
   EXPECT_EQ(0, Equals("TH3OR -> ZX", h2ZXOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3D("oYZ");
   EXPECT_EQ(0, Equals("TH3OR -> ZY", h2ZYOR, projected, options));
   delete projected;
   options = 0;

   options = cmpOptStats;
   projected = (TH2D *)h3->Project3DProfile("yx  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PXY", (TH2D *)pe2XYR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("zx  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PXZ", (TH2D *)pe2XZR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("xy  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PYX", (TH2D *)pe2YXR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("zy  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PYZ", (TH2D *)pe2YZR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("xz  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PZX", (TH2D *)pe2ZXR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("yz  UF OF");
   EXPECT_EQ(0, Equals("TH3R -> PZY", (TH2D *)pe2ZYR, projected, options));
   delete projected;
   options = 0;

   options = cmpOptStats;
   projected = (TH2D *)h3->Project3DProfile("oyx  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PXY", (TH2D *)pe2XYOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("ozx  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PXZ", (TH2D *)pe2XZOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("oxy  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PYX", (TH2D *)pe2YXOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("ozy  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PYZ", (TH2D *)pe2YZOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("oxz  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PZX", (TH2D *)pe2ZXOR, projected, options));
   delete projected;
   projected = (TH2D *)h3->Project3DProfile("oyz  UF OF");
   EXPECT_EQ(0, Equals("TH3OR -> PZY", (TH2D *)pe2ZYOR, projected, options));
   delete projected;
   options = 0;

...
TEST(StressHistogram, TestMul2D1)
{
   ...
   TH2D h1("m2D1-h1", "h1-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TH2D h2("m2D1-h2", "h2-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TH2D h3("m2D1-h3", "h3=c1*h1*c2*h2", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   ...
   TH2D h4("m2D1-h4", "h4=h1*h2", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
...
TEST(StressHistogram, TestMul2D2)
{
   ...
   TH2D h2("m2D2-h2", "h2-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TH2D h3("m2D2-h3", "h3=h1*h2", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);

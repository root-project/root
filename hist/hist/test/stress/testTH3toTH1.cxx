...
TEST(StressHistorgram, TestTH3toTH1)
{
   ...
   options = cmpOptStats;
   TH1D *projection = (TH1D *)h3->Project3D("x");
   EXPECT_EQ(0, Equals("TH3 -> X", h1X, projection, options));
   delete projection;
   tmp1 = h3->ProjectionX("x335");
   projection = (TH1D *)h3->Project3D("x2");
   EXPECT_EQ(0, Equals("TH3 -> X(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("y");
   EXPECT_EQ(0, Equals("TH3 -> Y", h1Y, projection, options));
   delete projection;
   tmp1 = h3->ProjectionY("y335");
   projection = (TH1D *)h3->Project3D("y2");
   EXPECT_EQ(0, Equals("TH3 -> Y(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("z");
   EXPECT_EQ(0, Equals("TH3 -> Z", h1Z, projection, options));
   delete projection;
   tmp1 = h3->ProjectionZ("z335");
   projection = (TH1D *)h3->Project3D("z2");
   EXPECT_EQ(0, Equals("TH3 -> Z(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;

   options = cmpOptStats;
   projection = (TH1D *)h3->Project3D("ox");
   EXPECT_EQ(0, Equals("TH3O -> X", h1X, projection, options));
   delete projection;
   tmp1 = h3->ProjectionX("x1335");
   projection = (TH1D *)h3->Project3D("ox2");
   EXPECT_EQ(0, Equals("TH3O -> X(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("oy");
   EXPECT_EQ(0, Equals("TH3O -> Y", h1Y, projection, options));
   delete projection;
   tmp1 = h3->ProjectionY("y1335");
   projection = (TH1D *)h3->Project3D("oy2");
   EXPECT_EQ(0, Equals("TH3O -> Y(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("oz");
   EXPECT_EQ(0, Equals("TH3O -> Z", h1Z, projection, options));
   delete projection;
   tmp1 = h3->ProjectionZ("z1335");
   projection = (TH1D *)h3->Project3D("oz2");
   EXPECT_EQ(0, Equals("TH3O -> Z(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   ...
   options = 0;
   projection = (TH1D *)h3->Project3D("x34");
   EXPECT_EQ(0, Equals("TH3R -> X", h1XR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionX("x3335", minbinY, maxbinY, minbinZ, maxbinZ);
   projection = (TH1D *)h3->Project3D("x22");
   EXPECT_EQ(0, Equals("TH3R -> X(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("y34");
   EXPECT_EQ(0, Equals("TH3R -> Y", h1YR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionY("y3335", minbinX, maxbinX, minbinZ, maxbinZ);
   projection =  (TH1D *)h3->Project3D("y22");
   EXPECT_EQ(0, Equals("TH3R -> Y(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("z34");
   EXPECT_EQ(0, Equals("TH3R -> Z", h1ZR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionZ("z3335", minbinX, maxbinX, minbinY, maxbinY);
   projection = (TH1D *)h3->Project3D("z22");
   EXPECT_EQ(0, Equals("TH3R -> Z(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   ...
   options = 0;
   projection = (TH1D *)h3->Project3D("ox");
   EXPECT_EQ(0, Equals("TH3RO -> X", h1XOR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionX("x1335", minbinY, maxbinY, minbinZ, maxbinZ, "o");
   projection = (TH1D *)h3->Project3D("ox2");
   EXPECT_EQ(0, Equals("TH3RO-> X(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("oy");
   EXPECT_EQ(0, Equals("TH3RO -> Y", h1YOR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionY("y1335", minbinX, maxbinX, minbinZ, maxbinZ, "o");
   projection = (TH1D *)h3->Project3D("oy2");
   EXPECT_EQ(0, Equals("TH3RO-> Y(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;
   projection = (TH1D *)h3->Project3D("oz");
   EXPECT_EQ(0, Equals("TH3RO-> Z", h1ZOR, projection, options));
   delete projection;
   tmp1 = h3->ProjectionZ("z1335", minbinX, maxbinX, minbinY, maxbinY, "o");
   projection = (TH1D *)h3->Project3D("oz2");
   EXPECT_EQ(0, Equals("TH3RO-> Z(x2)", tmp1, projection, options));
   delete projection;
   delete tmp1;
   tmp1 = 0;

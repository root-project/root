...
TEST(StressHistorgram, TestAssign1D)
{
   ...
   TH1D h2("=1D-h2", "h2-Title", numberOfBins, minRange, maxRange);
   h2 = h1;
...
TEST(StressHistorgram, TestAssign2D)
{
   ...
   TH2D h2("=2D-h2", "h2-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   h2 = h1;
...
TEST(StressHistorgram, TestAssignVar1D)
{
   ...
   TH1D h1("=1D-h1", "h1-Title", numberOfBins, v);
   ...
   TH1D h2("=1D-h2", "h2-Title", numberOfBins, v);
   h2 = h1;

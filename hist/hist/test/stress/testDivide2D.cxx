...
TEST(StressHistogram, TestDivide2D1)
{
   ...
   TH2D h1("d2D1-h1", "h1-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   TH2D h2("d2D1-h2", "h2-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   ...
   TH2D h3("d2D1-h3", "h3=(c1*h1)/(c2*h2)", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   h3.Divide(&h1, &h2, c1, c2);

   TH2D h4("d2D1-h4", "h4=h3*h2)", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
...
TEST(StressHistogram, TestDivide2D2)
{
   ...
   TH2D h2("d2D2-h2", "h2-Title", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);
   ...
   unique_ptr<TH2D> h3(static_cast<TH2D *>(h1.Clone()));
   h3->Divide(&h2);

   TH2D h4("d2D2-h4", "h4=h3*h2)", numberOfBins, minRange, maxRange, numberOfBins + 2, minRange, maxRange);

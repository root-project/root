...
//______________________________________________________________________________
TList *TGraphDelaunay::GetContourList(Double_t contour)
{
   ...
   if(contour<zmin || contour>zmax) {
      Error("GetContour", "Contour level outside the Z scope");
      return 0;
   }
   ...
   FindAllTriangles();
   if (fNdt <= 0) {
      Error("GetContour", "Invalid number of triangles: %d",fNdt);
      return 0;
   }

...
//______________________________________________________________________________
 TSpectrum2::TSpectrum2(Int_t maxpositions, Float_t resolution)
   :TNamed("Spectrum","Miroslav Morhac peak finder")
{
...
//______________________________________________________________________________
 const char *TSpectrum2::Background(TH1 *h,int number_of_iterations, Option_t *option)
{
/////////////////////////////////////////////////////////////////////////////
...
//______________________________________________________________________________
 Int_t TSpectrum2::Search(TH1 *hin, Double_t sigma, Option_t *option)
{
/////////////////////////////////////////////////////////////////////////////
...
//______________________________________________________________________________
 const char *TSpectrum2::Background2(float **spectrum,int sizex,int sizey,int number_of_iterations)
{
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
   ...
   if (number_of_iterations<1) return "Width of Clipping Window Must Be Positive";
   if(sizex<2*number_of_iterations+1) return("Too Large Clipping Window");
...
//_______________________________________________________________________________
	const char *TSpectrum2::Background2RectangularRidges(float **spectrum,int sizex,int sizey,int number_of_iterations_x,int number_of_iterations_y,int direction,int filter_order,int filter_type)
        {
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
	...
	float a,b,c,d,e,p1,p2,p3,p4,s1,s2,s3,s4,ar1,ar2;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if (number_of_iterations_x<1||number_of_iterations_y<1) return "Width of Clipping Window Must Be Positive";
        if(sizex<2*number_of_iterations_x+1||sizey<2*number_of_iterations_y+1) return("Too Large Clipping Window");
        float **working_space = new float* [sizex];
        for(i=0;i<sizex;i++) working_space[i] = new float[sizey];
	sampling=(int)TMath::Max(number_of_iterations_x,number_of_iterations_y);
                ...
                if(filter_type==BACK2_SUCCESSIVE_FILTERING){
                        if(filter_order==BACK2_ORDER2){
                        	for(i=1;i<=sampling;i++){
                        		r1=(int)TMath::Min(i,number_of_iterations_x),r2=(int)TMath::Min(i,number_of_iterations_y);
                        	...
                        	for(i=1;i<=sampling;i++){
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
	        			                ...
	        			                s4=spectrum[x][y+r2];
        		        		        b=(p1+p2)/2.0;
	                	                	c=(-spectrum[x-r1][y-(int)(2*ar2)]+4*spectrum[x-r1][y-(int)ar2]+4*spectrum[x-r1][y+(int)ar2]-spectrum[x-r1][y+(int)(2*ar2)])/6;
                                                        if(b<c)
                                                                b=c;
        	        		        	if(b>s2)
	        	        		        	s2=b;
        	        	        		b=(p1+p3)/2.0;
	                	                	c=(-spectrum[x-(int)(2*ar1)][y-r2]+4*spectrum[x-(int)ar1][y-r2]+4*spectrum[x+(int)ar1][y-r2]-spectrum[x+(int)(2*ar1)][y-r2])/6;
                                                        if(b<c)
                                                                b=c;
	        	        	        	if(b>s1)
		        	        	        	s1=b;
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
        		        		        ...
        		        		        b=(p1+p2)/2.0;
	                	                	...
	                	                	c=(-spectrum[x-r1][y-(int)(2*ar2)]+4*spectrum[x-r1][y-(int)ar2]+4*spectrum[x-r1][y+(int)ar2]-spectrum[x-r1][y+(int)(2*ar2)])/6;
                                                        ar1=r1/3,ar2=r2/3;
	                	                	d=(spectrum[x-r1][y-(int)(3*ar2)]-6*spectrum[x-r1][y-(int)(2*ar2)]+15*spectrum[x-r1][y-(int)ar2]+15*spectrum[x-r1][y+(int)ar2]-6*spectrum[x-r1][y+(int)(2*ar2)]+spectrum[x-r1][y+(int)(3*ar2)])/20;
                                                        if(b<d)
                                                                b=d;
                                                        if(b<c)
                                                                b=c;
        	        	        		...
        	        	        		b=(p1+p3)/2.0;
	                	                	...
	                	                	c=(-spectrum[x-(int)(2*ar1)][y-r2]+4*spectrum[x-(int)ar1][y-r2]+4*spectrum[x+(int)ar1][y-r2]-spectrum[x+(int)(2*ar1)][y-r2])/6;
                                                        ar1=r1/3,ar2=r2/3;
	                	                	d=(spectrum[x-(int)(3*ar1)][y-r2]-6*spectrum[x-(int)(2*ar1)][y-r2]+15*spectrum[x-(int)ar1][y-r2]+15*spectrum[x+(int)ar1][y-r2]-6*spectrum[x+(int)(2*ar1)][y-r2]+spectrum[x+(int)(3*ar1)][y-r2])/20;
                                                        if(b<d)
                                                                b=d;
                                                        if(b<c)
                                                                b=c;
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
        		        		        ...
        		        		        b=(p1+p2)/2.0;
	                	                	...
	                	                	d=(spectrum[x-r1][y-(int)(3*ar2)]-6*spectrum[x-r1][y-(int)(2*ar2)]+15*spectrum[x-r1][y-(int)ar2]+15*spectrum[x-r1][y+(int)ar2]-6*spectrum[x-r1][y+(int)(2*ar2)]+spectrum[x-r1][y+(int)(3*ar2)])/20;
                                                        ar1=r1/4,ar2=r2/4;
	                	                	e=(-spectrum[x-r1][y-(int)(4*ar2)]+8*spectrum[x-r1][y-(int)(3*ar2)]-28*spectrum[x-r1][y-(int)(2*ar2)]+56*spectrum[x-r1][y-(int)ar2]+56*spectrum[x-r1][y+(int)ar2]-28*spectrum[x-r1][y+(int)(2*ar2)]+8*spectrum[x-r1][y+(int)(3*ar2)]-spectrum[x-r1][y+(int)(4*ar2)])/70;
                                                        if(b<e)
                                                                b=e;
                                                        if(b<d)
                                                                b=d;
        	        	        		...
        	        	        		b=(p1+p3)/2.0;
	                	                	...
	                	                	d=(spectrum[x-(int)(3*ar1)][y-r2]-6*spectrum[x-(int)(2*ar1)][y-r2]+15*spectrum[x-(int)ar1][y-r2]+15*spectrum[x+(int)ar1][y-r2]-6*spectrum[x+(int)(2*ar1)][y-r2]+spectrum[x+(int)(3*ar1)][y-r2])/20;
                                                        ar1=r1/4,ar2=r2/4;
	                	                	e=(-spectrum[x-(int)(4*ar1)][y-r2]+8*spectrum[x-(int)(3*ar1)][y-r2]-28*spectrum[x-(int)(2*ar1)][y-r2]+56*spectrum[x-(int)ar1][y-r2]+56*spectrum[x+(int)ar1][y-r2]-28*spectrum[x+(int)(2*ar1)][y-r2]+8*spectrum[x+(int)(3*ar1)][y-r2]-spectrum[x+(int)(4*ar1)][y-r2])/70;
                                                        if(b<e)
                                                                b=e;
                                                        if(b<d)
                                                                b=d;
                        ...
                        if(filter_order==BACK2_ORDER2){
                        	for(i=1;i<=sampling;i++){
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
			                        	a=spectrum[x][y];
                                                        b=-(spectrum[x-r1][y-r2]+spectrum[x-r1][y+r2]+spectrum[x+r1][y-r2]+spectrum[x+r1][y+r2])/4+(spectrum[x][y-r2]+spectrum[x-r1][y]+spectrum[x+r1][y]+spectrum[x][y+r2])/2;
	        		        	        if(b<a&&b>0)
		        		        	        a=b;
                	        			working_space[x][y]=a;
	                	        	}
                        	...
                        	for(i=1;i<=sampling;i++){
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
			                        	a=spectrum[x][y];
                                                        b=-(spectrum[x-r1][y-r2]+spectrum[x-r1][y+r2]+spectrum[x+r1][y-r2]+spectrum[x+r1][y+r2])/4+(spectrum[x][y-r2]+spectrum[x-r1][y]+spectrum[x+r1][y]+spectrum[x][y+r2])/2;
                                                        c=-(spectrum[x-(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(2*ar2)]);
                                                        c+=4*(spectrum[x-(int)ar1][y-(int)(2*ar2)]+spectrum[x+(int)ar1][y-(int)(2*ar2)]+spectrum[x-(int)ar1][y+(int)(2*ar2)]+spectrum[x+(int)ar1][y+(int)(2*ar2)]);
                                                        c+=4*(spectrum[x-(int)(2*ar1)][y-(int)ar2]+spectrum[x+(int)(2*ar1)][y-(int)ar2]+spectrum[x-(int)(2*ar1)][y+(int)ar2]+spectrum[x+(int)(2*ar1)][y+(int)ar2]);
                                                        c-=6*(spectrum[x][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y]+spectrum[x][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y]);
                                                        c-=16*(spectrum[x-(int)ar1][y-(int)ar2]+spectrum[x-(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y-(int)ar2]);
                                                        c+=24*(spectrum[x][y-(int)ar2]+spectrum[x-(int)ar1][y]+spectrum[x][y+(int)ar2]+spectrum[x+(int)ar1][y]);
                                                        c=c/36;
	        		        	        if(b<c)
		        		        	        b=c;
	        		        	        if(b<a&&b>0)
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
			                        	a=spectrum[x][y];
                                                        ...
                                                        c=c/36;
                                                        ar1=r1/3,ar2=r2/3;
                                                        d=-(spectrum[x-(int)(3*ar1)][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y-(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y+(int)(3*ar2)]);
                                                        d+=6*(spectrum[x-(int)(2*ar1)][y-(int)(3*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(3*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(3*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(3*ar2)]);
                                                        d+=6*(spectrum[x-(int)(3*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(3*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(3*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(3*ar1)][y+(int)(2*ar2)]);
                                                        d-=15*(spectrum[x-(int)ar1][y-(int)(3*ar2)]+spectrum[x+(int)ar1][y-(int)(3*ar2)]+spectrum[x-(int)ar1][y+(int)(3*ar2)]+spectrum[x+(int)ar1][y+(int)(3*ar2)]);
                                                        d-=15*(spectrum[x-(int)(3*ar1)][y-(int)ar2]+spectrum[x+(int)(3*ar1)][y-(int)ar2]+spectrum[x-(int)(3*ar1)][y+(int)ar2]+spectrum[x+(int)(3*ar1)][y+(int)ar2]);
                                                        d+=20*(spectrum[x][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y]+spectrum[x][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y]);
                                                        d-=36*(spectrum[x-(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(2*ar2)]);                                                        d+=20*(spectrum[x][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y]+spectrum[x][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y]);
                                                        d+=90*(spectrum[x-(int)ar1][y-(int)(2*ar2)]+spectrum[x+(int)ar1][y-(int)(2*ar2)]+spectrum[x-(int)ar1][y+(int)(2*ar2)]+spectrum[x+(int)ar1][y+(int)(2*ar2)]);
                                                        d+=90*(spectrum[x-(int)(2*ar1)][y-(int)ar2]+spectrum[x+(int)(2*ar1)][y-(int)ar2]+spectrum[x-(int)(2*ar1)][y+(int)ar2]+spectrum[x+(int)(2*ar1)][y+(int)ar2]);
                                                        d-=120*(spectrum[x][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y]+spectrum[x][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y]);
                                                        d-=225*(spectrum[x-(int)ar1][y-(int)ar2]+spectrum[x-(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y-(int)ar2]);
                                                        d+=300*(spectrum[x][y-(int)ar2]+spectrum[x-(int)ar1][y]+spectrum[x][y+(int)ar2]+spectrum[x+(int)ar1][y]);
                                                        d=d/400;
	        		        	        if(b<d)
		        		        	        b=d;
	        		        	        if(b<c)
	                        	...
	                        	for(y=r2;y<sizey-r2;y++){
		                        	for(x=r1;x<sizex-r1;x++){
			                        	a=spectrum[x][y];
                                                        ...
                                                        d=d/400;
                                                        ar1=r1/4,ar2=r2/4;
                                                        e=-(spectrum[x-(int)(4*ar1)][y-(int)(4*ar2)]+spectrum[x-(int)(4*ar1)][y+(int)(4*ar2)]+spectrum[x+(int)(4*ar1)][y-(int)(4*ar2)]+spectrum[x+(int)(4*ar1)][y+(int)(4*ar2)]);
                                                        e+=8*(spectrum[x-(int)(3*ar1)][y-(int)(4*ar2)]+spectrum[x+(int)(3*ar1)][y-(int)(4*ar2)]+spectrum[x-(int)(3*ar1)][y+(int)(4*ar2)]+spectrum[x+(int)(3*ar1)][y+(int)(4*ar2)]);
                                                        e+=8*(spectrum[x-(int)(4*ar1)][y-(int)(3*ar2)]+spectrum[x+(int)(4*ar1)][y-(int)(3*ar2)]+spectrum[x-(int)(4*ar1)][y+(int)(3*ar2)]+spectrum[x+(int)(4*ar1)][y+(int)(3*ar2)]);
                                                        e-=28*(spectrum[x-(int)(2*ar1)][y-(int)(4*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(4*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(4*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(4*ar2)]);
                                                        e-=28*(spectrum[x-(int)(4*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(4*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(4*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(4*ar1)][y+(int)(2*ar2)]);
                                                        e+=56*(spectrum[x-(int)ar1][y-(int)(4*ar2)]+spectrum[x+(int)ar1][y-(int)(4*ar2)]+spectrum[x-(int)ar1][y+(int)(4*ar2)]+spectrum[x+(int)ar1][y+(int)(4*ar2)]);
                                                        e+=56*(spectrum[x-(int)(4*ar1)][y-(int)ar2]+spectrum[x+(int)(4*ar1)][y-(int)ar2]+spectrum[x-(int)(4*ar1)][y+(int)ar2]+spectrum[x+(int)(4*ar1)][y+(int)ar2]);
                                                        e-=70*(spectrum[x][y-(int)(4*ar2)]+spectrum[x-(int)(4*ar1)][y]+spectrum[x][y+(int)(4*ar2)]+spectrum[x+(int)(4*ar1)][y]);
                                                        e-=64*(spectrum[x-(int)(3*ar1)][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y-(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y+(int)(3*ar2)]);
                                                        e+=224*(spectrum[x-(int)(2*ar1)][y-(int)(3*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(3*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(3*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(3*ar2)]);
                                                        e+=224*(spectrum[x-(int)(3*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(3*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(3*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(3*ar1)][y+(int)(2*ar2)]);
                                                        e-=448*(spectrum[x-(int)ar1][y-(int)(3*ar2)]+spectrum[x+(int)ar1][y-(int)(3*ar2)]+spectrum[x-(int)ar1][y+(int)(3*ar2)]+spectrum[x+(int)ar1][y+(int)(3*ar2)]);
                                                        e-=448*(spectrum[x-(int)(3*ar1)][y-(int)ar2]+spectrum[x+(int)(3*ar1)][y-(int)ar2]+spectrum[x-(int)(3*ar1)][y+(int)ar2]+spectrum[x+(int)(3*ar1)][y+(int)ar2]);
                                                        e+=560*(spectrum[x][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y]+spectrum[x][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y]);
                                                        e-=784*(spectrum[x-(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y-(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y+(int)(2*ar2)]);                                                        d+=20*(spectrum[x][y-(int)(3*ar2)]+spectrum[x-(int)(3*ar1)][y]+spectrum[x][y+(int)(3*ar2)]+spectrum[x+(int)(3*ar1)][y]);
                                                        e+=1568*(spectrum[x-(int)ar1][y-(int)(2*ar2)]+spectrum[x+(int)ar1][y-(int)(2*ar2)]+spectrum[x-(int)ar1][y+(int)(2*ar2)]+spectrum[x+(int)ar1][y+(int)(2*ar2)]);
                                                        e+=1568*(spectrum[x-(int)(2*ar1)][y-(int)ar2]+spectrum[x+(int)(2*ar1)][y-(int)ar2]+spectrum[x-(int)(2*ar1)][y+(int)ar2]+spectrum[x+(int)(2*ar1)][y+(int)ar2]);
                                                        e-=1960*(spectrum[x][y-(int)(2*ar2)]+spectrum[x-(int)(2*ar1)][y]+spectrum[x][y+(int)(2*ar2)]+spectrum[x+(int)(2*ar1)][y]);
                                                        e-=3136*(spectrum[x-(int)ar1][y-(int)ar2]+spectrum[x-(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y+(int)ar2]+spectrum[x+(int)ar1][y-(int)ar2]);
                                                        e+=3920*(spectrum[x][y-(int)ar2]+spectrum[x-(int)ar1][y]+spectrum[x][y+(int)ar2]+spectrum[x+(int)ar1][y]);
                                                        e=e/4900;
	        		        	        if(b<e)
		        		        	        b=e;
	        		        	        if(b<d)
...
//_______________________________________________________________________________
	const char *TSpectrum2::Background2RectangularRidgesX(float **spectrum,int sizex,int sizey,int number_of_iterations,int direction,int filter_order)
        {
/////////////////////////////////////////////////////////////////////////////
/*	TWO-DIMENSIONAL BACKGROUND ESTIMATION FUNCTION -                   */
...
//_______________________________________________________________________________
	const char *TSpectrum2::Background2RectangularRidgesY(float **spectrum,int sizex,int sizey,int number_of_iterations,int direction,int filter_order)
        {
/////////////////////////////////////////////////////////////////////////////
/*	TWO-DIMENSIONAL BACKGROUND ESTIMATION FUNCTION -                   */
...
/////////////////////////////////////////////////////////////////////////////
	...
	float a,b,c,d,e,ai;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if (number_of_iterations<1) return "Width of Clipping Window Must Be Positive";
        if(sizey<2*number_of_iterations+1) return("Too Large Clipping Window");
        float **working_space = new float* [sizex];
        for(i=0;i<sizex;i++) working_space[i] = new float[sizey];
	sampling=number_of_iterations;
        if(direction==BACK2_INCREASING_WINDOW){
...
//_______________________________________________________________________________
	const char *TSpectrum2::Background2SkewRidges(float **spectrum,int sizex,int sizey,int number_of_iterations_x,int number_of_iterations_y,int direction,int filter_order)
        {
/////////////////////////////////////////////////////////////////////////////
	                       	...
	                       	for(y=r2;y<sizey-r2;y++){
	                        	for(x=r1;x<sizex-r1;x++){
		                        	a=spectrum[x][y];
                                                ...
                                                b=(2*(array[0]+array[1]+array[2]+array[3])-(array[4]+array[5]+array[6]+array[7]))/4;
	       		        	        if(b<a&&b>0)
	        		        	        a=b;
               	        			working_space[x][y]=a;
	               	        	}
	                       	...
	                       	for(y=r2;y<sizey-r2;y++){
	                        	for(x=r1;x<sizex-r1;x++){
		                        	a=spectrum[x][y];
                                                ...
                                                b=(2*(array[0]+array[1]+array[2]+array[3])-(array[4]+array[5]+array[6]+array[7]))/4;
                                                for(j=-1,k=0;j<1;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)ar2];
                                                }
                                                for(j=-1;j<1;j++,k++){
                                                        array[k]=spectrum[x+(int)ar1][y+(int)(j*ar1)];
                                                }
                                                for(j=-1;j<1;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y+(int)ar2];
                                                }
                                                ...
                                                c=24*(array[0]+array[1]+array[2]+array[3])-16*(array[4]+array[5]+array[6]+array[7]);
                                                for(j=-2,k=0;j<2;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(2*ar2)];
                                                }
                                                for(j=-2;j<2;j++,k++){
                                                        array[k]=spectrum[x+(int)(2*ar1)][y+(int)(j*ar1)];
                                                }
                                                for(j=-2;j<2;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y+(int)(2*ar2)];
                                                }
                                                ...
                                                c=c-6*(array[0]+array[1]+array[2]+array[3])+4*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])-(array[12]+array[13]+array[14]+array[15]);
                                                c=c/36;
                                                if(b<c)
                                                        b=c;
	       		        	        if(b<a&&b>0)
	                       	...
	                       	for(y=r2;y<sizey-r2;y++){
	                        	for(x=r1;x<sizex-r1;x++){
		                        	a=spectrum[x][y];
                                                ...
                                                d=300*(array[0]+array[1]+array[2]+array[3])-225*(array[4]+array[5]+array[6]+array[7]);
                                                for(j=-2,k=0;j<2;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(2*ar2)];
                                                }
                                                for(j=-2;j<2;j++,k++){
                                                ...
                                                d=d-120*(array[0]+array[1]+array[2]+array[3])+90*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])-36*(array[12]+array[13]+array[14]+array[15]);
                                                for(j=-3,k=0;j<3;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(3*ar2)];
                                                }
                                                for(j=-3;j<3;j++,k++){
                                                        array[k]=spectrum[x+(int)(3*ar1)][y+(int)(j*ar1)];
                                                }
                                                for(j=-3;j<3;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y+(int)(3*ar2)];
                                                }
                                                ...
                                                d=d+20*(array[0]+array[1]+array[2]+array[3])-15*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])+6*(array[12]+array[13]+array[14]+array[15]+array[16]+array[17]+array[18]+array[19])-(array[20]+array[21]+array[22]+array[23]);
                                                d=d/400;
                                                if(b<d)
                                                        b=d;
                                                if(b<c)
	                       	...
	                       	for(y=r2;y<sizey-r2;y++){
	                        	for(x=r1;x<sizex-r1;x++){
		                        	a=spectrum[x][y];
                                                ...
                                                e=3920*(array[0]+array[1]+array[2]+array[3])-3136*(array[4]+array[5]+array[6]+array[7]);
                                                for(j=-2,k=0;j<2;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(2*ar2)];
                                                }
                                                for(j=-2;j<2;j++,k++){
                                                ...
                                                e=e-1960*(array[0]+array[1]+array[2]+array[3])+1568*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])-784*(array[12]+array[13]+array[14]+array[15]);
                                                for(j=-3,k=0;j<3;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(3*ar2)];
                                                }
                                                for(j=-3;j<3;j++,k++){
                                                ...
                                                e=e+560*(array[0]+array[1]+array[2]+array[3])-448*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])+224*(array[12]+array[13]+array[14]+array[15]+array[16]+array[17]+array[18]+array[19])-64*(array[20]+array[21]+array[22]+array[23]);
                                                for(j=-4,k=0;j<4;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y-(int)(4*ar2)];
                                                }
                                                for(j=-4;j<4;j++,k++){
                                                        array[k]=spectrum[x+(int)(4*ar1)][y+(int)(j*ar1)];
                                                }
                                                for(j=-4;j<4;j++,k++){
                                                        array[k]=spectrum[x+(int)(j*ar1)][y+(int)(4*ar2)];
                                                }
                                                ...
                                                e=e-70*(array[0]+array[1]+array[2]+array[3])+56*(array[4]+array[5]+array[6]+array[7]+array[8]+array[9]+array[10]+array[11])-28*(array[12]+array[13]+array[14]+array[15]+array[16]+array[17]+array[18]+array[19])+8*(array[20]+array[21]+array[22]+array[23]+array[24]+array[25]+array[26]+array[27])-(array[28]+array[29]+array[30]+array[31]);
                                                e=e/4900;
                                                if(b<e)
                                                        b=e;
                                                if(b<d)
...
//_______________________________________________________________________________
	const char *TSpectrum2::Background2NonlinearRidges(float **spectrum,int sizex,int sizey,int number_of_iterations_x,int number_of_iterations_y,int direction,int filter_order)
        {
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
	...
	float a,b,c,d,e,f,p,ar1,ar2,array[1000],p1,p2,p3,p4,s1,s2,s3,s4;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if (number_of_iterations_x<1||number_of_iterations_y<1) return "Width of Clipping Window Must Be Positive";
        if(sizex<2*number_of_iterations_x+1||sizey<2*number_of_iterations_y+1) return("Too Large Clipping Window");
        float **working_space = new float* [sizex];
	                       	...
	                       	for(y=r2;y<sizey-r2;y++){
	                        	for(x=r1;x<sizex-r1;x++){
        		        	        ...
        		        	        s2=s2-(p1+p2)/2.0;
       	        		        	s3=s3-(p3+p4)/2.0;
        	        		        s4=s4-(p2+p4)/2.0;
                                                if(s1>0&&s4>0&&x1max==x2max&&s2>0&&s3>0&&y1max==y2max){
                                                        b=-(spectrum[x-r1][y-r2]+spectrum[x-r1][y+r2]+spectrum[x+r1][y-r2]+spectrum[x+r1][y+r2])/4+(spectrum[x][y-r2]+spectrum[x-r1][y]+spectrum[x+r1][y]+spectrum[x][y+r2])/2;
                                                        if(b<a&&b>0)
                                                                a=b;
                                                }
        	        		        ...
        	        		        s4=s4-(p2+p4)/2.0;
	        		        	        ...
	        		        	        if(b<a&&b>0)
		        		        	        a=b;
                                                        ...
                                                        for(j=-r1,k=0;j<r1;j++,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y-(int)ar2];
                                                        }
                                                        for(j=2*r1-1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        for(j=-r2,k=0;j<r2;j++,k++){
                                                                array[k]=spectrum[x+(int)ar1][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2-1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        for(j=-2*r1,k=0;j<2*r1;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y-(int)(2*ar2)];
                                                        }
                                                        for(j=2*r1-1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        c=c-6*array[0]+4*(array[r1-1]+array[r1])-array[2*r1-1];
                                                        for(j=-2*r2,k=0;j<2*r2;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(2*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2-1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        c=c-6*array[0]+4*(array[r2-1]+array[r2])-array[2*r2-1];
                                                        for(j=-2*r1,k=0;j<2*r1;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(2*ar2)];
                                                        }
                                                        for(j=2*r1-1;j>0;j--){
        	        		        ...
        	        		        s4=s4-(p2+p4)/2.0;
	        		        	        ...
	        		        	        if(b<a&&b>0)
		        		        	        a=b;
                                                        ...
                                                        d=d-120*array[0]+90*(array[r1-1]+array[r1])-36*array[2*r1-1];
                                                        for(j=-2*r2,k=0;j<2*r2;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(2*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2-1;j>0;j--){
                                                        ...
                                                        d=d-120*array[0]+90*(array[r2-1]+array[r2])-36*array[2*r2-1];
                                                        for(j=-2*r1,k=0;j<2*r1;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(2*ar2)];
                                                        }
                                                        for(j=2*r1-1;j>0;j--){
                                                        ...
                                                        for(j=-3*r1,k=0;j<3*r1;j+=3,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y-(int)(3*ar2)];
                                                        }
                                                        for(j=2*r1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        d=d+20*array[0]-15*(array[2*r1/3-1]+array[2*r1/3])+6*(array[4*r1/3-1]+array[4*r1/3])-array[2*r1-1];
                                                        for(j=-3*r2,k=0;j<3*r2;j+=3,k++){
                                                                array[k]=spectrum[x+(int)(3*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        d=d+20*array[0]-15*(array[2*r2/3-1]+array[2*r2/3])+6*(array[4*r2/3-1]+array[4*r2/3])-array[2*r2-1];
                                                        for(j=-3*r1,k=0;j<3*r1;j+=3,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(3*ar2)];
                                                        }
                                                        for(j=2*r1;j>0;j--){
        	        		        ...
        	        		        s4=s4-(p2+p4)/2.0;
	        		        	        ...
	        		        	        if(b<a&&b>0)
		        		        	        a=b;
                                                        ...
                                                        e=e-1960*array[0]+1568*(array[r1-1]+array[r1])-784*array[2*r1-1];
                                                        for(j=-2*r2,k=0;j<2*r2;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(2*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2-1;j>0;j--){
                                                        ...
                                                        e=e-1960*array[0]+1568*(array[r2-1]+array[r2])-784*array[2*r2-1];
                                                        for(j=-2*r1,k=0;j<2*r1;j+=2,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(2*ar2)];
                                                        }
                                                        for(j=2*r1-1;j>0;j--){
                                                        ...
                                                        e=e+560*array[0]-448*(array[2*r1/3-1]+array[2*r1/3])+224*(array[4*r1/3-1]+array[4*r1/3])-64*array[2*r1-1];
                                                        for(j=-3*r2,k=0;j<3*r2;j+=3,k++){
                                                                array[k]=spectrum[x+(int)(3*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2;j>0;j--){
                                                        ...
                                                        e=e+560*array[0]-448*(array[2*r2/3-1]+array[2*r2/3])+224*(array[4*r2/3-1]+array[4*r2/3])-64*array[2*r2-1];
                                                        for(j=-3*r1,k=0;j<3*r1;j+=3,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(3*ar2)];
                                                        }
                                                        for(j=2*r1;j>0;j--){
                                                        ...
                                                        for(j=-4*r1,k=0;j<4*r1;j+=4,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y-(int)(4*ar2)];
                                                        }
                                                        for(j=2*r1;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        e=e-70*array[0]+56*(array[2*r1/4-1]+array[2*r1/4])-28*(array[r1-1]+array[r1])+8*(array[3*r1/4-1]+array[3*r1/4])-array[2*r1-1];
                                                        for(j=-4*r2,k=0;j<4*r2;j+=4,k++){
                                                                array[k]=spectrum[x+(int)(4*ar1)][y+(int)(j*ar1/r2)];
                                                        }
                                                        for(j=2*r2;j>0;j--){
                                                                for(k=0;k<j;k++){
                                                                        if(array[k+1]>array[k]){
                                                        ...
                                                        e=e-70*array[0]+56*(array[2*r2/4-1]+array[2*r2/4])-28*(array[r2-1]+array[r2])+8*(array[3*r2/4-1]+array[3*r2/4])-array[2*r2-1];
                                                        for(j=-4*r1,k=0;j<4*r1;j+=4,k++){
                                                                array[k]=spectrum[x+(int)(j*ar1/r1)][y+(int)(4*ar2)];
                                                        }
                                                        for(j=2*r1;j>0;j--){
...
//_______________________________________________________________________________
	const char *TSpectrum2::Smooth2(float **spectrum,int sizex,int sizey,int pointsx,int pointsy)
	{
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
	...
	float men[7]={4,35,21,231,429,143,1105};
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if(pointsx<3||pointsx>15||pointsx%2==0||pointsy<3||pointsy>15||pointsy%2==0)return("Incorrect Number of Smoothing Points");
        float **working_space = new float* [sizex];
        for(i=0;i<sizex;i++) working_space[i] = new float[sizey];
	kx=pointsx/2-1;
	ky=pointsy/2-1;
          	...
          	for(iy=0;iy<sizey;iy++){
	        	...
	        	for(jx=ix-pointsx/2;jx<=ix+pointsx/2;jx++){
        	        	for(jy=iy-pointsy/2;jy<=iy+pointsy/2;jy++){
                		        	...
                		        	d=spectrum[jx][jy];
        	        		        c=coef[kx][TMath::Abs(ix-jx)]*coef[ky][TMath::Abs(iy-jy)];
                	        		a+=c*d;
                                        }
	        	        }
                        }
...
//______________________________________________________________________________________________________________________________
	const char *TSpectrum2::Deconvolution2(float** source,const float** resp,int sizex,int sizey,int number_of_iterations)
	{
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
	...
	int i,j,k,lhx,lhy,i1,i2,j1,j2,k1,k2,lindex,i1min,i1max,i2min,i2max,j1min,j1max,j2min,j2max,positx=0,posity=0;
	double lda,ldb,ldc,area,maximum=0;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if (number_of_iterations<=0) return "Number of iterations must be positive";
...
//____________________________________________________________________________
	...
	void TSpectrum2::DecFourier2(double *working_space,int num,int iter,int inv)
	{
//////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                      //
//                                                                          //
...
//////////////////////////////////////////////////////////////////////////////
	...
	long double a,b,c,d,sign,wpwr,arg,wr,wi,tr,ti,pi=3.14159265358979323846;
	...
	const char *TSpectrum2::Deconvolution2HighResolution(float** source,const float** resp,int sizex,int sizey,int number_of_iterations,int number_of_repetitions,double boost)
	{
/////////////////////////////////////////////////////////////////////////////
...
/*									   */
/////////////////////////////////////////////////////////////////////////////
	int i,j,k,lhx,lhy,i1,i2,j1,j2,k1,k2,lindex,i1min,i1max,i2min,i2max,j1min,j1max,j2min,j2max,positx=0,posity=0,iterx,itery,repet;
	double lda,ldb,ldc,area,maximum=0,a,b,c,d;
        double ws[8192];
        if(sizex>4096||sizey>4096) return("Maximum Dimension is 4096");
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if (number_of_iterations<=0) return "Number of iterations must be positive";
        if (number_of_repetitions<=0) return "Number of repetitions must be positive";
        if(boost<=0) return("Boosting Factor Must be Positive Number");
        double **working_space = new double* [sizex];
        for(i=0;i<sizex;i++) working_space[i] = new double[22*sizey];
...
/*initialization in x1 matrix*/
	for(i=0,a=0;i<sizex;i++){
                for(j=0;j<sizey;j++){
        		working_space[i][j+19*sizey]=working_space[i][j+21*sizey];
                        a+=working_space[i][j+21*sizey];
                }
        }
	for(i=0;i<sizex;i++){
                for(j=0;j<sizey;j++){
        		working_space[i][j+19*sizey]=working_space[i][j+19*sizey]/a;
	...
	/***START OF ITERATIONS***/
        for(repet=0;repet<number_of_repetitions;repet++){
                if(repet!=0){
                	for(i=0;i<sizex;i++){
                                for(j=0;j<sizey;j++){
        		                working_space[i][j+19*sizey]=TMath::Power(working_space[i][j+19*sizey],boost);
                                }
                        }
                }
        	for(lindex=0;lindex<number_of_iterations;lindex++){
...
//_______________________________________________________________________________
 Int_t TSpectrum2::PeakEvaluate(const double *temp,int size,int xmax,double xmin,bool markov)
{
//////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                      //
//                                                                          //
...
//______________________________________________________________________________
 Int_t TSpectrum2::Search2(float **source,int sizex,int sizey,double sigma)
{
/////////////////////////////////////////////////////////////////////////////
...
//end of checking
   ...
   int x,y,n,priz,polx,poly,peak_index=0,i,li,lj,lmin,lmax,xmin,xmax,ymin,ymax;
        ...
        if (val>=val2) {
         ...
         if (val>=val3) {
          ...
          //find peaks in y-th column
                       n = PeakEvaluate(working_vector_x,sizex,lmax-lmin+1,x+lmin-PEAK_WINDOW/2,false);
                       if (n==-1) {
           ...
           //find peaks in x-th row
                           n = PeakEvaluate(working_vector_y,sizey,lmax-lmin+1,y+lmin-PEAK_WINDOW/2,false);
                           if (n==-1) {
...
//____________________________________________________________________________
	...
	Int_t TSpectrum2::Search2General(float **source,int sizex,int sizey,double sigma,int threshold,bool markov,int aver_window)
	{
/////////////////////////////////////////////////////////////////////////////
/*	TWO-DIMENSIONAL PEAK SEARCH FUNCTION				   */
/*	This function searches for peaks in source spectrum		   */
...
/*									   */
/////////////////////////////////////////////////////////////////////////////
	int xmin=0,xmax=sizex,ymin=0,ymax=sizey,i,j,l,peak_index=0,k1,k2,is;
	...
	for(i=0;i<PEAK_WINDOW;i++){
        ...
        if(sigma!=0){
        		  ...
        		  if(val>=val2){
		           ...
		           if(val>=val3){
	        	    ...
	        	    if(val>=val4){
	        		 ...
	        		 //find peaks in y-th column
                                     n = PeakEvaluate(working_vector_x,sizex,lmax-lmin+1,x+lmin-PEAK_WINDOW/2,markov);
                                     if (n==-1) {
                                          Warning("Search2","TOO MANY PEAKS IN ONE COLUMN");
                                          return -1;
                                     }
			          ...
			          //find peaks in x-th row
                                      n = PeakEvaluate(working_vector_y,sizey,lmax-lmin+1,y+lmin-PEAK_WINDOW/2,markov);
                                      if (n==-1) {
                                          Warning("Search2","TOO MANY PEAKS IN ONE COLUMN");
                                          return -1;
                                      }
			              if(n!=0){
        			       ...
        			       dpeaky=fPosition[poly];
                                       is=(int)(3*sigma+0.5);
                                       k1=(int)dpeakx,k2=(int)dpeaky;
                                       val1=source[k1-is][k2-is];
                                       val2=source[k1-is][k2+is];
                                       val3=source[k1+is][k2-is];
                                       val4=source[k1+is][k2+is];
                                       val5=source[k1][k2-is];
                                       val6=source[k1-is][k2];
                                       val7=source[k1][k2+is];
                                       val8=source[k1+is][k2];
                                       val=source[k1][k2];
                                       a=(val1+val2+val3+val4-2*(val5+val6+val7+val8)+4*val)/4;
	        ...
	        for(x=1;x<sizex-1;x++){
        	        for(y=1;y<sizey-1;y++){
                                a=(source[x-1][y-1]+source[x-1][y+1]+source[x+1][y-1]+source[x+1][y+1]-2*(source[x-1][y]+source[x+1][y]+source[x][y-1]+source[x][y+1])+4*source[x][y])/4;
                                if(a>threshold){
                                      dpeaky = fPosition[poly];
                                      if (peak_index < fMaxPeaks) {
...
//////////////////////////////////////////////////////////////////////////////
	...
	double da1=0.1740121,da2=-0.0479399,da3=0.3739278,dap=0.47047;
	double a,t,c,w;
	a=TMath::Abs(x);
	w=1.+dap*a;
	t=1./w;
...
//////////////////////////////////////////////////////////////////////////////
	...
	c=(-1.)*dap*c*t*t*(da1+t*(2.*da2+t*3.*da3))-2.*a*Erfc(a);
	return(c);
	}

	double TSpectrum2::Ourpowl(double a,int pw){//power function
		double c;
		c=1;
		if(pw>0)
			c=c*a*a;
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Shape2(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double ro,double a0,double ax,double ay,double txy,double sxy,double tx,double ty,double sx,double sy,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
			...
			if(txy!=0){
				px=0,py=0;
				erx=Erfc(p/s2+1/(2*bx)),ery=Erfc(r/s2+1/(2*by));
	...
	double TSpectrum2::Deramp2(double x,double y,double x0,double y0,double sigmax,double sigmay,double ro,double txy,double sxy,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Derampx(double x,double x0,double sigmax,double tx,double sx,double bx)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Deri02(double x,double y,double a,double x0,double y0,double sigmax,double sigmay,double ro,double txy,double sxy,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
		...
		if(txy!=0){
			px=0,py=0;
			erx=(-Erfc(p/s2+1/(2*bx))/(s2*bx*sigmax)-Derfc(p/s2+1/(2*bx))/(s2*sigmax)),ery=Erfc(r/s2+1/(2*by));
			ex=p/(s2*bx),ey=r/(s2*by);
			if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
				px=exp(ex)*erx,py=exp(ey)*ery;
			}
	...
	double TSpectrum2::Derderi02(double x,double y,double a,double x0,double y0,double sigmax,double sigmay,double ro)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Derj02(double x,double y,double a,double x0,double y0,double sigmax,double sigmay,double ro,double txy,double sxy,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
		...
		if(txy!=0){
			px=0,py=0;
			ery=(-Erfc(r/s2+1/(2*by))/(s2*by*sigmay)-Derfc(r/s2+1/(2*by))/(s2*sigmay)),erx=Erfc(p/s2+1/(2*bx));
			ex=p/(s2*bx),ey=r/(s2*by);
			if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
				px=exp(ex)*erx,py=exp(ey)*ery;
			}
	...
	double TSpectrum2::Derderj02(double x,double y,double a,double x0,double y0,double sigmax,double sigmay,double ro)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Deri01(double x,double ax,double x0,double sigmax,double tx,double sx,double bx)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	if(TMath::Abs(p)<3){
		...
		if(tx!=0){
			px=0;
			erx=(-Erfc(p/s2+1/(2*bx))/(s2*bx*sigmax)-Derfc(p/s2+1/(2*bx))/(s2*sigmax));
			ex=p/(s2*bx);
			if(TMath::Abs(ex)<9)
				px=exp(ex)*erx;
			r1+=0.5*tx*px;
	...
	double TSpectrum2::Derderi01(double x,double ax,double x0,double sigmax)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dersigmax(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double ro,double txy,double sxy,double tx,double sx,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double p,r,r1=0,e,a,b,x0,y0,s2,px,py,rx,ry,erx,ery,ex,ey;
	int j;
	s2=sqrt(2.0);
	for(j=0;j<num_of_fitted_peaks;j++){
		a=parameter[7*j];
		...
		if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
			...
			if(txy!=0){
				px=0,py=0;
				erx=-Erfc(p/s2+1/(2*bx))*p/(s2*bx*sigmax)-Derfc(p/s2+1/(2*bx))*p/(s2*sigmax),ery=Erfc(r/s2+1/(2*by));
				ex=p/(s2*bx),ey=r/(s2*by);
				if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
					px=exp(ex)*erx,py=exp(ey)*ery;
				}
		...
		if(TMath::Abs(p)<3){
			...
			if(tx!=0){
				px=0;
				erx=(-Erfc(p/s2+1/(2*bx))*p/(s2*bx*sigmax)-Derfc(p/s2+1/(2*bx))*p/(s2*sigmax));
				ex=p/(s2*bx);
				if(TMath::Abs(ex)<9)
					px=exp(ex)*erx;
				e+=0.5*tx*px;
	...
	double TSpectrum2::Derdersigmax(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double ro)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
			...
			b=-(ro*p*r-p*p)/sigmax;
			e=e*(b*b/(1-ro*ro)-(3*p*p-2*ro*p*r)/(sigmax*sigmax))/(1-ro*ro);
			r1=r1+a*e;
		}
		if(TMath::Abs(p)<3){
			x0=parameter[7*j+5];
	...
	double TSpectrum2::Dersigmay(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double ro,double txy,double sxy,double ty,double sy,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
			...
			if(txy!=0){
				px=0,py=0;
				ery=-Erfc(r/s2+1/(2*by))*r/(s2*by*sigmay)-Derfc(r/s2+1/(2*by))*r/(s2*sigmay),erx=Erfc(p/s2+1/(2*bx));
				ex=p/(s2*bx),ey=r/(s2*by);
				if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
					px=exp(ex)*erx,py=exp(ey)*ery;
				}
		...
		if(TMath::Abs(r)<3){
			...
			if(ty!=0){
				py=0;
				ery=(-Erfc(r/s2+1/(2*by))*r/(s2*by*sigmay)-Derfc(r/s2+1/(2*by))*r/(s2*sigmay));
				ey=r/(s2*by);
				if(TMath::Abs(ey)<9)
					py=exp(ey)*ery;
				e+=0.5*ty*py;
	...
	double TSpectrum2::Derdersigmay(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double ro)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(TMath::Abs(p)<3&&TMath::Abs(r)<3){
			...
			b=-(ro*p*r-r*r)/sigmay;
			e=e*(b*b/(1-ro*ro)-(3*r*r-2*ro*r*p)/(sigmay*sigmay))/(1-ro*ro);
			r1=r1+a*e;
		}
		if(TMath::Abs(r)<3){
			y0=parameter[7*j+6];
	...
	double TSpectrum2::Derro(int num_of_fitted_peaks,double x,double y,const double* parameter,double sx,double sy,double r)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dertxy(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dersxy(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dertx(int num_of_fitted_peaks,double x,const double* parameter,double sigmax,double bx)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Derty(int num_of_fitted_peaks,double x,const double* parameter,double sigmax,double bx)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dersx(int num_of_fitted_peaks,double x,const double* parameter,double sigmax)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Dersy(int num_of_fitted_peaks,double x,const double* parameter,double sigmax)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double TSpectrum2::Derbx(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double txy,double tx,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(txy!=0){
			px=0,py=0;
			erx=-Erfc(p/s2+1/(2*bx))*p/(s2*bx*bx)-Derfc(p/s2+1/(2*bx))/(s2*bx*bx),ery=Erfc(r/s2+1/(2*by));
			ex=p/(s2*bx),ey=r/(s2*by);
			if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
				px=exp(ex)*erx,py=exp(ey)*ery;
			}
		...
		if(tx!=0){
			px=0;
			erx=(-Erfc(p/s2+1/(2*bx))*p/(s2*bx*bx)-Derfc(p/s2+1/(2*bx))/(s2*bx*bx));
			ex=p/(s2*bx);
			if(TMath::Abs(ex)<9)
				px=exp(ex)*erx;
			r1+=0.5*a*tx*px;
	...
	double TSpectrum2::Derby(int num_of_fitted_peaks,double x,double y,const double* parameter,double sigmax,double sigmay,double txy,double ty,double bx,double by)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(j=0;j<num_of_fitted_peaks;j++){
		...
		if(txy!=0){
			px=0,py=0;
			ery=-Erfc(r/s2+1/(2*by))*r/(s2*by*by)-Derfc(r/s2+1/(2*by))/(s2*by*by),erx=Erfc(p/s2+1/(2*bx));
			ex=p/(s2*bx),ey=r/(s2*by);
			if(TMath::Abs(ex)<9&&TMath::Abs(ey)<9){
				px=exp(ex)*erx,py=exp(ey)*ery;
			}
		...
		if(ty!=0){
			py=0;
			ery=(-Erfc(r/s2+1/(2*by))*r/(s2*by*by)-Derfc(r/s2+1/(2*by))/(s2*by*by));
			ey=r/(s2*by);
			if(TMath::Abs(ey)<9)
				py=exp(ey)*ery;
			r1+=0.5*a*ty*py;
...
/////////////////FITTING FUNCTION WITHOUT MATRIX INVERSION///////////////////////////////////////
	...
	const char* TSpectrum2::Fit2Awmi(float **source, TSpectrumTwoDimFit* p,int sizex,int sizey)
	{
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
        ...
        int i,i1,i2,j,k,shift=7*p->number_of_peaks+14,peak_vel,rozmer,iter,pw,regul_cycle,flag;
        double a,b,c,d=0,alpha,chi_opt,yw,ywm,f,chi2,chi_min,chi=0,pi,pmin=0,chi_cel=0,chi_er;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        ...
        if(p->statistic_type!=FIT2_OPTIM_CHI_COUNTS&&p->statistic_type!=FIT2_OPTIM_CHI_FUNC_VALUES&&p->statistic_type!=FIT2_OPTIM_MAX_LIKELIHOOD)
                return("WRONG TYPE OF STATISTIC");
        if(p->alpha_optim!=FIT2_ALPHA_HALVING&&p->alpha_optim!=FIT2_ALPHA_OPTIMAL)
                return("WRONG OPTIMIZATION ALGORITHM");
        if(p->power!=FIT2_FIT_POWER2&&p->power!=FIT2_FIT_POWER4&&p->power!=FIT2_FIT_POWER6&&p->power!=FIT2_FIT_POWER8&&p->power!=FIT2_FIT_POWER10&&p->power!=FIT2_FIT_POWER12)
                return("WRONG POWER");
        if(p->fit_taylor!=FIT2_TAYLOR_ORDER_FIRST&&p->fit_taylor!=FIT2_TAYLOR_ORDER_SECOND)
		...
		if(p->fix_amp[i]==false){
			...
			j+=1;
                ...
                if(p->position_init_x[i]<p->xmin)
                        return("INITIAL VALUE OF POSITION MUST BE WITHIN FITTING REGION");
	...
	if(rozmer>=(p->xmax-p->xmin+1)*(p->ymax-p->ymin+1))
        ...
        //filling vectors
	        ...
	        for(i1=p->xmin;i1<=p->xmax;i1++){
        	        for(i2=p->ymin;i2<=p->ymax;i2++){
        		        yw=source[i1][i2];
                		ywm=yw;
        			f=Shape2(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+3],working_space[peak_vel+4],working_space[peak_vel+5],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+8],working_space[peak_vel+9],working_space[peak_vel+10],working_space[peak_vel+11],working_space[peak_vel+12],working_space[peak_vel+13]);
		                ...
		                for(j=0,k=0;j<p->number_of_peaks;j++){
        					...
        					a=Deramp2((double)i1,(double)i2,working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
                			        if(ywm!=0){
	                			        c=Ourpowl(a,pw);
                                                        if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
        					...
        					a=Deri02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
                                                if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
	                				d=Derderi02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
        			                if(ywm!=0){
	        			                c=Ourpowl(a,pw);
                                                        if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
        					...
        					a=Derj02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
                                                if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
        	        				d=Derderj02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
        			                if(ywm!=0){
	        			                c=Ourpowl(a,pw);
                                                        if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                                d=d*TMath::Abs(yw-f)/(2*a*ywm);
        					...
        					a=Derampx((double)i1,working_space[7*j+5],working_space[peak_vel],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12]);
                			        if(ywm!=0){
	                			        c=Ourpowl(a,pw);
                                                        if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
                		                		b=a*(yw*yw-f*f)/(ywm*ywm);
        					...
        					a=Derampx((double)i2,working_space[7*j+6],working_space[peak_vel+1],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+13]);
                			        if(ywm!=0){
	                			        c=Ourpowl(a,pw);
                                                        if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
                		                		b=a*(yw*yw-f*f)/(ywm*ywm);
        					...
        					a=Deri01((double)i1,working_space[7*j+3],working_space[7*j+5],working_space[peak_vel],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12]);
                                                if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
        	        				d=Derderi01((double)i1,working_space[7*j+3],working_space[7*j+5],working_space[peak_vel]);
        			                if(ywm!=0){
	        			                c=Ourpowl(a,pw);
                                                        if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                                d=d*TMath::Abs(yw-f)/(2*a*ywm);
        					...
        					a=Deri01((double)i2,working_space[7*j+4],working_space[7*j+6],working_space[peak_vel+1],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+13]);
                                                if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
        	        				d=Derderi01((double)i2,working_space[7*j+4],working_space[7*j+6],working_space[peak_vel+1]);
        			                if(ywm!=0){
	        			                c=Ourpowl(a,pw);
                                                        if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                                d=d*TMath::Abs(yw-f)/(2*a*ywm);
        			...
        			if(p->fix_sigma_x==false){
	        			a=Dersigmax(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12],working_space[peak_vel+13]);
                                        if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
        		        		d=Derdersigmax(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
                		        if(ywm!=0){
	                		        c=Ourpowl(a,pw);
                                                if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                        d=d*TMath::Abs(yw-f)/(2*a*ywm);
        			...
        			if(p->fix_sigma_y==false){
        				a=Dersigmay(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+12],working_space[peak_vel+13]);
                                        if(p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND)
        	        			d=Derdersigmay(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
                		        if(ywm!=0){
	                		        c=Ourpowl(a,pw);
                                                if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                        d=d*TMath::Abs(yw-f)/(2*a*ywm);
        			...
        			if(p->fix_ro==false){
        				a=Derro(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
                		        if(ywm!=0){
	                		        c=Ourpowl(a,pw);
                                                if(TMath::Abs(a)>0.00000001&&p->fit_taylor==FIT2_TAYLOR_ORDER_SECOND){
                                                        d=d*TMath::Abs(yw-f)/(2*a*ywm);
        			...
        			if(p->fix_txy==false){
	        			a=Dertxy(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+12],working_space[peak_vel+13]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_sxy==false){
        				a=Dersxy(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_tx==false){
        				a=Dertx(p->number_of_peaks,(double)i1,working_space,working_space[peak_vel],working_space[peak_vel+12]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_ty==false){
        				a=Derty(p->number_of_peaks,(double)i2,working_space,working_space[peak_vel+1],working_space[peak_vel+13]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_sx==false){
        				a=Dersx(p->number_of_peaks,(double)i1,working_space,working_space[peak_vel]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_sy==false){
        				a=Dersy(p->number_of_peaks,(double)i2,working_space,working_space[peak_vel+1]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_bx==false){
        				a=Derbx(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+6],working_space[peak_vel+8],working_space[peak_vel+12],working_space[peak_vel+13]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        			...
        			if(p->fix_by==false){
        				a=Derby(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+6],working_space[peak_vel+8],working_space[peak_vel+12],working_space[peak_vel+13]);
        	                	if(ywm!=0){
	        	                	c=Ourpowl(a,pw);
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES){
       		        		                b=a*(yw*yw-f*f)/(ywm*ywm);
        ...
        //calculate chi_opt
	        chi2=chi_opt;
        	chi_opt=sqrt(TMath::Abs(chi_opt));
	        ...
	        do{
		        if(p->alpha_optim==FIT2_ALPHA_OPTIMAL){
			        ...
			        for(pi=0.1;flag==0&&pi<=100;pi+=0.1){
		        		...
		        		if(chi2<chi_min&&p->statistic_type!=FIT2_OPTIM_MAX_LIKELIHOOD||chi2>chi_min&&p->statistic_type==FIT2_OPTIM_MAX_LIKELIHOOD){
		        ...
		        iter+=1;
        		regul_cycle+=1;
	        }while((chi>chi_opt&&p->statistic_type!=FIT2_OPTIM_MAX_LIKELIHOOD||chi<chi_opt&&p->statistic_type==FIT2_OPTIM_MAX_LIKELIHOOD)&&regul_cycle<FIT2_NUM_OF_REGUL_CYCLES);
        	for(j=0;j<rozmer;j++){
        ...
        chi_er=chi_cel/b;
	for(i=0,j=0;i<p->number_of_peaks;i++){
		p->volume[i]=Volume(working_space[7*i],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
		if(p->volume[i]>0){
                        c=0;
        		if(p->fix_amp[i]==false){
	        		a=Derpa2(working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
        		...
        		if(p->fix_sigma_x==false){
	        		a=Derpsigmax(working_space[shift+j],working_space[peak_vel+1],working_space[peak_vel+2]);
        		...
        		if(p->fix_sigma_y==false){
        			a=Derpsigmay(working_space[shift+j],working_space[peak_vel],working_space[peak_vel+2]);
        		...
        		if(p->fix_ro==false){
	        		a=Derpro(working_space[shift+j],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
			...
			p->volume_err[i]=sqrt(TMath::Abs(chi_er*c));
                }
                else{
			p->volume_err[i]=0;
                }
		if(p->fix_amp[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->amp_err[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_position_x[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->position_err_x[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_position_y[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->position_err_y[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_amp_x1[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->amp_err_x1[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_amp_y1[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->amp_err_y1[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_position_x1[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->position_err_x1[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
		...
		if(p->fix_position_y1[i]==false){
			...
			if(working_space[3*shift+j]!=0)
				p->position_err_y1[i]=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
			j+=1;
		}
		else{
	...
	if(p->fix_sigma_x==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->sigma_err_x=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
	...
	if(p->fix_sigma_y==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->sigma_err_y=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
	...
	if(p->fix_ro==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->ro_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->ro_calc=p->ro_init;
	...
	if(p->fix_a0==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->a0_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->a0_calc=p->a0_init;
	...
	if(p->fix_ax==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->ax_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->ax_calc=p->ax_init;
	...
	if(p->fix_ay==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->ay_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->ay_calc=p->ay_init;
	...
	if(p->fix_txy==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->txy_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
	...
	if(p->fix_sxy==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->sxy_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
	...
	if(p->fix_tx==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->tx_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->tx_calc=p->tx_init;
	...
	if(p->fix_ty==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->ty_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->ty_calc=p->ty_init;
	...
	if(p->fix_sx==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->sx_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->sx_calc=p->sx_init;
	...
	if(p->fix_sy==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->sy_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->sy_calc=p->sy_init;
	...
	if(p->fix_bx==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->bx_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->bx_calc=p->bx_init;
	...
	if(p->fix_by==false){
		...
		if(working_space[3*shift+j]!=0)//temp[j]
			p->by_err=sqrt(TMath::Abs(working_space[2*shift+j]))/sqrt(TMath::Abs(working_space[3*shift+j]));//der[j]/temp[j]
		j+=1;
	}
	else{
		p->by_calc=p->by_init;
...
// ____________________________________________________________________________________________________________________________
	...
	const char* TSpectrum2::Fit2Stiefel(float **source, TSpectrumTwoDimFit* p,int sizex,int sizey)
	{
/////////////////////////////////////////////////////////////////////////////
/*	TWO-DIMENSIONAL FIT FUNCTION				           */
...
/*									   */
/////////////////////////////////////////////////////////////////////////////
        int i,i1,i2,j,k,shift=7*p->number_of_peaks+14,peak_vel,rozmer,iter,regul_cycle,flag;
        double a,b,c,alpha,chi_opt,yw,ywm,f,chi2,chi_min,chi=0,pi,pmin=0,chi_cel=0,chi_er;
        if (sizex <=0 || sizey <= 0) return "Wrong parameters";
        if(p->number_of_peaks<=0)
                return("INVALID NUMBER OF PEAKS, MUST BE POSITIVE");
        if(p->number_of_iterations<=0)
        ...
        for(iter=0;iter<p->number_of_iterations;iter++){
	        ...
	        for(i1=p->xmin;i1<=p->xmax;i1++){
	        	...
	        	//calculation of gradient vector
                		for(j=0,k=0;j<p->number_of_peaks;j++){
			                if(p->fix_amp[j]==false){
        					working_space[2*shift+k]=Deramp2((double)i1,(double)i2,working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
			                	k+=1;
        			        }
                			if(p->fix_position_x[j]==false){
        					working_space[2*shift+k]=Deri02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
		        	        	k+=1;
        		        	}
                			if(p->fix_position_y[j]==false){
        					working_space[2*shift+k]=Derj02((double)i1,(double)i2,working_space[7*j],working_space[7*j+1],working_space[7*j+2],working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+12],working_space[peak_vel+13]);
		        	        	k+=1;
        		        	}
			                if(p->fix_amp_x1[j]==false){
        					working_space[2*shift+k]=Derampx((double)i1,working_space[7*j+5],working_space[peak_vel],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12]);
                                                k+=1;
                                        }
			                if(p->fix_amp_y1[j]==false){
        					working_space[2*shift+k]=Derampx((double)i2,working_space[7*j+6],working_space[peak_vel+1],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+13]);
                                                k+=1;
                                        }
                			if(p->fix_position_x1[j]==false){
        					working_space[2*shift+k]=Deri01((double)i1,working_space[7*j+3],working_space[7*j+5],working_space[peak_vel],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12]);
                                                k+=1;
                                        }
                			if(p->fix_position_y1[j]==false){
        					working_space[2*shift+k]=Deri01((double)i2,working_space[7*j+4],working_space[7*j+6],working_space[peak_vel+1],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+13]);
                                                k+=1;
		        	        }
        		        }
        			if(p->fix_sigma_x==false){
	        			working_space[2*shift+k]=Dersigmax(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+8],working_space[peak_vel+10],working_space[peak_vel+12],working_space[peak_vel+13]);
        				k+=1;
	        		}
        			if(p->fix_sigma_y==false){
        				working_space[2*shift+k]=Dersigmay(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+9],working_space[peak_vel+11],working_space[peak_vel+12],working_space[peak_vel+13]);
        				k+=1;
	        		}
        			if(p->fix_ro==false){
        				working_space[2*shift+k]=Derro(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2]);
        				k+=1;
	        		}
        			if(p->fix_a0==false){
        			...
        			if(p->fix_txy==false){
	        			working_space[2*shift+k]=Dertxy(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+12],working_space[peak_vel+13]);
			        	k+=1;
        			}
        			if(p->fix_sxy==false){
        				working_space[2*shift+k]=Dersxy(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1]);
			        	k+=1;
        			}
        			if(p->fix_tx==false){
        				working_space[2*shift+k]=Dertx(p->number_of_peaks,(double)i1,working_space,working_space[peak_vel],working_space[peak_vel+12]);
			        	k+=1;
        			}
        			if(p->fix_ty==false){
        				working_space[2*shift+k]=Derty(p->number_of_peaks,(double)i2,working_space,working_space[peak_vel+1],working_space[peak_vel+13]);
			        	k+=1;
        			}
        			if(p->fix_sx==false){
        				working_space[2*shift+k]=Dersx(p->number_of_peaks,(double)i1,working_space,working_space[peak_vel]);
			        	k+=1;
        			}
        			if(p->fix_sy==false){
        				working_space[2*shift+k]=Dersy(p->number_of_peaks,(double)i2,working_space,working_space[peak_vel+1]);
			        	k+=1;
        			}
        			if(p->fix_bx==false){
        				working_space[2*shift+k]=Derbx(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+6],working_space[peak_vel+8],working_space[peak_vel+12],working_space[peak_vel+13]);
			        	k+=1;
        			}
        			if(p->fix_by==false){
        				working_space[2*shift+k]=Derby(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+6],working_space[peak_vel+8],working_space[peak_vel+12],working_space[peak_vel+13]);
                                        k+=1;
                                }
	        	        yw=source[i1][i2];
        	        	ywm=yw;
        			f=Shape2(p->number_of_peaks,(double)i1,(double)i2,working_space,working_space[peak_vel],working_space[peak_vel+1],working_space[peak_vel+2],working_space[peak_vel+3],working_space[peak_vel+4],working_space[peak_vel+5],working_space[peak_vel+6],working_space[peak_vel+7],working_space[peak_vel+8],working_space[peak_vel+9],working_space[peak_vel+10],working_space[peak_vel+11],working_space[peak_vel+12],working_space[peak_vel+13]);
                		...
                		for(j=0;j<rozmer;j++){
	                		for(k=0;k<rozmer;k++){
		                		b=working_space[2*shift+j]*working_space[2*shift+k]/ywm;
                                                if(p->statistic_type==FIT2_OPTIM_CHI_FUNC_VALUES)
                		                        b=b*(4*yw-2*f)/ywm;
	...
	for(i1=p->xmin;i1<=p->xmax;i1++){
        ...
        for(i=0;i<rozmer;i++) delete [] working_matrix[i];
...
//////////////////////////////////////////////////////////////////////////////////
	...
	val=working_space[0];
	val=val/sqrt(TMath::Power(2,iter));
	working_space[0]=val;
	val=working_space[1];
	val=val/sqrt(TMath::Power(2,iter));
	working_space[1]=val;
	for(ii=2;ii<=iter;ii++){
		i=ii-1;
		wlk=1/sqrt(TMath::Power(2,iter-i));
...
lab10:		ip=1;
	...
	void TSpectrum2::Fourier(float *working_space,int num,int hartley,int direction,int zt_clear)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	double a,b,c,d,sign,wpwr,arg,wr,wi,tr,ti,pi=3.14159265358979323846;
...
lab65:		j=j+k;
	...
	void TSpectrum2::BitReverseHaar(float *working_space,int shift,int num,int start)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	for(i=0;i<num;i++){
		...
		working_space[i+shift+start+2*shift]=working_space[i+start+2*shift];
	}
	for(i=1;i<=num;i++){
		ib=i-1;
		il=1;
...
lab10:		ip=1;
		...
		working_space[ip-1+start]=working_space[i-1+shift+start];
		working_space[ip-1+start+2*shift]=working_space[i-1+shift+start+2*shift];
	}
	return;
	}

	int TSpectrum2::GeneralExe(float *working_space,int zt_clear,int num,int degree,int type)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	int i,j,k,m,nump,mnum,mnum2,mp,ib,mp2,mnum21,iba,iter,mp2step,mppom,ring;
	double a,b,c,d,wpwr,arg,wr,wi,tr,ti,pi=3.14159265358979323846;
	...
	for(m=1;m<=iter;m++){
		...
		mnum=num/nump;
		mnum2=mnum/2;
		if(m>degree&&(type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR||type==TRANSFORM2_COS_HAAR||type==TRANSFORM2_SIN_HAAR))
			mp2step*=2;
		if(ring>1)
			ring=ring/2;
		for(mp=0;mp<nump;mp++){
			...
			for(mp2=0;mp2<mnum2;mp2++){
				...
				tr=a*b0r*wr-c*b0r*wi-b*a0r*wr+d*a0r*wi;
				val1=tr;
				working_space[num+mnum21]=val1;
				ti=c*b0r*wr+a*b0r*wi-d*a0r*wr-b*a0r*wi;
				val1=ti;
	...
	int TSpectrum2::GeneralInv(float *working_space,int num,int degree,int type)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	int i,j,k,m,nump=1,mnum,mnum2,mp,ib,mp2,mnum21,iba,iter,mp2step,mppom,ring;
	double a,b,c,d,wpwr,arg,wr,wi,tr,ti,pi=3.14159265358979323846;
	float val1,val2,val3,val4,a0oldr=0,b0oldr=0,a0r,b0r;
	i=num;
	iter=0;
	...
	wpwr=2.0*pi/a;
	mp2step=1;
	if(type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR||type==TRANSFORM2_COS_HAAR||type==TRANSFORM2_SIN_HAAR){
		for(i=0;i<iter-degree;i++)
			mp2step*=2;
	}
	ring=1;
	for(m=1;m<=iter;m++){
		...
		if(m<=iter-degree&&(type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR||type==TRANSFORM2_COS_HAAR||type==TRANSFORM2_SIN_HAAR))
			mp2step/=2;
		for(i=0;i<num;i++){
			val1=working_space[num+i];
			working_space[i]=val1;
	...
	void TSpectrum2::HaarWalsh2(float **working_matrix,float *working_vector,int numx,int numy,int direction,int type)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	void TSpectrum2::FourCos2(float **working_matrix,float *working_vector,int numx,int numy,int direction,int type)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
...
//////////////////////////////////////////////////////////////////////////////////
	...
	if(direction==TRANSFORM2_FORWARD){
		for(j=0;j<numy;j++){
			...
			case TRANSFORM2_COS:
				...
				for(i=0;i<numx;i++){
					working_vector[i]=working_vector[i]/cos(pi*i/(2*numx));
				}
				working_vector[0]=working_vector[0]/sqrt(2);
				break;
			case TRANSFORM2_SIN:
				for(i=1;i<=numx;i++){
					working_vector[2*numx-i]=-working_vector[i-1];
                        	...
                        	Fourier(working_vector,2*numx,0,TRANSFORM2_FORWARD,0);
				for(i=1;i<numx;i++){
					working_vector[i-1]=working_vector[i]/sin(pi*i/(2*numx));
				}
				working_vector[numx-1]=working_vector[numx]/sqrt(2);
				break;
		...
		for(i=0;i<numx;i++){
			...
			case TRANSFORM2_COS:
				...
				for(j=0;j<numy;j++){
					working_vector[j]=working_vector[j]/cos(pi*j/(2*numy));
			...
			case TRANSFORM2_SIN:
				for(j=1;j<=numy;j++){
					working_vector[2*numy-j]=-working_vector[j-1];
                        	...
                        	Fourier(working_vector,2*numy,0,TRANSFORM2_FORWARD,0);
				for(j=1;j<numy;j++){
					working_vector[j-1]=working_vector[j]/sin(pi*j/(2*numy));
                                        working_vector[j+numy]=0;
				}
				working_vector[numy-1]=working_vector[numy]/sqrt(2);
		...
		for(i=0;i<numx;i++){
			...
			case TRANSFORM2_COS:
				working_vector[0]=working_vector[0]*sqrt(2);
				for(j=0;j<numy;j++){
					working_vector[j+2*numy]=working_vector[j]*sin(pi*j/(2*numy));
					working_vector[j]=working_vector[j]*cos(pi*j/(2*numy));
				}
				for(j=1;j<numy;j++){
        				working_vector[2*numy-j]=working_vector[j];
	        			working_vector[2*numy-j+2*numy]=-working_vector[j+2*numy];
				}
				working_vector[numy]=0;
				...
				break;
			case TRANSFORM2_SIN:
				working_vector[numy]=working_vector[numy-1]*sqrt(2);
				for(j=numy-1;j>0;j--){
					working_vector[j+2*numy]=-working_vector[j-1]*cos(pi*j/(2*numy));
					working_vector[j]=working_vector[j-1]*sin(pi*j/(2*numy));
				}
				for(j=1;j<numy;j++){
					working_vector[2*numy-j]=working_vector[j];
					working_vector[2*numy-j+2*numy]=-working_vector[j+2*numy];
		...
		for(j=0;j<numy;j++){
			...
			case TRANSFORM2_COS:
				working_vector[0]=working_vector[0]*sqrt(2);
				for(i=0;i<numx;i++){
					working_vector[i+2*numx]=working_vector[i]*sin(pi*i/(2*numx));
					working_vector[i]=working_vector[i]*cos(pi*i/(2*numx));
				}
				for(i=1;i<numx;i++){
        				working_vector[2*numx-i]=working_vector[i];
	        			working_vector[2*numx-i+2*numx]=-working_vector[i+2*numx];
				}
				...
				break;
			case TRANSFORM2_SIN:
				working_vector[numx]=working_vector[numx-1]*sqrt(2);
				for(i=numx-1;i>0;i--){
					working_vector[i+2*numx]=-working_vector[i-1]*cos(pi*i/(2*numx));
					working_vector[i]=working_vector[i-1]*sin(pi*i/(2*numx));
				}
				for(i=1;i<numx;i++){
					working_vector[2*numx-i]=working_vector[i];
					working_vector[2*numx-i+2*numx]=-working_vector[i+2*numx];
	...
	void TSpectrum2::General2(float **working_matrix,float *working_vector,int numx,int numy,int direction,int type,int degree)
	{
//////////////////////////////////////////////////////////////////////////////////
//   AUXILIARY FUNCION                                                          //
//                                                                              //
	...
	if(direction==TRANSFORM2_FORWARD){
		for(j=0;j<numy;j++){
			...
			for(i=0;i<numx;i++){
				...
				if(type==TRANSFORM2_COS_WALSH||type==TRANSFORM2_COS_HAAR){
				...
				else if(type==TRANSFORM2_SIN_WALSH||type==TRANSFORM2_SIN_HAAR){
					jstup=(int)TMath::Power(2,degree)/2;
					kstup=i/jstup;
					kstup=2*kstup*jstup;
					working_vector[kstup+i%jstup]=val;
			...
			for(i=0,l=0;i<numx;i++,l=(l+kstup)%numx){
				working_vector[numx+i]=working_vector[l+i/jstup];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[numx+i+2*numx]=working_vector[l+i/jstup+2*numx];
                                else
	        			working_vector[numx+i+4*numx]=working_vector[l+i/jstup+4*numx];
			}
			for(i=0;i<numx;i++){
				working_vector[i]=working_vector[numx+i];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[i+2*numx]=working_vector[numx+i+2*numx];
                                else
        				working_vector[i+4*numx]=working_vector[numx+i+4*numx];
			}
			for(i=0;i<numx;i++){
                                working_matrix[i][j]=working_vector[i];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
		...
		for(i=0;i<numx;i++){
			...
			for(j=0;j<numy;j++){
				...
				if(type==TRANSFORM2_COS_WALSH||type==TRANSFORM2_COS_HAAR){
					...
					working_vector[kstup+2*jstup-1-j%jstup+4*numy]=valz;
				}
				else if(type==TRANSFORM2_SIN_WALSH||type==TRANSFORM2_SIN_HAAR){
					jstup=(int)TMath::Power(2,degree)/2;
					kstup=j/jstup;
			...
			for(j=0,l=0;j<numy;j++,l=(l+kstup)%numy){
				working_vector[numy+j]=working_vector[l+j/jstup];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[numy+j+2*numy]=working_vector[l+j/jstup+2*numy];
                                else
        				working_vector[numy+j+4*numy]=working_vector[l+j/jstup+4*numy];
			}
			for(j=0;j<numy;j++){
				working_vector[j]=working_vector[numy+j];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[j+2*numy]=working_vector[numy+j+2*numy];
                                else
        				working_vector[j+4*numy]=working_vector[numy+j+4*numy];
			}
			for(j=0;j<numy;j++){
                                working_matrix[i][j]=working_vector[j];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
		...
		for(i=0;i<numx;i++){
			...
			for(j=0,l=0;j<numy;j++,l=(l+kstup)%numy){
				working_vector[numy+l+j/jstup]=working_vector[j];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[numy+l+j/jstup+2*numy]=working_vector[j+2*numy];
                                else
        				working_vector[numy+l+j/jstup+4*numy]=working_vector[j+4*numy];
			}
			for(j=0;j<numy;j++){
				working_vector[j]=working_vector[numy+j];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
			...
			case TRANSFORM2_COS_HAAR:
				...
				for(j=0;j<numy;j++){
					...
					a=pi*(double)(j%jstup)/(double)(2*jstup);
					if(j%jstup==0){
						working_vector[2*numy+kstup+j%jstup]=working_vector[j]*sqrt(2.0);
						working_vector[2*numy+kstup+j%jstup+4*numy]=0;
					}
					else{
						b=sin(a);
						a=cos(a);
						working_vector[2*numy+kstup+j%jstup+4*numy]=-(double)working_vector[j]*b;
						working_vector[2*numy+kstup+j%jstup]=(double)working_vector[j]*a;
					}
				}
				for(j=0;j<numy;j++){
					kstup=j/jstup;
					...
					if(j%jstup==0){
						...
						working_vector[2*numy+kstup+2*jstup-j%jstup]=working_vector[2*numy+kstup+j%jstup];
						working_vector[2*numy+kstup+2*jstup-j%jstup+4*numy]=-working_vector[2*numy+kstup+j%jstup+4*numy];
					}
				}
				for(j=0;j<2*numy;j++){
					working_vector[j]=working_vector[2*numy+j];
					working_vector[j+4*numy]=working_vector[2*numy+j+4*numy];
				}
			...
			case TRANSFORM2_SIN_HAAR:
				...
				for(j=0;j<numy;j++){
					...
					a=pi*(double)(j%jstup)/(double)(2*jstup);
					if(j%jstup==0){
						working_vector[2*numy+kstup+jstup+j%jstup]=working_vector[jstup+kstup/2-j%jstup-1]*sqrt(2.0);
						working_vector[2*numy+kstup+jstup+j%jstup+4*numy]=0;
					}
					else{
						b=sin(a);
						a=cos(a);
						working_vector[2*numy+kstup+jstup+j%jstup+4*numy]=-(double)working_vector[jstup+kstup/2-j%jstup-1]*b;
						working_vector[2*numy+kstup+jstup+j%jstup]=(double)working_vector[jstup+kstup/2-j%jstup-1]*a;
					}
				}
				for(j=0;j<numy;j++){
					kstup=j/jstup;
					...
					if(j%jstup==0){
						...
						working_vector[2*numy+kstup+j%jstup]=working_vector[2*numy+kstup+2*jstup-j%jstup];
						working_vector[2*numy+kstup+j%jstup+4*numy]=-working_vector[2*numy+kstup+2*jstup-j%jstup+4*numy];
					}
				}
				for(j=0;j<2*numy;j++){
					working_vector[j]=working_vector[2*numy+j];
		...
		for(j=0;j<numy;j++){
			...
			for(i=0,l=0;i<numx;i++,l=(l+kstup)%numx){
				working_vector[numx+l+i/jstup]=working_vector[i];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
        				working_vector[numx+l+i/jstup+2*numx]=working_vector[i+2*numx];
                                else
        				working_vector[numx+l+i/jstup+4*numx]=working_vector[i+4*numx];
			}
			for(i=0;i<numx;i++){
				working_vector[i]=working_vector[numx+i];
                                if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR||type==TRANSFORM2_WALSH_HAAR)
			...
			case TRANSFORM2_COS_HAAR:
				...
				for(i=0;i<numx;i++){
					...
					a=pi*(double)(i%jstup)/(double)(2*jstup);
					if(i%jstup==0){
						working_vector[2*numx+kstup+i%jstup]=working_vector[i]*sqrt(2.0);
						working_vector[2*numx+kstup+i%jstup+4*numx]=0;
					}
					else{
						b=sin(a);
						a=cos(a);
        					working_vector[2*numx+kstup+i%jstup+4*numx]=-(double)working_vector[i]*b;
						working_vector[2*numx+kstup+i%jstup]=(double)working_vector[i]*a;
					}
				}
				for(i=0;i<numx;i++){
					kstup=i/jstup;
					...
					if(i%jstup==0){
						...
						working_vector[2*numx+kstup+2*jstup-i%jstup]=working_vector[2*numx+kstup+i%jstup];
						working_vector[2*numx+kstup+2*jstup-i%jstup+4*numx]=-working_vector[2*numx+kstup+i%jstup+4*numx];
					}
				}
				for(i=0;i<2*numx;i++){
					working_vector[i]=working_vector[2*numx+i];
					working_vector[i+4*numx]=working_vector[2*numx+i+4*numx];
				}
			...
			case TRANSFORM2_SIN_HAAR:
				...
				for(i=0;i<numx;i++){
					...
					a=pi*(double)(i%jstup)/(double)(2*jstup);
					if(i%jstup==0){
						working_vector[2*numx+kstup+jstup+i%jstup]=working_vector[jstup+kstup/2-i%jstup-1]*sqrt(2.0);
						working_vector[2*numx+kstup+jstup+i%jstup+4*numx]=0;
					}
					else{
						b=sin(a);
						a=cos(a);
						working_vector[2*numx+kstup+jstup+i%jstup+4*numx]=-(double)working_vector[jstup+kstup/2-i%jstup-1]*b;
						working_vector[2*numx+kstup+jstup+i%jstup]=(double)working_vector[jstup+kstup/2-i%jstup-1]*a;
					}
				}
				for(i=0;i<numx;i++){
					kstup=i/jstup;
					...
					if(i%jstup==0){
						...
						working_vector[2*numx+kstup+i%jstup]=working_vector[2*numx+kstup+2*jstup-i%jstup];
						working_vector[2*numx+kstup+i%jstup+4*numx]=-working_vector[2*numx+kstup+2*jstup-i%jstup+4*numx];
					}
				}
				for(i=0;i<2*numx;i++){
					working_vector[i]=working_vector[2*numx+i];
...
//////////TRANSFORM2 FUNCTION - CALCULATES DIFFERENT 2-D DIRECT AND INVERSE ORTHOGONAL TRANSFORMS//////
	const char *TSpectrum2::Transform2(const float **source,float **dest,int sizex,int sizey,int type,int direction,int degree)
	{
//////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	if(direction==TRANSFORM2_FORWARD){
	        	...
	        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_HAAR);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
	        	...
	        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_WALSH);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		...
        		for(i=0;i<sizex;i++){
                	...
                	FourCos2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_COS);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		...
        		for(i=0;i<sizex;i++){
                	...
                	FourCos2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_SIN);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		...
        		for(i=0;i<sizex;i++){
                	...
                	FourCos2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_FOURIER);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		...
        		for(i=0;i<sizex;i++){
                	...
                	FourCos2(working_matrix,working_vector,sizex,sizey,direction,TRANSFORM2_HARTLEY);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		...
        		for(i=0;i<sizex;i++){
                	...
                	General2(working_matrix,working_vector,sizex,sizey,direction,type,degree);
        		for(i=0;i<sizex;i++){
                		for(j=0;j<sizey;j++){
        		        	dest[i][j]=working_matrix[i][j];
                                }
        		}
                        if(type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR){
                		for(i=0;i<sizex;i++){
                        		for(j=0;j<sizey;j++){
        	        	        	dest[i][j+sizey]=working_matrix[i][j+sizey];
                                        }
...
//////////FILTER2_ZONAL FUNCTION - CALCULATES DIFFERENT 2-D ORTHOGONAL TRANSFORMS, SETS GIVEN REGION TO FILTER COEFFICIENT AND TRANSFORMS IT BACK//////
	const char *TSpectrum2::Filter2Zonal(const float **source,float **dest,int sizex,int sizey,int type,int degree,int xmin, int xmax,int ymin,int ymax,float filter_coeff)
	{
//////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	size=(int)TMath::Max(sizex,sizey);
        ...
        case TRANSFORM2_HAAR:
        	...
        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_HAAR);
                break;
        case TRANSFORM2_WALSH:
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
        	...
        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_WALSH);
                break;
        case TRANSFORM2_COS:
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
               	...
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_COS);
                break;
         case TRANSFORM2_SIN:
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
               	...
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_SIN);
                break;
         case TRANSFORM2_FOURIER:
      		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
               	...
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_FOURIER);
                break;
          case TRANSFORM2_HARTLEY:
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
               	...
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,TRANSFORM2_HARTLEY);
                break;
          case TRANSFORM2_FOURIER_WALSH:
          case TRANSFORM2_FOURIER_HAAR:
          case TRANSFORM2_WALSH_HAAR:
          ...
          case TRANSFORM2_SIN_HAAR:
       		for(i=0;i<sizex;i++){
               	...
               	General2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_FORWARD,type,degree);
                break;
        }
	for(i=0;i<sizex;i++){
        	for(j=0;j<sizey;j++){
        ...
        if(type==TRANSFORM2_FOURIER||type==TRANSFORM2_FOURIER_WALSH||type==TRANSFORM2_FOURIER_HAAR){
        	for(i=0;i<sizex;i++){
                	for(j=0;j<sizey;j++){
                                if(i>=xmin&&i<=xmax&&j>=ymin&&j<=ymax)
        ...
        switch(type){
        case TRANSFORM2_HAAR:
        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_HAAR);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
                ...
                break;
        case TRANSFORM2_WALSH:
        	HaarWalsh2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_WALSH);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
                ...
                break;
        case TRANSFORM2_COS:
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_COS);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
                ...
                break;
        case TRANSFORM2_SIN:
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_SIN);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
                ...
                break;
        case TRANSFORM2_FOURIER:
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_FOURIER);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
                ...
                break;
         case TRANSFORM2_HARTLEY:
               	FourCos2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,TRANSFORM2_HARTLEY);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
         ...
         case TRANSFORM2_SIN_WALSH:
         case TRANSFORM2_SIN_HAAR:
               	General2(working_matrix,working_vector,sizex,sizey,TRANSFORM2_INVERSE,type,degree);
       		for(i=0;i<sizex;i++){
               		for(j=0;j<sizey;j++){
       		        	new_area=new_area+working_matrix[i][j];
                        }
...
//////////ENHANCE2 FUNCTION - CALCULATES DIFFERENT 2-D ORTHOGONAL TRANSFORMS, MULTIPLIES GIVEN REGION BY ENHANCE COEFFICIENT AND TRANSFORMS IT BACK//////
	const char *TSpectrum2::Enhance2(const float **source,float **dest,int sizex,int sizey,int type,int degree,int xmin, int xmax,int ymin,int ymax,float enhance_coeff)
	{
//////////////////////////////////////////////////////////////////////////////////////////

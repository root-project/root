...
$(SPECTRUMPAINTERDS): $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL) $(ROOTCINTTMPDEP) $(call pcmdep,SPECTRUMPAINTER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,SPECTRUMPAINTER) -c $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL)

$(SPECTRUMPAINTERMAP): $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL) $(ROOTCINTTMPDEP) $(call pcmdep,SPECTRUMPAINTER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(SPECTRUMPAINTERDS) $(call dictModule,SPECTRUMPAINTER) -c $(SPECTRUMPAINTERH) $(SPECTRUMPAINTERL)

...
/// Convert a two-dimensional histogram to TH3L.
///
/// \copydetails ConvertToTH3I(const RHistEngine<int> &engine)
...
/// Convert a two-dimensional histogram to TH3F.
///
/// \copydetails ConvertToTH3I(const RHistEngine<int> &engine)
std::unique_ptr<TH3F> ConvertToTH3F(const RHistEngine<float> &engine);

/// Convert a two-dimensional histogram to TH3D.
///
/// \copydetails ConvertToTH3I(const RHistEngine<int> &engine)

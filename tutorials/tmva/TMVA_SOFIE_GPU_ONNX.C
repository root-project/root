...
void TMVA_SOFIE_GPU_ONNX(std::string inputFile = ""){
   if (inputFile.empty() )
      inputFile = std::string(gROOT->GetTutorialsDir()) + "/tmva/Linear_64.onnx";
    ...
    model.GenerateGPU();
    // write the code in a file (by default Linear_64.hxx and Linear_64.dat

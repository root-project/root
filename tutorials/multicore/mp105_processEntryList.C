...
std::vector<std::string> files = {"http://root-eos.web.cern.ch/files/h1/dstarmb.root",
                                  "http://root-eos.web.cern.ch/files/h1/dstarp1a.root",
                                  "http://root-eos.web.cern.ch/files/h1/dstarp1b.root",
                                  "http://root-eos.web.cern.ch/files/h1/dstarp2.root"};

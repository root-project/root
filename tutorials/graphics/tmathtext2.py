...
## \notebook
## This macro draws all possible symbols provided by TMathtext.
## \macro_image
...
def  tmathtext2() :
   global c1
   c1 = TCanvas("mathtext","TMathText symbol",1200,1400)
   ...
   global y, step, x1, x2
   y, step, x1, x2 = [ Float_t() for _ in range(4) ]
   y = 0.99
   step = 0.0126
   x1 = 0.01
   x2 = x1 + 0.02
   ...
   l.DrawText(x2, y, "\\blacktriangledown")
   ...
   l.DrawText(x2, y, "\\sphericalangle")

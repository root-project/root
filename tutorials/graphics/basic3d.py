...
def basic3d() :
   ...
   global c1
   c1 = TCanvas("c1","PolyLine3D & PolyMarker3D Window",200,10,700,500)
   
   # create a pad
   global p1
   p1 = TPad("p1","p1",0.05,0.02,0.95,0.82,46,3,1)
   p1.Draw()
   p1.cd()
   ...
   c1.cd()
   global title
   title = TPaveText(0.1,0.85,0.9,0.97)
   title.SetFillColor(24)
   title.AddText("Examples of 3-D primitives")

   global click
   click = title.AddText("Click anywhere on the picture to rotate") # TText

...
## \notebook
##
## An example illustrating how to modify individual labels of a TGaxis-object. The method
...
def gaxis3() :
   ...
   global c1
   c1 = TCanvas("c1","Examples of TGaxis",10,10,800,400)
   c1.Range(-6,-0.1,6,0.1)
   
   global axis
   axis = TGaxis(-5.5,0.,5.5,0.,0.0,100,510,"")
   axis.SetName("axis")

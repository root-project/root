...
## \notebook
##
## This script draws Greek letters as a table and save the result as GIF, PS, PDF
## and SVG files.
##
...
## command name. Some letters have two representations. The name of the
## second one (the "variation") starts with "var".
## Like #varepsilon, which is the variation of #epsilon.
##
## ### png output:
## \macro_image
##
...
def latex4() :
   global c1
   c1 = TCanvas("greek","greek",600,700)

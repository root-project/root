...
# to run your computations. This is done through the `SSHCluster` class.
#
# Example:
# ```python
...
# that would be written in the job description file.
#
# Example:
# ```python
...
# In this example, a cluster object is created for the local machine, using

...
using FourVectorTVec = ROOT::Experimental::VecOps::TVec<FourVector>;
...
int tdf002_dataModel()
{
   ...
   auto n_cut = [](const FourVectorTVec &tracks) { return tracks.size() > 8; };

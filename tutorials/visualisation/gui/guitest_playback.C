...
/// files will be later on compared with some reference values to verify the validity of different parts of the test.
///
/// \macro_code
///
...
void guitest_playback()
{
   ...
   TRecorder r("http://root-test.web.cern.ch/files/guitest_playback.root");

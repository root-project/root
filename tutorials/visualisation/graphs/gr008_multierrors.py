...
x = (0, 1, 2, 3, 4)
y = (0, 2, 4, 1, 3)
exl = (0.3, 0.3, 0.3, 0.3, 0.3) # Lower x errors
exh = (0.3, 0.3, 0.3, 0.3, 0.3) # Higher x errors
eylstat = (1, 0.5, 1, 0.5, 1) # Lower y statistical errors
eyhstat = (0.5, 1, 0.5, 1, 0.5) # Higher y statistical errors
eylsys = (0.5, 0.4, 0.8, 0.3, 1.2) # Lower y systematic errors
eyhsys = (0.6, 0.7, 0.6, 0.4, 0.8) # Higher y systematic errors

gme = ROOT.TGraphMultiErrors("gme", "TGraphMultiErrors Example", np, x, y, exl, exh, eylstat, eyhstat) # Create the TGraphMultiErrors object

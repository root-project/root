...
void geom_alias()
{
   ...
   gEve->RegisterGeometryAlias("ALICE", "http://root-test.web.cern.ch/files/alice.root");
   gEve->RegisterGeometryAlias("ATLAS", "http://root-test.web.cern.ch/files/atlas.root");

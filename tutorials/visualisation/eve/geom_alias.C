...
void geom_alias()
{
   ...
   gEve->RegisterGeometryAlias("ALICE", "http://root-eos.web.cern.ch/files/alice.root");
   gEve->RegisterGeometryAlias("ATLAS", "http://root-eos.web.cern.ch/files/atlas.root");

...
//
// The first argument to the script is the time interval in seconds when the display
// must be redrawn. (time refers to the time in the input file).
...
void memstat(double update=0.1, const char* fname="*") {

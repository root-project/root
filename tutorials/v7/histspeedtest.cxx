...
std::string MakeTitle(std::string_view version, std::string_view histname, std::string_view title,
...
struct Dim<T, 2> {
   ...
   using FillFunc_t =
      std::add_pointer_t<long(HistType_t &hist, std::vector<InputType_t> &input, std::string_view type)>;

...
/// in http://root-eos.web.cern.ch/files/NanoAOD_DoubleMuon_CMS2011OpenData.root
...
constexpr char const* kNTupleFileName = "http://root-eos.web.cern.ch/files/tutorials/ntpl004_dimuon_v1rc2.root";

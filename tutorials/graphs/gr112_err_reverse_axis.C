...
/// \notebook
/// This example tests all the various case of reverse graphs obtained with Draw("a  pl rx ry "), where rx and ry refere to the reversing of x and y axis.
///
/// \macro_image
/// \macro_code
///

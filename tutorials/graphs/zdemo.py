...
## \notebook
##
## This script is an example of how to use graphs in log scales with annotations.
##
...
NMAX = 20
NLOOP = Int_t()
Z, HZ, PT, INVSIG = [ to_c( [ Float_t() for _ in range(NMAX) ] ) for _ in range(4) ]

#def hz_calc(Float_t, Float_t, Float_t, Float_t, Float_t, Float_t) : pass 
...
def zdemo() :
   ...
   global c1
   c1 = TCanvas("zdemo", "Monte Carlo Study of Z scaling", 10, 40, 800, 600)
   c1.Range(0, 0, 25, 18)
   c1.SetFillColor(40)
   

   global pl
   pl = TPaveLabel(1, 16.3, 24, 17.5, 
   ...
   global pad1, pad2
   pad1 = TPad("pad1", "This is pad1", 0.02, 0.02, 0.48, 0.83, 33)
   pad2 = TPad("pad2", "This is pad2", 0.52, 0.02, 0.98, 0.83, 33)
   ...
   (energ, dens, tgrad, ptmin, ptmax, delp) = \
...
def hz_calc(ENERG : Float_t,
   ...
   EB1 = EB2 = PB1 = PB2 = MB1 = MB2 = M1 = M2 = 0. # Float_t
   DNDETA = 0. # Float_t
   
   P1P2 = P1P3 = P2P3 = 0. # Float_t
   Y1 = Y2 = S = SMIN = SX1 = SX2 = SX1X2 = DELM = 0. # Float_t
   Y1X1 = Y1X2 = Y2X1 = Y2X2 = Y2X1X2 = Y1X1X2 = 0. # Float_t
   KX1 = KX2 = ZX1 = ZX2 = 0. # Float_t
   H1 = 0. # Float_t
   
   PTOT = THET = ETOT = X1 = X2 = 0. # Float_t
   ...
   return ENERG, DENS, TGRAD, PTMIN, PTMAX, DELP 

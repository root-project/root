...
## \notebook
##
## Draws several graphs with exclusion zones.
##
## \macro_image
## \macro_code
##
...
def exclusiongraph2() :
   ...
   tex = TLatex(346.929,6.62281,"ATLAS")
   tex.SetLineWidth(2)
   tex.Draw()
   tex_list.append( tex )

   tex = TLatex(328.341,5.24703,"#intLdt = 300 fb^{-1}")
   tex.SetTextSize(0.0297619)
   tex.SetLineWidth(2)
   tex.Draw()
   tex_list.append( tex )

   tex = TLatex(340.463,4.1874,"Maximal mixing")
   tex.SetTextSize(0.0297619)
   tex.SetLineWidth(2)
   tex.Draw()
   tex_list.append( tex )

   tex = TLatex(413.2,2.51608,"LEP 2000")
   tex.SetTextSize(0.0297619)
   tex.SetLineWidth(2)
   tex.Draw()
   tex_list.append( tex )

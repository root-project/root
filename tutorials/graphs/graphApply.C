...
void graphApply()
{
   ...
   auto gr1 = new TGraph(npoints,xaxis,yaxis);
   auto gr2 = new TGraphErrors(npoints,xaxis,yaxis,errorx,errory);
   auto gr3 = new TGraphAsymmErrors(npoints,xaxis,yaxis,exl,exh,eyl,eyh);
   auto ff  = new TF2("ff","-1./y");

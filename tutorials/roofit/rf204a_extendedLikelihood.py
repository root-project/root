...
# Create two Gaussian PDFs g1(x,mean1,sigma) and 
# g2(x,mean2,sigma) and their parameters
...
canv = ROOT.TCanvas("rf201_composite", "rf201_composite", 600, 600)
canv.Divide(3,1)
...
# the interpretation of the coefficients is tied to the fit range that's used in the first fit

model1 = ROOT.RooAddPdf(model)
r = model1.fitTo(data,ROOT.RooFit.Save()) #
r.Print()
...
r2 = model2.fitTo(data,ROOT.RooFit.Range("left,right"),ROOT.RooFit.Save()) #
r2.Print()

# /
#
# 'ORGANIZATION AND SIMULTANEOUS FITS' ROOT.RooFit tutorial macro #512
#
...
def rf512_wsfactory_oper():
    ...
    # ROOT.The code required to make self p.d.f. is automatically embedded in
    # the workspace

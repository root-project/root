...
# Perform the fit
result = pdf.fitTo(ws["obsData"], Save=True, PrintLevel=-1, GlobalObservables=globalObservables)
...
outputFileName = meas.GetName() + "_combined.root" # In this tutorials output file will have name "meas_combined.root"

...
# void
def DeconvolutionRL_wide_boost() :
   ...
   h.SetTitle( "Deconvolution of closely positioned overlapping "
               "peaks using boosted Richardson-Lucy deconvolution "
               "method."
               )

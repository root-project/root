...
## TH1 Histograms
The examples below compare three implementations: C++, Python, and Python with UHI . While both Python versions offer similar functionality, UHI provides a more modern and Pythonic approach with significantly better interoperability. 
...
|                                    |           **Tutorial**          |                               |     **Description**    |
|------------------------------------|---------------------------------|-------------------------------|------------------------|
|hist029_TRatioPlot_simple.C|hist029_TRatioPlot_simple.py|hist029_TRatioPlot_simple_uhi.py|Create a simple ratio plot of two histograms using the `pois` division option.|
...
|hist031_TRatioPlot_residual_fit.C|hist031_TRatioPlot_residual_fit.py|hist031_TRatioPlot_residual_fit_uhi.py|Create a fit residual plot and set the y-axis range for it.|
|hist032_TRatioPlot_fit_lines.C|hist032_TRatioPlot_fit_lines.py|hist032_TRatioPlot_fit_lines_uhi.py|Set custom dashed lines specified by a vector of floats.|
|hist033_TRatioPlot_fit_confidence.C|hist033_TRatioPlot_fit_confidence.py|hist033_TRatioPlot_fit_confidence_uhi.py|Set the colors of the confidence interval bands by using|
|hist034_TRatioPlot_fit_margin.C|hist034_TRatioPlot_fit_margin.py|hist034_TRatioPlot_fit_margin_uhi.py|Create a fit residual plot, where the separation margin has been set to 0.|

...
def StandardFrequentistDiscovery(infile = "", workspaceName = "channel1",
                                    modelConfigNameSB = "ModelConfig", dataName = "obsData",
                                     toys = 1000,  poiValueForBackground = 0.0,  poiValueForSignal = 1.0):
   ...
   scale_ctte = 0.2
   ROOT.gInterpreter.Declare(f'''TF1 *g = new TF1("g", TString::Format("{scale_ctte}*ROOT::Math::chisquared_pdf(2*x,%d,0)", {nPOI}), 0, 9);''')
   g = ROOT.g
...
StandardFrequentistDiscovery(infile = "", workspaceName = "channel1",
                                    modelConfigNameSB = "ModelConfig", dataName = "obsData",
                                     toys = 1000,  poiValueForBackground = 0.0,  poiValueForSignal = 1.0)

...
import ROOT
from ROOT import RooWorkspace, TCanvas, TStopwatch, RooMsgService, kNone
...
def HybridStandardForm():
    ...
    pc = ProofConfig(w, 4, "workers=4", False)  # machine with 4 cores
    #  pc = ProofConfig(w, 2, "workers=2", False) # machine with 2 cores
    ...
    exit()  # keep the running time short by default
    # -------------------------------------------------------------------------
    ...
    exit()  # so standard tutorial runs faster

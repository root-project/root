...
public:
   ...
   Long64_t             Process(const char *filename, Option_t *option = "", Long64_t nentries = TTree::kMaxEntries,
                                Long64_t firstentry = 0) override; // *MENU*
   virtual void         Progress(Long64_t total, Long64_t processed);
   Long64_t             Process(TSelector *selector, Option_t *option = "", Long64_t nentries = TTree::kMaxEntries,

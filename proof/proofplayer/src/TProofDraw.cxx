...
extern "C" {
   void FeedBackCanvas(const char *name, Bool_t create)
   {
      ...
      if (create) {
         ...
         TCanvas *c = (gROOT->GetListOfCanvases()) ? (TCanvas *)gROOT->GetListOfCanvases()->FindObject(name) : nullptr;
         if (c) delete c;
      }
      // Done
      return;
...
TProofDraw::TProofDraw() : fStatus(nullptr), fManager(nullptr), fTree(nullptr)
{
   fVar[0] = nullptr;
   fVar[1] = nullptr;
   fVar[2] = nullptr;

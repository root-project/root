...
$(PROOFPLAYERDS): $(PROOFPLAYERH) $(PROOFPLAYERL) $(ROOTCINTTMPDEP) $(call pcm_dep,PROOFPLAYER)
		$(MAKEDIR)
...
$(PROOFDRAWDS): $(PROOFDRAWH) $(PROOFDRAWL) $(ROOTCINTTMPDEP) $(call pcm_dep,PROOFDRAW)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."

...
$(PROOFPLAYERDS): $(PROOFPLAYERH) $(PROOFPLAYERL) $(ROOTCINTTMPDEP) $(call pcmdep,PROOFPLAYER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,PROOFPLAYER) -c $(PROOFPLAYERH) $(PROOFPLAYERL)

$(PROOFPLAYERMAP): $(PROOFPLAYERH) $(PROOFPLAYERL) $(ROOTCINTTMPDEP) $(call pcmdep,PROOFPLAYER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(PROOFPLAYERDS) $(call dictModule,PROOFPLAYER) -c $(PROOFPLAYERH) $(PROOFPLAYERL)
...
$(PROOFDRAWDS): $(PROOFDRAWH) $(PROOFDRAWL) $(ROOTCINTTMPDEP) $(call pcmdep,PROOFDRAW)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,PROOFDRAW) -c $(PROOFDRAWH) $(PROOFDRAWL)

$(PROOFDRAWMAP): $(PROOFDRAWH) $(PROOFDRAWL) $(ROOTCINTTMPDEP) $(call pcmdep,PROOFDRAW)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -f $(PROOFDRAWDS) $(call dictModule,PROOFDRAW) -c $(PROOFDRAWH) $(PROOFDRAWL)

...
backend.MakeRootClass( 'PyROOT::TPyROOTApplication' ).InitCINTMessageCallback()
...
# backend.gSystem.Load('libReflex')
backend.gSystem.Load( 'libCintex' )

Cintex = backend.MakeRootClass( 'Cintex' )
Cintex.SetDebug(0)
Cintex.Enable()

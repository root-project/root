...
PyTypeObject TCustomFloat_Type = {
   // python float is a C/C++ double
   PyVarObject_HEAD_INIT(&PyType_Type, 0)(char *) "ROOT.double",     // tp_name
   0,                                                                // tp_basicsize
   0,                                                                // tp_itemsize
   nullptr,                                                          // tp_dealloc
   nullptr,                                                          // tp_print
...
PyTypeObject TCustomInt_Type = {
   // python int is a C/C++ long
   PyVarObject_HEAD_INIT(&PyType_Type, 0)(char *) "ROOT.long",       // tp_name
   0,                                                                // tp_basicsize
   0,                                                                // tp_itemsize
   nullptr,                                                          // tp_dealloc
   nullptr,                                                          // tp_print
...
static void im_dealloc( PyMethodObject* im )
{
   ...
   if (im->im_weakreflist != nullptr) PyObject_ClearWeakRefs((PyObject *)im);
...
{
   if (PyMethod_GET_SELF(meth) != nullptr
#if PY_VERSION_HEX < 0x03000000
       || (PyMethod_GET_CLASS(meth) != nullptr && !PyObject_IsSubclass(pyclass, PyMethod_GET_CLASS(meth)))
#endif
          ) {
      Py_INCREF( meth );
      return meth;
...
PyTypeObject TCustomInstanceMethod_Type = {
   PyVarObject_HEAD_INIT(&PyType_Type, 0)(char *) "ROOT.InstanceMethod", // tp_name
   0,                                                                    // tp_basicsize
   0,                                                                    // tp_itemsize

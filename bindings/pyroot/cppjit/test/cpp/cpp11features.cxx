...
int TestSmartPtr::get_value() { return 17; }

int DerivedTestSmartPtr::get_value() { return m_int + 76; }

int pass_shared_ptr(std::shared_ptr<TestSmartPtr> p) { return p->get_value(); }
...
TestSmartPtr create_TestSmartPtr_by_value() { return TestSmartPtr{}; }
...
void implicit_converion_move(TestMoving2&&) { /* empty */ }

// for std::function testing
std::function<int(const FNTestStruct& t)> FNCreateTestStructFunc() {
  return [](const FNTestStruct& t) { return t.t; };
}
std::function<int(const FunctionNS::FNTestStruct& t)>
FunctionNS::FNCreateTestStructFunc() {
  return [](const FNTestStruct& t) { return t.t; };
}

...
int CrossInheritance::Base1::call_get_value(Base1* b) { return b->get_value(); }
...
CrossInheritance::IBase3::IBase3(int i) { m_int = i; }

int CrossInheritance::CBase2::get_value() { return 42; }

int CrossInheritance::IBase4::call_get_value(IBase4* b) {
  return b->get_value();
}

int CrossInheritance::CBase4::get_value() const { return 27; }

int CrossInheritance::TDerived1::get_value() { return 27; }

int CrossInheritance::CountableBase::s_count = 0;

CrossInheritance::CountableBase::CountableBase() { ++s_count; }

CrossInheritance::CountableBase::CountableBase(const CountableBase&) {
  ++s_count;
}

CrossInheritance::CountableBase&
CrossInheritance::CountableBase::operator=(const CountableBase&) {
  return *this;
}

CrossInheritance::CountableBase::~CountableBase() { --s_count; }

int CrossInheritance::CountableBase::call() { return -1; }

CrossInheritance::Component::Component() { ++s_count; }

CrossInheritance::Component::~Component() { --s_count; }

int CrossInheritance::Component::get_count() { return s_count; }
...
AccessProtected::MyBase::MyBase() : my_data(101) { /* empty */ }

AccessProtected::MyBase::~MyBase() { /* empty */ }

int AccessProtected::MyBase::get_data_v() { return my_data; }

int AccessProtected::MyBase::get_data() { return my_data; }

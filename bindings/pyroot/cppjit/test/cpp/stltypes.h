...
enum VecTestEnum { EVal1 = 1, EVal2 = 3 };
...
template <typename S> class stringy_class {
public:
...
template <class T> class stl_like_class {
public:
...
template <class value_type, size_t sz> class stl_like_class2 {
protected:
  value_type fData[sz];

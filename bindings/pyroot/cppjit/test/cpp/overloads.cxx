...
a_overload::a_overload() {
  i1 = 42;
  i2 = -1;
}

ns_a_overload::a_overload::a_overload() {
  i1 = 88;
  i2 = -34;
}
int ns_a_overload::b_overload::f(const std::vector<int>* v) { return (*v)[0]; }

ns_b_overload::a_overload::a_overload() {
  i1 = -33;
  i2 = 89;
}

b_overload::b_overload() {
  i1 = -2;
  i2 = 13;
}
...
std::string more_overloads::call(const bb_ol&, void* n) {
  n = 0;
  return "bb_ol";
}

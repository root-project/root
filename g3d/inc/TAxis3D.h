...
public:
    ...
    virtual void     SetXTitle(char *title) {fAxis[0].SetTitle(title);} //*MENU*
    virtual void     SetYTitle(char *title) {fAxis[1].SetTitle(title);} //*MENU*
    virtual void     SetZTitle(char *title) {fAxis[2].SetTitle(title);} //*MENU*

...
//______________________________________________________________________________
TDSet::TDSet(const char *type, const char *dir)
{
   // Create a TDSet object. Type has the form "<class>[:name]", where
   // "class" defines the class of which object will be processed and
   // the optional "name" argument specifies the name of the object
   // of the specified class. If the "name" is not given all objects
   // of the "class" found in the specified directory are processed.
   // For objects of class TTree (or derived) a name must be specified.
   // The "dir" argument specifies in which directory the object is
...
//______________________________________________________________________________
void TDSet::Add(const char *file, const char *namedir)
{

...
// * A whole object written directly to a TFile
...
// Tests writing objects directly to a TFile

template <typename T>
void checkObjectWritingDirectToTFile(const T &obj, std::string_view name, std::normal_distribution<double> &gaus,
                                     std::uniform_real_distribution<double> &uniform, std::mt19937 &rng)
{
   const char *filename{"cpp11ContainersUnorderedMap_DirectToTFile.root"};
   ...
   // Write objects as a whole object directly to a TFile
   {
...
TYPED_TEST(cpp11ContainersUnorderedMap, DirectToTFileDoubleCont)
{
   checkObjectWritingDirectToTFile(this->fDoubleCont, "fDoubleCont", this->fGaus, this->fUniform, this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, DirectToTFileHistoCont)
{
   checkObjectWritingDirectToTFile(this->fHistoCont, "fHistoCont", this->fGaus, this->fUniform, this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, DirectToTFileVecHistoCont)
{
   checkObjectWritingDirectToTFile(this->fVecHistoCont, "fVecHistoCont", this->fGaus, this->fUniform, this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, DirectToTFileContHistoVec)
{
   checkObjectWritingDirectToTFile(this->fContHistoVec, "fContHistoVec", this->fGaus, this->fUniform, this->fRNG);
}

// Tests writing objects to TTree branches, in both split and unsplit mode

template <typename T>
void checkObjectWritingToTBranch(const T &obj, std::string_view name, unsigned nEvents,
                                 std::normal_distribution<double> &gaus,
                                 std::uniform_real_distribution<double> &uniform, std::mt19937 &rng)
{
   std::string filename{"cpp11ContainersUnorderedMap_ToTBranch.root"};
...
TYPED_TEST(cpp11ContainersUnorderedMap, ToTBranchDoubleCont)
{
   checkObjectWritingToTBranch(this->fDoubleCont, "fDoubleCont", this->fNEvents, this->fGaus, this->fUniform,
                               this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, ToTBranchHistoCont)
{
   checkObjectWritingToTBranch(this->fHistoCont, "fHistoCont", this->fNEvents, this->fGaus, this->fUniform, this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, ToTBranchVecHistoCont)
{
   checkObjectWritingToTBranch(this->fVecHistoCont, "fVecHistoCont", this->fNEvents, this->fGaus, this->fUniform,
                               this->fRNG);
}

TYPED_TEST(cpp11ContainersUnorderedMap, ToTBranchContHistoVec)
{
   checkObjectWritingToTBranch(this->fContHistoVec, "fContHistoVec", this->fNEvents, this->fGaus, this->fUniform,
                               this->fRNG);
}

//
// File generated by rootcint at Sat Jun  8 17:40:04 2002.
   ...
   if (R__b.IsReading()) {
      {
         ...
         R__stl.clear();
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TLine)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
            R__stl.reserve(R__n);
         for (R__i = 0; R__i < R__n; R__i++) {
...
void R__Event_fVectorTobject(TBuffer &R__b, void *R__p, int)
{
   ...
   if (R__b.IsReading()) {
      {
         fVectorTobject = new vector<TObject>;  //PROBLEM
         vector<TObject> &R__stl = *fVectorTobject;
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TObject)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
            R__stl.reserve(R__n);
         for (R__i = 0; R__i < R__n; R__i++) {
      ...
      {
         vector<TObject> &R__stl = *fVectorTobject; //PROBLEM
         R__b << int(R__stl.size());
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TObject)); //USELESS
   ...
   if (R__b.IsReading()) {
      {
         ...
         fVectorTnamed = new vector<TNamed>; //PROBLEM
         vector<TNamed> &R__stl = *fVectorTnamed; //PROBLEM
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TNamed)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
            R__stl.reserve(R__n);
         for (R__i = 0; R__i < R__n; R__i++) {
   ...
   if (R__b.IsReading()) {
      {
         ...
         R__stl.clear();
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(string)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
            R__stl.reserve(R__n);
         for (R__i = 0; R__i < R__n; R__i++) {
   ...
   } else {
      {
         ...
         for (R__k = R__stl.begin(); R__k != R__stl.end(); ++R__k) {
            {TString R__str((*R__k).c_str());
             R__str.Streamer(R__b)}; //ERROR R__str not declared
         }
      }
   }
}
   ...
   if (R__b.IsReading()) {
      {
         ...
         R__stl.clear();
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TAttLine)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
         for (R__i = 0; R__i < R__n; R__i++) {
            TAttLine R__t;
...
void R__Event_fListString(TBuffer &R__b, void *R__p, int)
{
   ...
   if (R__b.IsReading()) {
      {
         fListString = new list<string>; //PROBLEM
         list<string> &R__stl = *fListString; //PROBLEM
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(string)); //USELESS
         int R__i, R__n;
         R__b >> R__n;
         for (R__i = 0; R__i < R__n; R__i++) {
   ...
   } else {
      {
         ...
         for (R__k = R__stl.begin(); R__k != R__stl.end(); ++R__k) {
            {TString R__str((*R__k).c_str());
             R__str.Streamer(R__b)};//PROBLEM R__str not defined
         }
      }
   }
}
   ...
   if (R__b.IsReading()) {
      {
         ...
         R__stl.clear();
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TString)); //USELESS
   ...
   } else {
      {
         ...
         for (R__k = R__stl.begin(); R__k != R__stl.end(); ++R__k) {
            ((*R__k).first ).Streamer(R__b);//PROBLEM
            R__b << ((*R__k).second);
         }
      }
   }
...
void R__Event_fMapTAxisp(TBuffer &R__b, void *R__p, int)
{
   ...
   if (R__b.IsReading()) {
      {
         fMapTAxisp = new map<TAxis*,int>;  //PROBLEM
         map<TAxis*,int> &R__stl = *fMapTAxisp;  //PROBLEM
   ...
   } else {
      {
         map<TAxis*,int> &R__stl = *fMapTAxisp;  //PROBLEM
         R__b << int(R__stl.size());
         //TClass *R__tcl1 = TBuffer::GetClass(typeid(TAxis)); //USELESS
...
void R__Event_fSetTAxisp(TBuffer &R__b, void *R__p, int)
{
   ...
   if (R__b.IsReading()) {
      {
         fSetTAxisp = new set<TAxis*>;  //PROBLEM
         set<TAxis*> &R__stl = *fSetTAxisp;  //PROBLEM
         TClass *R__tcl1 = TBuffer::GetClass(typeid(TAxis));
         int R__i, R__n;
         R__b >> R__n;
         for (R__i = 0; R__i < R__n; R__i++) {
...
void R__Event_fMultiSetTAxisp(TBuffer &R__b, void *R__p, int)
{
   ...
   if (R__b.IsReading()) {
      {
         fMultiSetTAxisp = new multiset<TAxis*>;  //PROBLEM
         multiset<TAxis*> &R__stl = *fMultiSetTAxisp; //PROBLEM
         TClass *R__tcl1 = TBuffer::GetClass(typeid(TAxis));
         int R__i, R__n;
         R__b >> R__n;
         for (R__i = 0; R__i < R__n; R__i++) {
...
void UShortVector::ShowMembers(TMemberInspector &R__insp, char *R__parent)
{
   ...
   TClass *R__cl = UShortVector::IsA();
      ...
      ROOT::GenericShowMembers("vector<unsigned short,__malloc_alloc_template<0> >", dynamic_cast< vector<unsigned short,__malloc_alloc_template<0> > *>(this ), R__insp, R__parent);
}

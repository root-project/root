//
// File generated by rootcint at Wed Apr 10 13:55:32 2002.
...
namespace ROOT {
   namespace Shadow {
      typedef ::RootData RootData;

      #ifndef R__ACCESS_IN_SYMBOL
      typedef ::RootPCellID RootPCellID;
      #else
      class RootPCellID  :  public crap {
         public:
         //friend XX;
         virtual void forceVirtualTable() {};
         unsigned int id; //
         char base[4]; //
      };
      #endif
      ...
      typedef ::RootCaloHit RootCaloHit;

      #ifndef R__ACCESS_IN_SYMBOL
      typedef ::RootPCtemp<int> RootPCtemplEintgR;
      #else
      class RootPCtemplEintgR  :  public RootPCellID {
         public:
         //friend XX;
         virtual void forceVirtualTable() {};
         int temp; //
...
namespace ROOT {
   ...
   template <> ROOT::ClassInfo< RootData > &GenerateInitInstance< RootData >(const RootData*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootData)==sizeof(ROOT::Shadow::RootData));
      static ROOT::ClassInfo< RootData > 
         instance("RootData",RootData::Class_Version(),"RootData.h",9,
                  &ROOT::ShowMembers,4);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootData > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootData*)0x0);
}
...
namespace ROOT {
   ...
   // Function generating the singleton Type initializer
   template <> ROOT::ClassInfo< RootPCellID > &GenerateInitInstance< RootPCellID >(const RootPCellID*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootPCellID)==sizeof(ROOT::Shadow::RootPCellID));
      static ROOT::ClassInfo< RootPCellID > 
         instance("RootPCellID","RootPCellID.h",12,
                  &ROOT::ShowMembers,4);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootPCellID > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootPCellID*)0x0);
}
...
namespace ROOT {
   ...
   // Function generating the singleton Type initializer
   template <> ROOT::ClassInfo< RootPCfix > &GenerateInitInstance< RootPCfix >(const RootPCfix*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootPCfix)==sizeof(ROOT::Shadow::RootPCfix));
      static ROOT::ClassInfo< RootPCfix > 
         instance("RootPCfix","RootPCellID.h",48,
                  &ROOT::ShowMembers,4);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootPCfix > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootPCfix*)0x0);
}
...
namespace ROOT {
   ...
   // Function generating the singleton Type initializer
   template <> ROOT::ClassInfo< RootPCvirt > &GenerateInitInstance< RootPCvirt >(const RootPCvirt*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootPCvirt)==sizeof(ROOT::Shadow::RootPCvirt));
      static ROOT::ClassInfo< RootPCvirt > 
         instance("RootPCvirt","RootPCellID.h",59,
                  &ROOT::ShowMembers,4);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootPCvirt > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootPCvirt*)0x0);
}
...
namespace ROOT {
   ...
   // Function generating the singleton Type initializer
   template <> ROOT::ClassInfo< RootCaloHit > &GenerateInitInstance< RootCaloHit >(const RootCaloHit*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootCaloHit)==sizeof(ROOT::Shadow::RootCaloHit));
      static ROOT::ClassInfo< RootCaloHit > 
         instance("RootCaloHit",RootCaloHit::Class_Version(),"RootCaloHit.h",10,
                  &ROOT::ShowMembers,4);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootCaloHit > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootCaloHit*)0x0);
}

namespace ROOT {
   void ShowMembers(RootPCtemp<int> *obj, TMemberInspector &R__insp, char *R__parent);

   // Function generating the singleton Type initializer
   template <> ROOT::ClassInfo< RootPCtemp<int> > &GenerateInitInstance< RootPCtemp<int> >(const RootPCtemp<int>*)
   {
      // Make sure the shadow class has the right sizeof
      Assert(sizeof(::RootPCtemp<int>)==sizeof(ROOT::Shadow::RootPCtemplEintgR));
      static ROOT::ClassInfo< RootPCtemp<int> > 
         instance("RootPCtemp<int>","RootPCellID.h",82,
                  &ROOT::ShowMembers,0);
      return instance;
   }
   // Static variable to force the class initialization
   static ROOT::ClassInfo< RootPCtemp<int> > & _R__UNIQUE_(Init) 
      = GenerateInitInstance((const RootPCtemp<int>*)0x0);
}
...
{
   return ROOT::ClassInfo< RootData >::GetImplFileName();
}

//______________________________________________________________________________
int   RootData::ImplFileLine()
{
   return ROOT::ClassInfo< RootData >::GetImplFileLine();
}

//______________________________________________________________________________
void RootData::Dictionary()
{
   fgIsA = ROOT::ClassInfo< RootData >::GetClass();
}

//______________________________________________________________________________
TClass *RootData::Class()
{
   if (!fgIsA) fgIsA = ROOT::ClassInfo< RootData >::GetClass();
   return fgIsA;
}
...
{
   return ROOT::ClassInfo< RootCaloHit >::GetImplFileName();
}

//______________________________________________________________________________
int   RootCaloHit::ImplFileLine()
{
   return ROOT::ClassInfo< RootCaloHit >::GetImplFileLine();
}

//______________________________________________________________________________
void RootCaloHit::Dictionary()
{
   fgIsA = ROOT::ClassInfo< RootCaloHit >::GetClass();
}

//______________________________________________________________________________
TClass *RootCaloHit::Class()
{
   if (!fgIsA) fgIsA = ROOT::ClassInfo< RootCaloHit >::GetClass();
   return fgIsA;
}

//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootPCtemp<int> *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootPCtemp<int> *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootPCtemplEintgR ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootPCtemp<int>.

      TClass *R__cl  = ROOT::ClassInfo< RootPCtemp<int> >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "temp", &sobj->temp);
      ROOT::ClassInfo< RootPCellID >::ShowMembers(dynamic_cast< RootPCellID *>(obj ), R__insp, R__parent);
   }
#ifdef R__ACCESS_IN_SYMBOL
namespace ROOT {
   void ShowMembers(RootPCtemp<int> *obj, TMemberInspector &R__insp, char *R__parent)
...
//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootData *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootData *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootData ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootData.

      TClass *R__cl  = ROOT::ClassInfo< RootData >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "data", &sobj->data);
      sobj->data.ShowMembers(R__insp, strcat(R__parent,"data.")); R__parent[R__ncp] = 0;
...
//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootCaloHit *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootCaloHit *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootCaloHit ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootCaloHit.

      TClass *R__cl  = ROOT::ClassInfo< RootCaloHit >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "energy", &sobj->energy);
      R__insp.Inspect(R__cl, R__parent, "time", &sobj->time);
      R__insp.Inspect(R__cl, R__parent, "itra", &sobj->itra);
      R__insp.Inspect(R__cl, R__parent, "mycell", (void*)&sobj->mycell);
      ROOT::ClassInfo< RootPCellID >::ShowMembers(&sobj->mycell, R__insp, strcat(R__parent,"mycell.")); R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "mynocell", (void*)&sobj->mynocell);
      ROOT::ClassInfo< RootPCnodict >::ShowMembers(&sobj->mynocell, R__insp, strcat(R__parent,"mynocell.")); R__parent[R__ncp] = 0;
      R__insp.Inspect(R__cl, R__parent, "*mycellnull", &sobj->mycellnull);
      R__insp.Inspect(R__cl, R__parent, "*mycellfix", &sobj->mycellfix);
      R__insp.Inspect(R__cl, R__parent, "*mycellvirt", &sobj->mycellvirt);
      R__insp.Inspect(R__cl, R__parent, "*mynocellp", &sobj->mynocellp);
      sobj->TObject::ShowMembers(R__insp, R__parent);
   }
#ifdef R__ACCESS_IN_SYMBOL
namespace ROOT {
...
//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootPCellID *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootPCellID *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootPCellID ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootPCellID.

      TClass *R__cl  = ROOT::ClassInfo< RootPCellID >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "id", &sobj->id);
      R__insp.Inspect(R__cl, R__parent, "base[4]", sobj->base);
      ROOT::ClassInfo< crap >::ShowMembers(dynamic_cast< crap *>(obj ), R__insp, R__parent);
   }
#ifdef R__ACCESS_IN_SYMBOL
namespace ROOT {
   void ShowMembers(RootPCellID *obj, TMemberInspector &R__insp, char *R__parent)
...
//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootPCfix *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootPCfix *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootPCfix ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootPCfix.

      TClass *R__cl  = ROOT::ClassInfo< RootPCfix >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "fix", &sobj->fix);
      ROOT::ClassInfo< RootPCellID >::ShowMembers(dynamic_cast< RootPCellID *>(obj ), R__insp, R__parent);
   }
#ifdef R__ACCESS_IN_SYMBOL
namespace ROOT {
...
//______________________________________________________________________________
#ifdef R__ACCESS_IN_SYMBOL
void ROOT__ShowMembersFunc(RootPCvirt *obj, TMemberInspector &R__insp, char *R__parent)
   {
#else
namespace ROOT {
   void ShowMembers(RootPCvirt *obj, TMemberInspector &R__insp, char *R__parent)
   {
#endif
      typedef ROOT::Shadow::RootPCvirt ShadowClass;
      ShadowClass *sobj = (ShadowClass*)obj;
      sobj = sobj; // Dummy usage just in case there is no datamember.

      // Inspect the data members of an object of class RootPCvirt.

      TClass *R__cl  = ROOT::ClassInfo< RootPCvirt >::GetClass();
      Int_t   R__ncp = strlen(R__parent);
      if (R__ncp || R__cl || R__insp.IsA()) { }
      R__insp.Inspect(R__cl, R__parent, "virt", &sobj->virt);
      ROOT::ClassInfo< RootPCellID >::ShowMembers(dynamic_cast< RootPCellID *>(obj ), R__insp, R__parent);
   }
#ifdef R__ACCESS_IN_SYMBOL
namespace ROOT {
...
static int G__ROOT_ResetClassVersion_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
...
static int G__ROOT_RegisterClassTemplate_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
...
/* RootPCtemp<int> */
static int G__RootPCtemplEintgR_RootPCtemplEintgR_0_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   RootPCtemp<int> *p=NULL;
   if(G__getaryconstruct()) p=new RootPCtemp<int>[G__getaryconstruct()];
   else p=::new((G__mydictdOcc_tag*)G__getgvp()) RootPCtemp<int>;
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR);
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__RootPCtemplEintgR_RootPCtemplEintgR_1_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   RootPCtemp<int> *p=NULL;
      p=::new((G__mydictdOcc_tag*)G__getgvp()) RootPCtemp<int>((int)G__int(libp->para[0]));
      result7->obj.i = (long)p;
      result7->ref = (long)p;
      result7->type = 'u';
      result7->tagnum = G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR);
...
static int G__RootPCtemplEintgR_Print_2_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
      G__setnull(result7);
      ((RootPCtemp<int>*)(G__getstructoffset()))->Print();
   return(1 || funcname || hash || result7 || libp) ;
}

// automatic copy constructor
static int G__RootPCtemplEintgR_RootPCtemplEintgR_3_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash)
{
   RootPCtemp<int> *p;
   p=new RootPCtemp<int>(*(RootPCtemp<int>*)G__int(libp->para[0]));
   result7->obj.i = (long)p;
   result7->ref = (long)p;
   result7->type = 'u';
   result7->tagnum = G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR);
...
// automatic destructor
typedef RootPCtemp<int> G__TRootPCtemplEintgR;
static int G__RootPCtemplEintgR_wARootPCtemplEintgR_4_0(G__value *result7,G__CONST char *funcname,struct G__param *libp,int hash) {
   if(0==G__getstructoffset()) return(1);
   if(G__getaryconstruct())
     if(G__PVOID==G__getgvp())
       delete[] (RootPCtemp<int> *)(G__getstructoffset());
     else
       for(int i=G__getaryconstruct()-1;i>=0;i--)
         ((RootPCtemp<int> *)((G__getstructoffset())+sizeof(RootPCtemp<int>)*i))->~G__TRootPCtemplEintgR();
   else {
     long G__Xtmp=G__getgvp();
     G__setgvp(G__PVOID);
     ((RootPCtemp<int> *)(G__getstructoffset()))->~G__TRootPCtemplEintgR();
     G__setgvp(G__Xtmp);
     G__operator_delete((void*)G__getstructoffset());
   }
      G__setnull(result7);
...
extern "C" void G__cpp_setup_inheritancemydict() {
   ...
   if(0==G__getnumbaseclass(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR))) {
     RootPCtemp<int> *G__Lderived;
     G__Lderived=(RootPCtemp<int>*)0x1000;
     {
       RootPCellID *G__Lpbase=(RootPCellID*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),G__get_linked_tagnum(&G__mydictLN_RootPCellID),(long)G__Lpbase-(long)G__Lderived,1,1);
     }
     {
       crap *G__Lpbase=(crap*)G__Lderived;
       G__inheritance_setup(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),G__get_linked_tagnum(&G__mydictLN_crap),(long)G__Lpbase-(long)G__Lderived,1,0);
     }
   }
}
...
static void G__setup_memvarRootCaloHit(void) {
   ...
   /* RootPCtemp<int> */
static void G__setup_memvarRootPCtemplEintgR(void) {
   G__tag_memvar_setup(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR));
   { RootPCtemp<int> *p; p=(RootPCtemp<int>*)0x1000; if (p) { }
   G__memvar_setup((void*)((long)(&p->temp)-(long)(p)),105,0,0,-1,-1,-1,1,"temp=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
"u 'type_info' - 11 - info Q - 'IsAFunc_t' 0 - isa "
...
"i - 'Int_t' 0 - pragmabits",(char*)NULL,(void*)NULL,0);
   ...
   G__memfunc_setup("ResetClassVersion",1759,G__ROOT_ResetClassVersion_3_0,121,-1,-1,0,3,1,1,0,
"U 'TClass' - 0 - - C - - 10 - - "
"s - 'Short_t' 0 - -",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("RegisterClassTemplate",2167,G__ROOT_RegisterClassTemplate_4_0,85,G__get_linked_tagnum(&G__mydictLN_TNamed),-1,0,3,1,1,0,
"C - - 10 - name C - - 10 - file "
...
static void G__setup_memfuncRootPCtemplEintgR(void) {
   /* RootPCtemp<int> */
   G__tag_memfunc_setup(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR));
   G__memfunc_setup("RootPCtemp<int>",1458,G__RootPCtemplEintgR_RootPCtemplEintgR_0_0,105,G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("RootPCtemp<int>",1458,G__RootPCtemplEintgR_RootPCtemplEintgR_1_0,105,G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),-1,0,1,1,1,0,"i - - 0 - n",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("Print",525,G__RootPCtemplEintgR_Print_2_0,121,-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,1);
   // automatic copy constructor
   G__memfunc_setup("RootPCtemp<int>",1458,G__RootPCtemplEintgR_RootPCtemplEintgR_3_0,(int)('i'),G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),-1,0,1,1,1,0,"u 'RootPCtemp<int>' - 1 - -",(char*)NULL,(void*)NULL,0);
   // automatic destructor
   G__memfunc_setup("~RootPCtemp<int>",1584,G__RootPCtemplEintgR_wARootPCtemplEintgR_4_0,(int)('y'),-1,-1,0,0,1,1,0,"",(char*)NULL,(void*)NULL,0);
   G__tag_memfunc_reset();
}
...
G__linked_taginfo G__mydictLN_RootPCtemplEintgR = { "RootPCtemp<int>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtablemydict() {
  ...
  G__mydictLN_RootPCtemplEintgR.tagnum = -1 ;
}
...
extern "C" void G__cpp_setup_tagtablemydict() {
   ...
   G__tagtable_setup(G__get_linked_tagnum(&G__mydictLN_RootPCtemplEintgR),sizeof(RootPCtemp<int>),-1,256,(char*)NULL,G__setup_memvarRootPCtemplEintgR,G__setup_memfuncRootPCtemplEintgR);
}

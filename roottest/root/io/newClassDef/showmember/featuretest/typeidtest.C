...
int typeidtest() {
  ...
  cerr << "Expect A: "; print_root_classname(a,"A");
  cerr << "Expect A: "; print_root_classname(a2,"A");
  cerr << "Expect B: "; print_root_classname(b,"B");
  cerr << "Expect C: "; print_root_classname(b2,"C");

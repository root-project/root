// @(#)root/meta:$Name:  $:$Id: TStreamerElement.h,v 1.1 2000/11/21 21:10:30 brun Exp $
...
protected:
   ...
   void         *fStreamer;        //!pointer to element Streamer      
...
public:
   ...
   Int_t            GetArrayDim() {return fArrayDim;}
   ...
   virtual Long_t   GetMethod() {return Long_t(fStreamer);}
   ...
   virtual Bool_t   IsaPointer() {return kFALSE;}
   virtual void     ls(Option_t *option="");
   virtual void     SetArrayDim(Int_t dim);
   virtual void     SetMaxIndex(Int_t dim, Int_t max);
   virtual void     SetOffset(Int_t offset) {fOffset=offset;}
   virtual void     SetStreamer(void *streamer);
...
public:
   ...
   Long_t           GetMethod() {return Long_t(fMethod);}
   virtual void     Init(TObject *obj=0);
...
public:
   ...
   TClass        *GetClass() {return fClassObject;}
   const char    *GetInclude() const;
   Long_t         GetMethod() {return (Long_t)fClassObject;}
   virtual void   Init(TObject *obj=0);
   virtual Bool_t IsaPointer() {return kTRUE;}
...
public:
   ...
   Int_t          GetSTLtype() {return fSTLtype;}
   Int_t          GetCtype()   {return fCtype;}
   const char    *GetInclude() const;
   virtual void   ls(Option_t *option="");

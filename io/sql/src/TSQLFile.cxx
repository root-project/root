     ...
     fIdsTableExists(kFALSE), fStmtCounter(0)
{
   ...
   fUnits = 4;
   fOption = option;
   SetCompressionLevel(static_cast<Int_t>(ROOT::RCompressionSetting::EDefaults::kUseCompiledDefault) % 100);
   fWritten = 0;
   fSumBuffer = 0;
   fSum2Buffer = 0;
   fBytesRead = 0;
...
{
   Int_t maxlen = !fSQL ? 32 : fSQL->GetMaxIdentifierLength();

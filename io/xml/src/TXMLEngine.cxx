...
{
   if ((xmlnode == nullptr) || (name == nullptr))
      return kFALSE;
...
const char *TXMLEngine::GetNSName(XMLNsPointer_t ns)
{
   ...
   if ((nsname != nullptr) && (strncmp(nsname, "xmlns:", 6) == 0))
      nsname += 6;
...
{
   if ((xmlnode == nullptr) || (comment == nullptr))
      return kFALSE;
...
{
   if ((xmlnode == nullptr) || (line == nullptr))
      return kFALSE;
...
{
   if ((xmlnode == nullptr) || (href == nullptr) || (type == nullptr))
      return kFALSE;
...
{
   if ((xmlnode == nullptr) || (content == nullptr))
      return;
   if (len <= 0)
      len = strlen(content);
...
XMLNodePointer_t TXMLEngine::GetChild(XMLNodePointer_t xmlnode, Bool_t realnode)
{
   ...
   if (realnode && (res != nullptr) && (((SXmlNode_t *)res)->fType != kXML_NODE))
...
{
   if ((xmlstring == nullptr) || (strlen(xmlstring) == 0))
      return nullptr;
...
{
   if ((res == nullptr) || (xmlnode == nullptr))
      return;

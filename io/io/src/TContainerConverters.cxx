...
TConvertClonesArrayToProxy::TConvertClonesArrayToProxy(TVirtualCollectionProxy *proxy, Bool_t isPointer,
                                                       Bool_t isPrealloc)
   : fIsPointer(isPointer), fIsPrealloc(isPrealloc), fCollectionClass(proxy ? proxy->GetCollectionClass() : nullptr)
{
...
TConvertMapToProxy::TConvertMapToProxy(TClassStreamer *streamer, Bool_t isPointer, Bool_t isPrealloc)
   : fIsPointer(isPointer), fIsPrealloc(isPrealloc), fSizeOf(0), fCollectionClass(nullptr)
{

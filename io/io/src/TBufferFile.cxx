...
////////////////////////////////////////////////////////////////////////////////
/// Write array of n bools into the I/O buffer.
/// \note Operation throws error in case of underflow or overflow
...
void TBufferFile::WriteFastArray(const Bool_t *b, Int_t n)
{
   ...
   {
      Fatal("WriteFastArray", "Not enough space left in the buffer (1GB limit).  %d elements is greater than the max left of %d", n, maxElements);
...
/// \note Operation throws error in case of underflow
                                 ...
                                 TMemberStreamer *streamer)
{
   ...
   {
      Fatal("WriteFastArray", "Negative number of elements %d", n);
      return; // In case the user re-route the error handler to not die when Fatal is called)
   }
   int size = cl->Size();

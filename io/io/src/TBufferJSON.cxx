...
#define JsonReadBasic(arg, cast_type, do_check)                        \
   TJSONStackObj *stack = Stack();                                     \
   if (stack && stack->fNode) {                                        \
      nlohmann::json &json = *((nlohmann::json *)stack->fNode);        \
...
{
   JsonReadBasic(*val, std::string, 0);
}

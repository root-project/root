...
std::optional<std::string> ROOT::Internal::GetEOSRedirectedXRootURL([[maybe_unused]] std::string_view inputURL)
{
#ifdef R__UNIX
   if (inputURL.empty() || inputURL.back() == '/')
      return std::nullopt;
   ...
   auto baseName = inputURL.substr(inputURL.find_last_of("/") + 1);

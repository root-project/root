...
def main():
    with urllib.request.urlopen("https://repo.prefix.dev/root/linux-64/repodata.json") as response:
        ...
        for pkg in jsondata["packages.conda"]:
            ...
            delete_response = requests.delete(
                f"https://prefix.dev/api/v1/delete/root/linux-64/{pkg}", headers=headers)

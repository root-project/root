...
def main():
    ...
    parser.add_argument('--buildtype', required=True)
    parser.add_argument('--platform', required=True)
    parser.add_argument('--incremental', type=bool, default=False)
    parser.add_argument('--base_ref', required=True)
    parser.add_argument('--repository', required=True)
    args = parser.parse_args()

    # Accessing the matrix.image value
    platform = args.platform
    print(platform)
    # Now you can use the 'platform' variable in your script as needed.

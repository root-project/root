...
public:
   ...
   void     AxisVertex(Double_t ang, Double_t *av, Int_t &ix1, Int_t &ix2, Int_t &iy1, Int_t &iy2, Int_t &iz1,
                       Int_t &iz2) override;
   void     DefinePerspectiveView() override;
   void     DefineViewDirection(const Double_t *s, const Double_t *c, Double_t cosphi, Double_t sinphi, Double_t costhe,
                                Double_t sinthe, Double_t cospsi, Double_t sinpsi, Double_t *tnorm,
                                Double_t *tback) override;
   ...
   void   SetAxisNDC(const Double_t *x1, const Double_t *x2, const Double_t *y1, const Double_t *y2, const Double_t *z1,
                     const Double_t *z2) override;
   ...
   //--
   void MoveFocus(Double_t *center, Double_t dx, Double_t dy, Double_t dz, Int_t nsteps = 10, Double_t dlong = 0,
                  Double_t dlat = 0, Double_t dpsi = 0) override;
   void MoveViewCommand(Char_t chCode, Int_t count = 1) override;
   void MoveWindow(Char_t option) override;

   void AdjustScales(TVirtualPad *pad = 0) override;
   void Centered3DImages(TVirtualPad *pad = 0) override;
   void Centered() override; // *MENU*
   void FrontView(TVirtualPad *pad = 0) override;
   void Front() override; // *MENU*

   void ZoomIn() override;  // *MENU*
   void ZoomOut() override; // *MENU*
   void ZoomView(TVirtualPad *pad = 0, Double_t zoomFactor = 1.25) override;
   void UnzoomView(TVirtualPad *pad = 0, Double_t unZoomFactor = 1.25) override;

   void RotateView(Double_t phi, Double_t theta, TVirtualPad *pad = 0) override;
   void SideView(TVirtualPad *pad = 0) override;
   void Side() override; // *MENU*
   void TopView(TVirtualPad *pad = 0) override;
   void Top() override; // *MENU*

   void ToggleRulers(TVirtualPad *pad = 0) override;
   void ShowAxis() override; // *MENU*
   void ToggleZoom(TVirtualPad *pad = 0) override;

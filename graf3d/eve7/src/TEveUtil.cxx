...
TObjArray* REX::TEveUtil::fgDefaultColors = 0;
...
TEveException REX::operator+(const TEveException &s1, const std::string &s2)
{ TEveException r(s1); r += s2; return r; }

TEveException REX::operator+(const TEveException &s1, const TString &s2)
{ TEveException r(s1); r += s2; return r; }

TEveException REX::operator+(const TEveException &s1,  const char *s2)
{ TEveException r(s1); r += s2; return r; }

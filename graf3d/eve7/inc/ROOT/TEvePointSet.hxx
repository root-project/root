...
class TEvePointSet : public TEveElement, public TPointSet3D, public TEvePointSelectorConsumer, public TEveProjectable {
...
public:
   ...
   ClassDef(TEvePointSet, 0); // Set of 3D points with same marker attributes; optionally each point can be assigned an
...
public:
   ...
   ClassDef(TEvePointSetArray, 0); // Array of TEvePointSet's filled via a common point-source; range of displayed TEvePointSet's can be
...
class TEvePointSetProjected : public TEvePointSet, public TEveProjected {
private:

...
#ifndef ROOT_TEveTreeTools_hxx
#define ROOT_TEveTreeTools_hxx
...
public:
   ...
   ClassDef(TEveSelectorToEventList,
...
public:
   ...
   ClassDef(TEvePointSelectorConsumer,
            1); // Virtual base for classes that can be filled from TTree data via the TEvePointSelector class.
};

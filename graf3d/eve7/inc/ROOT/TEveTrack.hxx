...
class TEveTrackList : public TEveElementList, public TAttMarker, public TAttLine {
...
protected:
   TEveTrackPropagator *fPropagator{nullptr}; // Basic track rendering parameters, not enforced to elements.

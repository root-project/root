...
public:
   TEveMagFieldConst(Double_t x, Double_t y, Double_t z) : TEveMagField(), fB(x, y, z) { fFieldConstant = kTRUE; }
...
public:
   TEveMagFieldDuo(Double_t r, Double_t bIn, Double_t bOut)
      : TEveMagField(), fBIn(0, 0, bIn), fBOut(0, 0, bOut), fR2(r * r)
   {
...
protected:
   ...
   TEveMagField *fMagFieldObj{nullptr};
   ...
   void RebuildTracks();
   void
   Update(const TEveVector4D &v, const TEveVectorD &p, Bool_t full_update = kFALSE, Bool_t enforce_max_step = kFALSE);
   void Step(const TEveVector4D &v, const TEveVectorD &p, TEveVector4D &vOut, TEveVectorD &pOut);
   ...
   Bool_t
   HelixIntersectPlane(const TEveVectorD &p, const TEveVectorD &point, const TEveVectorD &normal, TEveVectorD &itsect);
   Bool_t
   LineIntersectPlane(const TEveVectorD &p, const TEveVectorD &point, const TEveVectorD &normal, TEveVectorD &itsect);
   Bool_t PointOverVertex(const TEveVector4D &v0, const TEveVector4D &v, Double_t *p = 0);

   void ClosestPointFromVertexToLineSegment(const TEveVectorD &v, const TEveVectorD &s, const TEveVectorD &r,
                                            Double_t rMagInv, TEveVectorD &c);
   Bool_t ClosestPointBetweenLines(const TEveVectorD &, const TEveVectorD &, const TEveVectorD &, const TEveVectorD &,
                                   TEveVectorD &out);
...
public:
   ...
   Bool_t
   IntersectPlane(const TEveVectorD &p, const TEveVectorD &point, const TEveVectorD &normal, TEveVectorD &itsect);
...
inline Bool_t TEveTrackPropagator::IsOutsideBounds(const TEveVectorD &point, Double_t maxRsqr, Double_t maxZ)
{
...
//______________________________________________________________________________
inline Bool_t TEveTrackPropagator::PointOverVertex(const TEveVector4D &v0, const TEveVector4D &v, Double_t *p)
{

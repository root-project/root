...
TGL5DDataSetEditor::TGL5DDataSetEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back),
     //"Grid" tab.
     fNCellsXEntry(nullptr), fNCellsYEntry(nullptr), fNCellsZEntry(nullptr), fXRangeSlider(nullptr),
     fXRangeSliderMin(nullptr), fXRangeSliderMax(nullptr), fYRangeSlider(nullptr), fYRangeSliderMin(nullptr),
     fYRangeSliderMax(nullptr), fZRangeSlider(nullptr), fZRangeSliderMin(nullptr), fZRangeSliderMax(nullptr),
     fCancelGridBtn(nullptr), fOkGridBtn(nullptr),
     //"Surfaces" tab.
     fV4MinEntry(nullptr), fV4MaxEntry(nullptr), fHighlightCheck(nullptr), fIsoList(nullptr), fVisibleCheck(nullptr),
     fShowCloud(nullptr), fSurfColorSelect(nullptr), fSurfAlphaSlider(nullptr), fSurfRemoveBtn(nullptr),
     fNewIsoEntry(nullptr), fAddNewIsoBtn(nullptr),
     //"Style" tab's widgets.
     fShowBoxCut(), fNumberOfPlanes(nullptr), fAlpha(nullptr), fLogScale(nullptr), fSlideRange(nullptr),
     fApplyAlpha(nullptr), fApplyPlanes(nullptr),
     // Model.
     fDataSet(nullptr), fPainter(nullptr), fHidden(nullptr), fSelectedSurface(-1)
{
   //Constructor.
   CreateStyleTab();
   CreateGridTab();

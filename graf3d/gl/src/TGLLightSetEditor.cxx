...
TGLLightSetSubEditor::TGLLightSetSubEditor(const TGWindow *p)
   : TGVerticalFrame(p), fM(nullptr),

     fLightFrame(nullptr), fTopLight(nullptr), fRightLight(nullptr), fBottomLight(nullptr), fLeftLight(nullptr),
     fFrontLight(nullptr), fSpecularLight(nullptr)
{
   // Constructor.
...
TGLLightSetEditor::TGLLightSetEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)

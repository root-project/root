...
TGLViewerEditor::TGLViewerEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fGuidesFrame(nullptr), fClipFrame(nullptr),
     fClearColor(nullptr), fIgnoreSizesOnUpdate(nullptr), fResetCamerasOnUpdate(nullptr), fUpdateScene(nullptr),
     fCameraHome(nullptr), fMaxSceneDrawTimeHQ(nullptr), fMaxSceneDrawTimeLQ(nullptr), fPointSizeScale(nullptr),
     fLineWidthScale(nullptr), fPointSmooth(nullptr), fLineSmooth(nullptr), fWFLineWidth(nullptr),
     fOLLineWidth(nullptr),

     fCameraCenterExt(nullptr), fCaptureCenter(nullptr), fCameraCenterX(nullptr), fCameraCenterY(nullptr),
     fCameraCenterZ(nullptr), fCaptureAnnotate(), fAxesType(0), fAxesContainer(nullptr), fAxesNone(nullptr),
     fAxesEdge(nullptr), fAxesOrigin(nullptr), fAxesDepthTest(nullptr), fRefContainer(nullptr), fReferenceOn(nullptr),
     fReferencePosX(nullptr), fReferencePosY(nullptr), fReferencePosZ(nullptr), fCamContainer(nullptr),
     fCamMode(nullptr), fCamOverlayOn(nullptr), fClipSet(nullptr), fARotDt(nullptr), fARotWPhi(nullptr),
     fARotATheta(nullptr), fARotWTheta(nullptr), fARotADolly(nullptr), fARotWDolly(nullptr),
     fASavImageGUIBaseName(nullptr), fASavImageGUIOutMode(nullptr), fStereoZeroParallax(nullptr),
     fStereoEyeOffsetFac(nullptr), fStereoFrustumAsymFac(nullptr), fViewer(nullptr), fIsInPad(kTRUE)
{
  //  Constructor.

...
TEveArrowEditor::TEveArrowEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fM(nullptr),

     fTubeR(nullptr), fConeR(nullptr), fConeL(nullptr),

     fOrigin(nullptr), fVector(nullptr)
{
   // Constructor.

...
TEveProjectionAxesEditor::TEveProjectionAxesEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options,
                                                   Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fM(nullptr),

     fLabMode(nullptr), fAxesMode(nullptr),

     fCenterFrame(nullptr), fDrawCenter(nullptr), fDrawOrigin(nullptr)
{
   // Constructor.

...
TEveCaloVizEditor::TEveCaloVizEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fM(nullptr),

     fPlotE(nullptr), fPlotEt(nullptr),

     fScaleAbs(nullptr), fMaxValAbs(nullptr), fMaxTowerH(nullptr),

     fEtaRng(nullptr), fPhi(nullptr), fPhiOffset(nullptr), fDataFrame(nullptr), fSliceFrame(nullptr)
{
...
TEveCalo3DEditor::TEveCalo3DEditor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fM(nullptr), fFrameTransparency(nullptr)
{

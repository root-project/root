...
TEveVSD::TEveVSD(const char *, const char *)
   : TObject(),
     ...
     fFile(nullptr), fDirectory(nullptr), fBuffSize(32000), fVerbose(0),

     fTreeK(nullptr), fTreeH(nullptr), fTreeC(nullptr), fTreeR(nullptr), fTreeKK(nullptr), fTreeV0(nullptr),
     fTreeCC(nullptr), fTreeGI(nullptr),

     fK(), fpK(&fK), fH(), fpH(&fH), fC(), fpC(&fC), fR(), fpR(&fR), fKK(), fpKK(&fKK), fV0(), fpV0(&fV0), fCC(),
     fpCC(&fCC), fGI(), fpGI(&fGI)
{
}
...
void TEveVSD::LoadTrees()
{
   ...
   if (fDirectory == nullptr) throw eH + "directory not set.";

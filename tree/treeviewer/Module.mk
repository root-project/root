...
$(TREEVIEWERDS): $(TREEVIEWERH) $(TREEVIEWERL) $(ROOTCINTTMPDEP) $(call pcmdep,TREEVIEWER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,TREEVIEWER) -c $(TREEVIEWERH) $(TREEVIEWERL)

$(TREEVIEWERMAP): $(TREEVIEWERH) $(TREEVIEWERL) $(ROOTCINTTMPDEP) $(call pcmdep,TREEVIEWER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(TREEVIEWERDS) $(call dictModule,TREEVIEWER) -c $(TREEVIEWERH) $(TREEVIEWERL)

...
public:
   ...
   TBufferSQL(TBuffer::EMode mode, Long64_t bufsize, std::vector<Int_t> *vc, TString *insert_query, TSQLRow **rowPtr);
   TBufferSQL(TBuffer::EMode mode, Long64_t bufsize, std::vector<Int_t> *vc, TString *insert_query, TSQLRow **rowPtr,void *buf, bool adopt = true);
   ~TBufferSQL() override;

...
public:
   ...
   DeserializeType GetDeserializeType() const override { return fLeafCount ? DeserializeType::kDestructive : DeserializeType::kZeroCopy; }
   ...
   void    SetAddress(void* addr = 0) override;
   ...
   bool    ReadBasketFast(TBuffer&, Long64_t) override { return !fLeafCount; }
   bool    ReadBasketSerialized(TBuffer&, Long64_t) override { return !fLeafCount; }

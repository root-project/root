...
TEntryListArray::TEntryListArray()
   : TEntryList(), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr), fSubListIter(nullptr)
{
}
...
TEntryListArray::TEntryListArray(const char *name, const char *title)
   : TEntryList(name, title), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr), fSubListIter(nullptr)
{
}
...
TEntryListArray::TEntryListArray(const char *name, const char *title, const TTree *tree)
   : TEntryList(name, title, tree), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr), fSubListIter(nullptr)
{
}
...
TEntryListArray::TEntryListArray(const char *name, const char *title, const char *treename, const char *filename)
   : TEntryList(name, title, treename, filename), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr),
     fSubListIter(nullptr)
{
}
...
TEntryListArray::TEntryListArray(const TTree *tree)
   : TEntryList(tree), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr), fSubListIter(nullptr)
{
}
...
TEntryListArray::TEntryListArray(const TEntryList &elist)
   : TEntryList(elist), fSubLists(nullptr), fEntry(-1), fLastSubListQueried(nullptr), fSubListIter(nullptr)
{
}

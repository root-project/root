...
// Writes an ntuple with the following constraints:
// - At least 1 cluster group is non-contiguous in memory
// - At least 1 cluster is non-contiguous in memory
// - At least 1 column range is non-contiguous in memory
void WriteShuffledNTuple(std::string_view ntupleName, std::string_view path)
{

...
TTreeTableInterface::TTreeTableInterface(TTree *tree, const char *varexp, const char *selection, Option_t *option,
                                         Long64_t nentries, Long64_t firstentry)
   : TVirtualTableInterface(), fTree(tree), fFormulas(nullptr), fEntry(0), fNEntries(nentries), fFirstEntry(firstentry),
     fManager(nullptr), fSelect(nullptr), fSelector(nullptr), fInput(nullptr), fForceDim(kFALSE), fEntries(nullptr),
     fNRows(0), fNColumns(0)
{
   if (fTree == nullptr) {

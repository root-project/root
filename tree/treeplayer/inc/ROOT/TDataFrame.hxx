...
public:
   ...
   /// methods available.
   TDataFrame(const std::string &treeName, TDirectory *dirPtr, const BranchNames &defaultBranches = {}) : TDataFrameInterface<ROOT::Detail::TDataFrameImpl>(treeName, dirPtr, defaultBranches) {};
   ...
   /// See ROOT::Experimental::TDataFrameInterface for the documentation of the
   /// methods available.
   TDataFrame(TTree &tree, const BranchNames &defaultBranches = {}) : TDataFrameInterface<ROOT::Detail::TDataFrameImpl> (tree, defaultBranches) {};
};

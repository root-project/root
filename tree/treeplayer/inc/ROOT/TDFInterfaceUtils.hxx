...
// this function is meant to be called by the jitted code generated by JitFilter
template <typename F, typename PrevNode>
void JitFilterHelper(F &&f, const ColumnNames_t &cols, std::string_view name, TJittedFilter *jittedFilter,
                     PrevNode *prevNode)
{
   using F_t = TFilter<F, PrevNode>;

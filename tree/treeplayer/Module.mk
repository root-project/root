...
$(TREEPLAYERDS): $(TREEPLAYERH) $(TREEPLAYERL) $(ROOTCINTTMPDEP) $(call pcmdep,TREEPLAYER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,TREEPLAYER) -c $(TREEPLAYERH) $(TREEPLAYERL)

$(TREEPLAYERMAP): $(TREEPLAYERH) $(TREEPLAYERL) $(ROOTCINTTMPDEP) $(call pcmdep,TREEPLAYER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(TREEPLAYERDS) $(call dictModule,TREEPLAYER) -c $(TREEPLAYERH) $(TREEPLAYERL)

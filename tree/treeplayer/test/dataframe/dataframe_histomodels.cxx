...
TEST(TDataFrameHistoModels, Histo2D)
{
   ...
   auto h1eXeY = d.Histo2D(::TH2D("h1eXeY", "h1eXeY", (int) edgesX.size(), edgesX.data(), (int) edgesY.size(), edgesY.data()), "x", "y");
   auto h2eXeY = d.Histo2D({"h2eXeY", "h2eXeY", (int) edgesX.size(), edgesX.data(), (int) edgesY.size(), edgesY.data()}, "x", "y");
   std::vector<float> edgesXf {1,2,3,4,5,6,10};
   std::vector<float> edgesYf {1,2,3,4,5,6,10};
   auto h1eXeYf = d.Histo2D(::TH2D("h1eXeYf", "h1eXeYf", (int) edgesXf.size(), edgesXf.data(), (int) edgesYf.size(), edgesYf.data()), "x", "y");
   auto h2eXeYf = d.Histo2D({"h2eXeYf", "h2eXeYf", (int) edgesXf.size(), edgesXf.data(), (int) edgesYf.size(), edgesYf.data()}, "x", "y");
...
TEST(TDataFrameHistoModels, Histo3D)
{
   ...
   auto h1e = d.Histo3D(::TH3D("h1e", "h1e", (int) edgesXd.size(), edgesXd.data(), (int) edgesYd.size(), edgesYd.data(), (int) edgesZd.size(), edgesZd.data()), "x", "y", "z");
   auto h2e = d.Histo3D({"h2e", "h2e", (int) edgesXd.size(), edgesXd.data(), (int) edgesYd.size(), edgesYd.data(), (int) edgesZd.size(), edgesZd.data()}, "x", "y", "z");

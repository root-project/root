...
void makeTree(){
	...
	myTree->Branch("vectorB_0.",	&myObject0.vectorB,	32000, 0);
	myTree->Branch("vectorB_99.",	&myObject0.vectorB,	32000, 99);

	myTree->Branch("vectorBStar_0.",	&myObject0.vectorBStar,	32000, 0);
	myTree->Branch("vectorBStar_99.",	&myObject0.vectorBStar,	32000, 99);

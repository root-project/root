   ...
   */
   ...
   private:
      ...
      struct RCombinedJoinFieldValue {
         std::vector<NTupleJoinFieldValue_t> fJoinFieldValues;

         RCombinedJoinFieldValue(const std::vector<NTupleJoinFieldValue_t> &joinFieldValues)
   ...
   std::vector<REntryMapping *> GetMappingsForKey(PartitionKey_t partitionKey) const;

...
public:
   ...
   template <typename T>
   RNTupleView<T> GetView(std::string_view fieldName, std::shared_ptr<T> objPtr, std::string_view typeName)
   {
   ...
   template <typename T>
   RNTupleView<T> GetView(std::string_view fieldName, T *rawPtr, std::string_view typeName)
   {

...
INSTANTIATE_TEST_SUITE_P(
   RPageSourceS3Wire, RPageSourceS3ClusterCache,
   ::testing::Values(ROOT::RNTupleReadOptions::EClusterCache::kOn, ROOT::RNTupleReadOptions::EClusterCache::kOff),
   ...
   ([](const ::testing::TestParamInfo<RPageSourceS3ClusterCache::ParamType> &paramInfo) {
      return std::string(paramInfo.param == ROOT::RNTupleReadOptions::EClusterCache::kOn ? "ClusterCacheOn"
                                                                                         : "ClusterCacheOff");
   }));

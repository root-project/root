...
The current Attribute Schema Version is **1.0**. It has the following fields (in the following order):
  ...
  3. `_userModel` (untyped record): a record-type field that serves as the root field to the user-provided schema description
     of the Attribute Set RNTuple. Each user-defined field that was attached to the Field Zero in the user-provided

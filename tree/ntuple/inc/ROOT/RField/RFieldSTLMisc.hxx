...
protected:
   ...
   /// Given the index of the nullable field, returns the corresponding cluster-local index of the subfield or,
   /// if it is null, returns a default constructed RNTupleLocalIndex
   RNTupleLocalIndex GetItemIndex(NTupleSize_t globalIndex);
   /// Given the index of the nullable field, returns the corresponding local index of the subfield or,
   /// if it is null, returns a default constructed RNTupleLocalIndex

...
protected:
   ...
   virtual void
   SetEntryPointers(const Internal::RNTupleProcessorEntry &entry, std::string_view fieldNamePrefix = "") = 0;
   ...
   virtual void AddFieldToEntry(const std::string &fieldName) = 0;

   /////////////////////////////////////////////////////////////////////////////
   /// \brief Freeze the processor's entry, so fields cannot be added to it anymore.
   ///
   /// \param[in] setEntryPointers If true, also set the entry pointers in any inner processors to that of the processor
   /// this function is called on. This is in principle only necessary for the outermost processor.
   virtual void FreezeEntry(bool setEntryPointers = false) = 0;
...
public:
   ...
   */
   ...
   public:
      ...
      {
         fProcessor.FreezeEntry(/*setEntryPointers=*/true);
...
private:
   ...
   void SetEntryPointers(const Internal::RNTupleProcessorEntry &entry, std::string_view fieldNamePrefix = "") final;
   ...
   /// \brief Add a new field to the processor's entry.
   ///
   /// \sa ROOT::Experimental::RNTupleProcessor::AddFieldToEntry
   void AddFieldToEntry(const std::string &fieldName) final { fEntry->AddField(fieldName); }

   /////////////////////////////////////////////////////////////////////////////
   /// \brief Freeze the processor's entry, so fields cannot be added to it anymore.
   ///
   /// \sa ROOT::Experimental::RNTupleProcessor::FreezeEntry
   void FreezeEntry(bool setEntryPointers = false) final;
...
private:
   ...
   ///
   /// \sa ROOT::Experimental::RNTupleProcessor::AddFieldToEntry
   void AddFieldToEntry(const std::string &fieldName) final;

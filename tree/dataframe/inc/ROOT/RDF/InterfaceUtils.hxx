...
// and those objects need to stay alive at least until the generated code is finally jitted and executed.
// So we pass addresses to shared_ptrs allocated on the heap to the jitted code, which is then responsible for
// the deletion of the shared_ptr object.
template <typename T>

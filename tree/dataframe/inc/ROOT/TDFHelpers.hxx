...
// This header contains helper free functions that slim down TDataFrame's programming model

#ifndef ROOT_TDF_HELPERS
#define ROOT_TDF_HELPERS
...
/// std::not_fn, required for interoperability with TDataFrame.
// clang-format on
template <typename F,

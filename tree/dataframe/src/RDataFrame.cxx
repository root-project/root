...
When cloning is disabled, TH3D will either be filled under lock, which will slow down execution or using atomics if C++20 is available. The latter is significantly faster.

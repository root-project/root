...
The best value for `ThreadsPerTH3` depends on the computation graph that runs. Use lower numbers if the computation graph is almost only Histo3D, higher number if it has a lot of other nodes.

...
ROOT::Internal::RDF::RMaskedColumnReader::RMaskedColumnReader(TTreeReader &r, std::unique_ptr<ROOT::Detail::RDF::RColumnReaderBase> valueReader,
...
void *ROOT::Internal::RDF::RMaskedColumnReader::GetImpl(Long64_t event) {
   ...
   if (mask.test(fMaskIndex) == false) return nullptr;

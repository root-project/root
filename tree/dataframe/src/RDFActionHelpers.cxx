...
{
   // This assertion is wrong because there is a very important case where fOutputFiles is never filled: if the
   // input dataset has no entries, the computation graph will simply not run and our InitTask function will never
   // be called

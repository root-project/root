...
void ROOT::Internal::RDF::RTTreeDS::ProcessMT(ROOT::Detail::RDF::RLoopManager &lm)
{
   ...
   auto tp = fGlobalEntryRange.has_value()
                ? ROOT::TTreeProcessorMT(*fTree, fNSlots, fGlobalEntryRange.value(), suppressErrorsForMissingBranches)
                : ROOT::TTreeProcessorMT(*fTree, entryList, fNSlots, suppressErrorsForMissingBranches);

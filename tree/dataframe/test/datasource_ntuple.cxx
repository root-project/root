...
TEST_F(RNTupleDSTest, AlternativeColumnTypes)
{
   ...
   try {
      ...
      EXPECT_THAT(err.what(),
                  testing::HasSubstr("RNTupleDS: invalid type \"std::pair<float,float>\" for column \"jets\""));
   }
   ...
   try {
      ...
      EXPECT_THAT(err.what(),
                  testing::HasSubstr("RNTupleDS: invalid type \"std::vector<std::uint64_t>\" for column \"jets\""));
   }
}

...
TEST(RDFSnapshotRNTuple, LazyNotTriggered)
{
   ...
   EXPECT_FALSE(std::filesystem::exists(fileGuard.GetPath().c_str()));
}
...
TEST(RDFSnapshotRNTuple, DisallowToTTreeTemplated)
{
   ...
   FileRAII fileGuard{"RDFSnapshotRNTuple_disallow_to_ttree_templated.root"};
...
{
   const auto treename = "tree";
   FileRAII fileGuard{"RDFSnapshotRNTuple_disallow_to_ttree_jitted.root"};

...
constexpr auto url0 = "http://root-test.web.cern.ch/files/RSqliteDS_test.sqlite";
constexpr auto url1 = "http://root-test.web.cern.ch/files/RSqliteDS_test.sqlite.404";

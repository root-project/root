...
// TODO(fwdg): implement MT support and remove expected warnings
TEST_F(RNTupleProcessorDSTest, ReadMT)
{
   IMTRAII _;

   ROOT_EXPECT_WARNING(ReadTest(fNtplName, fFileName), "RNTupleProcessorDS",
                       "MT is not yet supported. Using single-threaded processing instead.");
}
...
TEST_F(RNTupleProcessorDSTest, ChainMT)
{
   ...
   ROOT_EXPECT_WARNING(ChainTest(fNtplName, fFileName), "RNTupleProcessorDS",
                       "MT is not yet supported. Using single-threaded processing instead.");
}
#endif

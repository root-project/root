...
class TestLiveVisualizationCallback:
    ...
    """
    def test_data_points_increase(self, connection):
        """
    ...
    def test_multiple_callbacks(self, connection):
        """
    ...
    def test_partial_callback(self, connection):
        """
...
class TestInvalidArgument:
    ...
    """
    def test_plot_argument(self, connection):
        """
    ...
    def test_callback_argument(self, connection):
        """
...
class TestUnsupportedCall:
    ...
    """
    def test_call_with_two_rdataframes(self, connection):
        """
    ...
    def test_unsupported_operation(self, connection):
        """
    ...
    def test_call_after_computation(self, connection):
        """

...
//Reference
//Gropp, W., & Lusk, E. (1999, September). Reproducible measurements of MPI performance characteristics. In European Parallel Virtual Machine/Message Passing Interface Users’ Group Meeting (pp. 11-18). Springer Berlin Heidelberg.

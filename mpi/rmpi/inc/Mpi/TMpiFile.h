...
namespace ROOT {
   ...
   namespace Mpi {
      ...
      */
      ...
      /**
      * \class TMpiFile
      * Class with all functionalities of TFile but that can to communicate the files using MPI with and object of TIntraCommunicator.
      * \ingroup Mpi
      */
      ...
      protected:
        ...
        TMpiFile(const TIntraCommunicator &comm, const Char_t *name,
                 Char_t *buffer, Long64_t size, Option_t *option = "",
                 const Char_t *ftitle = "", Int_t compress = 1);
        TMpiFile(const TIntraCommunicator &comm, const Char_t *name,
                 Option_t *option = "", const Char_t *ftitle = "",
                 Int_t compress = 1);

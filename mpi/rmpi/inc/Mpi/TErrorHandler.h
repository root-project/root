...
public:
   ...
   inline Bool_t operator!=(const TErrorHandler &errhanlder) { return (Bool_t) !(*this == errhanlder); }
   virtual void Free();
   ...
   template <class T>
   static void TraceBack(const T *comm, const Char_t *function, const Char_t *file, Int_t line, Int_t errcode,
                         const Char_t *msg);
 ...
 */
template <class T>
void TErrorHandler::TraceBack(const T *comm, const Char_t *function, const Char_t *file, Int_t line, Int_t errcode,
                              const Char_t *_msg)
{
   TString msg;
...
void TErrorHandler::TraceBack(const Char_t *class_name, const Char_t *function, const Char_t *file, Int_t line,
                              Int_t errcode, const Char_t *msg);

// @(#)root/ged:$Name:  $:$Id: TStyleManager.cxx,v 1.0 2005/09/08
...
void TStyleManager::UpdateEditor(Int_t tabNum)
{
   ...
   switch (tabNum) {
      ...
      case 1: // CANVAS
         ...
         fAttDateTextColor->SetColor(TColor::Number2Pixel(
                                   fCurSelStyle->GetAttDate()->GetTextColor()));
...
// TODO Just delete when ComboBox can be grayed
      ...
      case 2: // PAD
         ...
         if (fCurSelStyle->GetPadTickX()) fPadTickX->SetState(kButtonDown, kFALSE);
                             else fPadTickX->SetState(kButtonUp, kFALSE);
         if (fCurSelStyle->GetPadTickY()) fPadTickY->SetState(kButtonDown, kFALSE);
                             else fPadTickY->SetState(kButtonUp, kFALSE);
         if (fCurSelStyle->GetPadGridX()) fPadGridX->SetState(kButtonDown, kFALSE);
                             else fPadGridX->SetState(kButtonUp, kFALSE);
         if (fCurSelStyle->GetPadGridY()) fPadGridY->SetState(kButtonDown, kFALSE);
                             else fPadGridY->SetState(kButtonUp, kFALSE);
      ...
      case 3: // HISTOS
         ...
         if (fCurSelStyle->GetHistMinimumZero()) fHistMinimumZero->SetState(kButtonDown, kFALSE);
                                    else fHistMinimumZero->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetDrawBorder()) fDrawBorder->SetState(kButtonDown, kFALSE);
                               else fDrawBorder->SetState(kButtonUp, kFALSE);
      ...
      case 4: // AXIS
         ...
         if (fCurSelStyle->GetOptLogx()) fOptLogx->SetState(kButtonDown, kFALSE);
                            else fOptLogx->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetNdivisions("X") > 0) fXNdivisionsOptimize->SetState(kButtonDown, kFALSE);
                                      else fXNdivisionsOptimize->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetOptLogy()) fOptLogy->SetState(kButtonDown, kFALSE);
                           else  fOptLogy->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetNdivisions("Y") > 0) fYNdivisionsOptimize->SetState(kButtonDown, kFALSE);
                                      else fYNdivisionsOptimize->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetOptLogz()) fOptLogz->SetState(kButtonDown, kFALSE);
                            else fOptLogz->SetState(kButtonUp, kFALSE);
         ...
         if (fCurSelStyle->GetNdivisions("Z") > 0) fZNdivisionsOptimize->SetState(kButtonDown, kFALSE);
                                      else fZNdivisionsOptimize->SetState(kButtonUp, kFALSE);
         break;
      case 5: // TITLES
...
// TODO Just delete when ComboBox can be grayed
      ...
      case 6: // STATS
         ...
         if (tmp % 10) fOptStatName->SetState(kButtonDown, kFALSE);                   else fOptStatName->SetState(kButtonUp, kFALSE);
         if ((tmp/10) % 10) fOptStatEntries->SetState(kButtonDown, kFALSE);         else fOptStatEntries->SetState(kButtonUp, kFALSE);
         if ((tmp/100) % 10) fOptStatMean->SetState(kButtonDown, kFALSE);           else fOptStatMean->SetState(kButtonUp, kFALSE);
         if ((tmp/1000) % 10) fOptStatRMS->SetState(kButtonDown, kFALSE);           else fOptStatRMS->SetState(kButtonUp, kFALSE);
         if ((tmp/10000) % 10) fOptStatUnderflow->SetState(kButtonDown, kFALSE);    else fOptStatUnderflow->SetState(kButtonUp, kFALSE);
         if ((tmp/100000) % 10) fOptStatOverflow->SetState(kButtonDown, kFALSE);    else fOptStatOverflow->SetState(kButtonUp, kFALSE);
         if ((tmp/1000000) % 10) fOptStatIntegral->SetState(kButtonDown, kFALSE);   else fOptStatIntegral->SetState(kButtonUp, kFALSE);
         if ((tmp/10000000) % 10) fOptStatSkewness->SetState(kButtonDown, kFALSE);  else fOptStatSkewness->SetState(kButtonUp, kFALSE);
         if ((tmp/100000000) % 10) fOptStatKurtosis->SetState(kButtonDown, kFALSE); else fOptStatKurtosis->SetState(kButtonUp, kFALSE);
         if ((((tmp/100) % 10) == 2) || (((tmp/1000) % 10) == 2) || (((tmp/10000000) % 10) == 2) || (((tmp/100000000) % 10) == 2))
                               fOptStatErrors->SetState(kButtonDown, kFALSE);   else  fOptStatErrors->SetState(kButtonUp, kFALSE);
         fStatFormat->SetText(fCurSelStyle->GetStatFormat());
         tmp2 = fCurSelStyle->GetOptFit();
         if (tmp2 % 10) fOptFitValues->SetState(kButtonDown, kFALSE);                 else fOptFitValues->SetState(kButtonUp, kFALSE);
         if ((tmp2/10) % 10) {
         ...
         if ((tmp2/100) % 10) fOptFitChi->SetState(kButtonDown, kFALSE);            else fOptFitChi->SetState(kButtonUp, kFALSE);
         if ((tmp2/1000) % 10) fOptFitProbability->SetState(kButtonDown, kFALSE);   else fOptFitProbability->SetState(kButtonUp, kFALSE);
...
void TStyleManager::ConnectEditor(Int_t tabNum)
{
   ...
   switch (tabNum) {
      ...
      case 5: // TITLES
         ...
         break;
      case 6: // STATS
         fStatColor->Connect("ColorSelected(Pixel_t)", "TStyleManager", this, "ModStatColor()");
         fStatStyle->Connect("PatternSelected(Style_t)", "TStyleManager", this, "ModStatStyle()");
         fStatTextColor->Connect("ColorSelected(Pixel_t)", "TStyleManager", this, "ModStatTextColor()");
...
void TStyleManager::DoSelectCanvas(TVirtualPad *pad, TObject *obj, Int_t mouseButton)
{
   ...
   sPad.Append(" - '");
   if (strlen(fCurPad->GetTitle())) sPad.Append(fCurPad->GetTitle());
                               else sPad.Append("[no title]");
   sPad.Append("'::");
   sPad.Append(fCurPad->ClassName());
   fCurPadTextEntry->SetText(sPad);
   TString sObj;
   if (strlen(fCurObj->GetName())) sObj.Append(fCurObj->GetName());
                              else sObj.Append("[no name]");
   sObj.Append("::");
...
void TStyleManager::ModCanvasBorderMode()
{
   ...
   while (!fCanvasBorderMode->Find(i)->IsDown()) i++;
...
void TStyleManager::ModOptDateBool()
{
   ...
   if (fOptDateBool->IsDown()) fCurSelStyle->SetOptDate(4);
                          else fCurSelStyle->SetOptDate(0);
   DisconnectEditor(fCurTabNum);
   UpdateEditor(fCurTabNum);
   ConnectEditor(fCurTabNum);
   DoEditor();
...
void TStyleManager::ModAttDateTextColor()
{
   ...
   // To modify this entry, the user must have checked 'Show'
   fCurSelStyle->GetAttDate()->SetTextColor(
...
void TStyleManager::ModPadBorderMode()
{
   ...
   while (!fPadBorderMode->Find(i)->IsDown()) i++;
...
void TStyleManager::ModFrameBorderMode()
{
   ...
   while (!fFrameBorderMode->Find(i)->IsDown()) i++;
...
//______________________________________________________________________________
void TStyleManager::ModStatColor()
{
   // Slot called whenever the stats fill color is modified by the user.

   fCurSelStyle->SetStatColor(TColor::GetColor(fStatColor->GetColor()));
   DoEditor();
}

//______________________________________________________________________________
void TStyleManager::ModStatStyle()
{
   // Slot called whenever the stats fill style is modified by the user.

   fCurSelStyle->SetStatStyle(fStatStyle->GetPattern());
   DoEditor();
}

//______________________________________________________________________________
void TStyleManager::ModStatTextColor()
{
   // Slot called whenever the stats text color is modified by the user.

   fCurSelStyle->SetStatTextColor(TColor::GetColor(fStatTextColor->GetColor()));
   DoEditor();
}

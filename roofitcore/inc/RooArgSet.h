 ...
 * Package: RooFitCore
 *    File: $Id: RooArgSet.rdl,v 1.25 2001/09/17 18:48:12 verkerke Exp $
 * Authors:
...
public:
  ...
  RooArgSet& operator=(const RooArgSet& other) { return (RooArgSet&) RooAbsCollection::operator=(other) ; }

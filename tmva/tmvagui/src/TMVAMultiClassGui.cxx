...
{   
   ...
   MultiClassActionButton(cbar, title, Form("TMVA::efficienciesMulticlass1vsRest(\"%s\", \"%s\")", dataset.Data(), fName),
   ...
   MultiClassActionButton(cbar, title, Form("TMVA::efficienciesMulticlass1vs1(\"%s\", \"%s\")", dataset.Data(), fName),
                          "Plots background rejection vs signal efficiencies (macro efficienciesMulticlass.cxx) [\"ROC\" stands "
                          "for \"Receiver Operation Characteristics\"]",
                          buttonType, defaultRequiredClassifier);

...
TMVA::StatDialogBDT *TMVA::StatDialogBDT::fThis = nullptr;
...
TMVA::StatDialogBDT::StatDialogBDT(TString dataset, const TGWindow *p, TString wfile, TString methName, Int_t itree)
   : fMain(nullptr), fItree(itree), fNtrees(0), fCanvas(nullptr), fInput(nullptr), fButtons(nullptr),
     fDrawButton(nullptr), fCloseButton(nullptr), fWfile(wfile), fMethName(methName), fDataset(dataset)
{

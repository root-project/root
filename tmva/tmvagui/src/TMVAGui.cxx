...
// main GUI
void TMVA::TMVAGui( const char* fName, const char* fDatasetName ) 
{   
   ...
   cout << "--- Launch TMVA GUI to view input file: " << fName << " and data-set " << fDatasetName << endl;
   ...
   while ((str = (TObjString*)it())) {
      ...
      ActionButton( cbar, 
                    ...
                    Form( "TMVA::variables(\"%s\",\"%s\",\"%s\",\"%s\")", fName, fDatasetName, str->GetString().Data(), title.Data() ),
   ...
   while ((str = (TObjString*)it())) {
      ...
      ActionButton( cbar, 
                    Form( "(%i%c) %s", ic, ch++, title.Data() ),
                    Form( "TMVA::CorrGui(\"%s\",\"%s\",\"%s\",\"%s\")", fName, fDatasetName, str->GetString().Data(), title.Data() ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::correlations(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::mvas(\"%s\",\"%s\",  TMVA::kMVAType)", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::mvas(\"%s\",\"%s\",  TMVA::kCompareType )", fName, fDatasetName),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::mvas(\"%s\",\"%s\", TMVA::kProbaType)", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::mvas(\"%s\",\"%s\", TMVA::kRarityType)", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::mvaeffs(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::efficiencies(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::efficiencies(\"%s\",\"%s\",%d)", fName, fDatasetName, 3 ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::paracoor(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::probas(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::likelihoodrefs(\"%s\",\"%s\")", fName, fDatasetName ), 
   ...
   TString call = Form( "TMVA::network(\"%s\",\"%s\")", fName, fDatasetName );
   ActionButton( cbar,  
                 title,
                 call, 
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::annconvergencetest(\"%s\",\"%s\")", fName, fDatasetName ), 
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::BDT(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::BDTControlPlots(\"%s\",\"%s\")", fName, fDatasetName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( "TMVA::BoostControlPlots(\"%s\",\"%s\")", fName, fDatasetName ),

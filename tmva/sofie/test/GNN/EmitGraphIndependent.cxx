...
int main(int argc, char *argv[]){
    ...
    func.reset(new RFunction_MLP(FunctionTarget::EDGES, 1, 0, GraphType::GraphIndependent));
    ...
    func.reset(new RFunction_MLP(FunctionTarget::NODES, 1, 0, GraphType::GraphIndependent));
    ...
    func.reset(new RFunction_MLP(FunctionTarget::GLOBALS, 1, 0, GraphType::GraphIndependent));

// @(#)root/tmva $Id: TNeuron.cxx,v 1.16 2006/10/04 22:29:27 andreas.hoecker Exp $
...
void TMVA::TNeuron::CalculateActivationValue()
{
   ...
   if (fActivation == NULL) {
      PrintMessage("Warning! No activation equation specified.");
      fActivationValue = UNINITIALIZED;
      return;
   }
...
void TMVA::TNeuron::SetError(Double_t error)
{
   ...
   if (!IsOutputNeuron()) 
      PrintMessage("Warning! Setting an error on a non-output neuron is probably not what you want to do.");
...
void TMVA::TNeuron::PrintActivationEqn()
{
   ...
   if (fActivation != NULL) cout << fActivation->GetExpression();
   else                     cout << "<none>";
   cout << endl;
}

//______________________________________________________________________________
void TMVA::TNeuron::PrintMessage(TString message)
{
   // print message, for debugging

   cout << "--- TMVA::TNeuron: " << message << endl;
}

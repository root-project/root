// @(#)root/tmva $Id: VariableInfo.cxx,v 1.10 2006/10/04 22:29:27 andreas.hoecker Exp $   
...
void TMVA::VariableInfo::WriteToStream(std::ostream& o, Types::PreprocessingMethod corr) const
{
   ...
   UInt_t nc = TMath::Max( 30, TMath::Max( GetExpression().Length(), GetInternalVarName().Length() ) );

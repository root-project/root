// @(#)root/tmva $Id: GeneticBase.cxx,v 1.6 2006/05/22 01:34:14 stelzer Exp $    
...
//_______________________________________________________________________
TMVA::GeneticBase::GeneticBase( Int_t populationSize, vector<LowHigh*> ranges ) 
{
  // Constructor
  // Parameters: 
  ...
  //     vector<LowHigh*> ranges : LowHigh is a pair of doubles, where the first entry 

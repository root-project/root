...
public:
   ...
   static void RotateWeights(TCudaMatrix<AFloat> &A,
                             const TCudaMatrix<AFloat> &B,
                             size_t filterDepth,
                             size_t filterHeight,
                             size_t filterWidth,
   ...
   static void Flatten(TCudaMatrix<AFloat> &A,
    ...
    *  tensor \p B. */
   static void Deflatten(std::vector<TCudaMatrix<AFloat>> A,
                         const TCudaMatrix<AFloat> &B,
                         size_t index,
                         size_t nRows,
                         size_t nCols);
   ...
   static void AddConvBiases(TCudaMatrix<AFloat> &output,
                             const TCudaMatrix<AFloat> &biases);
    ...
    *  \p B. */
   static void Downsample(TCudaMatrix<AFloat> &A,
                          ...
                          const int fltHeight,
                          const int fltWidth,
                          const int strideRows,
                          const int strideCols);

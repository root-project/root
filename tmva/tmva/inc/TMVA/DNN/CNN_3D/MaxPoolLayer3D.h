...
auto TMaxPool3DLayer<Architecture_t>::Forward(Tensor_t &input, bool applyDropout) -> void
{
   ...
   Architecture_t::Downsample3D(
      this->GetOutput(), fIndexTensor, input, (TCNNDescriptors<TMaxPool3DLayer<Architecture_t>> &)*fDescriptors,
      (TCNNWorkspace<TMaxPool3DLayer<Architecture_t>> &)*fWorkspace, this->GetInputHeight(), this->GetInputWidth(), this->GetInputDepth(),
...
//                                             Tensor_t & /*inp1*/, Tensor_t &
{
   ...
   Architecture_t::MaxPoolLayer3DBackward(
      ...
      (TCNNDescriptors<TMaxPool3DLayer<Architecture_t>> &)(*fDescriptors),
      (TCNNWorkspace<TMaxPool3DLayer<Architecture_t>> &)(*fWorkspace), this->GetInputHeight(), this->GetInputWidth(), this->GetInputDepth(),
      this->GetFilterHeight(), this->GetFilterWidth(), this->GetFilterDepth(), this->GetStrideX(), this->GetStrideY(), this->GetStrideZ(),
      this->GetNLocalViews());
}

...
template <typename Architecture_t> class TDAE : public AELayer<Architecture_t> {
...
public:
  ...
  TDAE(size_t BatchSize, size_t VisibleUnits, size_t HiddenUnits);
...
TDAE<Architecture_t>::TDAE(size_t batchSize, size_t visibleUnits,
                           size_t hiddenUnits)
...
//______________________________________________________________________________
template <typename Architecture_t>
auto TDAE<Architecture_t>::Initialize(DNN::EInitialization m) -> void {
...
template <typename Architecture_t>
auto TDAE<Architecture_t>::Corruption(Matrix_t &input, Matrix_t &corruptedInput,
...
template <typename Architecture_t>
auto TDAE<Architecture_t>::TrainLayer(Matrix_t &input, Double_t learningRate,
  ...
  Architecture_t::UpdateParams(
      input, corruptedInput, compressedInput, reconstructedInput,
      this->GetVBiases(), this->GetHBiases(), this->GetWeights(), VBiasError,
      HBiasError, learningRate, this->GetBatchSize());
}

...
TMVA::DataSetInfo::DataSetInfo(const TString &name)
   : TObject(), fDataSetManager(nullptr), fName(name), fDataSet(nullptr), fNeedsRebuilding(kTRUE), fVariables(),
     fTargets(), fSpectators(), fClasses(0), fNormalization("NONE"), fSplitOptions(""), fTrainingSumSignalWeights(-1),
     fTrainingSumBackgrWeights(-1), fTestingSumSignalWeights(-1), fTestingSumBackgrWeights(-1), fOwnRootDir(nullptr),
     fVerbose(kFALSE), fSignalClass(0), fTargetsForMulticlass(nullptr), fLogger(new MsgLogger("DataSetInfo", kINFO))
{
}

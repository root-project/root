                                                        ...
                                                        Int_t max_points )
{
   ...
   while ( !queue.empty() ) {
      ...
      tl =
         (*(volume->fLower))[d] < st.first->GetEventV()[d] && st.first->GetLeft() != nullptr; // Should we descend left?
      tr = (*(volume->fUpper))[d] >= st.first->GetEventV()[d] &&
           st.first->GetRight() != nullptr; // Should we descend right?

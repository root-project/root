...
TMVA::DecisionTree::DecisionTree()
   : BinaryTree(), fNvars(0), fNCuts(-1), fUseFisherCuts(kFALSE), fMinLinCorrForFisher(1), fUseExclusiveVars(kTRUE),
     fSepType(nullptr), fRegType(nullptr), fMinSize(0), fMinNodeSize(1), fMinSepGain(0), fUseSearchTree(kFALSE),
     fPruneStrength(0), fPruneMethod(kNoPruning), fNNodesBeforePruning(0), fNodePurityLimit(0.5),
     fRandomisedTree(kFALSE), fUseNvars(0), fUsePoissonNvars(kFALSE), fMyTrandom(nullptr), fMaxDepth(999999),
     fSigClass(0), fTreeID(0), fAnalysisType(Types::kClassification), fDataSetInfo(nullptr)
{
}
...
TMVA::DecisionTree::DecisionTree(TMVA::SeparationBase *sepType, Float_t minSize, Int_t nCuts, DataSetInfo *dataInfo,
                                 UInt_t cls, Bool_t randomisedTree, Int_t useNvars, Bool_t usePoissonNvars,
                                 UInt_t nMaxDepth, Int_t iSeed, Float_t purityLimit, Int_t treeID)
   : BinaryTree(), fNvars(0), fNCuts(nCuts), fUseFisherCuts(kFALSE), fMinLinCorrForFisher(1), fUseExclusiveVars(kTRUE),
     fSepType(sepType), fRegType(nullptr), fMinSize(0), fMinNodeSize(minSize), fMinSepGain(0), fUseSearchTree(kFALSE),
     fPruneStrength(0), fPruneMethod(kNoPruning), fNNodesBeforePruning(0), fNodePurityLimit(purityLimit),
     fRandomisedTree(randomisedTree), fUseNvars(useNvars), fUsePoissonNvars(usePoissonNvars),
     fMyTrandom(new TRandom3(iSeed)), fMaxDepth(nMaxDepth), fSigClass(cls), fTreeID(treeID),
     fAnalysisType(Types::kClassification), fDataSetInfo(dataInfo)
{

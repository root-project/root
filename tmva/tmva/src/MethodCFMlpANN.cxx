...
TMVA::MethodCFMlpANN::MethodCFMlpANN(const TString &jobName, const TString &methodTitle, DataSetInfo &theData,
                                     const TString &theOption)
   : TMVA::MethodBase(jobName, Types::kCFMlpANN, methodTitle, theData, theOption), fData(nullptr), fClass(nullptr),
     fNlayers(0), fNcycles(0), fNodes(nullptr), fYNN(nullptr), MethodCFMlpANN_nsel(0)
{
...
TMVA::MethodCFMlpANN::MethodCFMlpANN(DataSetInfo &theData, const TString &theWeightFile)
   : TMVA::MethodBase(Types::kCFMlpANN, theData, theWeightFile), fData(nullptr), fClass(nullptr), fNlayers(0),
     fNcycles(0), fNodes(nullptr), fYNN(nullptr), MethodCFMlpANN_nsel(0)
{
}

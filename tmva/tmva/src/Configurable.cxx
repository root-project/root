...
TMVA::Configurable::Configurable(const TString &theOption)
   : TNamed("Configurable", "Configurable"), fOptions(theOption), fLooseOptionCheckingEnabled(kTRUE),
     fLastDeclaredOption(nullptr), fConfigDescription("No description"), fReferenceFile("None"),

...
TMVA::ROCCalc::ROCCalc(TH1 *mvaS, TH1 *mvaB)
   : fMaxIter(100), fAbsTol(0.0), fStatus(kTRUE), fmvaS(nullptr), fmvaB(nullptr), fmvaSpdf(nullptr), fmvaBpdf(nullptr),
     fSplS(nullptr), fSplB(nullptr), fSplmvaCumS(nullptr), fSplmvaCumB(nullptr), fSpleffBvsS(nullptr), fnStot(0),
     fnBtot(0), fSignificance(nullptr), fPurity(nullptr), effBvsS(nullptr), rejBvsS(nullptr), inveffBvsS(nullptr),
...
TMVA::ROCCalc::~ROCCalc() {
   ...
   if (fSplmvaCumS)      { delete fSplmvaCumS;
      fSplmvaCumS = nullptr;
   }
   if (fSplmvaCumB)      { delete fSplmvaCumB;
      fSplmvaCumB = nullptr;
   }

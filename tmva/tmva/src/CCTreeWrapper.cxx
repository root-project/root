...
TMVA::CCTreeWrapper::CCTreeWrapper(DecisionTree *T, SeparationBase *qualityIndex) : fRoot(nullptr)
{
   fDTParent = T;
...
Double_t TMVA::CCTreeWrapper::CheckEvent( const TMVA::Event & e, Bool_t useYesNoLeaf )
{
   ...
   while (                                                   // current->GetNodeType() == 0 &&
      t->GetLeft() != nullptr && t->GetRight() != nullptr) { // at an interior (non-leaf) node

...
TMVA::RuleFitParams::RuleFitParams()
   : fRuleFit(nullptr), fRuleEnsemble(nullptr), fNRules(0), fNLinear(0), fPathIdx1(0), fPathIdx2(0), fPerfIdx1(0),
     fPerfIdx2(0), fGDNTauTstOK(0), fGDNTau(51), fGDTauPrec(0.02), fGDTauScan(1000), fGDTauMin(0.0), fGDTauMax(1.0),
     fGDTau(-1.0), fGDPathStep(0.01), fGDNPathSteps(1000), fGDErrScale(1.1), fAverageTruth(0), fFstarMedian(0),
     fGDNtuple(nullptr), fNTRisk(0), fNTErrorRate(0), fNTNuval(0), fNTCoefRad(0), fNTOffset(0), fNTCoeff(nullptr),
     fNTLinCoeff(nullptr), fsigave(0), fsigrms(0), fbkgave(0), fbkgrms(0), fLogger(new MsgLogger("RuleFit"))
{
   Init();
}
////////////////////////////////////////////////////////////////////////////////

...
/// standard constructor
   ...
   TMVA::MethodCuts::MethodCuts(const TString &jobName, const TString &methodTitle, DataSetInfo &theData,
                                const TString &theOption)
      : MethodBase(jobName, Types::kCuts, methodTitle, theData, theOption), fFitMethod(kUseGeneticAlgorithm),
        fEffMethod(kUseEventSelection), fFitParams(nullptr), fTestSignalEff(0.7), fEffSMin(0), fEffSMax(0),
        fCutRangeMin(nullptr), fCutRangeMax(nullptr), fBinaryTreeS(nullptr), fBinaryTreeB(nullptr), fCutMin(nullptr),
        fCutMax(nullptr), fTmpCutMin(nullptr), fTmpCutMax(nullptr), fAllVarsI(nullptr), fNpar(0), fEffRef(0),
        fRangeSign(nullptr), fRandom(nullptr), fMeanS(nullptr), fMeanB(nullptr), fRmsS(nullptr), fRmsB(nullptr),
        fEffBvsSLocal(nullptr), fVarHistS(nullptr), fVarHistB(nullptr), fVarHistS_smooth(nullptr),
        fVarHistB_smooth(nullptr), fVarPdfS(nullptr), fVarPdfB(nullptr), fNegEffWarning(kFALSE)
   {
}
...
TMVA::MethodCuts::MethodCuts(DataSetInfo &theData, const TString &theWeightFile)
   : MethodBase(Types::kCuts, theData, theWeightFile), fFitMethod(kUseGeneticAlgorithm), fEffMethod(kUseEventSelection),
     fFitParams(nullptr), fTestSignalEff(0.7), fEffSMin(0), fEffSMax(0), fCutRangeMin(nullptr), fCutRangeMax(nullptr),
     fBinaryTreeS(nullptr), fBinaryTreeB(nullptr), fCutMin(nullptr), fCutMax(nullptr), fTmpCutMin(nullptr),
     fTmpCutMax(nullptr), fAllVarsI(nullptr), fNpar(0), fEffRef(0), fRangeSign(nullptr), fRandom(nullptr),
     fMeanS(nullptr), fMeanB(nullptr), fRmsS(nullptr), fRmsB(nullptr), fEffBvsSLocal(nullptr), fVarHistS(nullptr),
     fVarHistB(nullptr), fVarHistS_smooth(nullptr), fVarHistB_smooth(nullptr), fVarPdfS(nullptr), fVarPdfB(nullptr),
...
void  TMVA::MethodCuts::Train( void )
{
   ...
   if (fBinaryTreeS != nullptr) {
      delete fBinaryTreeS;
      fBinaryTreeS = nullptr;
   }
   if (fBinaryTreeB != nullptr) {
      delete fBinaryTreeB;

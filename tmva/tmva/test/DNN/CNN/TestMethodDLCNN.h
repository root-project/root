...
void testMethodDL_DNN(TString architectureStr)
{
   ...
   // General layout.
   TString layoutString("Layout=RESHAPE|1|1|4|FLAT,DENSE|10|TANH,DENSE|10|TANH,DENSE|10|TANH,DENSE|1|LINEAR");
   ...
   TString training1("LearningRate=1e-2,Optimizer=SGD,Momentum=0.9,Repetitions=1,"
                     "ConvergenceSteps=10,BatchSize=256,TestRepetitions=5,"

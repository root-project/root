...
void test1()
{
   double weightsTest1[][12] =
      {
        {252, 116,  155,  246,  170,  149, 227,  113,  166,  227,  119,   57},
   ...
   double answerTest1[][16] =
      {
        {246, 155, 116, 252, 37, 151, 103,  92, 102, 216, 246, 153, 103, 115, 215,   5},
   ...
   bool status = testRotateWeights<TReference<double>>(A, B,
                                                       filterDepthTest1,
                                                       filterHeightTest1,
                                                       filterWidthTest1,
                                                       numFiltersTest1);

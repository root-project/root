...
int calculateDimension(size_t imgDim,
                       size_t fltDim,
                       size_t padding,
                       size_t stride)
{
...
void test1()
{
   ...
   size_t height = calculateDimension(imgHeightTest1, fltHeightTest1,
                                      zeroPaddingHeightTest1, strideRowsTest1);
    
   size_t width = calculateDimension(imgWidthTest1, fltWidthTest1,
                                     zeroPaddingWidthTest1, strideColsTest1);
   ...
   bool status = testIm2col<TReference<double>>(A, B, imgHeightTest1, imgWidthTest1,
                                                fltHeightTest1, fltWidthTest1,
                                                strideRowsTest1, strideColsTest1,
                                                zeroPaddingHeightTest1, zeroPaddingWidthTest1);
...
void test2()
{
   ...
   double answerTest2[][12] =
   {
        {0,   0,   0,   0,  244,  198,    0,    0,    0,    0,  205,  136},
   ...
   size_t height = calculateDimension(imgHeightTest2, fltHeightTest2,
                                      zeroPaddingHeightTest2, strideRowsTest2);
    
   size_t width = calculateDimension(imgWidthTest2, fltWidthTest2,
                                     zeroPaddingWidthTest2, strideColsTest2);
   ...
   bool status = testIm2col<TReference<double>>(A, B, imgHeightTest2, imgWidthTest2,
                                                fltHeightTest2, fltWidthTest2,
                                                strideRowsTest2, strideColsTest2,
                                                zeroPaddingHeightTest2, zeroPaddingWidthTest2);
...
void test3()
{
   ...
   double answerTest3[][18] =
   {
        {0, 0, 0, 0, 0, 235, 0, 0, 0, 0, 0, 158, 0, 0, 0, 0, 0, 240},
   ...
   size_t height = calculateDimension(imgHeightTest3, fltHeightTest3,
                                      zeroPaddingHeightTest3, strideRowsTest3);
    
   size_t width = calculateDimension(imgWidthTest3, fltWidthTest3,
                                     zeroPaddingWidthTest3, strideColsTest3);
   ...
   bool status = testIm2col<TReference<double>>(A, B, imgHeightTest3, imgWidthTest3,
                                                fltHeightTest3, fltWidthTest3,
                                                strideRowsTest3, strideColsTest3,
                                                zeroPaddingHeightTest3, zeroPaddingWidthTest3);

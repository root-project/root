...
void test1()
{
   ...
   testConvPrediction<TCpu<double>>(batchSizeTest1, imgDepthTest1, imgHeightTest1, imgWidthTest1, batchDepth,
...
void test2()
{
   ...
   testConvPrediction<TCpu<double>>(batchSizeTest2, imgDepthTest2, imgHeightTest2, imgWidthTest2, batchDepth,
                                          batchHeight, batchWidth, f);
}
...
void test3()
{
   ...
   testConvPrediction<TCpu<double>>(batchSizeTest3, imgDepthTest3, imgHeightTest3, imgWidthTest3, batchDepth,
                                          batchHeight, batchWidth, f);
}

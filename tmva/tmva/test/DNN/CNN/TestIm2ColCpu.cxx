...
void test1()
{
   ...
   bool status =
      testIm2col<TCpu<double>>(A, B, imgHeightTest1, imgWidthTest1, fltHeightTest1, fltWidthTest1, strideRowsTest1,
                               strideColsTest1, zeroPaddingHeightTest1, zeroPaddingWidthTest1);
...
void test2()
{
   ...
   bool status =
      testIm2col<TCpu<double>>(A, B, imgHeightTest2, imgWidthTest2, fltHeightTest2, fltWidthTest2, strideRowsTest2,
                               strideColsTest2, zeroPaddingHeightTest2, zeroPaddingWidthTest2);
...
void test3()
{
   ...
   bool status =
      testIm2col<TCpu<double>>(A, B, imgHeightTest3, imgWidthTest3, fltHeightTest3, fltWidthTest3, strideRowsTest3,
                               strideColsTest3, zeroPaddingHeightTest3, zeroPaddingWidthTest3);

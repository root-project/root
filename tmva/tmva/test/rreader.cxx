...
static const std::string filenameClassification = "http://root-test.web.cern.ch/files/tmva_class_example.root";
...
void TrainClassificationModel()
{
   ...
   const std::string filename = "http://root-test.web.cern.ch/files/tmva_class_example.root";
...
static const std::string filenameRegression = "http://root-test.web.cern.ch/files/tmva_reg_example.root";
...
void TrainRegressionModel()
{
   ...
   // Open trees with signal and background events
   const std::string filename = "http://root-test.web.cern.ch/files/tmva_reg_example.root";
   std::unique_ptr<TFile> data{TFile::Open(filename.c_str())};
...
static const std::string filenameMulticlass = "http://root-test.web.cern.ch/files/tmva_multiclass_example.root";
...
void TrainMulticlassModel()
{
   ...
   // Open trees with signal and background events
   const std::string filename = "http://root-test.web.cern.ch/files/tmva_multiclass_example.root";
   std::unique_ptr<TFile> data{TFile::Open(filename.c_str())};
   auto signal = (TTree *)data->Get("TreeS");

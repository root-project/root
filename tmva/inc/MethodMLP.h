// @(#)root/tmva $Id: MethodMLP.h,v 1.20 2006/10/04 22:29:27 andreas.hoecker Exp $
...
namespace TMVA {
   ...
   private:
      ...
      void MinuitMinimize();
      static MethodMLP* GetThisPtr() { return m_This; }
      ...
      static MethodMLP* m_This;
#endif

      // debugging flags
      static const Int_t    PRINT_ESTIMATOR_INC = 10;
      static const Bool_t   PRINT_SEQ           = kFALSE;
      static const Bool_t   PRINT_BATCH         = kFALSE;

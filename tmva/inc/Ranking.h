// @(#)root/tmva $Id: Ranking.h,v 1.5 2006/08/30 22:19:59 andreas.hoecker Exp $
 ...
 * $Id: Ranking.h,v 1.5 2006/08/30 22:19:59 andreas.hoecker Exp $          
 **********************************************************************************/
...
namespace TMVA {
   ...
   public:
      ...
      void SetContext  ( const TString context   ) { fContext = context; }

// @(#)root/tmva $Id: TMVA_Tools.h,v 1.5 2006/05/03 19:45:38 helgevoss Exp $   
 ...
 * $Id: TMVA_Tools.h,v 1.5 2006/05/03 19:45:38 helgevoss Exp $        
 **********************************************************************************/
...
#define __N__(a1,a2,a3) TMVA_Tools::NormVariable(a1,a2,a3)

using std::vector;

namespace TMVA_Tools {

  //  TString GetName( void ) { return "TMVA_Tools"; }
  ...
  void  ComputeStat( std::vector<TMVA_Event*>, Int_t ivar,
		     Double_t&, Double_t&, Double_t&, 
		     Double_t&, Double_t&, Double_t&, Bool_t norm = kFALSE );

// @(#)root/mathcore:$Name:  $:$Id: RotationZ.hv 1.0 2005/06/23 12:00:00 moneta Exp $
...
//
// Last update: $Id: RotationZ.h,v 1.9 2005/08/23 15:03:37 fischler Exp $
//
...
namespace Math {
  ...
  /**
     Rotation class representing a rotation about the Z axis.
...
public:
  ...
  */
   ...
   */
  bool operator == (const RotationZ & rhs) {

// @(#)root/mathcore:$Name:  $:$Id: BoostY.h,v 1.1 2005/11/16 19:30:47 marafino Exp $
...
// 
// Last update: $Id: BoostY.h,v 1.1 2005/11/16 19:30:47 marafino Exp $
// 
...
public:
  ...
  */
  ...
  explicit
  BoostY(const Avector & beta) { SetComponents(0.0, beta.y(), 0.0); }
   ...
   */
  template<class IT>
  BoostY(IT begin, IT end) { SetComponents(begin,end); }

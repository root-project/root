// @(#)root/mathcore:$Name:  $:$Id: LorentzVector.h,v 1.11 2006/08/11 15:34:38 moneta Exp $
...
//
// Last update: $Id: LorentzVector.h,v 1.11 2006/08/11 15:34:38 moneta Exp $
//
...
namespace ROOT {
  ...
  namespace Math {
    ...
    */
    ...
    public:
      ...
      */
      void SetXYZT (Scalar x, Scalar y, Scalar z, Scalar t) {
            fCoordinates =  PxPyPzE4D<Scalar> (x,y,z,t);
      }
	...
	return 1./std::sqrt(1. - v2/t2 );
      ...
      Scalar mt()    const { return Mt();    }
      Scalar mt2()   const { return Mt2();   }
 

      //---- requested by CMS ---
      Scalar energy() const { return E();    }
      Scalar mass()   const { return M();    }
      Scalar mass2()  const { return M2();   }
   ...
   */
    template< class CoordSystem >
    LorentzVector<CoordSystem> operator *

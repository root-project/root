...
* The legacy headers `v5/TF1Data.h`, `v5/TFormula.h` and `v5/TFormulaPrimitive.h` have been moved to `ROOT/v5/TF1Data.hxx`, `ROOT/v5/TFormula.hxx` and `ROOT/v5/TFormulaPrimitive.hxx`. Including them as before will now raise warnings and will be no longer supported in ROOT 6.44.

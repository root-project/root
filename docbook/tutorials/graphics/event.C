...
{
   gROOT->Reset();
   c1 = new TCanvas("c1","ROOT Event description",700,500);
   c1->Range(0,0,14,15.5);
   TPaveText event(1,13,3,15);
   event.SetFillColor(11);
   event.Draw();
   event.AddText("Event");
   TLine line(1.1,13,1.1,1.5);
   line.SetLineWidth(2);
   line.Draw();
   ...
   TArrow arrow(1.1,1.5,3.9,1.5,0.02,"|>");
   ...
   TPaveText p1(4,1,11,2);
   p1.SetTextAlign(12);
   p1.SetFillColor(42);
   p1.AddText("1 Mbyte");
   p1.Draw();
   TPaveText p2(4,3,10,4);
   p2.SetTextAlign(12);
   p2.SetFillColor(42);
   p2.AddText("100 Kbytes");
   p2.Draw();
   TPaveText p3(4,5,9,6);
   p3.SetTextAlign(12);
   p3.SetFillColor(42);
   p3.AddText("10 Kbytes");
   p3.Draw();
   TPaveText p4(4,7,8,8);
   p4.SetTextAlign(12);
   p4.SetFillColor(42);
   p4.AddText("1 Kbytes");
   p4.Draw();
   TPaveText p5(4,9,7,10);
   p5.SetTextAlign(12);
   p5.SetFillColor(42);
   p5.AddText("100 bytes");
   p5.Draw();
   TPaveText p6(4,11,6,12);
   p6.SetTextAlign(12);
   p6.SetFillColor(42);
   p6.AddText("10 bytes");
   p6.Draw();

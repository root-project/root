 ...
 *    File: $Id: RooBRArrayPdf.cc,v 1.3 2001/05/17 00:43:15 verkerke Exp $
 * Authors:
...
Double_t RooBRArrayPdf::evaluate(const RooDataSet* dset) const {
...
Bool_t RooBRArrayPdf::checkDependents(const RooDataSet* set) const 
{

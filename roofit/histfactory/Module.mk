...
HISTFACTORYH_REL := $(patsubst $(MODDIRI)/RooStats/HistFactory/%.h,include/RooStats/HistFactory/%.h,$(HISTFACTORYH))
ALLHDRS      += $(HISTFACTORYH_REL)
...
$(HISTFACTORYDS): $(HISTFACTORYH_REL) $(HISTFACTORYL) $(ROOTCLINGEXE) $(call pcmdep,HISTFACTORY)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCLINGSTAGE2) -f $@ $(call dictModule,HISTFACTORY) -c -writeEmptyRootPCM -I$(HISTFACTORYDICTI) $(HISTFACTORYH_REL) $(HISTFACTORYL)

$(HISTFACTORYMAP): $(HISTFACTORYH_REL) $(HISTFACTORYL) $(ROOTCLINGEXE) $(call pcmdep,HISTFACTORY)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCLINGSTAGE2) -r $(HISTFACTORYDS) $(call dictModule,HISTFACTORY) -c -I$(HISTFACTORYDICTI) $(HISTFACTORYH_REL) $(HISTFACTORYL)
...
all-$(MODNAME): $(HISTFACTORYLIB) $(HF_MAKEWORKSPACEEXE)
clean-$(MODNAME):

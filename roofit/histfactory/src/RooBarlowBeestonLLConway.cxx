...
//////////////////////////////////////////////////////////////////////////////
/** \class RooStats::HistFactory::RooBarlowBeestonLLConway
 * \ingroup HistFactory
//
// Class RooBarlowBeestonLLConway implements the profile likelihood estimator for
// a given likelihood and set of parameters of interest. The value return by
// RooBarlowBeestonLLConway is the input likelihood nll minimized w.r.t all nuisance parameters
...
#include "RooStats/HistFactory/RooBarlowBeestonLLConway.h"
...
RooStats::HistFactory::RooBarlowBeestonLLConway::RooBarlowBeestonLLConway(const char *name, const char *title,
...
RooStats::HistFactory::RooBarlowBeestonLLConway::RooBarlowBeestonLLConway(const RooBarlowBeestonLLConway& other, const char* name) :
...
void RooStats::HistFactory::RooBarlowBeestonLLConway::BarlowCache::SetBinCenter() const {
...
void RooStats::HistFactory::RooBarlowBeestonLLConway::initializeBarlowCache() {
  bool verbose=false;
  ...
  for (const auto& nameIdx : *channelCat) {
   ...
   std::cout << "Channel: " << channel_name
    ...
    for( Int_t bin_index = 0; bin_index < num_bins; ++bin_index ) {
      ...
      if(!gamma_stat) throw std::runtime_error("ParamHistFunc contains non-RooRealVar, not supported in RooBarlowBeestonLLConway");
...
bool RooStats::HistFactory::RooBarlowBeestonLLConway::getParameters(const RooArgSet* depList,
                                                              RooArgSet& outputSet,
...
const RooArgSet& RooStats::HistFactory::RooBarlowBeestonLLConway::bestFitParams() const
{
  validateAbsMin() ;
  return _paramAbsMin ;
}
...
const RooArgSet& RooStats::HistFactory::RooBarlowBeestonLLConway::bestFitObs() const
{
  validateAbsMin() ;
  return _obsAbsMin ;
}
...
/*
RooAbsReal* RooStats::HistFactory::RooBarlowBeestonLLConway::createProfile(const RooArgSet& paramsOfInterest)
{
...
/*
void RooStats::HistFactory::RooBarlowBeestonLLConway::FactorizePdf(const RooArgSet &observables, RooAbsPdf &pdf, RooArgList &obsTerms, RooArgList &constraints) const {
...
double RooStats::HistFactory::RooBarlowBeestonLLConway::evaluate() const
{
...
void RooStats::HistFactory::RooBarlowBeestonLLConway::validateAbsMin() const
{
  ...
  if (_absMinValid) {
   ...
   cxcoutI(Minimization) << "RooStats::HistFactory::RooBarlowBeestonLLConway::evaluate(" << GetName() << ") constant status of parameter " << par->GetName() << " has changed from "
  ...
  if (!_absMinValid) {
    ...
    cxcoutI(Minimization) << "RooStats::HistFactory::RooBarlowBeestonLLConway::evaluate(" << GetName() << ") determining minimum likelihood for current configurations w.r.t all observable" << std::endl ;
    ...
    if (dologI(Minimization)) {
      cxcoutI(Minimization) << "RooStats::HistFactory::RooBarlowBeestonLLConway::evaluate(" << GetName() << ") minimum found at (" ;

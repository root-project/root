...
// s0    = 3.04623  +/-  0.0982477 (limited)
  ...
  if (!HasFailure()) {
    if( remove("failed_testRooGradMinimizer_BranchingPDF_workspace.root") != 0) {
      std::cout << "Failed to remove failed_testRooGradMinimizer_BranchingPDF_workspace.root workspace file, sorry. There were no failures though, so manually remove at your leisure." << std::endl;
    }
  }
...
//  for (auto var_name : {"x", "y", "z", "u", "v", "ga0_0_1", "ga1_0", "g0_0_0", "g0_0", "g0", "g1", "N_g0", "N_g1", "nll_sum_sumData", "sum", "k0_0_1", "k1_0", "m0_0", "m0_0_0", "m1", "s0"}) {

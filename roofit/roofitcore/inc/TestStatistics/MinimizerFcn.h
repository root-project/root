...
#ifndef ROOT_ROOFIT_TESTSTATISTICS_MINIMIZER_FCN
#define ROOT_ROOFIT_TESTSTATISTICS_MINIMIZER_FCN
...
class MinimizerFcn : public ROOT::Math::IBaseFunctionMultiDim {

public:
   MinimizerFcn(RooAbsReal *funct, MinimizerGenericPtr context, bool verbose = false);
   MinimizerFcn(const MinimizerFcn &other);
   virtual ~MinimizerFcn();
...
#endif // ROOT_ROOFIT_TESTSTATISTICS_Minimizer_FCN
#endif

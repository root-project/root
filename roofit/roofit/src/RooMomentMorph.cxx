...
RooMomentMorph::RooMomentMorph(const RooMomentMorph &other, const char *name)
   : RooAbsPdf(other, name), _cacheMgr(other._cacheMgr, this), _curNormSet(nullptr), m("m", this, other.m),
...
{
   CacheElem *cache = (CacheElem *)_cacheMgr.getObj(nullptr, (RooArgSet *)nullptr);
   if (cache) {
      return cache;
  }

...
RooMomentMorphFuncND::RooMomentMorphFuncND() :
  _curNormSet(0),
  _M(0),_MSqr(0),
  _setting(RooMomentMorphFuncND::Linear),
  _useHorizMorph(true)
{
...
//_____________________________________________________________________________
RooMomentMorphFuncND::RooMomentMorphFuncND(const char *name,
                                   const char *title,
  ...
  _useHorizMorph(true)
{
  ...
  for (int i = 0; (mref = dynamic_cast<RooAbsReal*>(mrefItr->Next())); ++i) {
    if (!mref) {
      coutE(InputArguments) << "RooMomentMorphFuncND::ctor(" << GetName() << ") ERROR: mref " << mref->GetName() << " is not of type RooAbsReal" << endl;
      throw string("RooMomentMorphFuncND::ctor() ERROR mref is not of type RooAbsReal") ;
    }
    if (!dynamic_cast<RooConstVar*>(mref)) {
      coutW(InputArguments) << "RooMomentMorphFuncND::ctor(" << GetName() << ") WARNING mref point " << i << " is not a constant, taking a snapshot of its value" << endl;
    }
...
void RooMomentMorphFuncND::initializeParameters(const RooArgList& parList)
{
  ...
  for (int i = 0; (par = (RooAbsArg*)parItr->Next()); ++i) {
    if (!dynamic_cast<RooAbsReal*>(par)) {
      coutE(InputArguments) << "RooMomentMorphFuncND::ctor(" << GetName() << ") ERROR: parameter " << par->GetName() << " is not of type RooAbsReal" << endl;
...
void RooMomentMorphFuncND::initializeObservables(const RooArgList& obsList)
{
  ...
  for (int i = 0; (var = (RooAbsArg*)obsItr->Next()); ++i) {
    if (!dynamic_cast<RooAbsReal*>(var)) {
      coutE(InputArguments) << "RooMomentMorphFuncND::ctor(" << GetName() << ") ERROR: variable " << var->GetName() << " is not of type RooAbsReal" << endl;
...
void RooMomentMorphFuncND::initialize()
{
  ...
  //   if (!pdf) {
  //     coutE(InputArguments) << "RooMomentMorphFunc::ctor(" << GetName() << ") ERROR: pdf " << pdf->GetName() << " is not of type RooAbsReal" << endl ;
  ...
  if (nPar != nDim) {
    coutE(InputArguments) << "RooMomentMorphFuncND::initialize(" << GetName() << ") ERROR: nPar != nDim" << ": " << nPar << " !=" << nDim << endl;
    assert(0);
  }

  if (nPdf != nRef) {
    coutE(InputArguments) << "RooMomentMorphFuncND::initialize(" << GetName() << ") ERROR: nPdf != nRef" << ": " << nPdf << " !=" << nRef<< endl;
    assert(0);
  }

...
void RooPoisson::computeBatch(double* output, size_t nEvents, RooBatchCompute::DataMap& dataMap) const
{
  RooBatchCompute::dispatch->compute(RooBatchCompute::Poisson, output, nEvents, dataMap, {&*x,&*mean,&*_norm}, 

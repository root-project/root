...
bool tryExportHistFactory(RooJSONFactoryWSTool *tool, const std::string &pdfname, const RooRealSumPdf *sumpdf, JSONNode &elem){
...
std::vector<RooAbsPdf*> findLostConstraints(RooJSONFactoryWSTool *tool, const std::vector<RooAbsPdf*>& constraints, const JSONNode &elem) {

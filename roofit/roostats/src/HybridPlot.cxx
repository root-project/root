...
HybridPlot::HybridPlot(const char *name, const char *title, const std::vector<double> &sb_vals,
                       const std::vector<double> &b_vals, double testStat_data, int n_bins, bool verbosity)
   : TNamed(name, title), fSb_histo(nullptr), fSb_histo_shaded(nullptr), fB_histo(nullptr), fB_histo_shaded(nullptr),
     fData_testStat_line(nullptr), fLegend(nullptr), fPad(nullptr), fVerbose(verbosity)
{

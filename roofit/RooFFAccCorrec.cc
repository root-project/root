 ...
 *    File: $Id: RooFFAccCorrec.cc,v 1.2 2002/05/14 04:18:38 msgill Exp $
 * Authors:
...
"$Id: RooFFAccCorrec.cc,v 1.2 2002/05/14 04:18:38 msgill Exp $";
...
//  reff DatFiles/SmearedEvtgen/R150.nosmear 99990   6.14.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(1740.890259  )+
//  R1*R1*rho2*(-9722.058594       )+
//  R1*R1*( 15379.225586          )+
// R1*rho2*rho2*( -2829.845703     )+
//  R1*rho2*(13071.272461           )+
//  R1*(-15695.636719                )+
// R2*R2*rho2*rho2*(10195.454102    )+
//  R2*R2*rho2*(-48384.066406        )+
//  R2*R2*(59774.632812            )+
// R2*rho2*rho2*(-48890.199219      )+
//  R2*rho2*(238180.953125           )+
//  R2*( -307506.968750              )+
// R1*R2*rho2*rho2*(483.739319   )+
//  R1*R2*rho2*(-2308.966309        )+
//  R1*R2*(  2827.552979          )+
// rho2*rho2*(  70183.375000      )+
// rho2*(-368517.218750               )+
// (       554046.312500            ); 

//  reff DatFiles/SmearedEvtgen/R125.nosmear 99990   6.14.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(1305.602783  )+
//  R1*R1*rho2*(-7421.624023       )+
//  R1*R1*( 11963.911133          )+
// R1*rho2*rho2*( -1626.166870     )+
//  R1*rho2*(7638.601562           )+
//  R1*(-9395.487305                )+
// R2*R2*rho2*rho2*(7196.691406    )+
//  R2*R2*rho2*(-34562.683594        )+
//  R2*R2*(43304.242188            )+
// R2*rho2*rho2*(-34539.515625      )+
//  R2*rho2*(170698.187500           )+
//  R2*( -224256.875000              )+
// R1*R2*rho2*rho2*(354.702667   )+
//  R1*R2*rho2*(-1680.917480        )+
//  R1*R2*(  2036.882202          )+
// rho2*rho2*(  50119.425781      )+
// rho2*(-268580.937500               )+
// (       414512.312500            ); 

//  reff DatFiles/SmearedEvtgen/R100.nosmear 99990   6.14.2002
  Double_t ffnorm =  
 R1*R1*rho2*rho2*(2923.882568  )+
 R1*R1*rho2*(-15621.412109       )+
 R1*R1*( 21970.689453          )+
R1*rho2*rho2*( -11789.263672     )+
 R1*rho2*(60107.714844           )+
 R1*(-76851.968750                )+
R2*R2*rho2*rho2*(11105.350586    )+
 R2*R2*rho2*(-55499.582031        )+
 R2*R2*(70751.921875            )+
R2*rho2*rho2*(-43758.976562      )+
 R2*rho2*(221032.078125           )+
 R2*( -289294.687500              )+
R1*R2*rho2*rho2*(7220.002930   )+
 R1*R2*rho2*(-36893.117188        )+
 R1*R2*(  47184.902344          )+
rho2*rho2*(  51376.261719      )+
rho2*(-274449.812500               )+
(       408529.937500            ); 


//  reff DatFiles/SmearedEvtgen/R075.nosmear 99990   6.14.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(552.573364  )+
//  R1*R1*rho2*(-3379.323486       )+
//  R1*R1*( 5862.339355          )+
// R1*rho2*rho2*( -30.209843     )+
//  R1*rho2*(151.392441           )+
//  R1*(-172.286194                )+
// R2*R2*rho2*rho2*(4122.610840    )+
//  R2*R2*rho2*(-19731.230469        )+
//  R2*R2*(24672.968750            )+
// R2*rho2*rho2*(-20469.726562      )+
//  R2*rho2*(100601.351562           )+
//  R2*( -131591.218750              )+
// R1*R2*rho2*rho2*(4.552307   )+
//  R1*R2*rho2*(-19.392452        )+
//  R1*R2*(  21.025452          )+
// rho2*rho2*(  29735.867188      )+
// rho2*(-158609.421875               )+
// (       244106.359375            ); 


//  reff DatFiles/SmearedEvtgen/R050.nosmear 99990   6.14.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(414.797943  )+
//  R1*R1*rho2*(-2549.209961       )+
//  R1*R1*( 4440.134766          )+
// R1*rho2*rho2*( -7.062644     )+
//  R1*rho2*(65.463371           )+
//  R1*(-118.689110                )+
// R2*R2*rho2*rho2*(3066.073730    )+
//  R2*R2*rho2*(-14687.586914        )+
//  R2*R2*(18391.324219            )+
// R2*rho2*rho2*(-15203.959961      )+
//  R2*rho2*(74791.140625           )+
//  R2*( -97965.617188              )+
// R1*R2*rho2*rho2*(5.243504   )+
//  R1*R2*rho2*(-35.701992        )+
//  R1*R2*(  68.960892          )+
// rho2*rho2*(  22084.009766      )+
// rho2*(-117959.351562               )+
// (       181894.562500            ); 
  ...
  // reff DatFiles/SmearedEvtgen/R.0.75.no.smear.smallfile.upsframe 9999  6.5.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(106.073082  )+
//  R1*R1*rho2*(-614.485596       )+
//  R1*R1*( 972.592896          )+
// R1*rho2*rho2*( -146.303101     )+
//  R1*rho2*(798.104126           )+
//  R1*(-1101.414917                )+
// R2*R2*rho2*rho2*(421.302277    )+
//  R2*R2*rho2*(-2084.733643        )+
//  R2*R2*(2693.123291            )+
// R2*rho2*rho2*(-1929.532959      )+
//  R2*rho2*(9758.717773           )+
//  R2*( -13113.157227              )+
// R1*R2*rho2*rho2*(102.307617   )+
//  R1*R2*rho2*(-564.716797        )+
//  R1*R2*(  794.757935          )+
// rho2*rho2*(  2752.518311      )+
// rho2*(-15057.136719               )+
// (       23714.753906            ); 
  ...
  // reff kv10k.dat 10000   -- 5.29.2002
//   Double_t ffnorm =  
//  R1*R1*rho2*rho2*(276.152344  )+
//  R1*R1*rho2*(-1445.403809       )+
//  R1*R1*( 2032.797119          )+
// R1*rho2*rho2*( -1116.928833     )+
//  R1*rho2*(5467.789551           )+
//  R1*(-6925.861816                )+
// R2*R2*rho2*rho2*(5114.403320    )+
//  R2*R2*rho2*(-22726.593750        )+
//  R2*R2*(25719.242188            )+
// R2*rho2*rho2*(-24230.533203      )+
//  R2*rho2*(108849.179688           )+
//  R2*( -125261.539062              )+
// R1*R2*rho2*rho2*(389.468506   )+
//  R1*R2*rho2*(-1863.300171        )+
//  R1*R2*(  2274.804199          )+
// rho2*rho2*(  30311.480469      )+
// rho2*(-139814.640625               )+
// (       169182.484375            ); 
...
// reff DatFiles/SmearedEvtgen/R.0.75.no.smear 99990   6.4.2002
//  Double_t ffnorm =  
//  R1*R1*rho2*rho2*(552.573364  )+
//  R1*R1*rho2*(-3379.323486       )+
//  R1*R1*( 5862.339355          )+
...
// 3a -- reff DatFiles/fgr.bg0.cosbycut.truelep.dat 9912 1 -- 3.30.2002
//  Double_t ffnorm =  

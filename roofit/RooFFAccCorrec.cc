 ...
 *    File: $Id: RooFFAccCorrec.cc,v 1.5 2001/10/08 05:21:18 verkerke Exp $
 * Authors:
...
"$Id: RooFFAccCorrec.cc,v 1.5 2001/10/08 05:21:18 verkerke Exp $";
...
Double_t RooFFAccCorrec::evaluate() const {
  ...
  // reff DatFiles/totnew.dat 75953 8   bg0: about 49K
 Double_t ffnorm =  

...
/*!
  ...
  @brief  The generator decays a central blob of a given 4-momentum into particles of specific masses. Original GENBOD algorithm with w few modifications.
 
### Authors
	
Radosław Kycia (kycia.radoslaw@gmail.com), Piotr Lebiedowicz, Antoni Szczurek

People who helped in the development of the project: Jacek Turnau, Janusz Chwastowski, Rafał Staszewski, Maciej Trzebiński.

### Description

This is a helper class that can be base to construct MC generators that simulate decay. It returns weight equals LIPS (Lorentz Invariant Phase Space):
...
This class is not recommended for non-advanced users. If you want a robust and adaptive MC generator and integrator, use TGenFoamDecay instead.

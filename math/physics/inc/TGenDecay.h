...
@brief  Generates spherical decay and returns the weight of event equals to LIPS (Lorentz Invariant Phase Space). The generator decays a central blob of a given 4-momentum into particles of specific masses. 

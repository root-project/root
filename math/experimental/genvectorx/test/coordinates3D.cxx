...
int test3D(const DisplacementVector3D<C> &v, double ticks)
{
   ...
   PositionVector3D<Cartesian3D<double>> pxyz_d;
   pxyz_d = vxyz_d;
   PositionVector3D<Polar3D<double>> prtp_d;
   prtp_d = vrtp_d;
   PositionVector3D<CylindricalEta3D<double>> prep_d;
   prep_d = vrep_d;
   PositionVector3D<Cylindrical3D<double>> przp_d;
   przp_d = vrzp_d;

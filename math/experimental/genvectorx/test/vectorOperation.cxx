...
template <class Vector>
TestVector<Vector>::TestVector() : vlist(std::vector<Vector>(N)), scale(std::vector<double>(N)), fTest(0)
{
...
void TestVector<Vector>::PrintSummary()
{
   ...
   std::cout << " v3 = v1+v2" << " v2 += v1  " << " v3 = v1-v2" << " v2 -= v1  " << " v2 = a*v1 " << " v1 *= a   "
             << " v2 = v1/a " << " v1 /= a   " << std::endl;

...
void testOstreamIter()
{
   ...
   Boost b(0.3, 0.4, 0.8);
   printRot(b);
   LorentzRotation lr(rr);
   printRot(lr);
   LorentzRotation lr2(b);
   printRot(lr2);
}
...
void testListIter()
{
   ...
   XYZVector v;
   v.SetCoordinates(inputData.begin(), inputData.end());
   ...
   XYZPoint p;
   p.SetCoordinates(inputData.begin(), inputData.end());
   data.clear();
   ...
   XYZTVector q;
   q.SetCoordinates(inputData.begin(), inputData.end());
   data.clear();
   ...
   tmp.GetComponents(inputData.begin());
   printList(inputData);
   ...
   ttmp.GetComponents(inputData.begin());
   printList(inputData);
   ...
   ltmp.GetComponents(inputData.begin());
   printList(inputData);

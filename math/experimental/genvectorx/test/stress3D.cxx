...
public:
   ...
   int check(std::string name, double s1, double s2, double s3, double scale = 1)
   {
      ...
      if (std::fabs(s1 - s2) < eps * std::fabs(s1) && std::fabs(s1 - s3) < eps * std::fabs(s1))
         return 0;
   ...
   double
   testTransformProd(std::vector<V *> &dataV, const T1 &trans, const T2 &, TStopwatch &tim, double &t, std::string s)
   {
   ...
   template <class V, class T1, class T2>
   double
   testTransformProd2(std::vector<V *> &dataV, const T1 &trans, const T2 &, TStopwatch &tim, double &t, std::string s)
   {
   ...
   // transformation  product
   template <class V, class T1, class T2>
   double testTransformProd3(std::vector<V *> &dataV, const T1 &trans1, const T2 &trans2, TStopwatch &tim, double &t,
                             std::string s)
   {

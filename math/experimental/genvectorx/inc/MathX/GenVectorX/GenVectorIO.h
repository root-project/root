...
inline int ios_data(int k)
{
   static int const ios_data[4] = {
      std::ios::xalloc() // open
      ,
      std::ios::xalloc() // sep
      ,
...
inline char_t get_manip(std::basic_ios<char_t, traits_t> &ios, manip_t m)
{
...
template <class char_t, class traits_t>
inline void set_manip(std::basic_ios<char_t, traits_t> &ios, manip_t m, char_t ch)
{
...
class manipulator {
public:
   explicit manipulator(manip_t m, char_t ch = 0) : fMan(m), fChar(ch) {}
...
template <class char_t, class traits_t>
inline std::basic_istream<char_t, traits_t> &require_delim(std::basic_istream<char_t, traits_t> &is, manip_t m)
{
...
template <class char_t>
inline detail::manipulator<char_t> set_open(char_t ch)
{
...
template <class char_t>
inline detail::manipulator<char_t> set_separator(char_t ch)
{
...
template <class char_t>
inline detail::manipulator<char_t> set_close(char_t ch)
{
...
template <class char_t, class traits_t>
inline std::basic_ios<char_t, traits_t> &human_readable(std::basic_ios<char_t, traits_t> &ios)
{
...
template <class char_t, class traits_t>
inline std::basic_ios<char_t, traits_t> &machine_readable(std::basic_ios<char_t, traits_t> &ios)
{

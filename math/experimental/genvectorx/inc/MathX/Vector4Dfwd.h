...
//     /**
//        LorentzVector based on the coordinates E, Eta, Phi and Mass in double precision. These coordinates are
//        normally used to represents a cluster objects in a calorimeter at a collider experiment.
//     */

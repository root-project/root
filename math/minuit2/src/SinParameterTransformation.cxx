...
namespace ROOT {
  ...
  namespace Minuit2 {
    ...
    double SinParameterTransformation::D2Int2Ext(double Value, double Upper, double Lower) const {
      // return the second derivative of the transformation d^2 Ext/ {d Int}^2
      return 0.5 * ( (Lower - Upper) * sin(Value) );
    }

    double SinParameterTransformation::GStepInt2Ext(double /*Value*/, double /*Upper*/, double /*Lower*/) const {
      return 1.;
    }

...
GeneticMinimizer::GeneticMinimizer(int) : fFitness(nullptr), fMinValue(0), fParameters(GeneticMinimizerParameters())
{
...
const double *  GeneticMinimizer::MinGradient() const {
   return nullptr;
}
bool GeneticMinimizer::ProvidesError() const { return false; }
const double * GeneticMinimizer::Errors() const {
   return nullptr;
}

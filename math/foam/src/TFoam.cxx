...
TFoam::TFoam()
   : fDim(0), fNCells(0), fRNmax(0), fOptDrive(0), fChat(0), fOptRej(0), fNBin(0), fNSampl(0), fEvPerBin(0),
     fMaskDiv(nullptr), fInhiDiv(nullptr), fOptPRD(0), fXdivPRD(nullptr), fNoAct(0), fLastCe(0), fCells(nullptr),
     fMCMonit(nullptr), fMaxWtRej(0), fCellsAct(nullptr), fPrimAcu(nullptr), fHistEdg(nullptr), fHistDbg(nullptr),
     fHistWt(nullptr), fMCvect(nullptr), fMCwt(0), fRvec(nullptr), fRho(nullptr), fMethodCall(nullptr),
     fPseRan(nullptr), fNCalls(0), fNEffev(0), fSumWt(0), fSumWt2(0), fSumOve(0), fNevGen(0), fWtMax(0), fWtMin(0),
     fPrime(0), fMCresult(0), fMCerror(0), fAlpha(nullptr)
{
}
////////////////////////////////////////////////////////////////////////////////
...
void TFoam::MakeActiveList()
{
   ...
   if (fCellsAct != nullptr) delete fCellsAct;
   ...
   if (fCellsAct == nullptr || fPrimAcu == nullptr) Error("MakeActiveList", "Cant allocate fCellsAct or fPrimAcu \n");
...
void  TFoam::SetXdivPRD(Int_t iDim, Int_t len, Double_t xDiv[])
{
  ...
  // set division list for direction iDim in H-cubic space!!!
   if( ( 0<=iDim) && (iDim<fDim)) {
      fOptPRD =1;      // !!!!
      if (fXdivPRD[iDim] != nullptr) Error("SetXdivPRD", "Second allocation of XdivPRD not allowed \n");

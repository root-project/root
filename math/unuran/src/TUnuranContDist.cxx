...
TUnuranContDist::TUnuranContDist(const ROOT::Math::IGenFunction &pdf, const ROOT::Math::IGenFunction *deriv,
                                 bool isLogPdf, bool copyFunc)
   : fPdf(&pdf), fDPdf(deriv), fCdf(nullptr), fXmin(1.), fXmax(-1.), fMode(0), fArea(0), fIsLogPdf(isLogPdf),
     fHasDomain(0), fHasMode(0), fHasArea(0), fOwnFunc(copyFunc)
{
...
TUnuranContDist::TUnuranContDist(TF1 *pdf, TF1 *deriv, bool isLogPdf)
   : fPdf((pdf) ? new ROOT::Math::WrappedTF1(*pdf) : nullptr),
     fDPdf((deriv) ? new ROOT::Math::WrappedTF1(*deriv) : nullptr), fCdf(nullptr), fXmin(1.), fXmax(-1.), fMode(0),
     fArea(0), fIsLogPdf(isLogPdf), fHasDomain(0), fHasMode(0), fHasArea(0), fOwnFunc(true)
{
...
TUnuranContDist::TUnuranContDist(const TUnuranContDist &rhs)
   : TUnuranBaseDist(), fPdf(nullptr), fDPdf(nullptr), fCdf(nullptr)
{

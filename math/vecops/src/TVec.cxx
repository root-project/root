...
#define TVEC_DECLARE_UNARY_FUNCTION(T, NAME, FUNC) \
   template TVec<RTYPE(FUNC,T)> NAME(const TVec<T> &);
...
#define TVEC_DECLARE_BINARY_FUNCTION(T0, T1, NAME, FUNC) \
   template TVec<RTYPE2(FUNC,T0,T1)> NAME(const TVec<T0> &, const T1 &); \
   template TVec<RTYPE2(FUNC,T0,T1)> NAME(const T0 &, const TVec<T1> &); \
   template TVec<RTYPE2(FUNC,T0,T1)> NAME(const TVec<T0> &, const TVec<T1> &);

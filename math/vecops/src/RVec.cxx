...
#define RVEC_DECLARE_STD_UNARY_FUNCTION(T, PASCAL_NAME, LOWER_NAME) \
   RVEC_DECLARE_UNARY_FUNCTION(T, PASCAL_NAME, ::std::LOWER_NAME)   \
   RVEC_DECLARE_UNARY_FUNCTION(T, LOWER_NAME, ::std::LOWER_NAME)
...
#define RVEC_DECLARE_STD_BINARY_FUNCTION(T, PASCAL_NAME, LOWER_NAME)  \
   RVEC_DECLARE_BINARY_FUNCTION(T, T, PASCAL_NAME, ::std::LOWER_NAME) \
   RVEC_DECLARE_BINARY_FUNCTION(T, T, LOWER_NAME, ::std::LOWER_NAME)

#define RVEC_DECLARE_STD_FUNCTIONS(T)                        \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Abs, abs)              \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, FDim, fdim)           \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, FMod, fmod)           \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, Remainder, remainder) \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Exp, exp)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Exp2, exp2)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ExpM1, expm1)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Log, log)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Log10, log10)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Log2, log2)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Log1P, log1p)          \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, Pow, pow)             \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Sqrt, sqrt)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Cbrt, cbrt)            \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, Hypot, hypot)         \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Sin, sin)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Cos, cos)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Tan, tan)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ASin, asin)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ACos, acos)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ATan, atan)            \
   RVEC_DECLARE_STD_BINARY_FUNCTION(T, ATan2, atan2)         \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, SinH, sinh)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, CosH, cosh)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, TanH, tanh)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ASinH, asinh)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ACosH, acosh)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ATanH, atanh)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Floor, floor)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Ceil, ceil)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Trunc, trunc)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, Round, round)          \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, LRound, lround)        \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, LLRound, llround)      \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ErF, erf)              \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, ErFC, erfc)            \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, LGamma, lgamma)        \
   RVEC_DECLARE_STD_UNARY_FUNCTION(T, TGamma, tgamma)
...
#define RVEC_DECLARE_VDT_UNARY_FUNCTION(T, PASCAL_NAME, LOWER_NAME) \
   RVEC_DECLARE_UNARY_FUNCTION(T, PASCAL_NAME, vdt::LOWER_NAME)     \
   RVEC_DECLARE_UNARY_FUNCTION(T, LOWER_NAME, vdt::LOWER_NAME)

RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_ExpF, fast_expf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_LogF, fast_logf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_SinF, fast_sinf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_CosF, fast_cosf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_TanF, fast_tanf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_ASinF, fast_asinf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_ACosF, fast_acosf)
RVEC_DECLARE_VDT_UNARY_FUNCTION(float, Fast_ATanF, fast_atanf)

RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_Exp, fast_exp)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_Log, fast_log)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_Sin, fast_sin)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_Cos, fast_cos)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_Tan, fast_tan)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_ASin, fast_asin)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_ACos, fast_acos)
RVEC_DECLARE_VDT_UNARY_FUNCTION(double, Fast_ATan, fast_atan)

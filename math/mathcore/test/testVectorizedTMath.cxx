  ...
  TEST_F(VectorizedTMathTest, tmathfunc)                       \
    {                                                          \
      ...
      for(int j = 0; j < trials;j++) {                              \
        ...
        Double_t re = (scalar_output == vec_output &&               \
              scalar_output == 0) ? 0 : (vec_output - scalar_output)/scalar_output;               \
...
#define TEST_VECTORIZED_TMATH_FUNCTION_FLT_RANGE(tmathfunc)      \
   TEST_VECTORIZED_TMATH_FUNCTION(tmathfunc, -FLT_MAX, FLT_MAX)

#define TEST_VECTORIZED_TMATH_FUNCTION_FLT_POS_RANGE(tmathfunc)  \
   TEST_VECTORIZED_TMATH_FUNCTION(tmathfunc, FLT_MIN, FLT_MAX)

#define TEST_VECTORIZED_TMATH_FUNCTION_FLT_LOG(tmathfunc)   \
   TEST_VECTORIZED_TMATH_FUNCTION(tmathfunc, 1, FLT_MAX)
...
#define TEST_VECTORIZED_TMATH_FUNCTION_FLT_PROB(tmathfunc)   \
   TEST_VECTORIZED_TMATH_FUNCTION(tmathfunc, 0, 1)

#define TEST_VECTORIZED_TMATH_FUNCTION_FLT_BESSEL(tmathfunc)  \
   TEST_VECTORIZED_TMATH_FUNCTION(tmathfunc, 0, 1e5)
...
TEST_VECTORIZED_TMATH_FUNCTION_FLT_EXP(KolmogorovProb);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_LOG(DiLog);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_EXP(BesselI0);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_EXP_POS(BesselK0);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_EXP(BesselI1);

TEST_VECTORIZED_TMATH_FUNCTION_FLT_BESSEL(BesselJ0);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_BESSEL(BesselJ1);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_BESSEL(BesselY0);
TEST_VECTORIZED_TMATH_FUNCTION_FLT_BESSEL(BesselY1);

// Currently fails in the range of [0, 0.09]
//TEST_VECTORIZED_TMATH_FUNCTION(NormQuantile, 0, 0.09);
//TEST_VECTORIZED_TMATH_FUNCTION_FLT_PROB(NormQuantile);

TEST_VECTORIZED_TMATH_FUNCTION(Gamma, FLT_MIN, 34);
TEST_VECTORIZED_TMATH_FUNCTION2(GamCf, FLT_MIN, 34, FLT_MIN, 34);
TEST_VECTORIZED_TMATH_FUNCTION2(GamSer, FLT_MIN, 34, FLT_MIN, 34);
TEST_VECTORIZED_TMATH_FUNCTION2(Poisson, FLT_MIN, 34, FLT_MIN, 34);

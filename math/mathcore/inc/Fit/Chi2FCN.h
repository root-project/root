...
public:
   ...
   */
   Chi2FCN (const std::shared_ptr<BinData> & data, const std::shared_ptr<IModelFunction> & func, ROOT::Fit::ExecutionPolicy executionPolicy = ROOT::Fit::ExecutionPolicy::kSerial) :
      BaseFCN( data, func),
      fNEffPoints(0),
   ...
   */
   Chi2FCN ( const BinData & data, const IModelFunction & func, ROOT::Fit::ExecutionPolicy executionPolicy = ROOT::Fit::ExecutionPolicy::kSerial) :

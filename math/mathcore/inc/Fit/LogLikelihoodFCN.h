...
public:
   ...
   */
   ...
   virtual double DataElement(const double * x, unsigned int i, double * g, double *  h = nullptr, bool = false) const {
      if (i==0) this->UpdateNCalls();
      return FitUtil::EvaluatePdf(BaseFCN::ModelFunction(), BaseFCN::Data(), x, i, g, h, BaseFCN::IsAGradFCN());
   }

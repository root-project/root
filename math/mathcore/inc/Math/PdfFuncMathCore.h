...
namespace Math {
  ...
  */
  ...
  inline double crystalball_function(double x, double alpha, double n, double sigma, double x0 = 0);

   /**
       pdf definition of the crystal_ball which is defined only for n > 1 otherwise integral is diverging
    */
  inline double crystalball_pdf(double x, double alpha, double n, double sigma, double x0 = 0);

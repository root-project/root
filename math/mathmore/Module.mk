...
$(MATHMOREDS):  $(MATHMOREDH1) $(MATHMOREL) $(MATHMORELINC) $(ROOTCINTTMPDEP) $(call pcmdep,MATHMORE)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@  $(call dictModule,MATHMORE) -c $(ROOT_SRCDIR:%=-I%) $(GSLFLAGS) $(MATHMOREDH1) $(MATHMOREL)

$(MATHMOREMAP): $(MATHMOREDH1) $(MATHMOREL) $(MATHMORELINC) $(ROOTCINTTMPDEP) $(call pcmdep,MATHMORE)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(MATHMOREDS)  $(call dictModule,MATHMORE) -c $(ROOT_SRCDIR:%=-I%) $(GSLFLAGS) $(MATHMOREDH1) $(MATHMOREL)

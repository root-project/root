...
struct GSLRngROOTWrapper {
   ...
   static unsigned long long IntRndm(void *p) { return ((GSLRngROOTWrapper *)p)->fEngine->IntRndm(); }
...
static const gsl_rng_type mixmax_type = {gsl_mixmax_name.c_str(),  GSLMixMaxWrapper::Max(), GSLMixMaxWrapper::Min(),
                                         GSLMixMaxWrapper::Size(), &GSLMixMaxWrapper::Seed, &GSLMixMaxWrapper::IntRndm,

...
namespace ROOT {
  namespace Math {
    ...
    double VoigtRelativistic::dumpingFunction(double median, double sigma, double lg, double integrationRange){
      return VoigtRelativistic::evaluate(median,median,sigma,lg,integrationRange)/TMath::BreitWignerRelativistic(median,median,lg);     
    }

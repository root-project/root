...
*  Allocate memory
******************************************************************/
long Cint::Internal::G__malloc(int n,int bsize,char *item) /* used to be int */
{
  ...
  if(G__globalvarpointer==G__PVOID) {
     ...
     ********************************************/
       ...
       ********************************************/
      if(G__struct.type[G__get_tagnum(G__tagdefining)]=='s' ||
         ...
         * padding 
         ***********************************/
        if(allocmem&&G__struct.size[G__get_tagnum(G__tagdefining)]%allocmem!=0){
          G__struct.size[G__get_tagnum(G__tagdefining)]
            += allocmem - G__struct.size[G__get_tagnum(G__tagdefining)]%allocmem;
        }
        return(G__struct.size[G__get_tagnum(G__tagdefining)]-size);
      }
      /***********************************
       * In case of union
       ***********************************/

...
struct G__Templatefuncarg {
  ...
  ::ROOT::Reflex::Type typenum[G__MAXFUNCPARA];
...
struct G__ifunc_table {
  ...
  ::ROOT::Reflex::Type p_typetable[G__MAXIFUNC];
  ...
  ::ROOT::Reflex::Type para_p_typetable[G__MAXIFUNC][G__MAXFUNCPARA];
...
struct G__var_array {
  ...
  ::ROOT::Reflex::Type p_typetable[G__MEMDEPTH];       /* typename if typedef */
...
struct G__tagtable {
  ...
  ::ROOT::Reflex::Type defaulttypenum[G__MAXSTRUCT];
#endif
...
public:
   G__RflxProperties(): 
      ...
      globalcomp(G__NOLINK), iscpplink(G__NOLINK), typenum(-1), tagnum(-1) {}
   int autoload;

...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_virtualbase_bytecode(G__value *result7
...
*
***********************************************************************/
int Cint::Bytecode::G__bc_exec_virtual_bytecode(G__value *result7
...
*  This function is set as LD_FUNC 4th oprand (*func)()
***********************************************************************/
int Cint::Bytecode::G__bc_exec_normal_bytecode(G__value *result7
			,char *funcname        // ifunc
			,struct G__param *libp
			,int hash              // ifn
			) {
...
*  This function is set as LD_FUNC 4th oprand (*func)()
***********************************************************************/
int Cint::Bytecode::G__bc_exec_ctor_bytecode(G__value *result7
			,char *funcname        // ifunc
			,struct G__param *libp
			,int hash              // ifn
			) {
...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_ctorary_bytecode(G__value *result7
			,char *funcname        // ifunc
			,struct G__param *libp 
			,int hash              // ifn
			) {
...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_dtorary_bytecode(G__value *result7
			,char *funcname        // ifunc
			,struct G__param *libp
			,int hash              // ifn
			) {
...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_try_bytecode(int start,
				       int stack,
				       G__value *presult,
				       long localmem) {
...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_throw_bytecode(G__value* pval) {
...
***********************************************************************/
int Cint::Bytecode::G__bc_exec_typematch_bytecode(G__value* catchtype,G__value* excptobj) {
...
G__exec_bytecode_autoobj::~G__exec_bytecode_autoobj() {
  ...
  Cint::Bytecode::G__delete_autoobjectstack(m_scopelevel+1);
...
**************************************************************************/
extern "C" 
int G__exec_bytecode(G__value *result7,G__CONST char *funcname,struct G__param *libp,int /*hash*/)
{
  int i;
...
#define G__LOCALBUFSIZE 32
  ...
  G__asm_name_p = 0;
  G__tagnum = G__Dict::GetDict().GetScope(bytecode->var->tagnum);
...
***********************************************************************/
int Cint::Bytecode::G__bc_throw_compile_error() {
...
***********************************************************************/
int Cint::Bytecode::G__bc_throw_runtime_error() {

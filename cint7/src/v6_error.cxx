...
*
******************************************************************/
void Cint::Internal::G__malloc_error(char *varname)
{
...
*
******************************************************************/
void Cint::Internal::G__arrayindexerror(int ig15 ,G__var_array *var ,char *item,int p_inc)
{
  int ig25;
...
* G__assign_error()
**************************************************************************/
int Cint::Internal::G__assign_error(char *item,G__value *pbuf)
{
  if(0==G__prerun) {
    if(pbuf->type) {
      G__fprinterr(G__serr,"Error: Incorrect assignment to %s, wrong type '%s'"
              ,item ,G__type2string(pbuf->type ,pbuf->tagnum 
                                    ,G__get_typenum(G__value_typenum(*pbuf))
...
**************************************************************************/
int Cint::Internal::G__err_pointer2pointer(char *item)
{
...
* G__assignmenterror()
**************************************************************************/
int Cint::Internal::G__assignmenterror(char *item)
{
...
* G__changeconsterror()
**************************************************************************/
int Cint::Internal::G__changeconsterror(char *item,char *categ)
{
...
extern "C" int G__genericerror(const char *message)
{
  ...
  if(G__cintv6) {
     if(G__cintv6&G__BC_COMPILEERROR) ::Cint::Bytecode::G__bc_throw_compile_error();
    if(G__cintv6&G__BC_RUNTIMEERROR) ::Cint::Bytecode::G__bc_throw_runtime_error();
  }
...
*
**************************************************************************/
int Cint::Internal::G__friendignore(int *piout,int *pspaceflag,int mparen)
{
#ifdef G__FRIEND
...
*
**************************************************************************/
int Cint::Internal::G__externignore(int *piout,int *pspaceflag,int mparen)
{
  int flag=0;
  int c;
  int store_iscpp;
...
**************************************************************************/
int Cint::Internal::G__handleEOF(char *statement,int mparen,int single_quote,int double_quote)
{
  G__eof=1;
...
* check for double
******************************************************************/
extern "C" int G__check_drange(int p,double low,double up,double d
...
* check for NULL pointer
******************************************************************/
extern "C" int G__check_nonull(int p
                    ,int t,G__value *para
                    ,G__value *result7,char *funcname)
{
  long l;

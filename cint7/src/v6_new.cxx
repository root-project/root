...
G__value Cint::Internal::G__new_operator(char *expression)
{
  ...
  if(typenum) tagnum = G__get_tagnum(typenum);
  else tagnum = -1;
  if(arrayindex) {
    ...
    *arrayindex='\0';
    ...
    if(G__asm_noverflow) {
      ...
      G__value_typenum(G__asm_stack[G__asm_dt]) = ::ROOT::Reflex::Type();
      ld_flag = 1 ;
    }
#endif
    if(initializer) {
  ...
  if(var_type=='u') {
    ...
    if(G__CPPLINK==G__struct.iscpplink[G__get_tagnum(G__tagnum)]) {
      ...
      if(arrayindex && !G__no_exec_compile
         && 'e'!=G__struct.type[G__get_tagnum(G__tagnum)]
          ...
          if(initializer) {
            ...
            *bp=0;
            ...
            if(-1!=buf.tagnum && 0==G__no_exec_compile) {
              if(G__Dict::GetDict().GetScope(buf.tagnum) != G__tagnum) {
                G__fprinterr(G__serr
  ...
  result.tagnum=G__get_tagnum(G__tagnum);
  G__value_typenum(result)=G__typenum;
...
void Cint::Internal::G__delete_operator(char *expression,int isarray)
{
  ...
  if(buf.type=='U' && G__PARANORMAL==buf.obj.reftype.reftype) {
    ...
    G__tagnum = G__Dict::GetDict().GetScope(buf.tagnum);
    ...
    if(0==G__no_exec_compile && -1!=G__struct.virtual_offset[G__get_tagnum(G__tagnum)]&&
       G__tagnum!= 
       G__Dict::GetDict().GetScope(*(long*)(G__store_struct_offset+G__struct.virtual_offset[G__get_tagnum(G__tagnum)]))) {
      int virtualtag=
...
****************************************************************/
int Cint::Internal::G__alloc_newarraylist(long point,int pinc)
{
...
****************************************************************/
int Cint::Internal::G__free_newarraylist(long point)
{

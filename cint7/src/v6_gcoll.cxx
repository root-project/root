...
*
**************************************************************************/
static void G__destroy_garbageobject(G__alloclist *alloc)
{
  ...
  if(-1!=alloc->tagnum) {
    ...
    G__tagnum = G__Dict::GetDict().GetScope(alloc->tagnum);
...
* G__init_garbagecollection()
**************************************************************************/
extern "C" void G__init_garbagecollection()
{
  static int state=1;
  if(state) {
...
* G__garbagecollection()
**************************************************************************/
extern "C" int G__garbagecollection()
{
  struct G__alloclist *alloc;
  struct G__reflist *reflist;
  unsigned int count;
...
* G__add_alloctable()
**************************************************************************/
extern "C" void G__add_alloctable(void *allocedmem,int type,int tagnum)
{
  if(G__p_alloc) {
...
* G__del_alloctable()
**************************************************************************/
extern "C" int G__del_alloctable(void *allocmem)
{
  struct G__alloclist *alloc;
...
* G__add_refcount()
**************************************************************************/
extern "C" int G__add_refcount(void *allocedmem,void **storedmem)
{
  struct G__alloclist *alloc;
  struct G__reflist *reflist;
...
* G__del_refcount()
**************************************************************************/
extern "C" int G__del_refcount(void *allocedmem,void **storedmem)
{
  int flag=1;
  struct G__alloclist *alloc;
  struct G__reflist *reflist;
...
**************************************************************************/
extern "C" int G__disp_garbagecollection(FILE *fout)
{

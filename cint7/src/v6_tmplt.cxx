...
* G__IntList_init()
***********************************************************************/
void Cint::Internal::G__IntList_init(G__IntList *body,long iin,G__IntList *prev)
{
  body->i=iin;
...
* G__IntList_add()
***********************************************************************/
void Cint::Internal::G__IntList_add(G__IntList *body,long iin)
{
...
***********************************************************************/
void Cint::Internal::G__IntList_addunique(G__IntList *body,long iin)
{
  while(body->next) {
...
***********************************************************************/
void Cint::Internal::G__IntList_delete(G__IntList *body)
{
...
* G__IntList_find()
***********************************************************************/
struct G__IntList* Cint::Internal::G__IntList_find(G__IntList *body,long iin)
{
  while(body->next) {
...
* G__IntList_free()
***********************************************************************/
void Cint::Internal::G__IntList_free(G__IntList *body)
{
  if(!body) return;
...
***********************************************************************/
static void G__instantiate_templatememfunclater(G__Definedtemplateclass *deftmpclass
...
*
***********************************************************************/
static int G__settemplatealias(char *tagnamein,char *tagname,int tagnum
                        ,G__Charlist *charlist,G__Templatearg *defpara,int encscope)
{
  ...
  while(charlist->next) {
     if(defpara->default_parameter) {
        ...
        if(0!=strcmp(tagnamein,tagname) && !G__find_typedef(tagname)) 
        {
           ::Reflex::Scope parent_tagnum;
           if (encscope && G__get_envtagnum()) {
              parent_tagnum = G__get_envtagnum();
           } else if (G__struct.parent_tagnum[tagnum]!=-1) {
              parent_tagnum = G__Dict::GetDict().GetScope(G__struct.parent_tagnum[tagnum]);
           }
           G__declare_typedef(tagname, 'u', tagnum,
...
***********************************************************************/
char *Cint::Internal::G__catparam(G__param *libp,int catn,char *connect)
{
  int i;
  char *p;
  int lenconnect;
...
*           ^
**************************************************************************/
struct G__Templatearg *Cint::Internal::G__read_formal_templatearg()
{
...
*                                         ^
**************************************************************************/
int Cint::Internal::G__createtemplatememfunc(char *new_name)
{
  /* int c; */
...
*                                 ^
**************************************************************************/
int Cint::Internal::G__createtemplateclass(char *new_name,G__Templatearg *targ
                          ,int isforwarddecl
                          )
{
  struct G__Definedtemplateclass *deftmpclass;
  ...
  /* store parent_tagnum */
  {
     ::Reflex::Scope env_tagnum;
      ...
      deftmpclass->parent_tagnum = G__get_tagnum(env_tagnum);
      if (!deftmpclass->parent_tagnum) deftmpclass->parent_tagnum = -1;
  }
...
* G__getobjecttagnum
***********************************************************************/
static int G__getobjecttagnum(char *name)
{
  int result = -1;
  char *p;
  char *p1;
...
struct G__Definetemplatefunc *Cint::Internal::G__defined_templatememfunc(char *name)
{
...

  {
    ...
    if(-1!=tagnum) {
      ...
      G__def_tagnum = G__Dict::GetDict().GetScope(tagnum);
      G__tagdefining = G__Dict::GetDict().GetScope(tagnum);
...
***********************************************************************/
struct G__Definetemplatefunc *Cint::Internal::G__defined_templatefunc(char *name)
{
  ...
  if(!env_tagnum.IsTopScope() && G__struct.baseclass[G__get_tagnum(env_tagnum)]->basen!=0)
  ...
  while(deftmplt->next) { /* BUG FIX */
    if(hash==deftmplt->hash && strcmp(atom_name,deftmplt->name)==0) {
      ...
      if(((!scope_tagnum || scope_tagnum.IsTopScope()) &&
          ...
          (-1==deftmplt->parent_tagnum||env_tagnum == declScope))
         || (scope_tagnum == declScope && (!G__tagdefining || G__tagdefining.IsTopScope() || G__tagdefining==declScope))
         || std::find(env_tagnum.UsingDirective_Begin(), env_tagnum.UsingDirective_End(), declScope) 
             != env_tagnum.UsingDirective_End()) {
        return(deftmplt);
      } 
#ifdef __GNUC__
#else
#pragma message (FIXME("This part also took using statements of base classes and enclosing scopes into account, we don't! Fix by using Reflex func lookup."))
        ...
        while(env_parent_tagnum && !env_parent_tagnum.IsTopScope()) {
          ...
          if(env_parent_tagnum == G__Dict::GetDict().GetScope(deftmplt->parent_tagnum)
             && (!G__tagdefining || G__tagdefining==G__Dict::GetDict().GetScope(deftmplt->parent_tagnum))
             ) 
            return(deftmplt);
  ...
  for( deftmplt = &G__definedtemplateclass;
    ...
    if(hash==deftmplt->hash && strcmp(atom_name,deftmplt->name)==0) {
      if (scope != G__NOSCOPEOPR) {
        /* look for ordinary scope resolution */
        if((!scope_tagnum&&(-1==deftmplt->parent_tagnum||
         ...
         return deftmplt;
      } else if(scope_tagnum.IsTopScope()) {
        ::Reflex::Scope env_parent_tagnum = env_tagnum;
        ...
        /* look for enclosing scope resolution */
        while(!candidate && env_parent_tagnum) {
          env_parent_tagnum = env_parent_tagnum.DeclaringScope();
          if(env_parent_tagnum==G__Dict::GetDict().GetScope(deftmplt->parent_tagnum)) {
             candidate = deftmplt;
             break;
...
void Cint::Internal::G__declare_template()
{
 ...
 /* template<...> X() in class context could be a ctor. */
  else if (c == '(' && G__def_struct_member && G__tagdefining &&
...
#ifndef G__OLDIMPLEMENTATION1712
        if(0==strstr(string,"::") && (typenum.DeclaringScope()!=::ROOT::Reflex::Scope::GlobalScope())) {
...
* separate and evaluate template argument list
**************************************************************************/
int Cint::Internal::G__gettemplatearglist(char *paralist,G__Charlist *charlist_in
                          ,G__Templatearg *def_para_in,int *pnpara
                          ,int parent_tagnum, G__Definedtemplateclass *specialization
                          )
{
...
int Cint::Internal::G__instantiate_templateclass(char *tagnamein, int noerror)
{
  ...
  if(typenum) return(G__get_tagnum(typenum));
  ...
  if(env_tagnum && G__struct.baseclass[G__get_tagnum(env_tagnum)]->basen!=0)
    baseclass = G__struct.baseclass[G__get_tagnum(env_tagnum)];
  else
    baseclass = (struct G__inheritance*)NULL;
  ...
  /* scope operator resolution, A::templatename<int> ... */
 {
   ...
   if(patom==atom_name) {
      scope_tagnum = ::Reflex::Scope::GlobalScope();
     G__hash(atom_name,hash,temp)
   }
   else {
     *(patom-2) = 0;
     if(strlen(atom_name)==0||strcmp(atom_name,"::")==0) scope_tagnum = ::Reflex::Scope::GlobalScope();
     else scope_tagnum = G__Dict::GetDict().GetScope(G__defined_tagname(atom_name,0));
     p = atom_name;
     while(*patom) *p++ = *patom++;
     *p = 0;
     G__hash(atom_name,hash,temp)
#define G__OLDIMPLEMENTATION1830 /* side effect t1011.h */
  ...
  while (deftmpclass->next) { /* BUG FIX */
    if ((hash == deftmpclass->hash) &&
      ...
      if (
        ...
        (scope_tagnum == G__Dict::GetDict().GetScope(deftmpclass->parent_tagnum))
      ) {
        break;
      } else if (!scope_tagnum || scope_tagnum.IsTopScope()) {
        ::Reflex::Scope env_parent_tagnum = env_tagnum;
        ...
        while (env_parent_tagnum && !env_parent_tagnum.IsTopScope()) {
          env_parent_tagnum = env_parent_tagnum.DeclaringScope();
          if (env_parent_tagnum == G__Dict::GetDict().GetScope(deftmpclass->parent_tagnum)) {
            goto exit_loop;
          }
          if (G__struct.baseclass[G__get_tagnum(env_parent_tagnum)]) {
            for (temp = 0; temp < G__struct.baseclass[G__get_tagnum(env_parent_tagnum)]->basen; temp++) {
              if (G__struct.baseclass[G__get_tagnum(env_parent_tagnum)]->basetagnum[temp] == deftmpclass->parent_tagnum) {
                goto exit_loop;
              }
            }
          }
 ...
 exit_loop:
  ...
  if((defarg=
      G__gettemplatearglist(arg,&call_para,deftmpclass->def_para,&npara
                          ,deftmpclass->parent_tagnum, deftmpclass->specialization
                            ))) {
#else
  if(G__gettemplatearglist(arg,&call_para,deftmpclass->def_para,&npara
    ...
    else tagnum = Reflex::Dummy::Scope();
...
#pragma message (FIXME("Is this really meant o be a local var hiding the func's version with same name?"))
  ...
  store_tagdefining = G__tagdefining;
  store_def_tagnum = G__def_tagnum;
  G__def_tagnum = G__tagdefining = G__Dict::GetDict().GetScope(deftmpclass->parent_tagnum);
...
#ifdef G__TEMPLATEMEMFUNC
  parent_tagnum = G__Dict::GetDict().GetScope(deftmpclass->parent_tagnum);
  ...
  while(deftmpmemfunc->next) {
    G__replacetemplate(templatename,tagname,&call_para
                       ...
                       ,0
                       ,npara
                       ,G__get_tagnum(parent_tagnum)
                       );
    deftmpmemfunc=deftmpmemfunc->next;
  }
#endif /* G__TEMPLATEFUNC */

  if(intTagnum<G__struct.alltag && G__struct.name[intTagnum] &&
     strcmp(tagname,G__struct.name[intTagnum])!=0) {
    char *p1 = strchr(tagname,'<');
    char *p2 = strchr(G__struct.name[intTagnum],'<');
    if(p1 && p2 && (p1-tagname)==(p2-G__struct.name[intTagnum]) &&
       0==strncmp(tagname,G__struct.name[intTagnum],p1-tagname)) {
#ifdef __GNUC__
#else
#pragma message (FIXME("Yet another ugly hack - we need to add template instances to reflex properly."))
#endif
      // e.g. in t987, template ...,false> gets added to G__struct
  ...
  if(-1!=intTagnum) {
    if(deftmpclass->instantiatedtagnum) {
      G__IntList_addunique(deftmpclass->instantiatedtagnum,intTagnum);
    }
    else {
      deftmpclass->instantiatedtagnum=G__IntList_new(intTagnum,NULL);
    }
  }
...
*
**************************************************************************/
void Cint::Internal::G__replacetemplate(char *templatename,char *tagname,G__Charlist *callpara
                        ...
                        )
{
  ...
  ********************************************************************/
  ...
  if(G__exec_memberfunc) G__memberfunc_tagnum = G__Dict::GetDict().GetScope(parent_tagnum);
  G__var_type = 'p';
  G__breaksignal=0;
...
*
**************************************************************************/
int Cint::Internal::G__templatesubstitute(char *symbol,G__Charlist *callpara
...
**************************************************************************/
void Cint::Internal::G__freetemplatememfunc(G__Definedtemplatememfunc *memfunctmplt)
{
...
* G__freetemplatearg()
**************************************************************************/
void Cint::Internal::G__freetemplatearg(G__Templatearg *def_para)
{
  if(def_para) {
...
***********************************************************************/
int Cint::Internal::G__checkset_charlist(char *type_name,G__Charlist *pcall_para,
                         int narg
                         ,int ftype
                         )
{
...
* matches.
***********************************************************************/
int Cint::Internal::G__matchtemplatefunc(G__Definetemplatefunc *deftmpfunc
                         ...
                         ,int funcmatch)
{
  ...
  int ftype,type;
  int ftagnum,tagnum;
  ::ROOT::Reflex::Type ftypenum,typenum;
  ...
  for(i=0;i<paran;i++) {
    ...
    typenum = G__value_typenum(libp->para[i]); 
    ref = libp->para[i].ref;
    if(
       'u'==libp->para[i].type ||
...
***********************************************************************/
int Cint::Internal::G__templatefunc(G__value *result,char *funcname,G__param *libp
...
***********************************************************************/
int Cint::Internal::G__createtemplatefunc(char *funcname,G__Templatearg *targ
  ...
  **************************************************************/
  {
    ...
    if(p) {
      *p = 0;
      ...
      if (!deftmpfunc->parent_tagnum) deftmpfunc->parent_tagnum = -1;
  ...
  **************************************************************/
  ...
  while(')'!=c) {
    ...
    /* 4. function parameter, fixed typedef or class,struct */
      ...
      if((typenum=G__find_typedef(paraname))) {

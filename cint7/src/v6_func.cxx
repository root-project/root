...
static int G__dispvalue(FILE *fp,G__value *buf)
{
  if(buf) {
    fprintf(fp
            ...
            ,buf->type
            ,buf->tagnum
            ,G__get_type(G__value_typenum(*buf))
            ,buf->ref
            ,buf->isconst
            );
  }
...
*
******************************************************************/
int Cint::Internal::G__explicit_fundamental_typeconv(char *funcname,int hash
                                     ,G__param *libp,G__value *presult3)
{
  ...
  */
  ...
  if(flag) {
    presult3->tagnum = -1;
    G__value_typenum(*presult3) = ::ROOT::Reflex::Type();
#ifdef G__ASM
    if(G__asm_noverflow) {
#ifdef G__ASM_DBG
      ...
      G__asm_inst[G__asm_cp+2]=G__get_typenum(G__value_typenum(*presult3));
  ...
  if(flag && 'u'==libp->para[0].type) {
    ...
    *presult3 = libp->para[0];
    G__fundamental_conversion_operator(xtype,-1 ,::ROOT::Reflex::Type() ,xreftype,xisconst
                                       ,presult3,ttt);
  }
#endif
  return(flag);
...
*
******************************************************************/
void Cint::Internal::G__gen_addstros(int addstros)
{
#ifdef G__ASM
  if(G__asm_noverflow) {
#ifdef G__ASM_DBG
...
static G__value G__pointerReference(char *item,G__param *libp,int *known3)
{
  ...
  ::ROOT::Reflex::Type store_typenum = G__typenum;
 ...
 ******************************************************************/
char* Cint::Internal::G__rename_templatefunc(char *funcname,int isrealloc)
{
  char *ptmplt ;
  ...
  if(ptmplt) {
    ...
    do {
      ...
      if(typenum) {
         strcpy(buf,typenum.Name(::ROOT::Reflex::SCOPED).c_str());
      }
      else {
...
*
******************************************************************/
static G__value G__operatorfunction(G__value *presult,char *item
...
*
******************************************************************/
static G__value G__getfunction_libp(char *item,char *funcname
                             ...
                             ,int memfunc_flag)
{
  ...
  *known3 = 1; /* temporary solution */
  ...
  ::ROOT::Reflex::Type typedf; // = hash_2; // or so it seems from the previous code!
     ...
     ***************************************************************/
     if(G__exec_memberfunc || G__TRYNORMAL!=memfunc_flag) {
        ...
        if(local_tagnum && !local_tagnum.IsTopScope()
           && G__interpret_func(&result3,funcname,libp,hash
           ,G__struct.memfunc[G__get_tagnum(local_tagnum)]
...
#define G__OLDIMPLEMENTATION1159
          ...
          if(!G__no_exec_compile || G__asm_noverflow) {
            if (0==G__const_noerror) 
              G__fprinterr(G__serr, "Error: Can't call %s::%s in current scope"
                           ,G__struct.name[G__get_tagnum(G__tagnum)],item);
            G__genericerror((char*)NULL);
          }
          store_exec_memberfunc=G__exec_memberfunc;
          G__exec_memberfunc=1;
  ...
  if(G__TRYNORMAL==memfunc_flag
    ...
    ::ROOT::Reflex::Type funcnameTypedef = G__find_typedef(funcname);
    ...
    if(funcnameTypedef) {
      if(-1!=G__get_tagnum(funcnameTypedef)) {
        ...
        char ttt[G__ONELINE];
        result3 = libp->para[0];
        if(G__fundamental_conversion_operator(G__get_type(funcnameTypedef),-1 
                                              ,typedf // CHECKME: or maye we should use: cursor
    ...
    while(cursor<G__struct.alltag) {
      if((G__struct.hash[cursor]==classhash)&&
        ...
        G__incsetup_memfunc(G__get_tagnum(G__tagnum));
        for(funcmatch=G__EXACT;funcmatch<=G__USERCONV;funcmatch++) {
        ...
        if(G__CPPLINK==G__struct.iscpplink[G__get_tagnum(G__tagnum)]
          ...
          result3.type='u';
          result3.tagnum=G__get_tagnum(G__tagnum);
          G__value_typenum(result3) = ::ROOT::Reflex::Type();
        ...
        if(0 == *known3) {
          if(-1 != cursor && libp->paran==1 && -1 != libp->para[0].tagnum) {
            long store_struct_offset = G__store_struct_offset;
            ...
            G__pop_tempobject();
            G__tagnum = G__Dict::GetDict().GetScope(libp->para[0].tagnum);
...
******************************************************************/
extern "C" G__value 
G__getfunction(char *item,int *known3,int memfunc_flag)
{
  G__value result3 = G__null;
  ...
  int store_asm_noverflow;
  int store_var_type;
  ::ROOT::Reflex::Scope store_memberfunc_tagnum;
  long store_memberfunc_struct_offset;
  int store_memberfunc_var_type;
  ::ROOT::Reflex::Scope store_def_tagnum;
  ::ROOT::Reflex::Scope store_tagdefining;
  int tempstore;
  char *pfparam;
  struct G__var_array *var;
  int nindex=0;
  ...
  if(3==castflag) {
    ...
    if(G__CALLMEMFUNC==memfunc_flag)
      result3=G__getstructmem(store_var_type ,funcname ,fpara.parameter[1]+hash_2
                              ...
                              ,(struct G__var_array*)NULL,hash_2);
    else 
      result3=G__getstructmem(store_var_type ,funcname ,fpara.parameter[1]+hash_2
                              ,fpara.parameter[0] ,known3 ,&G__global,hash_2);
...
#pragma message(FIXME("G__scopeoperator should take a Type, not an int* tagnum"))
  ...
  for(funcmatch=G__EXACT;funcmatch<=G__USERCONV;funcmatch++) {
    ...
    if(G__exec_memberfunc || G__TRYNORMAL!=memfunc_flag) {
      ...
      if(!G__tagnum.IsTopScope()) G__incsetup_memfunc(G__get_tagnum(G__tagnum));
      if(local_tagnum&& !local_tagnum.IsTopScope() 
         && G__interpret_func(&result3,funcname,&fpara,hash
                           ,G__struct.memfunc[G__get_tagnum(local_tagnum)]
                           ,funcmatch,memfunc_flag)==1 ) {
#ifdef G__DUMPFILE
        if(G__dumpfile!=NULL && 0==G__no_exec_compile) {
...
#define G__OLDIMPLEMENTATION1159
    ...
    if(
        memfunc_flag!=G__CALLSTATICMEMFUNC &&
        G__compiled_func_cxx(&result3,funcname,&fpara,hash)==1 ) {
  ...
  if(G__TRYNORMAL==memfunc_flag
    ...
    if(funcnameTypedef) {
      if(-1!=G__get_tagnum(funcnameTypedef)) {
        ...
        result3 = fpara.para[0];
        if(G__fundamental_conversion_operator(G__get_type(funcnameTypedef),-1 
           , ::ROOT::Reflex::Type() // CHECKME the old code was using 'i' now named 'hash_2' or cursor
                                              , G__get_reftype(funcnameTypedef),0
                                              ,&result3,ttt)) {
          *known3=1;
          if(oprp) *known3 = G__additional_parenthesis(&result3,&fpara);
    ...
    while(cursor<G__struct.alltag) {
      if((G__struct.hash[cursor]==classhash)&&
        ...
        if(0 == *known3) {
          if(-1 != cursor && fpara.paran==1 && -1 != fpara.para[0].tagnum) {
            long store_struct_offset = G__store_struct_offset;
            long store_memberfunc_struct_offset = G__memberfunc_struct_offset;
            ::Reflex::Scope store_memberfunc_tagnum = G__memberfunc_tagnum;
            int store_exec_memberfunc = G__exec_memberfunc;
            ...
            G__inc_cp_asm(-5,0); /* cancel ALLOCTEMP, SETTEMP, POPTEMP */
            G__pop_tempobject();
            G__tagnum = G__Dict::GetDict().GetScope(fpara.para[0].tagnum);
...
#endif /* G__ASM */
    G__value_typenum(*result7) = ::ROOT::Reflex::Type();
    result7->type = 'u';
...
/******************************************************************
* G__compiled_func_cxx() - C++ wrapper around G__compiled_func_c
******************************************************************/
int Cint::Internal::G__compiled_func_cxx(G__value *result7, char *funcname,struct G__param *libp, int hash) {
   return G__compiled_func(result7, funcname, libp, hash, G__no_exec_compile, 
      &G__p_tempbuf->obj, G__intp_sout, G__intp_sin);
}

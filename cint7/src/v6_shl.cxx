...
G__DLLINIT Cint::Internal::G__initpermanentsl;
...
* G__removetagid()
******************************************************************/
static void G__removetagid(char *buf)
{
  int i;
...
* G__getp2ftype()
******************************************************************/
static ::ROOT::Reflex::Type G__getp2ftype(struct G__ifunc_table *ifunc,int ifn)
{
  ...
  strcpy(temp1, G__type2string(ifunc->type[ifn],ifunc->p_tagtable[ifn]
                                 ,G__get_typenum(ifunc->p_typetable[ifn]),ifunc->reftype[ifn]
                                 ,ifunc->isconst[ifn]));
...
#endif
          G__value_typenum(*buf) = G__getp2ftype(ifunc,i);
        }
...
char *Cint::Internal::G__search_next_member(char *text,int state)
{
  ...
  if(isstruct) {
    while(flag) {
      ...
      case 3: /* typedef name */
         {
            static ::ROOT::Reflex::Scope scopetype;
            static ::ROOT::Reflex::Type_Iterator iter;

            ::ROOT::Reflex::Type typedf;
            if (!scopetype) {
               if(scope) {
                  scopetype = G__Dict::GetDict().GetScope(buf.tagnum);
                  iter = scopetype.SubType_Begin();
               } else {
                  scopetype = ::ROOT::Reflex::Scope::ByName("");
               }
            }
      ...
      case 5: /* template name */
         {
            ...
            if (typedf) {
               name = typedf.Name(::ROOT::Reflex::SCOPED);
               break;
            }
            else {
               index_item++;
 ...
 * G__GccNameMangle
 **************************************************************************/
static char* G__GccNameMangle(char* buf,struct G__ifunc_table *ifunc,int ifn)
{
 ...
 **************************************************************************/
static char* G__Vc6NameMangle(char* buf,struct G__ifunc_table *ifunc,int ifn)
{
  char *funcname = ifunc->funcname[ifn];
  int i;
 ...
 * G__FindSymbol
 **************************************************************************/
void* Cint::Internal::G__FindSymbol(struct G__ifunc_table *ifunc,int ifn)
{
#ifdef G__SHAREDLIB
  char *funcname=ifunc->funcname[ifn];
  void *p2f=0;

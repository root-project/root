 ...
 *************************************************************************/
void* Cint::Bytecode::G__push_heapobjectstack(int tagnum,int num,int scopelevel) {
 ...
 * G__push_autoobjectstack
 *************************************************************************/
void Cint::Bytecode::G__push_autoobjectstack(void *p,int tagnum,int num
 ...
 *************************************************************************/
void* Cint::Bytecode::G__allocheapobjectstack(struct G__ifunc_table *ifunc,int ifn,int scopelevel)
{
  ...
  G__value_typenum(dmy) = ifunc->p_typetable[ifn];

...
void Cint::Bytecode::G__functionscope::Init() {
  ...
  G__memberfunc_tagnum = G__Dict::GetDict().GetScope(m_ifunc->tagnum);
  G__memberfunc_struct_offset = (-1==m_ifunc->tagnum)?0:dmy_offset;

  // others
  G__store_struct_offset = (-1==m_ifunc->tagnum)?0:dmy_offset;
  G__tagnum = G__Dict::GetDict().GetScope(m_ifunc->tagnum);
...
void Cint::Bytecode::G__functionscope::Baseclasscopyctor(int c) {
  ...
  if(-1!=m_ifunc->tagnum && 
    ...
    for(int i=0;i<m_ifunc->para_nu[m_iexist];++i) {
      ...
      G__value_typenum(para.para[i])=m_ifunc->para_p_typetable[m_iexist][i];
...
void Cint::Bytecode::G__functionscope::ArgumentPassing() {
  ...
  for(i=0;i<m_ifunc->para_nu[m_iexist];i++) {
    ...
    G__value_typenum(dmy) = m_ifunc->para_p_typetable[m_iexist][i];
...
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_normalfunction(struct G__ifunc_table *ifunc
					,int iexist) {
...
// bytecode compiler entry function
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_function(struct G__ifunc_table *ifunc
					,int iexist) {
...
// bytecode compiler entry function
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_implicitdefaultctor(struct G__ifunc_table *ifunc
					          ,int iexist) {
  m_ifunc = ifunc;
  m_iexist = iexist;
...
// bytecode compiler entry function
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_implicitcopyctor(struct G__ifunc_table *ifunc
					          ,int iexist) {
  m_ifunc = ifunc;
  m_iexist = iexist;
...
// bytecode compiler entry function
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_implicitassign(struct G__ifunc_table *ifunc
					    ,int iexist) {
  m_ifunc = ifunc;
  m_iexist = iexist;
...
// bytecode compiler entry function
//////////////////////////////////////////////////////////////////////////
int Cint::Bytecode::G__functionscope::compile_implicitdtor(struct G__ifunc_table *ifunc
					   ,int iexist) {
  m_ifunc = ifunc;
  m_iexist = iexist;

...
////////////////////////////////////////////////////////////////
static int G__bc_assignment_indexoperator(struct G__var_array *var,int ig15
...
////////////////////////////////////////////////////////////////
int Cint::Internal::G__bc_assignment(struct G__var_array *var,int ig15,int lparan,
				     int lvar_type,G__value *prresult,
				     long struct_offset,long store_struct_offset,
				     G__value *ppara) {
  // error check
  ...
  G__value_typenum(lval) = var->p_typetable[ig15];

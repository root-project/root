...
#ifdef __GNUC__
#else
#pragma message (FIXME("G__rootCcomment is defined here and used in sizeof.c but not in a header file."))
#endif
...
* G__addpragma()
**************************************************************************/
extern "C" void G__addpragma(char *comname, void (*p2f)(char*))
{
...
* G__execpragma()
**************************************************************************/
int Cint::Internal::G__execpragma(char *comname,char *args)
{
  struct G__AppPragma *paddpragma;
  void (*p2f)(char*);
...
* G__freepragma()
**************************************************************************/
void Cint::Internal::G__freepragma(G__AppPragma *paddpragma)
{
  if(paddpragma) {
...
**************************************************************************/
void Cint::Internal::G__force_bytecode_compilation()
{
}
#endif
...
* G__sequrity_handle()
**************************************************************************/
extern "C" int G__security_handle(G__UINT32 category)
{
...
*
**************************************************************************/
G__UINT32 Cint::Internal::G__getsecuritycode(char *string)
{
  G__UINT32 code;
  int level;
  int len;

...
void Cint::Internal::G__bstore(int operatortag,G__value expressionin,G__value *defined)
{
  ...
  if((G__isdouble(expressionin))||(G__isdouble(*defined))) {
    ...
    G__value_typenum(*defined) = ::ROOT::Reflex::Type();
    switch(operatortag) {
    case '\0':
...
******************************************************************/
int Cint::Internal::G__scopeoperator(char *name /* name is modified and this is intentional */
                     ,int *phash
                     ,long *pstruct_offset,int *ptagnum)
{
  ...
  do {
    ...
    *pc='\0';
    ...
    if(-1==(offset=G__ispublicbase(G__get_tagnum(scopetagnum),*ptagnum
                                   ,*pstruct_offset+offset_sum))) {
      ::Reflex::Scope store_tagnum = G__tagnum;
      G__tagnum = G__Dict::GetDict().GetScope(*ptagnum);
      offset = -G__find_virtualoffset(G__get_tagnum(scopetagnum)); /* NEED REFINEMENT */
      G__tagnum = store_tagnum;
    }
#else
    if(-1==(offset=G__ispublicbase(G__get_tagnum(scopetagnum),*ptagnum))) offset=0;
#endif
...
**************************************************************************/
int Cint::Internal::G__label_access_scope(char *statement
                          ,int *piout,int *pspaceflag,int *pmparen)
{
  ...
  if(c==':') {
    ...
    if(1==G__prerun && -1==G__func_now && 
       (
       (G__def_tagnum.IsTopScope()||'n'==G__struct.type[G__get_tagnum(G__def_tagnum)])
        ||memfunc_def_flag
...
int Cint::Internal::G__iosrdstate(G__value *pios)
{
  ...
  G__tagnum = G__Dict::GetDict().GetScope(pios->tagnum);
#ifdef G__ASM
  if(G__asm_noverflow) {
...
int Cint::Internal::G__overloadopr(int operatortag,G__value expressionin,G__value *defined)
{
  ...
  if(defined->type==0) {
    ...
    G__tagnum = G__Dict::GetDict().GetScope(expressionin.tagnum);
   ...
   *****************************************************/
    ...
    if(defined->type=='u') {
      ...
      G__tagnum = G__Dict::GetDict().GetScope(defined->tagnum); 
    ...
    if(ig2==0) {
      ...
      if(0==ig2 && ('A'==operatortag||'O'==operatortag)) {
        ...
        buffer.ref=0;
        buffer.tagnum  = -1;
        G__value_typenum(buffer) = ::ROOT::Reflex::Type();
        switch(operatortag) {
        case 'A':
...
*
**************************************************************************/
int Cint::Internal::G__parenthesisovldobj(G__value *result3,G__value *result
                          ...
                          )
{
  ...
  for(funcmatch=G__EXACT;funcmatch<=G__USERCONV;funcmatch++) {
    if(!G__tagnum.IsTopScope()) G__incsetup_memfunc(G__get_tagnum(G__tagnum));
    if(G__interpret_func(result3,realname,libp,hash
                         ,G__struct.memfunc[G__get_tagnum(G__tagnum)]
...
int Cint::Internal::G__tryindexopr(G__value *result7,G__value *para,int paran,int ig25)
{
  ...
  while(ig25<paran) {
    G__oprovld = 1;
    if('u'==result7->type) {
      G__tagnum = G__Dict::GetDict().GetScope(result7->tagnum);

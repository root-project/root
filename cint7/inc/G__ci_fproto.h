...
G__DECL_API(100, int, G__memfunc_para_setup, (int ifn,int type,int tagnum,int typenum,int reftype,G__value *para_default,char *para_def,char *para_name));
...
G__DECL_API(240, void, G__set_typenum,(G__value* val, char* type));
G__DECL_API(126, void, G__alloc_tempobject, (int tagnum,int typenum));
G__DECL_API(241, void, G__alloc_tempobject_val, (G__value* val));
...
G__DECL_API(240, int, G__check_drange, (int p,double low,double up,double d,G__value *result7,char *funcname));
...
G__DECL_API(250, void, G__exec_alloc_unlock, ());
#ifdef _WIN32
G__DECL_API(251, FILE*, FOpenAndSleep, (const char *filename, const char *mode));
#endif

#define G__NUMBER_OF_API_FUNCTIONS 252

...
G__TypeInfo : public G__ClassInfo {
...
#ifndef __MAKECINT__
  struct ReflexInfo {
     long type; // Moved here to make sure the dummy has non-zero size
 ...
 private:
...
#ifndef __MAKECINT__
  struct DUMMY_CINT7 {
     //long type;  Left out on purpose, make sure dummy has non-zero size
     ReflexInfo* reflexInfo;
     long reftype;
     long isconst;
  };
  struct DUMMY_CINT5 {
  ...
  char dummy_buf_for_same_size_as_cint5[sizeof(DUMMY_CINT5) - sizeof(DUMMY_CINT7)];
#endif
};

...
$(SESSIONVIEWERDS): $(SESSIONVIEWERH) $(SESSIONVIEWERL) $(ROOTCINTTMPDEP) $(call pcmdep,SESSIONVIEWER)
		$(MAKEDIR)
		@echo "Generating dictionary $@..."
		$(ROOTCINTTMP) -f $@ $(call dictModule,SESSIONVIEWER) -c $(SESSIONVIEWERH) $(SESSIONVIEWERL)

$(SESSIONVIEWERMAP): $(SESSIONVIEWERH) $(SESSIONVIEWERL) $(ROOTCINTTMPDEP) $(call pcmdep,SESSIONVIEWER)
		$(MAKEDIR)
		@echo "Generating rootmap $@..."
		$(ROOTCINTTMP) -r $(SESSIONVIEWERDS) $(call dictModule,SESSIONVIEWER) -c $(SESSIONVIEWERH) $(SESSIONVIEWERL)

...
TProofProgressDialog::TProofProgressDialog(TProof *proof, const char *selector, Int_t files, Long64_t first,
                                           Long64_t entries)
   : fDialog(nullptr), fBar(nullptr), fClose(nullptr), fStop(nullptr), fAbort(nullptr), fAsyn(nullptr), fLog(nullptr),
     fRatePlot(nullptr), fMemPlot(nullptr), fKeepToggle(nullptr), fLogQueryToggle(nullptr), fTextQuery(nullptr),
     fEntry(nullptr), fTitleLab(nullptr), fFilesEvents(nullptr), fTimeLab(nullptr), fProcessed(nullptr),
     fEstim(nullptr), fTotal(nullptr), fRate(nullptr), fInit(nullptr), fSelector(nullptr), fSpeedo(nullptr),

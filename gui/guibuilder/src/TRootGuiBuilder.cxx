...
static ToolBarData_t gToolBarData[] = {
   ...
   {"bld_AlignRight.png", "Align selected frames to the right line of lasso (Right  Arrow)", kFALSE, kRightAct,
    nullptr},
   {"", "", kFALSE, -1, nullptr},
...
void TRootGuiBuilder::InitMenu()
{
   ...
   fMenuFile->AddEntry(new TGHotString("&Edit (Ctrl+double-click)"), kGUIBLD_FILE_START, nullptr,
                       fClient->GetPicture("bld_edit.png"));
   fMenuFile->AddEntry(new TGHotString("&Stop (Ctrl+double-click)"), kGUIBLD_FILE_STOP, nullptr,
                       fClient->GetPicture("bld_stop.png"));
   fMenuFile->DisableEntry(kGUIBLD_FILE_STOP);
   fMenuFile->DisableEntry(kGUIBLD_FILE_START);
   fMenuFile->AddSeparator();
   fMenuFile->AddEntry(new TGHotString("&New Project"), kGUIBLD_FILE_NEW, nullptr, fClient->GetPicture("bld_new.png"));
   fMenuFile->AddEntry(new TGHotString("&Open"), kGUIBLD_FILE_OPEN, nullptr, fClient->GetPicture("bld_open.png"));
   fMenuFile->AddEntry(new TGHotString("&Close"), kGUIBLD_FILE_CLOSE, nullptr, fClient->GetPicture("bld_delete.png"));
   fMenuFile->AddEntry(new TGHotString("&Save project as"), kGUIBLD_FILE_SAVE, nullptr,
                       fClient->GetPicture("bld_save.png"));
   fMenuFile->DisableEntry(kGUIBLD_FILE_CLOSE);
   fMenuFile->AddSeparator();
   fMenuFile->AddEntry(new TGHotString("E&xit"), kGUIBLD_FILE_EXIT, nullptr, fClient->GetPicture("bld_exit.png"));
   /*
...
static const char *gSaveMacroTypes[] = {"Macro files", "*.[C|c]*", "All files", "*", nullptr, nullptr};

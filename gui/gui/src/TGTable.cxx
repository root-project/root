...
TGTable::TGTable(const TGWindow *p, Int_t id, TVirtualTableInterface *interface, UInt_t nrows, UInt_t ncolumns)
   : TGCompositeFrame(p, 500, 500, kVerticalFrame), TGWidget(id), fRows(nullptr), fRowHeaders(nullptr),
     fColumnHeaders(nullptr), fReadOnly(kFALSE), fSelectColor(0), fTMode(0), fAllData(kFALSE), fTableFrame(nullptr),
     fCanvas(nullptr), fCellWidth(80), fCellHeight(25), fInterface(interface)
{

...
static const char *gFontSizes[] = {"8",  "9",  "10", "11", "12", "13", "14", "16", "18", "20",   "22",
                                   "24", "26", "28", "30", "32", "34", "36", "48", "72", nullptr};

static const char *gFontStyles[] = {"Normal", "Bold", "Italic", "Bold Italic", nullptr};

static TString gFontStylesReal[4];

static const char *gAlignTypes[] = {"top left",     "top center",  "top right",     "middle left",  "middle center",
                                    "middle right", "bottom left", "bottom center", "bottom right", nullptr};
...
TGFontDialog::TGFontDialog(const TGWindow *p, const TGWindow *t, FontProp_t *fontProp, const TString &sample,
                           char **fontList, Bool_t wait)
   : TGTransientFrame(p, t, 100, 100), fFontNames(nullptr), fFontSizes(nullptr), fFontStyles(nullptr),
     fTextAligns(nullptr), fColorSelect(nullptr), fFontProp(nullptr), fItalic(0), fBold(0), fSize(0), fTextAlign(0),
     fTextColor(0), fNumberOfFonts(0)
{
   TGLabel *lbl;

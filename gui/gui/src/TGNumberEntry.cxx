...
void TGNumberEntryField::SetTime(Int_t hour, Int_t min, Int_t sec, Int_t centisec, Bool_t emit)
{
   switch (fNumStyle) {
   case kNESHourMinSec:
   ...
   case kNESMinSec:
      ...
      break;
   case kNESMinSecCent:
      SetIntNumber(6000 *TMath::Abs(min) + 100 * TMath::Abs(sec) + TMath::Abs(centisec), emit);
      break;
   case kNESHourMin:

...
TGListTreeItem::TGListTreeItem(TGClient *client) :
   fClient(client),
   fParent    (nullptr), fFirstchild(nullptr), fLastchild (nullptr), fPrevsibling(nullptr),
   fNextsibling(nullptr),fOpen (kFALSE), fDNDState  (0),
...
void TGListTree::AddItem(TGListTreeItem *parent, TGListTreeItem *item)
{
   ...
   if ((parent == nullptr) || (parent && parent->IsOpen()))
      ClearViewPort();
}

...
TGScrollBar::TGScrollBar(const TGWindow *p, UInt_t w, UInt_t h, UInt_t options, Pixel_t back)
   : TGFrame(p, w, h, options | kOwnBackground, back), fX0(0), fY0(0), fXp(0), fYp(0), fDragging(kFALSE),
     fGrabPointer(kTRUE), fRange(0), fPsize(0), fPos(0), fSliderSize(0), fSliderRange(0), fSmallInc(1), fHead(nullptr),
     fTail(nullptr), fSlider(nullptr), fHeadPic(nullptr), fTailPic(nullptr), fRepeat(nullptr), fSubw()
{
   fAccelerated = kFALSE;
    ...
    TGScrollBar(p, w, h, options, back)
{
   ...
   fTail   = new TGScrollBarElement(this, fTailPic, fgScrollBarWidth, fgScrollBarWidth,
                                    kRaisedFrame);
   fSlider = new TGScrollBarElement(this, nullptr, fgScrollBarWidth, 50, kRaisedFrame);

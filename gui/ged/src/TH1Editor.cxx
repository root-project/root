...
TH1Editor::TH1Editor(const TGWindow *p, Int_t width, Int_t height, UInt_t options, Pixel_t back)
   : TGedFrame(p, width, height, options | kVerticalFrame, back), fHist(nullptr), fSameOpt(kFALSE), fBin(nullptr),
     fBinHist(nullptr)
{
...
{
   if (obj == nullptr || !obj->InheritsFrom(TH1::Class()) || ((TH1 *)obj)->GetDimension() != 1 ||

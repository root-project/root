...
void TRaylibPadPainter::PaintTextHelper(int px, int py, const char *text)
{
   ...
   Vector2 textSize = MeasureTextEx(font, text, (float)pixelsize, 0.0f);
   ...
   switch (txalv) {
      ...
      case 3: drawY += textSize.y; break;                 // top
   }
   ...
   if (angle == 0.0f) {
      ...
      DrawTextEx(font, text, (Vector2){drawX, drawY}, (float) pixelsize, 2, col);
   } else {

...
TRefTable::TRefTable()
   : fNumPIDs(0), fAllocSize(nullptr), fN(nullptr), fParentIDs(nullptr), fParentID(-1), fDefaultSize(10), fUID(0),
     fUIDContext(nullptr), fSize(0), fParents(nullptr), fOwner(nullptr)
{
   fgRefTable   = this;
}
...
TRefTable::TRefTable(TObject *owner, Int_t size)
   : fNumPIDs(0), fAllocSize(nullptr), fN(nullptr), fParentIDs(nullptr), fParentID(-1),
     fDefaultSize(size < 10 ? 10 : size), fUID(0), fUIDContext(nullptr), fSize(0), fParents(new TObjArray(1)),
     fOwner(owner)
{
   fgRefTable   = this;
}

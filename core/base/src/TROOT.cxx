...
{
   // The initialization of this static is thread-safe (guaranteed by the C++11
   // standard for function-local statics), so the in-place lambda initializes
   // the resource directories exactly once.
   static const ResourceDirs dirs = []() {

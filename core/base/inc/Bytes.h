...
inline void tobuf(char *&buf, Short_t x, Bool_t buffBigEndian = kTRUE)  { tobuf(buf, (UShort_t) x, buffBigEndian); }
inline void tobuf(char *&buf, Int_t x, Bool_t buffBigEndian = kTRUE)    { tobuf(buf, (UInt_t) x, buffBigEndian); }
inline void tobuf(char *&buf, Long64_t x, Bool_t buffBigEndian = kTRUE) { tobuf(buf, (ULong64_t) x, buffBigEndian); }

inline void frombuf(char *&buf, Char_t *x)   { frombuf(buf, (UChar_t *) x); }
inline void frombuf(char *&buf, Short_t *x, Bool_t buffBigEndian = kTRUE)  { frombuf(buf, (UShort_t *) x, buffBigEndian); }
inline void frombuf(char *&buf, Int_t *x, Bool_t buffBigEndian = kTRUE)    { frombuf(buf, (UInt_t *) x, buffBigEndian); }
inline void frombuf(char *&buf, Long_t *x, Bool_t buffBigEndian = kTRUE)   { frombuf(buf, (ULong_t *) x, buffBigEndian); }
inline void frombuf(char *&buf, Long64_t *x, Bool_t buffBigEndian = kTRUE) { frombuf(buf, (ULong64_t *) x, buffBigEndian); }

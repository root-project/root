...
TClingBaseClassInfo::TClingBaseClassInfo(cling::Interpreter *interp, TClingClassInfo *ci)
   : fInterp(interp), fClassInfo(nullptr), fFirstTime(true), fDescend(false), fDecl(nullptr), fIter(nullptr),
     fBaseInfo(nullptr), fOffset(0L), fClassInfoOwnership(true)
{
...
TClingBaseClassInfo::TClingBaseClassInfo(cling::Interpreter *interp, TClingClassInfo *derived, TClingClassInfo *base)
   : fInterp(interp), fClassInfo(nullptr), fFirstTime(true), fDescend(false), fDecl(nullptr), fIter(nullptr),
     fBaseInfo(nullptr), fOffset(0L), fClassInfoOwnership(false)
{
...
TClingBaseClassInfo::TClingBaseClassInfo(const TClingBaseClassInfo &rhs)
   : fInterp(rhs.fInterp), fClassInfo(nullptr), fFirstTime(rhs.fFirstTime), fDescend(rhs.fDescend), fDecl(rhs.fDecl),
     fIter(rhs.fIter), fBaseInfo(nullptr), fIterStack(rhs.fIterStack), fOffset(rhs.fOffset), fClassInfoOwnership(true)
{
                                                ...
                                                void* address, bool isDerivedObject) const
{
   ...
   if (fInterp->isInSyntaxOnlyMode()) return nullptr;

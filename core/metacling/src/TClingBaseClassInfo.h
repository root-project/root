...
// TClingBaseClassInfo                                                  //
//                                                                      //
// Emulation of the historical CINT BaseClassInfo class.                //
//                                                                      //
...
private:
   ...
   bool                          fFirstTime; // Flag to provide historical Next() CINT semantics for iterator advancement (not first time)
   ...
   std::vector<std::pair<std::pair<const clang::Decl*, clang::CXXRecordDecl::base_class_const_iterator>, ptrdiff_t> > fIterStack; // Iterator stack.

...
ROOT::TMetaUtils::EIOCtorCategory TClingClassInfo::HasDefaultConstructor() const
{
   ...
   //
   if (!IsLoaded()) {
      return ROOT::TMetaUtils::EIOCtorCategory::kAbsent;
   }
   ...
   return CheckConstructor(CRD,ioctortype,*fInterp);
}

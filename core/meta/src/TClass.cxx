...
// Mutex to protect Cling and META operations
                             ...
                             const void *addr, Bool_t /* isTransient */)
{
   ...
   //  - the member G__virtualinfo inserted by the historical CINT RTTI system
                  ...
                  Bool_t silent)
{
   ...
   if (fState!=kForwardDeclared && !fClassInfo && !TClassEdit::IsArtificial(fName)) {
      ...
      if (fState == kHasTClassInit) {
         ...
         // even though we do not seem to have a historical CINT dictionary for
         // the class, we will will try to load it anyway UNLESS
         // the class is an STL container (or string).
         // This is because we do not expect the historical CINT dictionary
...
TClass *TClass::GetClass(const char *name, Bool_t load, Bool_t silent, size_t hint_pair_offset, size_t hint_pair_size)
{
   ...
   //last attempt. Look in Cling list of all (compiled+interpreted) classes
   if (gDebug>0){
...
TClass::ObjectPtr TClass::NewObject(ENewType defConstructor, Bool_t quiet) const
{
   ...
   if (fNew) {
      ...
      // by rootcling, so there should be a default
      ...
      // not generated by rootcling.  Let's try to
...
TClass::ObjectPtr TClass::NewObjectArray(Long_t nElements, void *arena, ENewType defConstructor) const
{
   ...
   if (fNewArray) {
      ...
      // so the dictionary was not generated by rootcling (it was made either
      // by historical CINT or by some external mechanism).  Let's try to create the
...
void TClass::Destructor(void *obj, Bool_t dtorOnly)
{
   ...
   if (dtorOnly && fDestructor) {
      ...
      // not generated by rootcling (it could have been
      // created by historical CINT or by some external mechanism).
...
////////////////////////////////////////////////////////////////////////////////
/// Do the initialization that can only be done after the ROOT dictionary has

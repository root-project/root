...
ROOTCLINGEXEEXTRAO := $(COREO) $(COREDO) $(IOO) $(IODO) $(THREADO) $(THREADDO)
$(ROOTCLINGEXE): $(ROOTCLINGO) $(ROOTCLINGUTILO) $(ROOTCLINGTCLINGO) \
	   $(CLINGMETAUTILSO) $(SNPRINTFO) $(CLINGO) $(ROOTCLINGEXEEXTRAO)  $(METAOLLVM) $(PCREDEP) $(CORELIBDEP)
	$(LD) $(LDFLAGS) -o $@ $(ROOTCLINGO) $(ROOTCLINGUTILO) $(ROOTCLINGTCLINGO) $(CLINGMETAUTILSO) \
	   $(SNPRINTFO)  $(CLINGO) $(ROOTCLINGEXEEXTRAO) $(METAOLLVM) $(CLINGLIBEXTRA) $(RPATH) $(CILIBS) $(CORELIBEXTRA) $(PCRELDFLAGS) $(PCRELIB) $(CRYPTLIBS)

...
TTabCom::TTabCom()
   : fpClasses(nullptr), fPrevInterpMarker(0), fpDirectives(nullptr), fpEnvVars(nullptr), fpFiles(nullptr),
     fpGlobals(nullptr), fpPragmas(nullptr), fpSysIncFiles(nullptr), fpUsers(nullptr), fBuf(nullptr), fpLoc(nullptr),
     fVarIsPointer(kFALSE), fLastIter(0)
{
   InitPatterns();
}

...
void senewcint::Begin(TTree *tree)
{
...
Bool_t senewcint::Process(Int_t entry)
{
   // Processing function.
...
Bool_t senewcint::ProcessCut(Int_t entry)
{
   // Selection function.
   // Entry is the entry number in the current tree.
   // Read only the necessary branches to select entries.
...
void senewcint::ProcessFill(Int_t entry)
{

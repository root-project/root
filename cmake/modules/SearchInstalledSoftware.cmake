...
if(http AND NOT builtin_civetweb)
  ...
  if(fail-on-missing)
    ...
    if(civetweb_FOUND AND civetweb_VERSION VERSION_LESS 1.17)
      message(STATUS "found civetweb does not include some CVE security fixes. Switching on builtin_civetweb option")
      set(builtin_civetweb ON CACHE BOOL "Enabled because civetweb version too old" FORCE)
    endif()
  else()

...
macro(find_package)
  if(NOT "${ARGV0}" IN_LIST ROOT_BUILTIN_TARGETS)
    _find_package(${ARGV})
  endif()
endmacro()
...
#---Check for Zlib ------------------------------------------------------------------
if(builtin_zlib)
  list(APPEND ROOT_BUILTIN_TARGETS ZLIB)
...
if(builtin_pcre)
  list(APPEND ROOT_BUILTIN_TARGETS PCRE)
  add_subdirectory(builtins/pcre)
endif()

#---Check for LZMA-------------------------------------------------------------------
if(builtin_lzma)
  list(APPEND ROOT_BUILTIN_TARGETS LZMA)
...
if(builtin_xxhash)
  list(APPEND ROOT_BUILTIN_TARGETS xxHash)
...
if(builtin_zstd)
  list(APPEND ROOT_BUILTIN_TARGETS zstd)
  list(APPEND ROOT_BUILTIN_TARGETS ZSTD)
...
#---Check for LZ4--------------------------------------------------------------------
if(builtin_lz4)
  list(APPEND ROOT_BUILTIN_TARGETS LZ4)
...
if (roofit_multiprocess)
  ...
  if(builtin_zeromq)
    ...
    if(NO_CONNECTION)
      ...
      list(APPEND ROOT_BUILTIN_TARGETS ZeroMQ)
  ...
  if(builtin_cppzmq)
    ...
    if(NO_CONNECTION)
      ...
      list(APPEND ROOT_BUILTIN_TARGETS cppzmq)

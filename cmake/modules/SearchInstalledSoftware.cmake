...
if(builtin_fftw3 AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(builtin_fftw3 OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
...
if(fitsio OR builtin_cfitsio)
  if(builtin_cfitsio AND NO_CONNECTION)
    if(fail-on-missing)
      ...
      set(builtin_cfitsio OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
    endif()
  endif()
  if(builtin_cfitsio)
...
if(builtin_xrootd AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(builtin_xrootd OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
if(builtin_xrootd)
...
if(vc AND NOT Vc_FOUND AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(vc OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
...
if(builtin_veccore AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(builtin_veccore OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
...
if(builtin_vdt AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(builtin_vdt OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
...
if(testing AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(testing OFF CACHE BOOL "Disabled because there no internet connection" FORCE)
  endif()
endif()
...
if(webgui AND NOT builtin_openui5 AND NO_CONNECTION)
  if(fail-on-missing)
    ...
    set(builtin_openui5 ON CACHE BOOL "Enabled because there no internet connection" FORCE)
  endif()
endif()

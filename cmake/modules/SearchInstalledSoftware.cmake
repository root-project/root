...
if(dcache)
  ...
  if(NOT DCAP_FOUND)
    message(SEND_ERROR "dCap library not found and is required (dcache option enabled)."
      " Set variable DCAP_DIR to point to your dCache installation. Or disable option 'dcap'.")
    endif()
  endif()
endif()
...
if (daos)
  find_package(DAOS)
  if(NOT DAOS_FOUND)
    message(SEND_ERROR "libdaos not found and it is required (daos option enabled). Install it on the system, or disable option 'daos'")
  endif()
endif()
  ...
  if(tmva-gpu)
    ...
    if (tmva-cudnn)
      ...
      if (CUDNN_FOUND)
        ...
        message(SEND_ERROR "cudnn not found and it is required (tmva-cudnn option enabled). Install it on the system, or disable option 'tmva-cudnn'")
      endif()
    endif()
  endif()
  if(tmva-pymva)

...
if(builtin_freetype)
  ...
  set(FREETYPE_LIBRARY ${PROJECT_BINARY_DIR}/FREETYPE-prefix/src/FREETYPE/objs/.libs/${CMAKE_STATIC_LIBRARY_PREFIX}freetype${CMAKE_STATIC_LIBRARY_SUFFIX})
  if(WIN32)
    if(winrtdebug)
    ...
    ExternalProject_Add(
      FREETYPE
      URL ${PROJECT_SOURCE_DIR}/graf2d/freetype/src/freetype-${freetype_version}.tar.gz
  ...
  set(FREETYPE_INCLUDE_DIR ${PROJECT_BINARY_DIR}/FREETYPE-prefix/src/FREETYPE/include)
...
if(builtin_lzma)
  ...
  if(WIN32)
    set(LIBLZMA_LIBRARIES ${PROJECT_BINARY_DIR}/LZMA/src/LZMA/lib/liblzma.lib)
    if("${CMAKE_GENERATOR_PLATFORM}" MATCHES "x64")
      set(LZMA_URL ${PROJECT_SOURCE_DIR}/core/lzma/src/xz-${lzma_version}-win64.tar.gz)
      set(LZMA_URL_HASH SHA256=76ba7cdff547141f6d6810c8600a9d782feca343debde378fc8f6a307cbfd1d2)
    else()
      set(LZMA_URL ${PROJECT_SOURCE_DIR}/core/lzma/src/xz-${lzma_version}-win32.tar.gz)
    ...
    set(LIBLZMA_INCLUDE_DIR ${PROJECT_BINARY_DIR}/LZMA/src/LZMA/include)
  else()
    ...
    set(LIBLZMA_LIBRARIES ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}lzma${CMAKE_STATIC_LIBRARY_SUFFIX})
    set(LIBLZMA_CFLAGS "${LIBLZMA_CFLAGS} -O3")
    ExternalProject_Add(
      LZMA
      URL ${PROJECT_SOURCE_DIR}/core/lzma/src/xz-${lzma_version}.tar.gz
    ...
    set(LIBLZMA_INCLUDE_DIR ${PROJECT_BINARY_DIR}/include)
  endif()
endif()
...
if(builtin_afterimage)
  set(AFTERIMAGE_LIBRARIES ${PROJECT_BINARY_DIR}/lib/libAfterImage${CMAKE_STATIC_LIBRARY_SUFFIX})
  if(WIN32)
    if(winrtdebug)
      set(astepbld "Debug")
    else()
    ...
    ExternalProject_Add(
      AFTERIMAGE
      DOWNLOAD_COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_SOURCE_DIR}/graf2d/asimage/src/libAfterImage AFTERIMAGE
      INSTALL_DIR ${PROJECT_BINARY_DIR}
    ...
    set(AFTERIMAGE_INCLUDE_DIR ${PROJECT_BINARY_DIR}/AFTERIMAGE-prefix/src/AFTERIMAGE)
  else()
    ...
    set(AFTERIMAGE_INCLUDE_DIR ${PROJECT_BINARY_DIR}/include/libAfterImage)
  endif()
  if(builtin_freetype)
...
if(mathmore OR builtin_gsl)
  ...
  if(NOT builtin_gsl)
    ...
    foreach(l gsl gslcblas)
      list(APPEND GSL_LIBRARIES ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}${l}${CMAKE_STATIC_LIBRARY_SUFFIX})
    endforeach()
    set(GSL_CBLAS_LIBRARY ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}gslcblas${CMAKE_STATIC_LIBRARY_SUFFIX})
    if(CMAKE_OSX_SYSROOT)
    ...
    set(GSL_INCLUDE_DIR ${PROJECT_BINARY_DIR}/GSL-prefix/src/GSL-build)
    set(GSL_FOUND ON)
...
if(builtin_fftw3)
  ...
  set(FFTW_LIBRARIES ${PROJECT_BINARY_DIR}/lib/libfftw3.a)
  ExternalProject_Add(
    FFTW3
  ...
  set(FFTW_INCLUDE_DIR ${PROJECT_BINARY_DIR}/include)
...
if(fitsio OR builtin_cfitsio)
  ...
  if(builtin_cfitsio)
    ...
    set(CFITSIO_LIBRARIES ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}cfitsio${CMAKE_STATIC_LIBRARY_SUFFIX})
    if(WIN32)
      if(winrtdebug)
      ...
      set(CFITSIO_INCLUDE_DIR ${PROJECT_BINARY_DIR}/CFITSIO-prefix/src/CFITSIO)
    else()
      ExternalProject_Add(
        CFITSIO
        # ftp://heasarc.gsfc.nasa.gov/software/fitsio/c/cfitsio${cfitsio_version_no_dots}.tar.gz
      ...
      set(CFITSIO_INCLUDE_DIR ${PROJECT_BINARY_DIR}/include)
    endif()
...
if(builtin_xrootd)
  ...
  set(XROOTD_DESTDIR ${PROJECT_BINARY_DIR})
...
if(builtin_ftgl)
  ...
  foreach(var FTGL_LIBRARIES FTGL_LIBRARY FTGL_LIBRARY_DEBUG FTGL_LIBRARY_RELEASE)
    ...
    unset(${var} CACHE)
  endforeach()
  set(FTGL_INCLUDE_DIR ${PROJECT_SOURCE_DIR}/graf3d/ftgl/inc)
  set(FTGL_INCLUDE_DIRS ${PROJECT_SOURCE_DIR}/graf3d/ftgl/inc)
...
if(builtin_tbb)
  ...
  if(${ROOT_ARCHITECTURE} MATCHES "macosxarm64")
    set(tbb_command patch -p1 -i ${PROJECT_SOURCE_DIR}/builtins/tbb/patches/apple-m1.patch)
  else()
    set(tbb_command "")
  endif()
  if(MSVC)
    ...
    set(TBB_LIBRARIES ${PROJECT_BINARY_DIR}/lib/tbb.lib)
    ExternalProject_Add(
      TBB
      ...
      INSTALL_COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbb.dll ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc.dll ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc_proxy.dll ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbb.lib ${PROJECT_BINARY_DIR}/lib/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc.lib ${PROJECT_BINARY_DIR}/lib/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc_proxy.lib ${PROJECT_BINARY_DIR}/lib/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbb.pdb ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc.pdb ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -E copy_if_different build/${vsdir}/${tbb_arch}/Release/tbbmalloc_proxy.pdb ${PROJECT_BINARY_DIR}/bin/
              COMMAND ${CMAKE_COMMAND} -Dinstall_dir=<INSTALL_DIR> -Dsource_dir=<SOURCE_DIR>
                                       -P ${PROJECT_SOURCE_DIR}/cmake/scripts/InstallTBB.cmake
      BUILD_IN_SOURCE 1
      LOG_DOWNLOAD 1 LOG_CONFIGURE 1 LOG_BUILD 1 LOG_INSTALL 1
      BUILD_BYPRODUCTS ${TBB_LIBRARIES}
      TIMEOUT 600
    )
    install(DIRECTORY ${PROJECT_BINARY_DIR}/bin/ DESTINATION ${CMAKE_INSTALL_BINDIR} COMPONENT libraries FILES_MATCHING PATTERN "tbb*")
    install(DIRECTORY ${PROJECT_BINARY_DIR}/lib/ DESTINATION ${CMAKE_INSTALL_LIBDIR} COMPONENT libraries FILES_MATCHING PATTERN "tbb*")
  else()
    ...
    set(TBB_LIBRARIES ${PROJECT_BINARY_DIR}/lib/libtbb${CMAKE_SHARED_LIBRARY_SUFFIX})
    ExternalProject_Add(
      TBB
      URL ${lcgpackages}/tbb-${tbb_builtin_version}.tar.gz
      URL_HASH SHA256=${tbb_sha256}
    ...
    install(DIRECTORY ${PROJECT_BINARY_DIR}/lib/ DESTINATION ${CMAKE_INSTALL_LIBDIR} COMPONENT libraries FILES_MATCHING PATTERN "libtbb*")
  endif()
  ExternalProject_Add_Step(
     TBB tbb2externals
     COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_BINARY_DIR}/include/tbb ${PROJECT_BINARY_DIR}/ginclude/tbb
     DEPENDEES install
  )
  set(TBB_INCLUDE_DIRS ${PROJECT_BINARY_DIR}/ginclude)
  set(TBB_CXXFLAGS "-DTBB_SUPPRESS_DEPRECATED_MESSAGES=1")
  set(TBB_TARGET TBB)
endif()
...
if(vc AND NOT Vc_FOUND)
  ...
  set(Vc_DESTDIR "${PROJECT_BINARY_DIR}/externals")
  ...
  if(UNIX)
    set(VC_PATCH_COMMAND patch -p1 < ${PROJECT_SOURCE_DIR}/cmake/patches/vc-deprecated-and-bit-scan-forward.patch)
  endif()
  ...
  if(NOT EXISTS ${PROJECT_BINARY_DIR}/include/Vc)
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -E create_symlink
      ${Vc_INCLUDE_DIR}/Vc ${PROJECT_BINARY_DIR}/include/Vc)
  endif()
  # end of workaround
...
if(builtin_veccore)
  ...
  set(VecCore_DESTDIR "${PROJECT_BINARY_DIR}/externals")
  ...
  # they are in the build directory. This is necessary until we decide how to
  # treat externals with headers used by ROOT
  if(NOT EXISTS ${PROJECT_BINARY_DIR}/include/VecCore)
    if (NOT EXISTS ${PROJECT_BINARY_DIR}/include)
      execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory ${PROJECT_BINARY_DIR}/include)
    endif()
    execute_process(COMMAND ${CMAKE_COMMAND} -E create_symlink
      ${VecCore_ROOTDIR}/include/VecCore ${PROJECT_BINARY_DIR}/include/VecCore)
  endif()
  # end of workaround
...
if(vdt OR builtin_vdt)
  ...
  if(builtin_vdt)
    ...
    set(VDT_FOUND True)
    set(VDT_LIBRARIES ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}vdt${CMAKE_SHARED_LIBRARY_SUFFIX})
    ExternalProject_Add(
      VDT
    ...
    ExternalProject_Add_Step(
       VDT copy2externals
       COMMAND ${CMAKE_COMMAND} -E copy_directory ${PROJECT_BINARY_DIR}/include/vdt ${PROJECT_BINARY_DIR}/ginclude/vdt
       DEPENDEES install
    )
    set(VDT_INCLUDE_DIR ${PROJECT_BINARY_DIR}/ginclude)
    set(VDT_INCLUDE_DIRS ${PROJECT_BINARY_DIR}/ginclude)
    install(FILES ${PROJECT_BINARY_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}vdt${CMAKE_SHARED_LIBRARY_SUFFIX}
            DESTINATION ${CMAKE_INSTALL_LIBDIR} COMPONENT libraries)
    install(DIRECTORY ${PROJECT_BINARY_DIR}/include/vdt
...
if(webgui)
  if(NOT "$ENV{OPENUI5DIR}" STREQUAL "" AND EXISTS "$ENV{OPENUI5DIR}/resources/sap-ui-core-nojQuery.js")
     ...
     file(MAKE_DIRECTORY ${PROJECT_BINARY_DIR}/ui5)
     execute_process(COMMAND ${CMAKE_COMMAND} -E create_symlink
        $ENV{OPENUI5DIR} ${PROJECT_BINARY_DIR}/ui5/distribution)
  else()
    if(builtin_openui5)
      ExternalProject_Add(
        OPENUI5
        URL ${PROJECT_SOURCE_DIR}/builtins/openui5/openui5.tar.gz
        URL_HASH SHA256=f40910aae22afb80f0d1a0ff07577ff8073896dd4415e4c64a125b7c29b89b0e
        CONFIGURE_COMMAND ""
        BUILD_COMMAND ""
        INSTALL_COMMAND ""
        SOURCE_DIR ${PROJECT_BINARY_DIR}/ui5/distribution
        TIMEOUT 600
      )
    else()
      ExternalProject_Add(
    ...
    install(DIRECTORY ${PROJECT_BINARY_DIR}/ui5/distribution/ DESTINATION ${CMAKE_INSTALL_OPENUI5DIR}/distribution/ COMPONENT libraries FILES_MATCHING PATTERN "*")
  endif()
endif()

...
if(NOT builtin_nlohmannjson)
  ...
  # If we found an external nlohmann_json, check for json_fwd.hpp header.
  if(nlohmann_json_FOUND)
    ...
    if(NOT _nlohmann_json_fwd_hpp)
      if((nlohmann_json_VERSION VERSION_LESS 3.9.0) OR (nlohmann_json_VERSION VERSION_GREATER 3.10.5))
        message(FATAL_ERROR "Found nlohmann/json.hpp version ${nlohmann_json_VERSION} cannot be used without json_fwd.hpp")
      else()
        message(STATUS "nlohmann/json.hpp will be used without json_fwd.hpp")
      endif()
    endif()

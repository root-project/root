...
if(tmva)
  if(tmva-cpu AND imt)
    ...
    if(NOT DEFINED BLA_VENDOR)
      ...
      if(BLAS_FOUND)
        message(STATUS "Using FlexiBLAS for optional parts of TMVA")
        target_link_libraries(Blas INTERFACE BLAS::BLAS)
        target_compile_definitions(Blas INTERFACE ROOT_BLAS_FLEXIBLAS)
      endif()
      unset(BLA_VENDOR)
    endif()
    if(NOT BLAS_FOUND)
    ...
    if(NOT BLAS_FOUND)
      ...
      target_compile_definitions(Blas INTERFACE ROOT_BLAS_GSL)
    endif()

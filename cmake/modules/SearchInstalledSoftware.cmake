...
macro(ROOT_FIND_REQUIRED_DEP PACKAGE_NAME BUILTIN_CONFIG_OPTION)
  if(NOT ${BUILTIN_CONFIG_OPTION})
    ...
    ROOT_CHECK_CONNECTION("${BUILTIN_CONFIG_OPTION}=ON")
    if(NO_CONNECTION)
      message(SEND_ERROR "No internet connection, check it or set -D${BUILTIN_CONFIG_OPTION}=OFF")
      list(APPEND MISSING_PACKAGES '${PACKAGE_NAME}')
      list(APPEND HOTFIX_BUILD_FLAGS -D${BUILTIN_CONFIG_OPTION}=OFF)
    endif()
  endif()
endmacro()
...
if(builtin_pcre)
  ROOT_FIND_REQUIRED_DEP(PCRE2 builtin_pcre)
else()
...
if(mathmore OR (tmva-cpu AND use_gsl_cblas))
  ...
  if(NOT builtin_gsl AND NOT GSL_FOUND)
...
#---Check for FFTW3-------------------------------------------------------------------
if(fftw3 AND builtin_fftw3)
  add_subdirectory(builtins/fftw3)
endif()

#---Check for fitsio-------------------------------------------------------------------
if(fitsio AND builtin_cfitsio)
...
if(imt AND builtin_tbb)
  add_subdirectory(builtins/tbb)
endif()

#---Check for Vdt--------------------------------------------------------------------
if(vdt AND builtin_vdt)
  if(builtin_vdt)

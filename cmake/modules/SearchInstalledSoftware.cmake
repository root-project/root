...
if(builtin_zlib)
  ...
  if((CMAKE_SYSTEM_PROCESSOR MATCHES "amd64|x86_64|AMD64|x86|X86") AND (CMAKE_SYSTEM_NAME MATCHES "Linux"))
    set(simdzlib ON)
    set(ZLIB_DEFINITIONS -DZLIB_ENABLE_SIMD)
    set(ZLIB_ASMS core/zip/contrib/amd64/crc32-pclmul_asm.S)
    ...
    foreach(src ${ZLIB_ASMS})
      ...
      SET(LOBJ ${CMAKE_CURRENT_BINARY_DIR}/${FILE_BASE}.lo)
      SET(MY_ASM_OBJS ${MY_ASM_OBJS} ${OBJ} ${LOBJ})
    endforeach()
  else()
    set(simdzlib OFF)
  endif()

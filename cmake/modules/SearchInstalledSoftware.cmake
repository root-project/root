...
if(http AND NOT builtin_civetweb)
  ...
  if(civetweb_FOUND)
    ...
    if (CIVETWEB_FEATURE_API)
      ...
      message(STATUS "civetweb websocket ; xdomsocket support: ${CIVETWEB_HAS_WEBSOCKET} ; ${CIVETWEB_HAS_X_DOM_SOCKET}")
    else()
      message(FATAL_ERROR "Could not check for civetweb features: ${CIVETWEB_FEATURE_API_LOG}")
    endif()

    if(NOT "${CIVETWEB_HAS_WEBSOCKET}" STREQUAL "1" OR NOT "${CIVETWEB_HAS_X_DOM_SOCKET}" STREQUAL "1")
      ...
      foreach(var CIVETWEB_LIBRARIES CIVETWEB_LIBRARY CIVETWEB_LIBRARY_DEBUG CIVETWEB_LIBRARY_RELEASE CIVETWEB_FOUND CIVETWEB_VERSION CIVETWEB_INCLUDE_DIR CIVETWEB_LIBRARY CIVETWEB_LIBRARIES)
        ...
        unset(${var} CACHE)
      endforeach()
      message(WARNING "Force-enabling builtin_civetweb since found system-wide version does not include websocket or xdomsocket components (-DCIVETWEB_ENABLE_WEBSOCKETS=ON -DCIVETWEB_ENABLE_X_DOM_SOCKET=ON)")

...
if (daos OR daos_mock)
  ...
  if(fail-on-missing)
    ...
    find_package(libuuid)
    if(NOT libuuid_FOUND)
      message(FATAL_ERROR "libuuid not found. Cannot build daos. Reconfigure with -Ddaos=off to build without daos.")
    endif()
  endif()
endif()
if (daos)
  ...
  if(fail-on-missing)
    ...
    find_package(DAOS)
    if(NOT DAOS_FOUND)
      message(FATAL_ERROR "libdaos not found. Cannot build daos. Reconfigure with -Ddaos=off to build without daos.")
    endif()
  endif()
endif()

  ...
  if(civetweb_FOUND)
    ...
    if(NOT "${CIVETWEB_HAS_WEBSOCKET}" STREQUAL "1")
      ...
      foreach(var CIVETWEB_LIBRARIES CIVETWEB_LIBRARY CIVETWEB_LIBRARY_DEBUG CIVETWEB_LIBRARY_RELEASE CIVETWEB_FOUND CIVETWEB_VERSION CIVETWEB_INCLUDE_DIR CIVETWEB_LIBRARY CIVETWEB_LIBRARIES)
        ...
        unset(${var} CACHE)
      endforeach()
      message(WARNING "Force-enabling builtin_civetweb since found system-wide version does not include websocket component (-DCIVETWEB_ENABLE_WEBSOCKETS=ON)")
      set(builtin_civetweb ON CACHE BOOL "Enabled because system-wide civetweb version was compiled without websockets (-DCIVETWEB_ENABLE_WEBSOCKETS=ON)" FORCE)
    endif()
  endif()

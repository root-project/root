...
# A failed connection check will cause a fatal
# configuration error.
# Input variables:
#    option:
  ...
  if(NOT DEFINED NO_CONNECTION)
    if(NOT check_connection)
      ...
      if(${STATUS_CODE} EQUAL 0)
        ...
        # Error
        message(SEND_ERROR "No internet connection. Please check your connection, set '-D${option}' to automatically disable options requiring internet access. You can also bypass the connection check with -Dcheck_connection=OFF.")
...
# Check internet connection. If no connection, disable the option
#----------------------------------------------------------------------------
macro(ROOT_CHECK_CONNECTION_AND_DISABLE_OPTION option_name)
...
if(opengl OR cocoa)
  ...
  if(NOT OPENGL_FOUND OR NOT OPENGL_GLU_FOUND)
    message(SEND_ERROR "OpenGL package (with GLU) not found and required for opengl or cocoa")
  endif()
endif()
...
if (daos OR daos_mock)
  message(STATUS "Looking for libuuid for daos or daos_mock")
...
int main() { return 0; }" tbb_exception_result)
    if(NOT tbb_exception_result)
      message(SEND_ERROR "Found TBB uses tbb::captured_exception, not suitable for ROOT!, enable 'builtin_tbb' option")
    endif()
  endif()
...
if(tmva-sofie)
  if(testing)
    ...
    find_package(BLAS)
    if(NOT BLAS_FOUND)
      message(SEND_ERROR "BLAS not found, but it's required for TMVA-SOFIE testing")
    endif()
  endif()

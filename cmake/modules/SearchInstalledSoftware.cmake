...
if(builtin_xrootd)
  ...
  if(NO_CONNECTION)
    ...
    list(APPEND HOTFIX_BUILD_FLAGS '-Dxrootd=OFF -Dbuiltin_xrootd=OFF')
  endif()
...
if (daos OR daos_mock)
  ...
  if(NOT libuuid_FOUND)
    ...
    list(APPEND HOTFIX_BUILD_FLAGS '-Ddaos=OFF -Ddaos_mock=OFF')
  endif()
endif()
if (daos)
  find_package(DAOS)
...
if(builtin_tbb)
  ...
  if(NO_CONNECTION)
    ...
    list(APPEND HOTFIX_BUILD_FLAGS '-Dbuiltin_tbb=OFF -Dimt=OFF')
  endif()
endif()
...
if(builtin_vdt)
  ...
  if(NO_CONNECTION)
    ...
    list(APPEND HOTFIX_BUILD_FLAGS '-Dbuiltin_vdt=OFF -Dvdt=OFF')
  endif()
endif()
...
if(mathmore OR builtin_gsl OR (tmva-cpu AND use_gsl_cblas))
  if(builtin_gsl)
    ...
    if(NO_CONNECTION)
      ...
      list(APPEND HOTFIX_BUILD_FLAGS '-Dbuiltin_gsl=OFF -Dtmva-cpu=OFF -Duse_gsl_cblas=OFF')
    endif()
  endif()
  if(builtin_gsl)
...
if (testing OR testsupport)
  if (builtin_gtest)
    ...
    if(NO_CONNECTION)
      ...
      list(APPEND HOTFIX_BUILD_FLAGS '-Dtesting=OFF -Dtestsupport=OFF -Dbuiltin_gtest=OFF')
    else()

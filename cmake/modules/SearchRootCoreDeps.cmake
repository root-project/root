...
if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.14)
  ...
  if(PYTHON_EXECUTABLE)
    ...
    if(Python${PYTHON_PREFER_VERSION}_Interpreter_FOUND)
      ...
      set(PYTHON_VERSION_STRING "${Python${PYTHON_PREFER_VERSION}_VERSION}")
      set(PYTHON_VERSION_MAJOR "${Python${PYTHON_PREFER_VERSION}_VERSION_MAJOR}")
      set(PYTHON_VERSION_MINOR "${Python${PYTHON_PREFER_VERSION}_VERSION_MINOR}")
      ...
      if(Python${PYTHON_PREFER_VERSION}_NumPy_FOUND)
        ...
        set(NUMPY_INCLUDE_DIRS "${Python${PYTHON_PREFER_VERSION}_NumPy_INCLUDE_DIRS}")
      endif()
    endif()

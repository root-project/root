...
elseif(MSVC)
  ...
  if(asan)
    ...
    set(ASAN_EXTRA_SHARED_LINKER_FLAGS "/InferASanLibs /incremental:no")
    set(ASAN_EXTRA_EXE_LINKER_FLAGS "/InferASanLibs /incremental:no")
    if(winrtdebug)
      set(ASAN_EXTRA_SHARED_LINKER_FLAGS "${ASAN_EXTRA_SHARED_LINKER_FLAGS} /DEBUG")
      set(ASAN_EXTRA_EXE_LINKER_FLAGS "${ASAN_EXTRA_EXE_LINKER_FLAGS} /DEBUG")
    endif()
  endif()

  if(CMAKE_PROJECT_NAME STREQUAL ROOT)
    set(CMAKE_CXX_FLAGS "-nologo -I${CMAKE_SOURCE_DIR}/cmake/win -Zc:__cplusplus -std:c++${CMAKE_CXX_STANDARD} -GR -FIw32pragma.h -FIsehmap.h ${BLDCXXFLAGS} -EHsc -d2FH4- -W3 -wd4141 -wd4291 -wd4244 -wd4049 -wd4146 -wd4250 -wd4624 ${ARCH} -D_XKEYCHECK_H -DNOMINMAX -D_CRT_SECURE_NO_WARNINGS")
    set(CMAKE_C_FLAGS   "-nologo -I${CMAKE_SOURCE_DIR}/cmake/win -FIw32pragma.h -FIsehmap.h -GR ${BLDCFLAGS} -EHsc -d2FH4- -W3 ${ARCH} -DNOMINMAX")
    ...
    set(CMAKE_CXX_FLAGS "-nologo -FIw32pragma.h -FIsehmap.h -Zc:__cplusplus -std:c++${CMAKE_CXX_STANDARD} -GR ${BLDCXXFLAGS} -EHsc -d2FH4- -W3 -wd4244 ${ARCH}")
    set(CMAKE_C_FLAGS   "-nologo -FIw32pragma.h -FIsehmap.h -GR ${BLDCFLAGS} -EHsc -d2FH4- -W3 ${ARCH}")
  endif()

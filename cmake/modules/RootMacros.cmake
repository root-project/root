...
macro(ROOTTEST_COMPILE_MACRO filename)
  ...
  if(CMAKE_GENERATOR MATCHES Ninja AND NOT MSVC)
    set_tests_properties(${COMPILE_MACRO_TEST} PROPERTIES
        RESOURCE_LOCK NINJA_COMPILATION
        FIXTURES_REQUIRED UPDATE_BUILD_TREE)
  endif()
  if (ARG_FIXTURES_SETUP)
...
macro(ROOTTEST_GENERATE_DICTIONARY dictname)
  ...
  if(CMAKE_GENERATOR MATCHES Ninja AND NOT MSVC)
    set_tests_properties(${GENERATE_DICTIONARY_TEST} PROPERTIES
        RESOURCE_LOCK NINJA_COMPILATION
        FIXTURES_REQUIRED UPDATE_BUILD_TREE)
  endif()
...
macro(ROOTTEST_GENERATE_REFLEX_DICTIONARY dictionary)
  ...
  if(CMAKE_GENERATOR MATCHES Ninja AND NOT MSVC)
    set_tests_properties(${GENERATE_REFLEX_TEST} PROPERTIES
        RESOURCE_LOCK NINJA_COMPILATION
        FIXTURES_REQUIRED UPDATE_BUILD_TREE)
  endif()
...
macro(ROOTTEST_GENERATE_EXECUTABLE executable)
  ...
  if(CMAKE_GENERATOR MATCHES Ninja AND NOT MSVC)
    set_tests_properties(${GENERATE_EXECUTABLE_TEST} PROPERTIES
        RESOURCE_LOCK NINJA_COMPILATION
        FIXTURES_REQUIRED UPDATE_BUILD_TREE)
  endif()

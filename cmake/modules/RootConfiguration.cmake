...
#set(ROOT_CONFIGARGS "")
set(top_srcdir ${ROOT_SOURCE_DIR})
set(top_builddir ${ROOT_BINARY_DIR})
...
#---RConfigure.h---------------------------------------------------------------------------------------------
try_compile(has__cplusplus "${ROOT_BINARY_DIR}" SOURCES "${ROOT_SOURCE_DIR}/config/__cplusplus.cxx"
...
install(FILES ${ROOT_BINARY_DIR}/ginclude/RConfigure.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
...
configure_file(${ROOT_SOURCE_DIR}/config/rootrc.in ${ROOT_BINARY_DIR}/etc/system.rootrc @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/rootauthrc.in ${ROOT_BINARY_DIR}/etc/system.rootauthrc @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/rootdaemonrc.in ${ROOT_BINARY_DIR}/etc/system.rootdaemonrc @ONLY NEWLINE_STYLE UNIX)

# file used in TROOT.cxx, not need in include/ dir and not need to install
configure_file(${ROOT_SOURCE_DIR}/config/RConfigOptions.in ginclude/RConfigOptions.h NEWLINE_STYLE UNIX)

configure_file(${ROOT_SOURCE_DIR}/config/Makefile-comp.in config/Makefile.comp NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/Makefile.in config/Makefile.config NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/mimes.unix.in ${ROOT_BINARY_DIR}/etc/root.mimes NEWLINE_STYLE UNIX)
...
configure_file(${ROOT_SOURCE_DIR}/etc/class.rules ${ROOT_BINARY_DIR}/etc/class.rules COPYONLY)
...
configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/ROOTConfig-version.cmake.in
               ${ROOT_BINARY_DIR}/ROOTConfig-version.cmake @ONLY NEWLINE_STYLE UNIX)
...
if(MSVC)
  string(REPLACE "-I${ROOT_SOURCE_DIR}/build/win" "" __cxxflags "${__cxxflags}")
  string(REPLACE "-I${ROOT_SOURCE_DIR}/build/win" "" __cflags "${__cflags}")
endif()
...
set(ROOT_BINDIR ${ROOT_BINARY_DIR}/bin CACHE INTERNAL "")
...
set(ROOT_INCLUDE_DIRS ${ROOT_BINARY_DIR}/include)
")
set(ROOT_LIBRARY_DIR_SETUP "
# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_LIBRARY_DIR ${ROOT_BINARY_DIR}/lib)
")
set(ROOT_BINDIR_SETUP "
# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_BINDIR ${ROOT_BINARY_DIR}/bin)
")
...
# ROOT configured for use from the build tree - absolute paths are used.
set(ROOT_CMAKE_DIR ${ROOT_SOURCE_DIR}/cmake)
")
...
configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/ROOTConfig.cmake.in
               ${ROOT_BINARY_DIR}/ROOTConfig.cmake @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/RootUseFile.cmake.in
               ${ROOT_BINARY_DIR}/ROOTUseFile.cmake @ONLY NEWLINE_STYLE UNIX)
...
configure_file(${ROOT_SOURCE_DIR}/cmake/modules/RootMacros.cmake
               ${ROOT_BINARY_DIR}/RootMacros.cmake COPYONLY)

# used by roottest to run tests against ROOT build
configure_file(${ROOT_SOURCE_DIR}/cmake/modules/RootTestDriver.cmake
               ${ROOT_BINARY_DIR}/RootTestDriver.cmake COPYONLY)

configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/ROOTConfig.cmake.in
               ${ROOT_BINARY_DIR}/installtree/ROOTConfig.cmake @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/RootUseFile.cmake.in
               ${ROOT_BINARY_DIR}/installtree/ROOTUseFile.cmake @ONLY NEWLINE_STYLE UNIX)
install(FILES ${ROOT_BINARY_DIR}/ROOTConfig-version.cmake
              ${ROOT_BINARY_DIR}/installtree/ROOTUseFile.cmake
              ${ROOT_BINARY_DIR}/installtree/ROOTConfig.cmake DESTINATION ${CMAKE_INSTALL_CMAKEDIR})
...
if(WIN32)
  ...
  configure_file(${ROOT_SOURCE_DIR}/cmake/scripts/compiledata.win32.in ${ROOT_BINARY_DIR}/ginclude/compiledata.h NEWLINE_STYLE UNIX)
else()
  ...
  execute_process(COMMAND ${ROOT_SOURCE_DIR}/build/unix/compiledata.sh
    ${ROOT_BINARY_DIR}/ginclude/compiledata.h "${CMAKE_CXX_COMPILER}"
...
file(REMOVE ${ROOT_BINARY_DIR}/installtree/root-config)
configure_file(${ROOT_SOURCE_DIR}/config/root-config.in ${ROOT_BINARY_DIR}/installtree/root-config @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/thisroot.sh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.sh @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/thisroot.csh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.csh @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/thisroot.fish ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.fish @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/setxrd.csh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/setxrd.csh COPYONLY)
configure_file(${ROOT_SOURCE_DIR}/config/setxrd.sh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/setxrd.sh COPYONLY)
configure_file(${ROOT_SOURCE_DIR}/config/proofserv.in ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/proofserv @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/roots.in ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/roots @ONLY NEWLINE_STYLE UNIX)
configure_file(${ROOT_SOURCE_DIR}/config/rootssh ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/rootssh @ONLY NEWLINE_STYLE UNIX)
if(xproofd AND xrootd AND ssl AND XROOTD_NOMAIN)
  configure_file(${ROOT_SOURCE_DIR}/config/xproofd.in ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/xproofd @ONLY NEWLINE_STYLE UNIX)
endif()
if(WIN32)
  set(thisrootbat ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.bat)
  set(thisrootps1 ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.ps1)
  configure_file(${ROOT_SOURCE_DIR}/config/thisroot.bat ${thisrootbat} @ONLY)
  configure_file(${ROOT_SOURCE_DIR}/config/thisroot.ps1 ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/thisroot.ps1 @ONLY)
  configure_file(${ROOT_SOURCE_DIR}/config/root.rc.in ${ROOT_BINARY_DIR}/etc/root.rc @ONLY)
  configure_file(${ROOT_SOURCE_DIR}/config/root-manifest.xml.in ${ROOT_BINARY_DIR}/etc/root-manifest.xml @ONLY)
  install(FILES ${ROOT_SOURCE_DIR}/build/win/w32pragma.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} COMPONENT headers)
  install(FILES ${ROOT_SOURCE_DIR}/build/win/sehmap.h  DESTINATION ${CMAKE_INSTALL_INCLUDEDIR} COMPONENT headers)
endif()
...
configure_file(${ROOT_SOURCE_DIR}/config/root-config.in ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/root-config @ONLY NEWLINE_STYLE UNIX)
if(MSVC)
  configure_file(${ROOT_SOURCE_DIR}/config/root-config.bat.in ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/root-config.bat @ONLY)
...
install(FILES ${ROOT_BINARY_DIR}/installtree/root-config
...
install(FILES ${ROOT_BINARY_DIR}/ginclude/RConfigOptions.h
              ${ROOT_BINARY_DIR}/ginclude/compiledata.h
              DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})

install(FILES ${ROOT_BINARY_DIR}/etc/root.mimes
              ${ROOT_BINARY_DIR}/etc/system.rootrc
              ${ROOT_BINARY_DIR}/etc/system.rootauthrc
              ${ROOT_BINARY_DIR}/etc/system.rootdaemonrc
              DESTINATION ${CMAKE_INSTALL_SYSCONFDIR})

if(NOT gnuinstall)
  install(FILES ${ROOT_BINARY_DIR}/config/Makefile.comp
                ${ROOT_BINARY_DIR}/config/Makefile.config
                DESTINATION config)
endif()

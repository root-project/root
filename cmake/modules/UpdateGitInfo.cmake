...
# In script mode, CMake doesn't get ROOT_SOURCE_DIR / ROOT_BINARY_DIR right.
if(SRCDIR)
  set(ROOT_SOURCE_DIR ${SRCDIR})
endif()
if(BINDIR)
  set(ROOT_BINARY_DIR ${BINDIR})
endif()

include(${ROOT_SOURCE_DIR}/cmake/modules/SetROOTVersion.cmake)

function(UPDATE_GIT_VERSION)
  string(TIMESTAMP PSEUDO_GIT_TIMESTAMP "%b %d %Y, %H:%M:%S" UTC)
  if(GIT_DESCRIBE_ALL)
    file(WRITE ${ROOT_BINARY_DIR}/etc/gitinfo.txt

...
function(SET_VERSION_FROM_FILE)
  ...
  file(READ "${ROOT_SOURCE_DIR}/core/foundation/inc/ROOT/RVersion.hxx" versionstr)
...
function(SET_ROOT_VERSION)
  if(Git_FOUND AND EXISTS ${ROOT_SOURCE_DIR}/.git)
    execute_process(COMMAND ${GIT_EXECUTABLE} --git-dir=${ROOT_SOURCE_DIR}/.git describe --all
  ...
  if(${ROOT_PATCH_VERSION_ODD} EQUAL 1)
    if(NOT GIT_DESCRIBE_ERRCODE)
      execute_process(COMMAND ${GIT_EXECUTABLE} --git-dir=${ROOT_SOURCE_DIR}/.git describe --always

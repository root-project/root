...
if (CMAKE_SYSTEM_NAME MATCHES Darwin)
  ...
  elseif(${CMAKE_CXX_COMPILER_ID} MATCHES Clang)
     ...
     if(asan)
       ...
       set(ASAN_EXTRA_CXX_FLAGS -fsanitize=address -fno-omit-frame-pointer -fsanitize-address-use-after-scope -fsanitize-blacklist=${PROJECT_SOURCE_DIR}/build/ASan_blacklist.txt)

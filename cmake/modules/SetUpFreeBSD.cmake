...
if(CMAKE_SYSTEM_PROCESSOR MATCHES x86_64 OR CMAKE_SYSTEM_PROCESSOR MATCHES amd64)
  if(CMAKE_CXX_COMPILER_ID STREQUAL Intel)
    ...
    set(ROOT_ARCHITECTURE freebsdx8664)
  endif()
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES i686)
  set(FP_MATH_FLAGS "-msse2 -mfpmath=sse")
  if(CMAKE_CXX_COMPILER_ID STREQUAL Intel)
    set(ROOT_ARCHITECTURE freebsdicc)
  else()
    set(ROOT_ARCHITECTURE freebsd)
  endif()
...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES ppc64 OR
  ...
  set(ROOT_ARCHITECTURE freebsdppc64gcc)
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES s390x)
  set(ROOT_ARCHITECTURE freebsds390xgcc)
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES s390)
  set(ROOT_ARCHITECTURE freebsds390gcc)

...
if(libcxx)
  ...
  if(NOT HAS_LIBCXX11)
    message(SEND_ERROR "Current compiler ${CMAKE_CXX_COMPILER_ID} does not support -stdlib=libc++ option. Install compatible compiler or set -Dlibcxx=OFF")
    list(APPEND HOTFIX_BUILD_FLAGS -Dlibcxx=OFF)
  endif()
endif()

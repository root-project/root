...
ROOT_BUILD_OPTION(sysinstall OFF "Perform installation as a system package")
...
if(CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT AND NOT sysinstall)
...
if(sysinstall)
  ...
  set(CINTINC_INSTALL_DIR cint)
  set(ICON_INSTALL_DIR    icons)
  set(SRC_INSTALL_DIR     src)
  set(FONT_INSTALL_DIR    fonts)
  set(DOC_INSTALL_DIR     .)
  set(TEST_INSTALL_DIR    test)
  set(TUT_INSTALL_DIR     tutorials)
  set(ACLOCAL_INSTALL_DIR build/misc)
  set(ELISP_INSTALL_DIR   build/misc)

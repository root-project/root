...
ROOT_BUILD_OPTION(builtin_cfitsio OFF "Build CFITSIO from an externally provided source tarball (requires network)")
...
ROOT_BUILD_OPTION(builtin_civetweb OFF "Build civetweb from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_fftw3 OFF "Build FFTW3 from an externally provided source tarball (requires network) [GPL]")
ROOT_BUILD_OPTION(builtin_freetype OFF "Build freetype from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_ftgl OFF "Build FTGL from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_gif OFF "Build libgif from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_gl2ps OFF "Build gl2ps from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_gsl OFF "Build GSL from an externally provided source tarball (requires network) [GPL]")
ROOT_BUILD_OPTION(builtin_gtest OFF "Build googletest from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_jpeg OFF "Build libjpeg from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_llvm ON "Build bundled copy of LLVM (advanced option)")
MARK_AS_ADVANCED(builtin_llvm)
ROOT_BUILD_OPTION(builtin_lz4 OFF "Build lz4 from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_lzma OFF "Build lzma from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_nlohmannjson OFF "Build nlohmann/json from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_openssl OFF "Build OpenSSL from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_openui5 ON "Use openui5 bundle distributed with ROOT")
ROOT_BUILD_OPTION(builtin_pcre OFF "Build PCRE2 from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_png OFF "Build libpng from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_tbb OFF "Build TBB from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_tiff OFF "Build libtiff from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_unuran OFF "Build unuran from an externally provided source tarball (requires network) [GPL]")
ROOT_BUILD_OPTION(builtin_vdt OFF "Build VDT from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_xrootd OFF "Build XRootD from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_xxhash OFF "Build xxHash from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_zlib OFF "Build zlib from an externally provided source tarball (requires network)")
ROOT_BUILD_OPTION(builtin_zstd OFF "Build zstd from an externally provided source tarball (requires network)")

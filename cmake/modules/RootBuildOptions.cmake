...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
    # require at least gcc 4.5
    if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 4.5)
        message("GCC version must be at least 4.5!")
	set(canBuildVC OFF)
    endif()
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Clang")
	...
	set(canBuildVC OFF)
        message("Clang version must be at least 4.0 to build Vc!")
    endif()
elseif ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
    # require at least MSVC 2010 (corresponding number is 1600)
    if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 1600)
	set(canBuildVC OFF)
        message("MSVC version must be at least 2010 to build Vc!")
    endif()
endif()

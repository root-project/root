...
if(CMAKE_COMPILER_IS_GNUCXX)
  ...
  # Select flags.
  ROOT_SET_COMPILER_FLAGS(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O3 -g"  "Flags for release build with debug info")
  ROOT_SET_COMPILER_FLAGS(CMAKE_CXX_FLAGS_RELEASE        "-O3"     "Flags for release build")
  ROOT_SET_COMPILER_FLAGS(CMAKE_CXX_FLAGS_DEBUG          "-g"      "Flags for a debug build")
  ROOT_SET_COMPILER_FLAGS(CMAKE_C_FLAGS_RELWITHDEBINFO   "-O3 -g"  "Flags for release build with debug info")
  ROOT_SET_COMPILER_FLAGS(CMAKE_C_FLAGS_RELEASE          "-O3"     "Flags for release build")
  ROOT_SET_COMPILER_FLAGS(CMAKE_C_FLAGS_DEBUG            "-g"      "Flags for a debug build")

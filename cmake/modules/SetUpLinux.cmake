...
if(CMAKE_COMPILER_IS_GNUCXX)
  ...
  set(CMAKE_CXX_FLAGS_OPTIMIZED      "-Ofast -DNDEBUG"  CACHE STRING "Flags for a highly optimised build")
  set(CMAKE_CXX_FLAGS_DEBUG          "-g"               CACHE STRING "Flags for a debug build")
  set(CMAKE_CXX_FLAGS_DEBUGFULL      "-g3"              CACHE STRING "Flags for a debug build with more debug info")
  set(CMAKE_CXX_FLAGS_PROFILE        "-g3 -ftest-coverage -fprofile-arcs" CACHE STRING "")
  ...
  set(CMAKE_C_FLAGS_OPTIMIZED        "-Ofast -DNDEBUG"  CACHE STRING "Flags for a highly optimised build")
  set(CMAKE_C_FLAGS_DEBUG            "-g"               CACHE STRING "Flags for a debug build")
  set(CMAKE_C_FLAGS_DEBUGFULL        "-g3 -fno-inline"  CACHE STRING "Flags for a debug build with more debug info")
  set(CMAKE_C_FLAGS_PROFILE          "-g3 -fno-inline -ftest-coverage -fprofile-arcs" CACHE STRING "")
elseif(CMAKE_CXX_COMPILER_ID STREQUAL Clang)
  ...
  set(CMAKE_CXX_FLAGS_OPTIMIZED      "-O3 -ffast-math -DNDEBUG"  CACHE STRING "Flags for a highly optimised build")
  set(CMAKE_CXX_FLAGS_DEBUG          "-g"                        CACHE STRING "Flags for a debug build")
  set(CMAKE_CXX_FLAGS_DEBUGFULL      "-g3"                       CACHE STRING "Flags for a debug build with more debug info")
  set(CMAKE_CXX_FLAGS_PROFILE        "-g3 -ftest-coverage -fprofile-arcs" CACHE STRING "")
  ...
  set(CMAKE_C_FLAGS_OPTIMIZED        "-O3 -ffast-math -DNDEBUG"  CACHE STRING "Flags for a highly optimised build")
  set(CMAKE_C_FLAGS_DEBUG            "-g"                        CACHE STRING "Flags for a debug build")
  set(CMAKE_C_FLAGS_DEBUGFULL        "-g3"                       CACHE STRING "Flags for a debug build with more debug info")
  set(CMAKE_C_FLAGS_PROFILE          "-g3 -ftest-coverage -fprofile-arcs" CACHE STRING "")
elseif(CMAKE_CXX_COMPILER_ID STREQUAL Intel)
  ...
  set(CMAKE_CXX_FLAGS_OPTIMIZED      "-O3 -DNDEBUG"                      CACHE STRING "Flags for a highly optimised build")
  ...
  set(CMAKE_C_FLAGS_OPTIMIZED        "-O3 -DNDEBUG"                      CACHE STRING "Flags for a highly optimised build")

...
find_path(HDFS_INCLUDE_DIR NAMES hdfs.h  HINTS ${CCTOOLS_DIR}/include $ENV{CCTOOLS_DIR}/inlcude)
find_library(HDFS_LIBRARY NAMES hdfs HINTS ${CCTOOLS_DIR}/lib/native $ENV{HDFS_DIR}/lib/native)

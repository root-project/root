...
function(ROOT_GENERATE_DICTIONARY dictionary)
  ...
  if(ARG_MODULE)
    ...
    if(ARG_MULTIDICT)
      set(cpp_module ${ARG_MODULE}_${dictionary})
    else()
    ...
    set(cpp_module ${deduced_arg_module})
  endif()

  set(pcm_name ${library_output_dir}/${libprefix}${cpp_module}_rdict.pcm)
  set(rootmap_name ${library_output_dir}/${libprefix}${cpp_module}.rootmap)
  set(newargs -s ${library_output_dir}/${library_name})
  if(ARG_MODULE AND ARG_MULTIDICT)

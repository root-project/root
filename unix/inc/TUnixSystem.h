// @(#)root/unix:$Name:  $:$Id: TUnixSystem.h,v 1.16 2004/01/28 02:41:42 rdm Exp $
...
protected:
   ...
   static void         UnixSigAlarmInterruptsSyscall(Bool_t set);
...
public:
   ...
   void              SigAlarmInterruptsSyscall(Bool_t set);

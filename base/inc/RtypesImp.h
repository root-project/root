...
namespace ROOT {
   ...
   inline void GenericShowMembers(const char *topClassName, 
      ...
      // This could be faster if we implemented this either as a templated function
      // either by rootcint-generated code using the typeid (i.e. the difference is
      // a lookup a in TList instead of in a map.

//
// File generated by utils/src/rootcint_tmp at Fri Feb  9 08:50:11 2007
...
{
      ((TDirectory*) G__getstructoffset())->GetObject((const char*) G__int(libp->para[0]), libp->para[1].ref ? *(void**) libp->para[1].ref : *(void**) (&G__Mlong(libp->para[1])));
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
}

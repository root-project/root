//
// File generated by utils/src/rootcint_tmp at Thu Jun  3 11:54:19 2004.
...
//    switch(libp->paran) {
//    case 3:
//       G__letint(result7,105,(long)((TDirectory*)(G__getstructoffset()))->WriteObject((const void*)G__int(libp->para[0]),(const char*)G__int(libp->para[1])
...
//       G__setnull(result7);
//       ((TDirectory*)(G__getstructoffset()))->GetObjectAny((const char*)G__int(libp->para[0]),libp->para[1].ref?*(void**)libp->para[1].ref:*(void**)(&G__Mlong(libp->para[1])));
//    return(1 || funcname || hash || result7 || libp) ;
// }
...
static void G__setup_memfuncTDirectory(void) {
   ...
   G__memfunc_setup("WriteObject",1122,G__ManualBase4_104_4_8,105,-1,G__defined_typename("Int_t"),0,3,1,1,0,
"Y - - 10 - obj C - - 10 - name "
"C - 'Option_t' 10 \"\" option",(char*)NULL,(void*)NULL,0);
   G__memfunc_setup("GetObjectAny",1183,G__ManualBase4_104_5_8,121,-1,-1,0,2,1,1,0,

// @(#)root/matrix:$Name:  $:$Id: TMatrix.cxx,v 1.44 2003/07/16 21:22:19 brun Exp $
...
void TMatrix::EigenSort(TMatrix &eigenVectors, TVector &eigenValues)
{
  ...
  */
  ...
  Real_t *pVec = eigenVectors.fElements;
  Real_t *pVal = eigenValues.fElements;

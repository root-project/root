// @(#)root/matrix:$Name:  $:$Id: TMatrixDSym.h,v 1.25 2003/09/05 09:21:54 brun Exp $
...
inline const Double_t *TMatrixDSym::GetElements  () const { return fElements; }
inline       Double_t *TMatrixDSym::GetElements  ()       { return fElements; }

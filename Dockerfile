...
# RUN cd root_build && cmake -DCMAKE_INSTALL_PREFIX=/home/root/root_install -Dtmva-sofie=On -Dtmva-pymva=Off -DPython3_executable=/usr/bin/python3 -Dtesting=On -DBLAS_LIBRARIES=/usr/lib/x86_64-linux-gnu/blas/libblas.so -DProtobuf_LIBRARIES=/usr/lib/x86_64-linux-gnu/libprotobuf.so -Dsofie-sycl=On 
...
RUN cd root_build && cmake -DCMAKE_INSTALL_PREFIX=/home/root/root_install -Droofit=Off -Dtmva-sofie=On -Dtmva-pymva=Off -DPython3_executable=/usr/bin/python3 -Dtesting=On -DBLAS_LIBRARIES=/usr/lib/x86_64-linux-gnu/blas/libblas.so -DProtobuf_LIBRARIES=/usr/lib/x86_64-linux-gnu/libprotobuf.so -Dsofie-sycl=On  -DCMAKE_C_COMPILER=/opt/intel/oneapi/compiler/2023.2.1/linux/bin/icx  -DCMAKE_CXX_COMPILER=/opt/intel/oneapi/compiler/2023.2.1/linux/bin/icpx  -DIntelSYCL_DIR=/opt/intel/oneapi/compiler/2023.2.1/linux/IntelSYCL/  -Dxrootd=Off -Dbuiltin_xrootd=Off -DTBB_LIBRARY=/opt/intel/oneapi/tbb/2021.10.0/lib/intel64/gcc4.8/libtbb.so /home/root/root_src && cmake --build . -j16 --target install
# cd root_build && /data/ipanagou/cmake_install/bin/cmake -DCMAKE_INSTALL_PREFIX=/data/ipanagou/root_install -Dtmva-sofie=On -Dtmva-pymva=Off -DPython3_executable=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/intelpython/latest/bin/python3 -Dtesting=On -DBLAS_LIBRARIES=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/mkl/2023.2.0/lib/intel64/libmkl_rt.so -DProtobuf_LIBRARIES=/var/lib/snapd/snap/protobuf/52/lib/libprotobuf.so -Dsofie-sycl=On -DCMAKE_C_COMPILER=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/compiler/2023.2.1/linux/bin/icx -DCMAKE_CXX_COMPILER=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/compiler/2023.2.1/linux/bin/icpx -DIntelSYCL_DIR=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/compiler/2023.2.1/linux/IntelSYCL  -Dxrootd=Off -Dbuiltin_xrootd=Off -DTBB_LIBRARY=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/tbb/2021.10.0/lib/intel64/gcc4.8/libtbb.so -DProtobuf_INCLUDE_DIR=/var/lib/snapd/snap/protobuf/52/include/ -DMKL_DIR=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/mkl/2023.2.0/lib/cmake/mkl/ /data/ipanagou/root_src
# /data/ipanagou/cmake_install/bin/cmake -DCMAKE_INSTALL_PREFIX=/data/ipanagou/root_install -Dtmva-sofie=On -Dtmva-pymva=Off -DPython3_executable=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/intelpython/latest/bin/python3 -Dtesting=Off -DBLAS_LIBRARIES=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/mkl/2023.2.0/lib/intel64/libmkl_rt.so -DProtobuf_LIBRARIES=/var/lib/snapd/snap/protobuf/52/lib/libprotobuf.so -DProtobuf_PROTOC_EXECUTABLE=/var/lib/snapd/snap/protobuf/52/bin/protoc -Dsofie-sycl=On -DCMAKE_C_COMPILER=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/compiler/2023.2.1/linux/bin/icx -DCMAKE_CXX_COMPILER=/cvmfs/projects.cern.ch/intelsw/oneAPI/linux/x86_64/2023/compiler/2023.2.1/linux/bin/icpx -Dxrootd=Off -Dbuiltin_xrootd=Off -Dimt=Off -DProtobuf_INCLUDE_DIR=/var/lib/snapd/snap/protobuf/52/include/ /data/ipanagou/root_src 
# cmake -DCMAKE_INSTALL_PREFIX=/home/root/root_install -Droofit=Off -Dtmva-sofie=On -Dtmva-pymva=Off -DPython3_executable=/usr/bin/python3 -Dtesting=On -DBLAS_LIBRARIES=/usr/lib/x86_64-linux-gnu/blas/libblas.so -DProtobuf_LIBRARIES=/usr/lib/x86_64-linux-gnu/libprotobuf.so -Dsofie-sycl=On  -DCMAKE_C_COMPILER=/opt/intel/oneapi/compiler/2023.2.1/linux/bin/icx  -DCMAKE_CXX_COMPILER=/opt/intel/oneapi/compiler/2023.2.1/linux/bin/icpx  -DIntelSYCL_DIR=/opt/intel/oneapi/compiler/2023.2.1/linux/IntelSYCL/  -Dxrootd=Off -Dbuiltin_xrootd=Off -DTBB_LIBRARY=/opt/intel/oneapi/tbb/2021.10.0/lib/intel64/gcc4.8/libtbb.so -DSYCL_IMPLEMENTATION=IntelSYCL -DTARGET_GPU=Intel -DGPU_BLAS=portBLAS -DPORTBLAS_INCLUDE_DIR=/home/root/portblas_install/include -DPORTBLAS_SRC_DIR=/home/root/portBLAS/src -Dbuiltin_davix=Off -Ddavix=Off /home/root/root_src

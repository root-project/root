// @(#)root/cont:$Name:  $:$Id: TArrayF.h,v 1.15 2002/10/30 20:39:50 brun Exp $
...
public:
   ...
   void           Copy(TArrayF &array) const {array.Set(fN); memcpy(array.fArray,fArray,fN*sizeof(Float_t));}

// @(#)root/cont:$Name:  $:$Id: TArrayS.h,v 1.14 2002/10/30 20:39:50 brun Exp $
...
public:
   ...
   void           Copy(TArrayS &array) const {array.Set(fN); memcpy(array.fArray,fArray,fN*sizeof(Short_t));}
